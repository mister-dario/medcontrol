<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_ORDEN_TRABAJO']['sc_process_barr'] = true;
require_once('../pdfreport_ORDEN_TRABAJO/index.php');
unset($_SESSION['scriptcase']['pdfreport_ORDEN_TRABAJO']['sc_process_barr']);
$ExportCtrl = new pdfreport_ORDEN_TRABAJO_export_control;
$ExportCtrl->Export_barr();

class pdfreport_ORDEN_TRABAJO_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - FACTURA</TITLE>
