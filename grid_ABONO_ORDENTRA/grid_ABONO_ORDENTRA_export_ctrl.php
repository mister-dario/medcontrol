<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ABONO_ORDENTRA']['sc_process_barr'] = true;
require_once('../grid_ABONO_ORDENTRA/index.php');
unset($_SESSION['scriptcase']['grid_ABONO_ORDENTRA']['sc_process_barr']);
$ExportCtrl = new grid_ABONO_ORDENTRA_export_control;
$ExportCtrl->Export_barr();

class grid_ABONO_ORDENTRA_export_control
{
