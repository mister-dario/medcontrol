...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_ABONO_ORDENTRA"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_ABONO_ORDENTRA"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ABONO_ORDENTRA']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ABONO_ORDENTRA']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ABONO_ORDENTRA']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ABONO_ORDENTRA']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ABONO_ORDENTRA']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_ABONO_ORDENTRA</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ABONO_ORDENTRA']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ABONO_ORDENTRA']['embutida_filho'] as $ind => $sc_init)
          {
