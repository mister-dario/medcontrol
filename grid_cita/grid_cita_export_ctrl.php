<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cita']['sc_process_barr'] = true;
require_once('../grid_cita/index.php');
unset($_SESSION['scriptcase']['grid_cita']['sc_process_barr']);
$ExportCtrl = new grid_cita_export_control;
$ExportCtrl->Export_barr();

class grid_cita_export_control
{
