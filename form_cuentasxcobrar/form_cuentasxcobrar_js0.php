<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="emiruc_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['emiruc_']); ?>">
<input type="hidden" name="cxctipodoc_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['cxctipodoc_']); ?>">
<input type="hidden" name="cxcnumdoc_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['cxcnumdoc_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_cuentasxcobrar"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_cuentasxcobrar_submit_form(y, z);
