  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_servicio" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate sercodigo
  function do_ajax_form_servicio_validate_sercodigo()
  {
    var nomeCampo_sercodigo = "sercodigo";
    var var_sercodigo = scAjaxGetFieldHidden(nomeCampo_sercodigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_validate_sercodigo(var_sercodigo, var_script_case_init, do_ajax_form_servicio_validate_sercodigo_cb);
  } // do_ajax_form_servicio_validate_sercodigo

  function do_ajax_form_servicio_validate_sercodigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_validate_sercodigo_cb

  // ---------- Validate sernombre
  function do_ajax_form_servicio_validate_sernombre()
  {
    var nomeCampo_sernombre = "sernombre";
    var var_sernombre = scAjaxGetFieldText(nomeCampo_sernombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_validate_sernombre(var_sernombre, var_script_case_init, do_ajax_form_servicio_validate_sernombre_cb);
  } // do_ajax_form_servicio_validate_sernombre

  function do_ajax_form_servicio_validate_sernombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_validate_sernombre_cb

  // ---------- Validate serduracion
  function do_ajax_form_servicio_validate_serduracion()
  {
    var nomeCampo_serduracion = "serduracion";
    var var_serduracion = scAjaxGetFieldText(nomeCampo_serduracion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_validate_serduracion(var_serduracion, var_script_case_init, do_ajax_form_servicio_validate_serduracion_cb);
  } // do_ajax_form_servicio_validate_serduracion

  function do_ajax_form_servicio_validate_serduracion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_validate_serduracion_cb

  // ---------- Validate espcodigo
  function do_ajax_form_servicio_validate_espcodigo()
  {
  } // do_ajax_form_servicio_validate_espcodigo

  function do_ajax_form_servicio_validate_espcodigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_validate_espcodigo_cb

  // ---------- Validate serprecio
  function do_ajax_form_servicio_validate_serprecio()
  {
    var nomeCampo_serprecio = "serprecio";
    var var_serprecio = scAjaxGetFieldText(nomeCampo_serprecio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_validate_serprecio(var_serprecio, var_script_case_init, do_ajax_form_servicio_validate_serprecio_cb);
  } // do_ajax_form_servicio_validate_serprecio

  function do_ajax_form_servicio_validate_serprecio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_validate_serprecio_cb

  // ---------- Validate sersincosto
  function do_ajax_form_servicio_validate_sersincosto()
  {
    var nomeCampo_sersincosto = "sersincosto";
    var var_sersincosto = scAjaxGetFieldCheckbox(nomeCampo_sersincosto, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_validate_sersincosto(var_sersincosto, var_script_case_init, do_ajax_form_servicio_validate_sersincosto_cb);
  } // do_ajax_form_servicio_validate_sersincosto

  function do_ajax_form_servicio_validate_sersincosto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_validate_sersincosto_cb

  // ---------- Validate serusucrea
  function do_ajax_form_servicio_validate_serusucrea()
  {
    var nomeCampo_serusucrea = "serusucrea";
    var var_serusucrea = scAjaxGetFieldText(nomeCampo_serusucrea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_validate_serusucrea(var_serusucrea, var_script_case_init, do_ajax_form_servicio_validate_serusucrea_cb);
  } // do_ajax_form_servicio_validate_serusucrea

  function do_ajax_form_servicio_validate_serusucrea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_validate_serusucrea_cb

  // ---------- Validate serfeccrea
  function do_ajax_form_servicio_validate_serfeccrea()
  {
    var nomeCampo_serfeccrea = "serfeccrea";
    var var_serfeccrea = scAjaxGetFieldText(nomeCampo_serfeccrea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_validate_serfeccrea(var_serfeccrea, var_script_case_init, do_ajax_form_servicio_validate_serfeccrea_cb);
  } // do_ajax_form_servicio_validate_serfeccrea

  function do_ajax_form_servicio_validate_serfeccrea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_validate_serfeccrea_cb

  // ---------- Validate serusumodi
  function do_ajax_form_servicio_validate_serusumodi()
  {
    var nomeCampo_serusumodi = "serusumodi";
    var var_serusumodi = scAjaxGetFieldText(nomeCampo_serusumodi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_validate_serusumodi(var_serusumodi, var_script_case_init, do_ajax_form_servicio_validate_serusumodi_cb);
  } // do_ajax_form_servicio_validate_serusumodi

  function do_ajax_form_servicio_validate_serusumodi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_validate_serusumodi_cb

  // ---------- Validate serfecmodi
  function do_ajax_form_servicio_validate_serfecmodi()
  {
    var nomeCampo_serfecmodi = "serfecmodi";
    var var_serfecmodi = scAjaxGetFieldText(nomeCampo_serfecmodi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_validate_serfecmodi(var_serfecmodi, var_script_case_init, do_ajax_form_servicio_validate_serfecmodi_cb);
  } // do_ajax_form_servicio_validate_serfecmodi

  function do_ajax_form_servicio_validate_serfecmodi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_validate_serfecmodi_cb

  // ---------- Event onclick sersincosto
  function do_ajax_form_servicio_event_sersincosto_onclick()
  {
    var var_sersincosto = scAjaxGetFieldCheckbox("sersincosto", ";");
    var var_serprecio = scAjaxGetFieldText("serprecio");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_servicio_event_sersincosto_onclick(var_sersincosto, var_serprecio, var_script_case_init, do_ajax_form_servicio_event_sersincosto_onclick_cb);
  } // do_ajax_form_servicio_event_sersincosto_onclick

  function do_ajax_form_servicio_event_sersincosto_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "sersincosto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_servicio_event_sersincosto_onclick_cb_after_alert);
  } // do_ajax_form_servicio_event_sersincosto_onclick_cb
  function do_ajax_form_servicio_event_sersincosto_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_servicio_event_sersincosto_onclick_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_servicio_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_servicio_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_servicio_submit_form(var_sercodigo, var_sernombre, var_serduracion, var_espcodigo, var_serprecio, var_sersincosto, var_serusucrea, var_serfeccrea, var_serusumodi, var_serfecmodi, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_servicio_submit_form_cb);
  } // do_ajax_form_servicio_submit_form

  function do_ajax_form_servicio_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_servicio_submit_form_cb_after_alert);
  } // do_ajax_form_servicio_submit_form_cb
  function do_ajax_form_servicio_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_servicio_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_servicio_navigate_form()
  {
    perform_ajax_form_servicio_navigate_form();
  }

  function perform_ajax_form_servicio_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_servicio_navigate_form(var_sercodigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_servicio_navigate_form_cb);
  } // do_ajax_form_servicio_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_servicio_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_servicio_navigate_form_cb_after_alert);
  } // do_ajax_form_servicio_navigate_form_cb
  function do_ajax_form_servicio_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_servicio_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_servicio_navigate_form_cb_after_alert
  function sc_hide_form_servicio_form()
  {
