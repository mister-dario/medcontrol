...
<style type="text/css">
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_servicio_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_servicio_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-espcodigo", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_servicio_event_espcodigo_onchange) { do_ajax_form_servicio_event_espcodigo_onchange(sRow); }
    }
   }
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    $vertical_center = '';
...
<?php
 include_once("form_servicio_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_servicio'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_servicio'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['fast_search'][2] : "";
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sercodigo_label" id="hidden_field_label_sercodigo" style="<?php echo $sStyleHidden_sercodigo; ?>"><span id="id_label_sercodigo"><?php echo $this->nm_new_label['sercodigo']; ?></span></TD>
    <TD class="scFormDataOdd css_sercodigo_line" id="hidden_field_data_sercodigo" style="<?php echo $sStyleHidden_sercodigo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sercodigo_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_sercodigo" class="css_sercodigo_line" style="<?php echo $sStyleReadLab_sercodigo; ?>"><?php echo $this->form_format_readonly("sercodigo", $this->form_encode_input($this->sercodigo)); ?></span><span id="id_read_off_sercodigo" class="css_read_off_sercodigo" style="<?php echo $sStyleReadInp_sercodigo; ?>"><input type="hidden" name="sercodigo" value="<?php echo $this->form_encode_input($sercodigo) . "\">"?><span id="id_ajax_label_sercodigo"><?php echo nl2br($sercodigo); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sernombre_label" id="hidden_field_label_sernombre" style="<?php echo $sStyleHidden_sernombre; ?>"><span id="id_label_sernombre"><?php echo $this->nm_new_label['sernombre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['php_cmp_required']['sernombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['php_cmp_required']['sernombre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_sernombre_line" id="hidden_field_data_sernombre" style="<?php echo $sStyleHidden_sernombre; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sernombre_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_serduracion_label" id="hidden_field_label_serduracion" style="<?php echo $sStyleHidden_serduracion; ?>"><span id="id_label_serduracion"><?php echo $this->nm_new_label['serduracion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['php_cmp_required']['serduracion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['php_cmp_required']['serduracion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_serduracion_line" id="hidden_field_data_serduracion" style="<?php echo $sStyleHidden_serduracion; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_serduracion_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_espcodigo_label" id="hidden_field_label_espcodigo" style="<?php echo $sStyleHidden_espcodigo; ?>"><span id="id_label_espcodigo"><?php echo $this->nm_new_label['espcodigo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['php_cmp_required']['espcodigo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['php_cmp_required']['espcodigo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_espcodigo_line" id="hidden_field_data_espcodigo" style="<?php echo $sStyleHidden_espcodigo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_espcodigo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_serprecio_label" id="hidden_field_label_serprecio" style="<?php echo $sStyleHidden_serprecio; ?>"><span id="id_label_serprecio"><?php echo $this->nm_new_label['serprecio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['php_cmp_required']['serprecio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['php_cmp_required']['serprecio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_serprecio_line" id="hidden_field_data_serprecio" style="<?php echo $sStyleHidden_serprecio; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_serprecio_line" style="vertical-align: top;padding: 0px">
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sersincosto_label" id="hidden_field_label_sersincosto" style="<?php echo $sStyleHidden_sersincosto; ?>"><span id="id_label_sersincosto"><?php echo $this->nm_new_label['sersincosto']; ?></span></TD>
    <TD class="scFormDataOdd css_sersincosto_line" id="hidden_field_data_sersincosto" style="<?php echo $sStyleHidden_sersincosto; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sersincosto_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['Lookup_sersincosto'][] = '1'; ?>
<?php  if (in_array("1", $this->sersincosto_1))  { echo " checked" ;} ?> onClick="do_ajax_form_servicio_event_sersincosto_onclick();" ><span></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_serusucrea_label" id="hidden_field_label_serusucrea" style="<?php echo $sStyleHidden_serusucrea; ?>"><span id="id_label_serusucrea"><?php echo $this->nm_new_label['serusucrea']; ?></span></TD>
    <TD class="scFormDataOdd css_serusucrea_line" id="hidden_field_data_serusucrea" style="<?php echo $sStyleHidden_serusucrea; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_serusucrea_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_serfeccrea_label" id="hidden_field_label_serfeccrea" style="<?php echo $sStyleHidden_serfeccrea; ?>"><span id="id_label_serfeccrea"><?php echo $this->nm_new_label['serfeccrea']; ?></span></TD>
    <TD class="scFormDataOdd css_serfeccrea_line" id="hidden_field_data_serfeccrea" style="<?php echo $sStyleHidden_serfeccrea; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_serfeccrea_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_serusumodi_label" id="hidden_field_label_serusumodi" style="<?php echo $sStyleHidden_serusumodi; ?>"><span id="id_label_serusumodi"><?php echo $this->nm_new_label['serusumodi']; ?></span></TD>
    <TD class="scFormDataOdd css_serusumodi_line" id="hidden_field_data_serusumodi" style="<?php echo $sStyleHidden_serusumodi; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_serusumodi_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_serfecmodi_label" id="hidden_field_label_serfecmodi" style="<?php echo $sStyleHidden_serfecmodi; ?>"><span id="id_label_serfecmodi"><?php echo $this->nm_new_label['serfecmodi']; ?></span></TD>
    <TD class="scFormDataOdd css_serfecmodi_line" id="hidden_field_data_serfecmodi" style="<?php echo $sStyleHidden_serfecmodi; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_serfecmodi_line" style="vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_servicio");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_servicio");
 parent.scAjaxDetailHeight("form_servicio", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
