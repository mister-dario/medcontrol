...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_serfeccrea_hora' + iSeqRow).bind('blur', function() { sc_form_servicio_serfeccrea_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_servicio_serfeccrea_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_serfecmodi_hora' + iSeqRow).bind('blur', function() { sc_form_servicio_serfecmodi_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_servicio_serfecmodi_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function scHidePage(pageNo) {
	$("#id_form_servicio_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_serfeccrea" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_servicio_mob_validate_serfeccrea(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_serfecmodi" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_servicio_mob_validate_serfecmodi(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_servicio_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
