  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_servicio_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_servicio_mob_form();
	}
  ...
  // ---------- Validate sercodigo
  function do_ajax_form_servicio_mob_validate_sercodigo()
  {
    var nomeCampo_sercodigo = "sercodigo";
    var var_sercodigo = scAjaxGetFieldHidden(nomeCampo_sercodigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_mob_validate_sercodigo(var_sercodigo, var_script_case_init, do_ajax_form_servicio_mob_validate_sercodigo_cb);
  } // do_ajax_form_servicio_mob_validate_sercodigo

  function do_ajax_form_servicio_mob_validate_sercodigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sercodigo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_mob_validate_sercodigo_cb

  // ---------- Validate sernombre
  function do_ajax_form_servicio_mob_validate_sernombre()
  {
    var nomeCampo_sernombre = "sernombre";
    var var_sernombre = scAjaxGetFieldText(nomeCampo_sernombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_mob_validate_sernombre(var_sernombre, var_script_case_init, do_ajax_form_servicio_mob_validate_sernombre_cb);
  } // do_ajax_form_servicio_mob_validate_sernombre

  function do_ajax_form_servicio_mob_validate_sernombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sernombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_mob_validate_sernombre_cb

  // ---------- Validate serduracion
  function do_ajax_form_servicio_mob_validate_serduracion()
  {
    var nomeCampo_serduracion = "serduracion";
    var var_serduracion = scAjaxGetFieldText(nomeCampo_serduracion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_mob_validate_serduracion(var_serduracion, var_script_case_init, do_ajax_form_servicio_mob_validate_serduracion_cb);
  } // do_ajax_form_servicio_mob_validate_serduracion

  function do_ajax_form_servicio_mob_validate_serduracion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "serduracion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_mob_validate_serduracion_cb

  // ---------- Validate espcodigo
  function do_ajax_form_servicio_mob_validate_espcodigo()
  {
  } // do_ajax_form_servicio_mob_validate_espcodigo

  function do_ajax_form_servicio_mob_validate_espcodigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_mob_validate_espcodigo_cb

  // ---------- Validate serprecio
  function do_ajax_form_servicio_mob_validate_serprecio()
  {
    var nomeCampo_serprecio = "serprecio";
    var var_serprecio = scAjaxGetFieldText(nomeCampo_serprecio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_mob_validate_serprecio(var_serprecio, var_script_case_init, do_ajax_form_servicio_mob_validate_serprecio_cb);
  } // do_ajax_form_servicio_mob_validate_serprecio

  function do_ajax_form_servicio_mob_validate_serprecio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "serprecio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_mob_validate_serprecio_cb

  // ---------- Validate sersincosto
  function do_ajax_form_servicio_mob_validate_sersincosto()
  {
    var nomeCampo_sersincosto = "sersincosto";
    var var_sersincosto = scAjaxGetFieldCheckbox(nomeCampo_sersincosto, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_mob_validate_sersincosto(var_sersincosto, var_script_case_init, do_ajax_form_servicio_mob_validate_sersincosto_cb);
  } // do_ajax_form_servicio_mob_validate_sersincosto

  function do_ajax_form_servicio_mob_validate_sersincosto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sersincosto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_mob_validate_sersincosto_cb

  // ---------- Validate serusucrea
  function do_ajax_form_servicio_mob_validate_serusucrea()
  {
    var nomeCampo_serusucrea = "serusucrea";
    var var_serusucrea = scAjaxGetFieldText(nomeCampo_serusucrea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_mob_validate_serusucrea(var_serusucrea, var_script_case_init, do_ajax_form_servicio_mob_validate_serusucrea_cb);
  } // do_ajax_form_servicio_mob_validate_serusucrea

  function do_ajax_form_servicio_mob_validate_serusucrea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "serusucrea";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_mob_validate_serusucrea_cb

  // ---------- Validate serfeccrea
  function do_ajax_form_servicio_mob_validate_serfeccrea()
  {
    var nomeCampo_serfeccrea = "serfeccrea";
    var var_serfeccrea = scAjaxGetFieldText(nomeCampo_serfeccrea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_mob_validate_serfeccrea(var_serfeccrea, var_script_case_init, do_ajax_form_servicio_mob_validate_serfeccrea_cb);
  } // do_ajax_form_servicio_mob_validate_serfeccrea

  function do_ajax_form_servicio_mob_validate_serfeccrea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "serfeccrea";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_mob_validate_serfeccrea_cb

  // ---------- Validate serusumodi
  function do_ajax_form_servicio_mob_validate_serusumodi()
  {
    var nomeCampo_serusumodi = "serusumodi";
    var var_serusumodi = scAjaxGetFieldText(nomeCampo_serusumodi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_mob_validate_serusumodi(var_serusumodi, var_script_case_init, do_ajax_form_servicio_mob_validate_serusumodi_cb);
  } // do_ajax_form_servicio_mob_validate_serusumodi

  function do_ajax_form_servicio_mob_validate_serusumodi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "serusumodi";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_mob_validate_serusumodi_cb

  // ---------- Validate serfecmodi
  function do_ajax_form_servicio_mob_validate_serfecmodi()
  {
    var nomeCampo_serfecmodi = "serfecmodi";
    var var_serfecmodi = scAjaxGetFieldText(nomeCampo_serfecmodi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servicio_mob_validate_serfecmodi(var_serfecmodi, var_script_case_init, do_ajax_form_servicio_mob_validate_serfecmodi_cb);
  } // do_ajax_form_servicio_mob_validate_serfecmodi

  function do_ajax_form_servicio_mob_validate_serfecmodi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "serfecmodi";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servicio_mob_validate_serfecmodi_cb

  // ---------- Event onclick sersincosto
  function do_ajax_form_servicio_mob_event_sersincosto_onclick()
  {
    var var_sersincosto = scAjaxGetFieldCheckbox("sersincosto", ";");
    var var_serprecio = scAjaxGetFieldText("serprecio");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_servicio_mob_event_sersincosto_onclick(var_sersincosto, var_serprecio, var_script_case_init, do_ajax_form_servicio_mob_event_sersincosto_onclick_cb);
  } // do_ajax_form_servicio_mob_event_sersincosto_onclick

  function do_ajax_form_servicio_mob_event_sersincosto_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "sersincosto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_servicio_mob_event_sersincosto_onclick_cb_after_alert);
  } // do_ajax_form_servicio_mob_event_sersincosto_onclick_cb
  function do_ajax_form_servicio_mob_event_sersincosto_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_servicio_mob_event_sersincosto_onclick_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_servicio_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_servicio_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_sercodigo = scAjaxGetFieldHidden("sercodigo");
    var var_sernombre = scAjaxGetFieldText("sernombre");
    var var_serduracion = scAjaxGetFieldText("serduracion");
    var var_espcodigo = scAjaxGetFieldText("espcodigo");
    var var_serprecio = scAjaxGetFieldText("serprecio");
    var var_sersincosto = scAjaxGetFieldCheckbox("sersincosto", ";");
    var var_serusucrea = scAjaxGetFieldText("serusucrea");
    var var_serfeccrea = scAjaxGetFieldText("serfeccrea");
    var var_serusumodi = scAjaxGetFieldText("serusumodi");
    var var_serfecmodi = scAjaxGetFieldText("serfecmodi");
    ...
    scAjaxProcOn();
    x_ajax_form_servicio_mob_submit_form(var_sercodigo, var_sernombre, var_serduracion, var_espcodigo, var_serprecio, var_sersincosto, var_serusucrea, var_serfeccrea, var_serusumodi, var_serfecmodi, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_servicio_mob_submit_form_cb);
  } // do_ajax_form_servicio_mob_submit_form

  function do_ajax_form_servicio_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("sercodigo");
      scAjaxHideErrorDisplay("sernombre");
      scAjaxHideErrorDisplay("serduracion");
      scAjaxHideErrorDisplay("espcodigo");
      scAjaxHideErrorDisplay("serprecio");
      scAjaxHideErrorDisplay("sersincosto");
      scAjaxHideErrorDisplay("serusucrea");
      scAjaxHideErrorDisplay("serfeccrea");
      scAjaxHideErrorDisplay("serusumodi");
      scAjaxHideErrorDisplay("serfecmodi");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_servicio_mob_submit_form_cb_after_alert);
  } // do_ajax_form_servicio_mob_submit_form_cb
  function do_ajax_form_servicio_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_servicio_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_servicio_mob_navigate_form()
  {
    perform_ajax_form_servicio_mob_navigate_form();
  }

  function perform_ajax_form_servicio_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("serusumodi");
    scAjaxHideErrorDisplay("serfecmodi");
    var var_sercodigo = document.F2.sercodigo.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_servicio_mob_navigate_form(var_sercodigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_servicio_mob_navigate_form_cb);
  } // do_ajax_form_servicio_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_servicio_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_servicio_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.sercodigo.value = scAjaxGetKeyValue("sercodigo");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_servicio_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_servicio_mob_navigate_form_cb
  function do_ajax_form_servicio_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_servicio_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_servicio_mob_navigate_form_cb_after_alert
  function sc_hide_form_servicio_mob_form()
  {
  ...
  ajax_field_list[0] = "sercodigo";
  ajax_field_list[1] = "sernombre";
  ajax_field_list[2] = "serduracion";
  ajax_field_list[3] = "espcodigo";
  ajax_field_list[4] = "serprecio";
  ajax_field_list[5] = "sersincosto";
  ajax_field_list[6] = "serusucrea";
  ajax_field_list[7] = "serfeccrea";
  ajax_field_list[8] = "serusumodi";
  ajax_field_list[9] = "serfecmodi";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "sercodigo": {"label": "CÓDIGO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sernombre": {"label": "NOMBRE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "serduracion": {"label": "DURACIÓN (min)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "serprecio": {"label": "PRECIO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sersincosto": {"label": "SIN COSTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "serusucrea": {"label": "USUARIO CREACIÓN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "serfeccrea": {"label": "FECHA CREACIÓN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "serusumodi": {"label": "USUARIO MODIFICACIÓN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "serfecmodi": {"label": "FECHA MODIFICACIÓN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "sercodigo": new Array(),
    "sernombre": new Array(),
    "serduracion": new Array(),
    "espcodigo": new Array(),
    "serprecio": new Array(),
    "sersincosto": new Array(),
    "serusucrea": new Array(),
    "serfeccrea": new Array(),
    "serusumodi": new Array(),
    "serfecmodi": new Array()
  };
  ajax_field_mult["sercodigo"][1] = "sercodigo";
  ajax_field_mult["sernombre"][1] = "sernombre";
  ajax_field_mult["serduracion"][1] = "serduracion";
  ajax_field_mult["espcodigo"][1] = "espcodigo";
  ajax_field_mult["serprecio"][1] = "serprecio";
  ajax_field_mult["sersincosto"][1] = "sersincosto";
  ajax_field_mult["serusucrea"][1] = "serusucrea";
  ajax_field_mult["serfeccrea"][1] = "serfeccrea";
  ajax_field_mult["serusumodi"][1] = "serusumodi";
  ajax_field_mult["serfecmodi"][1] = "serfecmodi";

  var ajax_field_id = {
    "sercodigo": new Array("hidden_field_label_sercodigo", "hidden_field_data_sercodigo"),
    "sernombre": new Array("hidden_field_label_sernombre", "hidden_field_data_sernombre"),
    "serduracion": new Array("hidden_field_label_serduracion", "hidden_field_data_serduracion"),
    "espcodigo": new Array("hidden_field_label_espcodigo", "hidden_field_data_espcodigo"),
    "serprecio": new Array("hidden_field_label_serprecio", "hidden_field_data_serprecio"),
    "sersincosto": new Array("hidden_field_label_sersincosto", "hidden_field_data_sersincosto"),
    "serusucrea": new Array("hidden_field_label_serusucrea", "hidden_field_data_serusucrea"),
    "serfeccrea": new Array("hidden_field_label_serfeccrea", "hidden_field_data_serfeccrea"),
    "serusumodi": new Array("hidden_field_label_serusumodi", "hidden_field_data_serusumodi"),
    "serfecmodi": new Array("hidden_field_label_serfecmodi", "hidden_field_data_serfecmodi")
  };
