...
class grid_FACTURAS_FIRMADAS_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_grid_FACTURAS_FIRMADAS" . $this->Xls_tp;
      ...
      require_once($this->Ini->path_aplicacao . "grid_FACTURAS_FIRMADAS_total.class.php"); 
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_FIRMADAS']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['grid_FACTURAS_FIRMADAS']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_FIRMADAS']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_FIRMADAS']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_FIRMADAS']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_FIRMADAS']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_FIRMADAS']['embutida'])
      { 
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_FIRMADAS']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_FIRMADAS']['nolabel'])
       {
