...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_FACTURAS_FIRMADAS"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_FACTURAS_FIRMADAS"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_FIRMADAS']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_FIRMADAS']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_FIRMADAS']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_FIRMADAS']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_FIRMADAS']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_FACTURAS_FIRMADAS</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_FIRMADAS']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_FIRMADAS']['embutida_filho'] as $ind => $sc_init)
          {
