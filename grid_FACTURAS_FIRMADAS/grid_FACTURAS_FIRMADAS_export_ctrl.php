<?php
@session_start() ;
$_SESSION['scriptcase']['grid_FACTURAS_FIRMADAS']['sc_process_barr'] = true;
require_once('../grid_FACTURAS_FIRMADAS/index.php');
unset($_SESSION['scriptcase']['grid_FACTURAS_FIRMADAS']['sc_process_barr']);
$ExportCtrl = new grid_FACTURAS_FIRMADAS_export_control;
$ExportCtrl->Export_barr();

class grid_FACTURAS_FIRMADAS_export_control
{
