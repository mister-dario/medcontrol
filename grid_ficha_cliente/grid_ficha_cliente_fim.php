...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_ficha_cliente"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_ficha_cliente"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_ficha_cliente'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ficha_cliente']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ficha_cliente']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ficha_cliente']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ficha_cliente']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ficha_cliente']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_ficha_cliente</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ficha_cliente']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ficha_cliente']['embutida_filho'] as $ind => $sc_init)
          {
