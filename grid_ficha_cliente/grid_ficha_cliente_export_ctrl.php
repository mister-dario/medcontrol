<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ficha_cliente']['sc_process_barr'] = true;
require_once('../grid_ficha_cliente/index.php');
unset($_SESSION['scriptcase']['grid_ficha_cliente']['sc_process_barr']);
$ExportCtrl = new grid_ficha_cliente_export_control;
$ExportCtrl->Export_barr();

class grid_ficha_cliente_export_control
{
