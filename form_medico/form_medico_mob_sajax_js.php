...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate medcodigo
  function do_ajax_form_medico_mob_validate_medcodigo()
  {
    var nomeCampo_medcodigo = "medcodigo";
    var var_medcodigo = scAjaxGetFieldHidden(nomeCampo_medcodigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_mob_validate_medcodigo(var_medcodigo, var_script_case_init, do_ajax_form_medico_mob_validate_medcodigo_cb);
  } // do_ajax_form_medico_mob_validate_medcodigo

  function do_ajax_form_medico_mob_validate_medcodigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_mob_validate_medcodigo_cb

  // ---------- Validate medapellidos
  function do_ajax_form_medico_mob_validate_medapellidos()
  {
    var nomeCampo_medapellidos = "medapellidos";
    var var_medapellidos = scAjaxGetFieldText(nomeCampo_medapellidos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_mob_validate_medapellidos(var_medapellidos, var_script_case_init, do_ajax_form_medico_mob_validate_medapellidos_cb);
  } // do_ajax_form_medico_mob_validate_medapellidos

  function do_ajax_form_medico_mob_validate_medapellidos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medapellidos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_mob_validate_medapellidos_cb

  // ---------- Validate mednombres
  function do_ajax_form_medico_mob_validate_mednombres()
  {
    var nomeCampo_mednombres = "mednombres";
    var var_mednombres = scAjaxGetFieldText(nomeCampo_mednombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_mob_validate_mednombres(var_mednombres, var_script_case_init, do_ajax_form_medico_mob_validate_mednombres_cb);
  } // do_ajax_form_medico_mob_validate_mednombres

  function do_ajax_form_medico_mob_validate_mednombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mednombres";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_mob_validate_mednombres_cb

  // ---------- Validate medemail
  function do_ajax_form_medico_mob_validate_medemail()
  {
    var nomeCampo_medemail = "medemail";
    var var_medemail = scAjaxGetFieldText(nomeCampo_medemail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_mob_validate_medemail(var_medemail, var_script_case_init, do_ajax_form_medico_mob_validate_medemail_cb);
  } // do_ajax_form_medico_mob_validate_medemail

  function do_ajax_form_medico_mob_validate_medemail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medemail";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_mob_validate_medemail_cb

  // ---------- Validate medtelefonos
  function do_ajax_form_medico_mob_validate_medtelefonos()
  {
    var nomeCampo_medtelefonos = "medtelefonos";
    var var_medtelefonos = scAjaxGetFieldText(nomeCampo_medtelefonos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_mob_validate_medtelefonos(var_medtelefonos, var_script_case_init, do_ajax_form_medico_mob_validate_medtelefonos_cb);
  } // do_ajax_form_medico_mob_validate_medtelefonos

  function do_ajax_form_medico_mob_validate_medtelefonos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medtelefonos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_mob_validate_medtelefonos_cb

  // ---------- Validate especialidades
  function do_ajax_form_medico_mob_validate_especialidades()
  {
    var nomeCampo_especialidades = "especialidades";
    nm_pack(nomeCampo_especialidades + '_dest', nomeCampo_especialidades);
    var var_especialidades = scAjaxGetFieldText(nomeCampo_especialidades);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_mob_validate_especialidades(var_especialidades, var_script_case_init, do_ajax_form_medico_mob_validate_especialidades_cb);
  } // do_ajax_form_medico_mob_validate_especialidades

  function do_ajax_form_medico_mob_validate_especialidades_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_mob_validate_especialidades_cb

  // ---------- Validate medusucrea
  function do_ajax_form_medico_mob_validate_medusucrea()
  {
    var nomeCampo_medusucrea = "medusucrea";
    var var_medusucrea = scAjaxGetFieldText(nomeCampo_medusucrea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_mob_validate_medusucrea(var_medusucrea, var_script_case_init, do_ajax_form_medico_mob_validate_medusucrea_cb);
  } // do_ajax_form_medico_mob_validate_medusucrea

  function do_ajax_form_medico_mob_validate_medusucrea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medusucrea";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_mob_validate_medusucrea_cb

  // ---------- Validate medfeccrea
  function do_ajax_form_medico_mob_validate_medfeccrea()
  {
    var nomeCampo_medfeccrea = "medfeccrea";
    var var_medfeccrea = scAjaxGetFieldText(nomeCampo_medfeccrea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_mob_validate_medfeccrea(var_medfeccrea, var_script_case_init, do_ajax_form_medico_mob_validate_medfeccrea_cb);
  } // do_ajax_form_medico_mob_validate_medfeccrea

  function do_ajax_form_medico_mob_validate_medfeccrea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medfeccrea";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_mob_validate_medfeccrea_cb

  // ---------- Validate medusumodi
  function do_ajax_form_medico_mob_validate_medusumodi()
  {
    var nomeCampo_medusumodi = "medusumodi";
    var var_medusumodi = scAjaxGetFieldText(nomeCampo_medusumodi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_mob_validate_medusumodi(var_medusumodi, var_script_case_init, do_ajax_form_medico_mob_validate_medusumodi_cb);
  } // do_ajax_form_medico_mob_validate_medusumodi

  function do_ajax_form_medico_mob_validate_medusumodi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medusumodi";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_mob_validate_medusumodi_cb

  // ---------- Validate medfecmodi
  function do_ajax_form_medico_mob_validate_medfecmodi()
  {
    var nomeCampo_medfecmodi = "medfecmodi";
    var var_medfecmodi = scAjaxGetFieldText(nomeCampo_medfecmodi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_mob_validate_medfecmodi(var_medfecmodi, var_script_case_init, do_ajax_form_medico_mob_validate_medfecmodi_cb);
  } // do_ajax_form_medico_mob_validate_medfecmodi

  function do_ajax_form_medico_mob_validate_medfecmodi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medfecmodi";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_mob_validate_medfecmodi_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_form_medico_mob_submit_form()
  {
    ...
    scAjaxHideMessage();
    var var_medcodigo = scAjaxGetFieldHidden("medcodigo");
    var var_medapellidos = scAjaxGetFieldText("medapellidos");
    var var_mednombres = scAjaxGetFieldText("mednombres");
    var var_medemail = scAjaxGetFieldText("medemail");
    var var_medtelefonos = scAjaxGetFieldText("medtelefonos");
    nm_pack("especialidades_dest", "especialidades");
    var var_especialidades = scAjaxGetFieldText("especialidades", "@?@");
    var var_medusucrea = scAjaxGetFieldText("medusucrea");
    var var_medfeccrea = scAjaxGetFieldText("medfeccrea");
    var var_medusumodi = scAjaxGetFieldText("medusumodi");
    var var_medfecmodi = scAjaxGetFieldText("medfecmodi");
    ...
    scAjaxProcOn();
    x_ajax_form_medico_mob_submit_form(var_medcodigo, var_medapellidos, var_mednombres, var_medemail, var_medtelefonos, var_especialidades, var_medusucrea, var_medfeccrea, var_medusumodi, var_medfecmodi, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_medico_mob_submit_form_cb);
  ...
  function do_ajax_form_medico_mob_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("medapellidos");
      scAjaxHideErrorDisplay("mednombres");
      scAjaxHideErrorDisplay("medemail");
      scAjaxHideErrorDisplay("medtelefonos");
      scAjaxHideErrorDisplay("especialidades");
      scAjaxHideErrorDisplay("medusucrea");
      scAjaxHideErrorDisplay("medfeccrea");
      scAjaxHideErrorDisplay("medusumodi");
      scAjaxHideErrorDisplay("medfecmodi");
      scLigEditLookupCall();
<?php
...
?>
  ...
  function perform_ajax_form_medico_mob_navigate_form()
  {
    ...
    scAjaxHideErrorDisplay("medusumodi");
    scAjaxHideErrorDisplay("medfecmodi");
    var var_medcodigo = document.F2.medcodigo.value;
    ...
    scAjaxProcOn();
    x_ajax_form_medico_mob_navigate_form(var_medcodigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_medico_mob_navigate_form_cb);
...
?>
  function do_ajax_form_medico_mob_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.medcodigo.value = scAjaxGetKeyValue("medcodigo");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
?>
  ...
  ajax_field_list[0] = "medcodigo";
  ajax_field_list[1] = "medapellidos";
  ajax_field_list[2] = "mednombres";
  ajax_field_list[3] = "medemail";
  ajax_field_list[4] = "medtelefonos";
  ajax_field_list[5] = "especialidades";
  ajax_field_list[6] = "medusucrea";
  ajax_field_list[7] = "medfeccrea";
  ajax_field_list[8] = "medusumodi";
  ajax_field_list[9] = "medfecmodi";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "medcodigo": {"label": "CÓDIGO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "medapellidos": {"label": "APELLIDOS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mednombres": {"label": "NOMBRES", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "medemail": {"label": "CORREO ELECTRÓNICO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "medtelefonos": {"label": "TELÉFONOS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "medusucrea": {"label": "USUARIO CREACIÓN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "medfeccrea": {"label": "FECHA CREACIÓN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "medusumodi": {"label": "USUARIO MODIFICACIÓN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "medfecmodi": {"label": "FECHA MODIFICACIÓN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "medcodigo": new Array(),
    "medapellidos": new Array(),
    "mednombres": new Array(),
    "medemail": new Array(),
    "medtelefonos": new Array(),
    "especialidades": new Array(),
    "medusucrea": new Array(),
    "medfeccrea": new Array(),
    "medusumodi": new Array(),
    "medfecmodi": new Array()
  };
  ajax_field_mult["medcodigo"][1] = "medcodigo";
  ajax_field_mult["medapellidos"][1] = "medapellidos";
  ajax_field_mult["mednombres"][1] = "mednombres";
  ajax_field_mult["medemail"][1] = "medemail";
  ajax_field_mult["medtelefonos"][1] = "medtelefonos";
  ajax_field_mult["especialidades"][1] = "especialidades";
  ajax_field_mult["medusucrea"][1] = "medusucrea";
  ajax_field_mult["medfeccrea"][1] = "medfeccrea";
  ajax_field_mult["medusumodi"][1] = "medusumodi";
  ajax_field_mult["medfecmodi"][1] = "medfecmodi";

  var ajax_field_id = {
    "medcodigo": new Array("hidden_field_label_medcodigo", "hidden_field_data_medcodigo"),
    "medapellidos": new Array("hidden_field_label_medapellidos", "hidden_field_data_medapellidos"),
    "mednombres": new Array("hidden_field_label_mednombres", "hidden_field_data_mednombres"),
    "medemail": new Array("hidden_field_label_medemail", "hidden_field_data_medemail"),
    "medtelefonos": new Array("hidden_field_label_medtelefonos", "hidden_field_data_medtelefonos"),
    "especialidades": new Array("hidden_field_label_especialidades", "hidden_field_data_especialidades"),
    "medusucrea": new Array("hidden_field_label_medusucrea", "hidden_field_data_medusucrea"),
    "medfeccrea": new Array("hidden_field_label_medfeccrea", "hidden_field_data_medfeccrea"),
    "medusumodi": new Array("hidden_field_label_medusumodi", "hidden_field_data_medusumodi"),
    "medfecmodi": new Array("hidden_field_label_medfecmodi", "hidden_field_data_medfecmodi")
  };
