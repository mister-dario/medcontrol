...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate medcodigo
  function do_ajax_form_medico_validate_medcodigo()
  {
    var nomeCampo_medcodigo = "medcodigo";
    var var_medcodigo = scAjaxGetFieldHidden(nomeCampo_medcodigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_validate_medcodigo(var_medcodigo, var_script_case_init, do_ajax_form_medico_validate_medcodigo_cb);
  } // do_ajax_form_medico_validate_medcodigo

  function do_ajax_form_medico_validate_medcodigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_validate_medcodigo_cb

  // ---------- Validate medapellidos
  function do_ajax_form_medico_validate_medapellidos()
  {
    var nomeCampo_medapellidos = "medapellidos";
    var var_medapellidos = scAjaxGetFieldText(nomeCampo_medapellidos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_validate_medapellidos(var_medapellidos, var_script_case_init, do_ajax_form_medico_validate_medapellidos_cb);
  } // do_ajax_form_medico_validate_medapellidos

  function do_ajax_form_medico_validate_medapellidos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_validate_medapellidos_cb

  // ---------- Validate mednombres
  function do_ajax_form_medico_validate_mednombres()
  {
    var nomeCampo_mednombres = "mednombres";
    var var_mednombres = scAjaxGetFieldText(nomeCampo_mednombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_validate_mednombres(var_mednombres, var_script_case_init, do_ajax_form_medico_validate_mednombres_cb);
  } // do_ajax_form_medico_validate_mednombres

  function do_ajax_form_medico_validate_mednombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_validate_mednombres_cb

  // ---------- Validate medemail
  function do_ajax_form_medico_validate_medemail()
  {
    var nomeCampo_medemail = "medemail";
    var var_medemail = scAjaxGetFieldText(nomeCampo_medemail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_validate_medemail(var_medemail, var_script_case_init, do_ajax_form_medico_validate_medemail_cb);
  } // do_ajax_form_medico_validate_medemail

  function do_ajax_form_medico_validate_medemail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_validate_medemail_cb

  // ---------- Validate medtelefonos
  function do_ajax_form_medico_validate_medtelefonos()
  {
    var nomeCampo_medtelefonos = "medtelefonos";
    var var_medtelefonos = scAjaxGetFieldText(nomeCampo_medtelefonos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_validate_medtelefonos(var_medtelefonos, var_script_case_init, do_ajax_form_medico_validate_medtelefonos_cb);
  } // do_ajax_form_medico_validate_medtelefonos

  function do_ajax_form_medico_validate_medtelefonos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_validate_medtelefonos_cb

  // ---------- Validate especialidades
  function do_ajax_form_medico_validate_especialidades()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_validate_especialidades(var_especialidades, var_script_case_init, do_ajax_form_medico_validate_especialidades_cb);
  } // do_ajax_form_medico_validate_especialidades

  function do_ajax_form_medico_validate_especialidades_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_validate_especialidades_cb

  // ---------- Validate medusucrea
  function do_ajax_form_medico_validate_medusucrea()
  {
    var nomeCampo_medusucrea = "medusucrea";
    var var_medusucrea = scAjaxGetFieldText(nomeCampo_medusucrea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_validate_medusucrea(var_medusucrea, var_script_case_init, do_ajax_form_medico_validate_medusucrea_cb);
  } // do_ajax_form_medico_validate_medusucrea

  function do_ajax_form_medico_validate_medusucrea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_validate_medusucrea_cb

  // ---------- Validate medfeccrea
  function do_ajax_form_medico_validate_medfeccrea()
  {
    var nomeCampo_medfeccrea = "medfeccrea";
    var var_medfeccrea = scAjaxGetFieldText(nomeCampo_medfeccrea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_validate_medfeccrea(var_medfeccrea, var_script_case_init, do_ajax_form_medico_validate_medfeccrea_cb);
  } // do_ajax_form_medico_validate_medfeccrea

  function do_ajax_form_medico_validate_medfeccrea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_validate_medfeccrea_cb

  // ---------- Validate medusumodi
  function do_ajax_form_medico_validate_medusumodi()
  {
    var nomeCampo_medusumodi = "medusumodi";
    var var_medusumodi = scAjaxGetFieldText(nomeCampo_medusumodi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_validate_medusumodi(var_medusumodi, var_script_case_init, do_ajax_form_medico_validate_medusumodi_cb);
  } // do_ajax_form_medico_validate_medusumodi

  function do_ajax_form_medico_validate_medusumodi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_validate_medusumodi_cb

  // ---------- Validate medfecmodi
  function do_ajax_form_medico_validate_medfecmodi()
  {
    var nomeCampo_medfecmodi = "medfecmodi";
    var var_medfecmodi = scAjaxGetFieldText(nomeCampo_medfecmodi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medico_validate_medfecmodi(var_medfecmodi, var_script_case_init, do_ajax_form_medico_validate_medfecmodi_cb);
  } // do_ajax_form_medico_validate_medfecmodi

  function do_ajax_form_medico_validate_medfecmodi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medico_validate_medfecmodi_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_form_medico_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_medico_submit_form(var_medcodigo, var_medapellidos, var_mednombres, var_medemail, var_medtelefonos, var_especialidades, var_medusucrea, var_medfeccrea, var_medusumodi, var_medfecmodi, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_medico_submit_form_cb);
...
?>
  ...
  function perform_ajax_form_medico_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_medico_navigate_form(var_medcodigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_medico_navigate_form_cb);
