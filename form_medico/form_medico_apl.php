...
//----- 
   function ini_controle()
   {
     ...
     global $espcodigo_especialidades, $espnombre_especialidades, $especialidades_1;
      ...
      $_SESSION['scriptcase']['error_icon']['form_medico']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_medico/form_medico_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_medico_calendar.php');
          }
          exit;
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['opc_ant'];
      } 
      ...
      else
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['lookup_filtro']['especialidades']);
          }
      }
...
//--------------------------------------------------------------------------------------
   function lookup_especialidades(&$conteudo)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['lookup_filtro']['especialidades'] = $nm_comando;
...
//---
    ...
    function ValidateField_medapellidos(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['php_cmp_required']['medapellidos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['php_cmp_required']['medapellidos'] == "on")) 
      { 
    ...
    function ValidateField_mednombres(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['php_cmp_required']['mednombres']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['php_cmp_required']['mednombres'] == "on")) 
      { 
          if ($this->mednombres == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_medtelefonos(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "TELÉFONOS " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 50 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
...
;
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "TELÉFONOS " . $this->Ini->Nm_lang['lang_errm_ivch']; 
              if (!isset($Campos_Erros['medtelefonos']))
              {
                  $Campos_Erros['medtelefonos'] = array();
              }
      ...
      if ($this->especialidades != "")
      {
          ...
          { 
              ...
              { 
                       ...
                       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['Lookup_especialidades']) && !in_array($dados_especialidades_1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['Lookup_especialidades']))
                       {
                           $hasError = true;
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['medcodigo']['keyVal'] = form_medico_pack_protect_string($this->nmgp_dados_form['medcodigo']);
          }
   } // ajax_return_values
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_medico_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_medico_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
  ...
  {
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_medico' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_medico']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['parms'] = "medcodigo?#?$this->medcodigo?@?"; 
      }
      $this->NM_commit_db(); 
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_medico']['SC_sep_date1'];
              }
          }
