...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_cobros_dia"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_cobros_dia"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_dia']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cobros_dia']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_dia']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cobros_dia']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_dia']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_dia']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cobros_dia']['embutida_filho'] as $ind => $sc_init)
          {
