<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="dprsecuen_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['dprsecuen_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_detalle_presupuesto_cita"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto_cita']['where_detal']))
  {
?>  
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_detalle_presupuesto_cita_submit_form(y, z);
