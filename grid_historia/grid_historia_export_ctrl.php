<?php
@session_start() ;
$_SESSION['scriptcase']['grid_historia']['sc_process_barr'] = true;
require_once('../grid_historia/index.php');
unset($_SESSION['scriptcase']['grid_historia']['sc_process_barr']);
$ExportCtrl = new grid_historia_export_control;
$ExportCtrl->Export_barr();

class grid_historia_export_control
{
