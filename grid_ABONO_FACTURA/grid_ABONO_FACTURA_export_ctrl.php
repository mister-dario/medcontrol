<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ABONO_FACTURA']['sc_process_barr'] = true;
require_once('../grid_ABONO_FACTURA/index.php');
unset($_SESSION['scriptcase']['grid_ABONO_FACTURA']['sc_process_barr']);
$ExportCtrl = new grid_ABONO_FACTURA_export_control;
$ExportCtrl->Export_barr();

class grid_ABONO_FACTURA_export_control
{
