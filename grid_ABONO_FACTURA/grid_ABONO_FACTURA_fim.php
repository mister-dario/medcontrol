...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_ABONO_FACTURA"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_ABONO_FACTURA"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ABONO_FACTURA']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ABONO_FACTURA']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ABONO_FACTURA']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ABONO_FACTURA']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ABONO_FACTURA']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_ABONO_FACTURA</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ABONO_FACTURA']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ABONO_FACTURA']['embutida_filho'] as $ind => $sc_init)
          {
