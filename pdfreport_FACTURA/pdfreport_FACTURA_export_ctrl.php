<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_FACTURA']['sc_process_barr'] = true;
require_once('../pdfreport_FACTURA/index.php');
unset($_SESSION['scriptcase']['pdfreport_FACTURA']['sc_process_barr']);
$ExportCtrl = new pdfreport_FACTURA_export_control;
$ExportCtrl->Export_barr();

class pdfreport_FACTURA_export_control
{
