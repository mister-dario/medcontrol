  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_medxesp" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate medcodigo_
  function do_ajax_form_medxesp_validate_medcodigo_(iNumLinha)
  {
  } // do_ajax_form_medxesp_validate_medcodigo_

  function do_ajax_form_medxesp_validate_medcodigo__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "medcodigo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "medcodigo_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "medcodigo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "medcodigo_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medxesp_validate_medcodigo__cb

  // ---------- Validate espcodigo_
  function do_ajax_form_medxesp_validate_espcodigo_(iNumLinha)
  {
  } // do_ajax_form_medxesp_validate_espcodigo_

  function do_ajax_form_medxesp_validate_espcodigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "espcodigo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "espcodigo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "espcodigo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "espcodigo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medxesp_validate_espcodigo__cb

  // ---------- Validate mxesecuen_
  function do_ajax_form_medxesp_validate_mxesecuen_(iNumLinha)
  {
    var nomeCampo_mxesecuen_ = "mxesecuen_" + iNumLinha;
    var var_mxesecuen_ = scAjaxGetFieldHidden(nomeCampo_mxesecuen_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medxesp_validate_mxesecuen_(var_mxesecuen_, iNumLinha, var_script_case_init, do_ajax_form_medxesp_validate_mxesecuen__cb);
  } // do_ajax_form_medxesp_validate_mxesecuen_

  function do_ajax_form_medxesp_validate_mxesecuen__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "mxesecuen_" + iLineNumber;
    }
    else
    {
      sFieldValid = "mxesecuen_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "mxesecuen_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "mxesecuen_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medxesp_validate_mxesecuen__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_medxesp_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_medxesp_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_medxesp_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_medxesp_add_new_line_cb);
  } // do_ajax_form_medxesp_add_new_line

  function do_ajax_form_medxesp_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_medxesp_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_medxesp_backup_line(iNumLinha)
  {
    var var_mxesecuen_ = scAjaxGetFieldHidden("mxesecuen_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medxesp_backup_line(var_mxesecuen_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_medxesp_backup_line_cb);
  } // do_ajax_form_medxesp_backup_line

  function do_ajax_form_medxesp_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_medxesp_backup_line_cb

  function do_ajax_form_medxesp_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_medxesp_cancel_insert

  function do_ajax_form_medxesp_cancel_update(iSeqVert)
  {
    do_ajax_form_medxesp_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_medxesp_cancel_update

  function do_ajax_form_medxesp_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_medxesp_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_medxesp_table_refresh()
  {
    var var_mxesecuen_ = document.F2.mxesecuen_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_medxesp_table_refresh(var_mxesecuen_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_medxesp_table_refresh_cb);
  } //  do_ajax_form_medxesp_table_refresh

  function do_ajax_form_medxesp_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.mxesecuen_.value = scAjaxGetKeyValue("mxesecuen_");
    ...
    scAjaxAlert(do_ajax_form_medxesp_table_refresh_cb_after_alert);
  } // do_ajax_form_medxesp_table_refresh_cb
  function do_ajax_form_medxesp_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_medxesp_table_refresh_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_medxesp_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_medxesp_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_medcodigo_ = scAjaxGetFieldText("medcodigo_" + iNumLinha);
    var var_espcodigo_ = scAjaxGetFieldText("espcodigo_" + iNumLinha);
    var var_mxesecuen_ = scAjaxGetFieldHidden("mxesecuen_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_medxesp_submit_form(var_medcodigo_, var_espcodigo_, var_mxesecuen_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_medxesp_submit_form_cb);
  } // do_ajax_form_medxesp_submit_form

  function do_ajax_form_medxesp_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("medcodigo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("espcodigo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("mxesecuen_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_medxesp_submit_form_cb_after_alert);
  } // do_ajax_form_medxesp_submit_form_cb
  function do_ajax_form_medxesp_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_medxesp_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_medxesp_navigate_form()
  {
    perform_ajax_form_medxesp_navigate_form();
  }

  function perform_ajax_form_medxesp_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_medxesp_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("medcodigo_" + iNavForm);
      scAjaxHideErrorDisplay("espcodigo_" + iNavForm);
      scAjaxHideErrorDisplay("mxesecuen_" + iNavForm);
    }
    var var_mxesecuen_ = document.F2.mxesecuen_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxProcOn();
    x_ajax_form_medxesp_navigate_form(var_mxesecuen_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_medxesp_navigate_form_cb);
  } // do_ajax_form_medxesp_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_medxesp']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_medxesp_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.mxesecuen_.value = scAjaxGetKeyValue("mxesecuen_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_medxesp_navigate_form_cb_after_alert);
  } // do_ajax_form_medxesp_navigate_form_cb
  function do_ajax_form_medxesp_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_medxesp_navigate_form_cb_after_alert
  function sc_hide_form_medxesp_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "medcodigo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "espcodigo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "mxesecuen_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["medcodigo_" + iNumLinha] = {"label": "MÉDICO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["espcodigo_" + iNumLinha] = {"label": "ESPECIALIDAD<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["mxesecuen_" + iNumLinha] = {"label": "Mxesecuen<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["medcodigo_"][iNumLinha] = "medcodigo_" + iNumLinha;
    ajax_field_mult["espcodigo_"][iNumLinha] = "espcodigo_" + iNumLinha;
    ajax_field_mult["mxesecuen_"][iNumLinha] = "mxesecuen_" + iNumLinha;
    ajax_field_id["medcodigo_" + iNumLinha] = new Array("hidden_field_label_medcodigo_", "hidden_field_data_medcodigo_" + iNumLinha);
    ajax_field_id["espcodigo_" + iNumLinha] = new Array("hidden_field_label_espcodigo_", "hidden_field_data_espcodigo_" + iNumLinha);
    ajax_error_count["medcodigo_" + iNumLinha] = "off";
    ajax_error_count["espcodigo_" + iNumLinha] = "off";
    ajax_error_count["mxesecuen_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["medcodigo_" + iNumLinha] = "on";
    ajax_read_only["espcodigo_" + iNumLinha] = "on";
    ajax_read_only["mxesecuen_" + iNumLinha] = "on";
<?php
}
else
{
...
?>
  ...
  {
    ajax_error_list["medcodigo_" + iNumLinha] = null;
    ajax_error_list["espcodigo_" + iNumLinha] = null;
    ajax_error_list["mxesecuen_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "medcodigo_": new Array(),
    "espcodigo_": new Array(),
    "mxesecuen_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["medcodigo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["medcodigo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["medcodigo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["medcodigo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["medcodigo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["espcodigo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["espcodigo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["espcodigo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["espcodigo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["espcodigo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["mxesecuen_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["mxesecuen_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["mxesecuen_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["mxesecuen_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["mxesecuen_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['medcodigo_'])) ? $this->nmgp_cmp_readonly['medcodigo_'] : 'on';
?>
    scAjaxFieldRead("medcodigo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['espcodigo_'])) ? $this->nmgp_cmp_readonly['espcodigo_'] : 'on';
?>
    scAjaxFieldRead("espcodigo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mxesecuen_'])) ? $this->nmgp_cmp_readonly['mxesecuen_'] : 'on';
?>
    scAjaxFieldRead("mxesecuen_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("medcodigo_" + iSeq, "on");
    scAjaxFieldRead("espcodigo_" + iSeq, "on");
    scAjaxFieldRead("mxesecuen_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["medcodigo_" + iRow] || "on" == ajax_error_count["espcodigo_" + iRow] || "on" == ajax_error_count["mxesecuen_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_medcodigo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_espcodigo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_mxesecuen_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["medcodigo_" + iRow] && "off" == ajax_error_count["espcodigo_" + iRow] && "off" == ajax_error_count["mxesecuen_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["medcodigo_" + iRow] = "off";
        ajax_error_count["espcodigo_" + iRow] = "off";
        ajax_error_count["mxesecuen_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_medcodigo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_espcodigo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_mxesecuen_" + iRow).removeClass("scFormErrorLine");
    }
  }
