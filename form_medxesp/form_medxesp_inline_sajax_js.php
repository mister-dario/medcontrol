  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_medxesp_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_medxesp_inline_form();
	}
  ...
  // ---------- Validate medcodigo_
  function do_ajax_form_medxesp_inline_validate_medcodigo_()
  {
  } // do_ajax_form_medxesp_inline_validate_medcodigo_

  function do_ajax_form_medxesp_inline_validate_medcodigo__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medxesp_inline_validate_medcodigo__cb

  // ---------- Validate espcodigo_
  function do_ajax_form_medxesp_inline_validate_espcodigo_()
  {
  } // do_ajax_form_medxesp_inline_validate_espcodigo_

  function do_ajax_form_medxesp_inline_validate_espcodigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medxesp_inline_validate_espcodigo__cb

  // ---------- Validate mxesecuen_
  function do_ajax_form_medxesp_inline_validate_mxesecuen_()
  {
    var nomeCampo_mxesecuen_ = "mxesecuen_";
    var var_mxesecuen_ = scAjaxGetFieldText(nomeCampo_mxesecuen_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_medxesp_inline_validate_mxesecuen_(var_mxesecuen_, var_script_case_init, do_ajax_form_medxesp_inline_validate_mxesecuen__cb);
  } // do_ajax_form_medxesp_inline_validate_mxesecuen_

  function do_ajax_form_medxesp_inline_validate_mxesecuen__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_medxesp_inline_validate_mxesecuen__cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_medxesp_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_medxesp_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_medcodigo_ = scAjaxGetFieldText("medcodigo_");
    var var_espcodigo_ = scAjaxGetFieldText("espcodigo_");
    var var_mxesecuen_ = scAjaxGetFieldText("mxesecuen_");
    ...
    scAjaxProcOn();
    x_ajax_form_medxesp_inline_submit_form(var_medcodigo_, var_espcodigo_, var_mxesecuen_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_medxesp_inline_submit_form_cb);
  } // do_ajax_form_medxesp_inline_submit_form

  function do_ajax_form_medxesp_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("medcodigo_");
      scAjaxHideErrorDisplay("espcodigo_");
      scAjaxHideErrorDisplay("mxesecuen_");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_medxesp_inline_submit_form_cb_after_alert);
  } // do_ajax_form_medxesp_inline_submit_form_cb
  function do_ajax_form_medxesp_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_medxesp_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_medxesp_inline_navigate_form()
  {
    perform_ajax_form_medxesp_inline_navigate_form();
  }

  function perform_ajax_form_medxesp_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_medxesp_inline_navigate_form(var_mxesecuen_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_medxesp_inline_navigate_form_cb);
  } // do_ajax_form_medxesp_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_medxesp_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_medxesp_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_medxesp_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_medxesp_inline_navigate_form_cb
  function do_ajax_form_medxesp_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_medxesp_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_medxesp_inline_navigate_form_cb_after_alert
  function sc_hide_form_medxesp_inline_form()
  {
  ...
  ajax_field_list[0] = "medcodigo_";
  ajax_field_list[1] = "espcodigo_";
  ajax_field_list[2] = "mxesecuen_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "medcodigo_": {"label": "MÉDICO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "espcodigo_": {"label": "ESPECIALIDAD", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mxesecuen_": {"label": "Mxesecuen", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["medcodigo_"][1] = "medcodigo_";
  ajax_field_mult["espcodigo_"][1] = "espcodigo_";
  ajax_field_mult["mxesecuen_"][1] = "mxesecuen_";

  var ajax_field_id = {
    "medcodigo_": new Array("hidden_field_label_medcodigo_", "hidden_field_data_medcodigo_"),
    "espcodigo_": new Array("hidden_field_label_espcodigo_", "hidden_field_data_espcodigo_")
  };
