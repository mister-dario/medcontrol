...
class grid_FACTURAS_ANULADAS_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_grid_FACTURAS_ANULADAS" . $this->Xls_tp;
          $this->Tit_doc    = "grid_FACTURAS_ANULADAS" . $this->Xls_tp;
      ...
      require_once($this->Ini->path_aplicacao . "grid_FACTURAS_ANULADAS_total.class.php"); 
      ...
      {
          $this->sum_f_importetotal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['tot_geral'][2];
      }
   }
   //---- 
...
$_SESSION['scriptcase']['grid_FACTURAS_ANULADAS']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_FACTURAS_ANULADAS']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['embutida'])
      { 
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['nolabel'])
       {
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>FACTURAS ANULADAS :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_FACTURAS_ANULADAS']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
