...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_FACTURAS_ANULADAS"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_FACTURAS_ANULADAS"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_ANULADAS']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_ANULADAS']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_ANULADAS']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_ANULADAS']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_ANULADAS']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_FACTURAS_ANULADAS</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_ANULADAS']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_ANULADAS']['embutida_filho'] as $ind => $sc_init)
          {
