<?php
@session_start() ;
$_SESSION['scriptcase']['grid_FACTURAS_ANULADAS']['sc_process_barr'] = true;
require_once('../grid_FACTURAS_ANULADAS/index.php');
unset($_SESSION['scriptcase']['grid_FACTURAS_ANULADAS']['sc_process_barr']);
$ExportCtrl = new grid_FACTURAS_ANULADAS_export_control;
$ExportCtrl->Export_barr();

class grid_FACTURAS_ANULADAS_export_control
{
