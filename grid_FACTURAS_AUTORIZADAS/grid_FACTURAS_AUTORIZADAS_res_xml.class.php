...
class grid_FACTURAS_AUTORIZADAS_res_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function grava_arquivo()
   {
      ...
      if ($this->New_Format)
      {
          fwrite($xml_f, "<grid_FACTURAS_AUTORIZADAS>\r\n");
      }
      if ($this->Grava_view)
      {
          ...
          if ($this->New_Format)
          {
              fwrite($xml_v, "<grid_FACTURAS_AUTORIZADAS>\r\n");
          }
      }
   ...
   function grava_linha($xml_f)
   {
      ...
      foreach ($this->array_linhas as $lines)
      {
          ...
          if (!$this->New_Format)
          {
              $xml_registro = "<grid_FACTURAS_AUTORIZADAS";
          }
          foreach ($lines as $columns)
          {
              if (0 <= $columns['level'])
