...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_FACTURAS_AUTORIZADAS"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_FACTURAS_AUTORIZADAS"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_FACTURA'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_AUTORIZADAS']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_AUTORIZADAS']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_AUTORIZADAS']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_AUTORIZADAS']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_AUTORIZADAS']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_FACTURAS_AUTORIZADAS</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_AUTORIZADAS']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_AUTORIZADAS']['embutida_filho'] as $ind => $sc_init)
          {
