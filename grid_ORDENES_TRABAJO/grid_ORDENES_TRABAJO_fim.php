...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_ORDENES_TRABAJO"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_ORDENES_TRABAJO"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ORDENES_TRABAJO']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ORDENES_TRABAJO']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ORDENES_TRABAJO']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ORDENES_TRABAJO']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ORDENES_TRABAJO']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_ORDENES_TRABAJO</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ORDENES_TRABAJO']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ORDENES_TRABAJO']['embutida_filho'] as $ind => $sc_init)
          {
