...
class grid_ORDENES_TRABAJO_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Tit_doc    = "grid_ORDENES_TRABAJO" . $this->Xls_tp;
      $this->Tit_zip    = "grid_ORDENES_TRABAJO.zip";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO']['xls_name'] .= $this->Xls_tp ;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO']['xls_name']);
      }
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO']['pivot_group_by'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO']['pivot_tabular'];
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>ÓRDENES DE TRABAJO :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO']['xls_return']); ?>"> 
</FORM> 
</td></tr></table>
</BODY>
</HTML>
