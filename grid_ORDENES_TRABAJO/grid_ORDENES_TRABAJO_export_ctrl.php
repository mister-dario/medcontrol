<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ORDENES_TRABAJO']['sc_process_barr'] = true;
require_once('../grid_ORDENES_TRABAJO/index.php');
unset($_SESSION['scriptcase']['grid_ORDENES_TRABAJO']['sc_process_barr']);
$ExportCtrl = new grid_ORDENES_TRABAJO_export_control;
$ExportCtrl->Export_barr();

class grid_ORDENES_TRABAJO_export_control
{
