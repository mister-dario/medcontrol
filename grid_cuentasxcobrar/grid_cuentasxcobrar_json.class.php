...
class grid_cuentasxcobrar_json
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['SC_Gb_Free_cmp']))
      {
          $this->Tem_json_res  = false;
      }
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_cuentasxcobrar/grid_cuentasxcobrar_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_format'];
      }
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_return']);
      ...
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "grid_cuentasxcobrar.json";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_name']);
      }
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "grid_cuentasxcobrar_res_json.class.php");
              $this->Res = new grid_cuentasxcobrar_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_res_grid']);
          } 
      }
   ...
   {
         $this->c_cxctipodoc = NM_charset_to_utf8($this->c_cxctipodoc);
         if ($this->Json_use_label)
         {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->c_cxctipodoc;
   }
   //----- c_cxcnumdoc
   function NM_export_c_cxcnumdoc()
   {
         $this->c_cxcnumdoc = NM_charset_to_utf8($this->c_cxcnumdoc);
         if ($this->Json_use_label)
         {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->c_cxcnumdoc;
   }
   //----- c_fclnumero
   ...
   function NM_export_c_cxcvalini()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->c_cxcvalini;
   }
   //----- c_cxcvalpen
   function NM_export_c_cxcvalpen()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->c_cxcvalpen;
   }
   //----- c_cxcvalretfte
   function NM_export_c_cxcvalretfte()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->c_cxcvalretfte;
   }
   //----- c_cxcfecvence
   function NM_export_c_cxcfecvence()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->c_cxcfecvence;
   }
   //----- c_cxcfeccancel
   function NM_export_c_cxcfeccancel()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->c_cxcfeccancel;
   }
   //----- c_cxcanulado
   function NM_export_c_cxcanulado()
   {
         $this->look_c_cxcanulado = NM_charset_to_utf8($this->look_c_cxcanulado);
         if ($this->Json_use_label)
         {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->look_c_cxcanulado;
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> cuentasxcobrar :: JSON</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
