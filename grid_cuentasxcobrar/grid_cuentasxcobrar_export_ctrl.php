<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cuentasxcobrar']['sc_process_barr'] = true;
require_once('../grid_cuentasxcobrar/index.php');
unset($_SESSION['scriptcase']['grid_cuentasxcobrar']['sc_process_barr']);
$ExportCtrl = new grid_cuentasxcobrar_export_control;
$ExportCtrl->Export_barr();

class grid_cuentasxcobrar_export_control
{
