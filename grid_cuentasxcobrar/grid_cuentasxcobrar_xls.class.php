...
class grid_cuentasxcobrar_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_grid_cuentasxcobrar" . $this->Xls_tp;
      ...
      require_once($this->Ini->path_aplicacao . "grid_cuentasxcobrar_total.class.php"); 
      ...
      {
          $this->sum_c_cxcvalini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['tot_geral'][2];
          $this->sum_c_cxcvalpen = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['tot_geral'][3];
      }
   }
   //---- 
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['embutida'])
      { 
   ...
   function NM_export_c_cxctipodoc()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->c_cxctipodoc = html_entity_decode($this->c_cxctipodoc, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->c_cxctipodoc = strip_tags($this->c_cxctipodoc);
         $this->c_cxctipodoc = NM_charset_to_utf8($this->c_cxctipodoc);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->c_cxctipodoc, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->c_cxctipodoc, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- c_cxcnumdoc
   function NM_export_c_cxcnumdoc()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->c_cxcnumdoc = html_entity_decode($this->c_cxcnumdoc, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->c_cxcnumdoc = strip_tags($this->c_cxcnumdoc);
         $this->c_cxcnumdoc = NM_charset_to_utf8($this->c_cxcnumdoc);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->c_cxcnumdoc, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->c_cxcnumdoc, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- c_fclnumero
   ...
   function NM_export_c_cxcvalini()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->c_cxcvalini = NM_charset_to_utf8($this->c_cxcvalini);
         if (is_numeric($this->c_cxcvalini))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->c_cxcvalini);
         $this->Xls_col++;
   }
   //----- c_cxcvalpen
   function NM_export_c_cxcvalpen()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->c_cxcvalpen = NM_charset_to_utf8($this->c_cxcvalpen);
         if (is_numeric($this->c_cxcvalpen))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->c_cxcvalpen);
         $this->Xls_col++;
   }
   //----- c_cxcvalretfte
   function NM_export_c_cxcvalretfte()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->c_cxcvalretfte = NM_charset_to_utf8($this->c_cxcvalretfte);
         if (is_numeric($this->c_cxcvalretfte))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->c_cxcvalretfte);
         $this->Xls_col++;
   }
   //----- c_cxcfecvence
   function NM_export_c_cxcfecvence()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->c_cxcfecvence = substr($this->c_cxcfecvence, 0, 10);
         if (empty($this->c_cxcfecvence) || $this->c_cxcfecvence == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->c_cxcfecvence, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->c_cxcfecvence, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->c_cxcfecvence);
   ...
   function NM_export_c_cxcfeccancel()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->c_cxcfeccancel = substr($this->c_cxcfeccancel, 0, 10);
         if (empty($this->c_cxcfeccancel) || $this->c_cxcfeccancel == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->c_cxcfeccancel, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->c_cxcfeccancel, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->c_cxcfeccancel);
             $this->NM_ctrl_style[$current_cell_ref]['format'] = $this->SC_date_conf_region;
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_c_cxcanulado()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_c_cxcanulado, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_c_cxcanulado, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- c_emiruc
   ...
   //----- c_cxctipodoc
   function NM_sub_cons_c_cxctipodoc()
   {
         $this->c_cxctipodoc = html_entity_decode($this->c_cxctipodoc, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->c_cxctipodoc = strip_tags($this->c_cxctipodoc);
         $this->c_cxctipodoc = NM_charset_to_utf8($this->c_cxctipodoc);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_cxctipodoc;
   ...
   //----- c_cxcnumdoc
   function NM_sub_cons_c_cxcnumdoc()
   {
         $this->c_cxcnumdoc = html_entity_decode($this->c_cxcnumdoc, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->c_cxcnumdoc = strip_tags($this->c_cxcnumdoc);
         $this->c_cxcnumdoc = NM_charset_to_utf8($this->c_cxcnumdoc);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_cxcnumdoc;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- c_cxcvalini
   function NM_sub_cons_c_cxcvalini()
   {
         $this->c_cxcvalini = NM_charset_to_utf8($this->c_cxcvalini);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_cxcvalini;
   ...
   //----- c_cxcvalpen
   function NM_sub_cons_c_cxcvalpen()
   {
         $this->c_cxcvalpen = NM_charset_to_utf8($this->c_cxcvalpen);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_cxcvalpen;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- c_cxcvalretfte
   function NM_sub_cons_c_cxcvalretfte()
   {
         $this->c_cxcvalretfte = NM_charset_to_utf8($this->c_cxcvalretfte);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_cxcvalretfte;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- c_cxcfecvence
   function NM_sub_cons_c_cxcfecvence()
   {
         $this->c_cxcfecvence = substr($this->c_cxcfecvence, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_cxcfecvence;
   ...
   //----- c_cxcfeccancel
   function NM_sub_cons_c_cxcfeccancel()
   {
         $this->c_cxcfeccancel = substr($this->c_cxcfeccancel, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_cxcfeccancel;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "data";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = $this->SC_date_conf_region;
         $this->Xls_col++;
   ...
   //----- c_cxcanulado
   function NM_sub_cons_c_cxcanulado()
   {
         $this->look_c_cxcanulado = NM_charset_to_utf8($this->look_c_cxcanulado);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_c_cxcanulado;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentasxcobrar']['nolabel'])
       {
