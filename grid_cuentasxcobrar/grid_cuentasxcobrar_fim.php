...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_cuentasxcobrar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_cuentasxcobrar"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cuentasxcobrar']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cuentasxcobrar']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cuentasxcobrar']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cuentasxcobrar']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cuentasxcobrar']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_cuentasxcobrar</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cuentasxcobrar']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cuentasxcobrar']['embutida_filho'] as $ind => $sc_init)
          {
