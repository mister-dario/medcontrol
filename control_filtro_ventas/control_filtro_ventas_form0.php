...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("control_filtro_ventas_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_filtro_ventas_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-medico", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_control_filtro_ventas_event_medico_onchange) { do_ajax_control_filtro_ventas_event_medico_onchange(sRow); }
    }
   }
  ...
  $(".sc-ui-autocomp-paciente", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    $("#id_sc_field_" + sId).val("");
    if (hasChanged) {
     if ('function' == typeof do_ajax_control_filtro_ventas_event_paciente_onchange) { do_ajax_control_filtro_ventas_event_paciente_onchange(sRow); }
    }
   }
   scEventControl_data[sId]["autocomp"] = false;
  }).on("keydown", function(e) {
  ...
  $(".sc-ui-autocomp-cliente", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    $("#id_sc_field_" + sId).val("");
    if (hasChanged) {
     if ('function' == typeof do_ajax_control_filtro_ventas_event_cliente_onchange) { do_ajax_control_filtro_ventas_event_cliente_onchange(sRow); }
    }
   }
   scEventControl_data[sId]["autocomp"] = false;
  }).on("keydown", function(e) {
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    $vertical_center = '';
...
<?php
 include_once("control_filtro_ventas_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_filtro_ventas'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_filtro_ventas'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emisor_label" id="hidden_field_label_emisor" style="<?php echo $sStyleHidden_emisor; ?>"><span id="id_label_emisor"><?php echo $this->nm_new_label['emisor']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['php_cmp_required']['emisor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['php_cmp_required']['emisor'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fecha_inicio_label" id="hidden_field_label_fecha_inicio" style="<?php echo $sStyleHidden_fecha_inicio; ?>"><span id="id_label_fecha_inicio"><?php echo $this->nm_new_label['fecha_inicio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['php_cmp_required']['fecha_inicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['php_cmp_required']['fecha_inicio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_fecha_inicio_line" id="hidden_field_data_fecha_inicio" style="<?php echo $sStyleHidden_fecha_inicio; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fecha_fin_label" id="hidden_field_label_fecha_fin" style="<?php echo $sStyleHidden_fecha_fin; ?>"><span id="id_label_fecha_fin"><?php echo $this->nm_new_label['fecha_fin']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['php_cmp_required']['fecha_fin']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['php_cmp_required']['fecha_fin'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_medico_label" id="hidden_field_label_medico" style="<?php echo $sStyleHidden_medico; ?>"><span id="id_label_medico"><?php echo $this->nm_new_label['medico']; ?></span></TD>
    <TD class="scFormDataOdd css_medico_line" id="hidden_field_data_medico" style="<?php echo $sStyleHidden_medico; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_paciente_label" id="hidden_field_label_paciente" style="<?php echo $sStyleHidden_paciente; ?>"><span id="id_label_paciente"><?php echo $this->nm_new_label['paciente']; ?></span></TD>
    <TD class="scFormDataOdd css_paciente_line" id="hidden_field_data_paciente" style="<?php echo $sStyleHidden_paciente; ?>">
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("control_filtro_ventas");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("control_filtro_ventas");
 parent.scAjaxDetailHeight("control_filtro_ventas", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ventas']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
