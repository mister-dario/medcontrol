<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ventas']['sc_process_barr'] = true;
require_once('../grid_ventas/index.php');
unset($_SESSION['scriptcase']['grid_ventas']['sc_process_barr']);
$ExportCtrl = new grid_ventas_export_control;
$ExportCtrl->Export_barr();

class grid_ventas_export_control
{
