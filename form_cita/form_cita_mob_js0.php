...
function sc_btn_CONTINUAR_ok()
{
    ...
    document.F1.action = "form_cita_mob.php";
    document.F1.target = "_self";
    document.F1.submit();
}
var Crtl_btn_regresar = false;
...
{
    Crtl_btn_regresar = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?regresar?@?";
    document.F1.action = "form_cita_mob.php";
    document.F1.target = "_self";
    document.F1.submit();
}
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['where_detal']))
  {
?>  
