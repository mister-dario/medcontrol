...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['Lookup_procesar_factura'][] = ''; ?>
 <option value="">------------------------</option>
 <option  value="F" <?php  if ($this->procesar_factura == "F") { echo " selected" ;} ?>>FACTURA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['Lookup_procesar_factura'][] = 'F'; ?>
 <option  value="O" <?php  if ($this->procesar_factura == "O") { echo " selected" ;} ?>>ORDEN DE TRABAJO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['Lookup_procesar_factura'][] = 'O'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['Lookup_tipo_pago'][] = '1'; ?>
<?php  if ("1" == $this->tipo_pago)  { echo " checked" ;} ?><?php  if (empty($this->tipo_pago)) { echo " checked" ;} ?>  onClick="do_ajax_form_cita_mob_event_tipo_pago_onclick();" ><label for="<?php echo $tempOptionId ?>">CONTADO</label></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['Lookup_tipo_pago'][] = '2'; ?>
<?php  if ("2" == $this->tipo_pago)  { echo " checked" ;} ?>  onClick="do_ajax_form_cita_mob_event_tipo_pago_onclick();" ><label for="<?php echo $tempOptionId ?>">CRÉDITO</label></TD>
</TR></TABLE>
</div>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['Lookup_forma_factura'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['Lookup_forma_factura'][] = '2'; ?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_presupuesto'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_presupuesto'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_presupuesto_cita_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_presupuesto'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_presupuesto_cita_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_presupuesto_cita_mob_script_case_init'] ]['form_detalle_presupuesto_cita_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_presupuesto_cita_mob_script_case_init'] ]['form_detalle_presupuesto_cita_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_presupuesto_cita_mob_script_case_init'] ]['form_detalle_presupuesto_cita_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_presupuesto_cita_mob_script_case_init'] ]['form_detalle_presupuesto_cita_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_presupuesto_cita_mob_script_case_init'] ]['form_detalle_presupuesto_cita_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_presupuesto_cita_mob_script_case_init'] ]['form_detalle_presupuesto_cita_mob']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_presupuesto_cita_mob_script_case_init'] ]['form_detalle_presupuesto_cita_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_presupuesto_cita_mob_script_case_init'] ]['form_detalle_presupuesto_cita_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_presupuesto_cita_mob_script_case_init'] ]['form_detalle_presupuesto_cita_mob']['embutida_liga_grid_edit'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_presupuesto_cita_mob_script_case_init'] ]['form_detalle_presupuesto_cita_mob']['embutida_liga_grid_edit_link'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_presupuesto_cita_mob_script_case_init'] ]['form_detalle_presupuesto_cita_mob']['embutida_liga_qtd_reg'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_presupuesto_cita_mob_script_case_init'] ]['form_detalle_presupuesto_cita_mob']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_presupuesto_cita_mob_script_case_init'] ]['form_cita_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_cita_mob_empty.htm' : $this->Ini->link_form_detalle_presupuesto_cita_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_detalle_presupuesto']) && 'nmsc_iframe_liga_form_detalle_presupuesto_cita_mob' != $this->Ini->sc_lig_target['C_@scinf_detalle_presupuesto'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detalle_presupuesto'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_presupuesto_cita_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_detalle_presupuesto_cita_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="850" name="nmsc_iframe_liga_form_detalle_presupuesto_cita_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_servicios'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_servicios'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_citadiagnos_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_servicios'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_citadiagnos_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_cita_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_cita_mob_empty.htm' : $this->Ini->link_form_detalle_citadiagnos_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=500';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_servicios']) && 'nmsc_iframe_liga_form_detalle_citadiagnos_mob' != $this->Ini->sc_lig_target['C_@scinf_servicios'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_servicios'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_citadiagnos_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_servicios_presup'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_servicios_presup'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_cita_presup_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_servicios_presup'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_cita_presup_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_cita_presup_mob_script_case_init'] ]['form_detalle_cita_presup_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_cita_presup_mob_script_case_init'] ]['form_detalle_cita_presup_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_cita_presup_mob_script_case_init'] ]['form_detalle_cita_presup_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_cita_presup_mob_script_case_init'] ]['form_detalle_cita_presup_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_cita_presup_mob_script_case_init'] ]['form_detalle_cita_presup_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_cita_presup_mob_script_case_init'] ]['form_detalle_cita_presup_mob']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_cita_presup_mob_script_case_init'] ]['form_detalle_cita_presup_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_cita_presup_mob_script_case_init'] ]['form_detalle_cita_presup_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_cita_presup_mob_script_case_init'] ]['form_detalle_cita_presup_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_cita_presup_mob_script_case_init'] ]['form_detalle_cita_presup_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_cita_presup_mob_script_case_init'] ]['form_detalle_cita_presup_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_cita_presup_mob_script_case_init'] ]['form_detalle_cita_presup_mob']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_cita_presup_mob_script_case_init'] ]['form_cita_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_cita_mob_empty.htm' : $this->Ini->link_form_detalle_cita_presup_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=500';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_servicios_presup']) && 'nmsc_iframe_liga_form_detalle_cita_presup_mob' != $this->Ini->sc_lig_target['C_@scinf_servicios_presup'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_servicios_presup'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['form_detalle_cita_presup_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_detalle_cita_presup_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="500" width="100%" name="nmsc_iframe_liga_form_detalle_cita_presup_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bavanca", "scBtnFn_sys_format_ava()", "scBtnFn_sys_format_ava()", "sc_b_avc_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + &#8594;)", "sc-unique-btn-8", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bfinal", "scBtnFn_sys_format_fim()", "scBtnFn_sys_format_fim()", "sc_b_fim_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Shift + &#8594;)", "sc-unique-btn-9", "", "");?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_mob']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
