  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_menu_conf" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_menu_conf_form();
	}
  ...
  function do_ajax_control_menu_conf_validate_especialidades()
  {
    var nomeCampo_especialidades = "especialidades";
    var var_especialidades = scAjaxGetFieldText(nomeCampo_especialidades);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_conf_validate_especialidades(var_especialidades, var_script_case_init, do_ajax_control_menu_conf_validate_especialidades_cb);
  } // do_ajax_control_menu_conf_validate_especialidades

  function do_ajax_control_menu_conf_validate_especialidades_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_conf_validate_especialidades_cb

  // ---------- Validate servicios
  function do_ajax_control_menu_conf_validate_servicios()
  {
    var nomeCampo_servicios = "servicios";
    var var_servicios = scAjaxGetFieldText(nomeCampo_servicios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_conf_validate_servicios(var_servicios, var_script_case_init, do_ajax_control_menu_conf_validate_servicios_cb);
  } // do_ajax_control_menu_conf_validate_servicios

  function do_ajax_control_menu_conf_validate_servicios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_conf_validate_servicios_cb

  // ---------- Validate medicos
  function do_ajax_control_menu_conf_validate_medicos()
  {
    var nomeCampo_medicos = "medicos";
    var var_medicos = scAjaxGetFieldText(nomeCampo_medicos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_conf_validate_medicos(var_medicos, var_script_case_init, do_ajax_control_menu_conf_validate_medicos_cb);
  } // do_ajax_control_menu_conf_validate_medicos

  function do_ajax_control_menu_conf_validate_medicos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medicos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_conf_validate_medicos_cb

  // ---------- Validate asignaciones
  function do_ajax_control_menu_conf_validate_asignaciones()
  {
    var nomeCampo_asignaciones = "asignaciones";
    var var_asignaciones = scAjaxGetFieldText(nomeCampo_asignaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_conf_validate_asignaciones(var_asignaciones, var_script_case_init, do_ajax_control_menu_conf_validate_asignaciones_cb);
  } // do_ajax_control_menu_conf_validate_asignaciones

  function do_ajax_control_menu_conf_validate_asignaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "asignaciones";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_conf_validate_asignaciones_cb

  // ---------- Validate agendas
  function do_ajax_control_menu_conf_validate_agendas()
  {
    var nomeCampo_agendas = "agendas";
    var var_agendas = scAjaxGetFieldText(nomeCampo_agendas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_conf_validate_agendas(var_agendas, var_script_case_init, do_ajax_control_menu_conf_validate_agendas_cb);
  } // do_ajax_control_menu_conf_validate_agendas

  function do_ajax_control_menu_conf_validate_agendas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "agendas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_conf_validate_agendas_cb

  // ---------- Validate emisores
  function do_ajax_control_menu_conf_validate_emisores()
  {
    var nomeCampo_emisores = "emisores";
    var var_emisores = scAjaxGetFieldText(nomeCampo_emisores);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_conf_validate_emisores(var_emisores, var_script_case_init, do_ajax_control_menu_conf_validate_emisores_cb);
  } // do_ajax_control_menu_conf_validate_emisores

  function do_ajax_control_menu_conf_validate_emisores_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "emisores";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_conf_validate_emisores_cb

  // ---------- Validate usuarios
  function do_ajax_control_menu_conf_validate_usuarios()
  {
    var nomeCampo_usuarios = "usuarios";
    var var_usuarios = scAjaxGetFieldText(nomeCampo_usuarios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_conf_validate_usuarios(var_usuarios, var_script_case_init, do_ajax_control_menu_conf_validate_usuarios_cb);
  } // do_ajax_control_menu_conf_validate_usuarios

  function do_ajax_control_menu_conf_validate_usuarios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuarios";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_conf_validate_usuarios_cb

  // ---------- Validate cambiar_contrasena
  function do_ajax_control_menu_conf_validate_cambiar_contrasena()
  {
    var nomeCampo_cambiar_contrasena = "cambiar_contrasena";
    var var_cambiar_contrasena = scAjaxGetFieldText(nomeCampo_cambiar_contrasena);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_conf_validate_cambiar_contrasena(var_cambiar_contrasena, var_script_case_init, do_ajax_control_menu_conf_validate_cambiar_contrasena_cb);
  } // do_ajax_control_menu_conf_validate_cambiar_contrasena

  function do_ajax_control_menu_conf_validate_cambiar_contrasena_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cambiar_contrasena";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_conf_validate_cambiar_contrasena_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_control_menu_conf_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_menu_conf_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_especialidades = "";
    var var_servicios = "";
    var var_medicos = "";
    var var_asignaciones = "";
    var var_agendas = "";
    var var_emisores = "";
    var var_usuarios = "";
    var var_cambiar_contrasena = "";
    ...
    scAjaxProcOn();
    x_ajax_control_menu_conf_submit_form(var_especialidades, var_servicios, var_medicos, var_asignaciones, var_agendas, var_emisores, var_usuarios, var_cambiar_contrasena, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_menu_conf_submit_form_cb);
  } // do_ajax_control_menu_conf_submit_form

  function do_ajax_control_menu_conf_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_menu_conf_submit_form_cb_after_alert);
  } // do_ajax_control_menu_conf_submit_form_cb
  function do_ajax_control_menu_conf_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_menu_conf_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_menu_conf_navigate_form()
  {
    perform_ajax_control_menu_conf_navigate_form();
  }

  function perform_ajax_control_menu_conf_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_menu_conf_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_menu_conf_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_menu_conf_navigate_form_cb_after_alert);
  } // do_ajax_control_menu_conf_navigate_form_cb
  function do_ajax_control_menu_conf_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_menu_conf_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_menu_conf_navigate_form_cb_after_alert
  function sc_hide_control_menu_conf_form()
  {
  ...
  ajax_field_list[0] = "especialidades";
  ajax_field_list[1] = "servicios";
  ajax_field_list[2] = "medicos";
  ajax_field_list[3] = "asignaciones";
  ajax_field_list[4] = "agendas";
  ajax_field_list[5] = "emisores";
  ajax_field_list[6] = "usuarios";
  ajax_field_list[7] = "cambiar_contrasena";
  ...
  var ajax_error_list = {
    ...
    "servicios": {"label": "SERVICIOS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "medicos": {"label": "MÉDICOS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "asignaciones": {"label": "ASIGNACIONES", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "agendas": {"label": "AGENDAS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "emisores": {"label": "EMISORES", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuarios": {"label": "USUARIOS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cambiar_contrasena": {"label": "CAMBIAR CONTRASEÑA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "emisores": new Array(),
    "usuarios": new Array(),
    "cambiar_contrasena": new Array()
  };
  ajax_field_mult["especialidades"][1] = "especialidades";
  ajax_field_mult["servicios"][1] = "servicios";
  ajax_field_mult["medicos"][1] = "medicos";
  ajax_field_mult["asignaciones"][1] = "asignaciones";
  ajax_field_mult["agendas"][1] = "agendas";
  ajax_field_mult["emisores"][1] = "emisores";
  ajax_field_mult["usuarios"][1] = "usuarios";
  ajax_field_mult["cambiar_contrasena"][1] = "cambiar_contrasena";
  ...
  var ajax_field_id = {
    ...
    "medicos": new Array("hidden_field_label_medicos", "hidden_field_data_medicos"),
    "asignaciones": new Array("hidden_field_label_asignaciones", "hidden_field_data_asignaciones"),
    "agendas": new Array("hidden_field_label_agendas", "hidden_field_data_agendas"),
    "emisores": new Array("hidden_field_label_emisores", "hidden_field_data_emisores"),
    "usuarios": new Array("hidden_field_label_usuarios", "hidden_field_data_usuarios"),
    "cambiar_contrasena": new Array("hidden_field_label_cambiar_contrasena", "hidden_field_data_cambiar_contrasena")
  };
