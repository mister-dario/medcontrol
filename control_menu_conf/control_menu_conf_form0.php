...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("control_menu_conf_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_menu_conf_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    $vertical_center = '';
...
<?php
 include_once("control_menu_conf_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_menu_conf'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_menu_conf'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_especialidades_line" id="hidden_field_data_especialidades" style="<?php echo $sStyleHidden_especialidades; ?>"> <?php
...
<span class="scFormLabelOddFormat css_especialidades_label" style="display: block;"><span id="id_label_especialidades"><?php echo $this->nm_new_label['especialidades']; ?></span></span> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_servicios_line" id="hidden_field_data_servicios" style="<?php echo $sStyleHidden_servicios; ?>"> <?php
...
<span class="scFormLabelOddFormat css_servicios_label" style="display: block;"><span id="id_label_servicios"><?php echo $this->nm_new_label['servicios']; ?></span></span> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_medicos_line" id="hidden_field_data_medicos" style="<?php echo $sStyleHidden_medicos; ?>"> <?php
...
<span class="scFormLabelOddFormat css_medicos_label" style="display: block;"><span id="id_label_medicos"><?php echo $this->nm_new_label['medicos']; ?></span></span> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_asignaciones_line" id="hidden_field_data_asignaciones" style="<?php echo $sStyleHidden_asignaciones; ?>"> <?php
...
<span class="scFormLabelOddFormat css_asignaciones_label" style="display: block;"><span id="id_label_asignaciones"><?php echo $this->nm_new_label['asignaciones']; ?></span></span> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agendas_line" id="hidden_field_data_agendas" style="<?php echo $sStyleHidden_agendas; ?>"> <?php
...
<span class="scFormLabelOddFormat css_agendas_label" style="display: block;"><span id="id_label_agendas"><?php echo $this->nm_new_label['agendas']; ?></span></span> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emisores_line" id="hidden_field_data_emisores" style="<?php echo $sStyleHidden_emisores; ?>"> <?php
...
<span class="scFormLabelOddFormat css_emisores_label" style="display: block;"><span id="id_label_emisores"><?php echo $this->nm_new_label['emisores']; ?></span></span> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_usuarios_line" id="hidden_field_data_usuarios" style="<?php echo $sStyleHidden_usuarios; ?>"> <?php
...
<span class="scFormLabelOddFormat css_usuarios_label" style="display: block;"><span id="id_label_usuarios"><?php echo $this->nm_new_label['usuarios']; ?></span></span> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cambiar_contrasena_line" id="hidden_field_data_cambiar_contrasena" style="<?php echo $sStyleHidden_cambiar_contrasena; ?>"> <?php
...
<span class="scFormLabelOddFormat css_cambiar_contrasena_label" style="display: block;"><span id="id_label_cambiar_contrasena"><?php echo $this->nm_new_label['cambiar_contrasena']; ?></span></span> </TD>
   <?php }?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("control_menu_conf");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("control_menu_conf");
 parent.scAjaxDetailHeight("control_menu_conf", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_conf']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
