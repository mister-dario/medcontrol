<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detalle_cobro']['sc_process_barr'] = true;
require_once('../grid_detalle_cobro/index.php');
unset($_SESSION['scriptcase']['grid_detalle_cobro']['sc_process_barr']);
$ExportCtrl = new grid_detalle_cobro_export_control;
$ExportCtrl->Export_barr();

class grid_detalle_cobro_export_control
{
