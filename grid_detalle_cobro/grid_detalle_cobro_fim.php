...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_detalle_cobro"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_detalle_cobro"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalle_cobro']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detalle_cobro']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalle_cobro']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detalle_cobro']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detalle_cobro']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detalle_cobro</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detalle_cobro']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detalle_cobro']['embutida_filho'] as $ind => $sc_init)
          {
