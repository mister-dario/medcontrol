...
<style type="text/css">
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_fac_emisores_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_fac_emisores_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    $vertical_center = '';
...
<?php
 include_once("form_fac_emisores_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_fac_emisores'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_fac_emisores'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['fast_search'][2] : "";
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emiruc_label" id="hidden_field_label_emiruc" style="<?php echo $sStyleHidden_emiruc; ?>"><span id="id_label_emiruc"><?php echo $this->nm_new_label['emiruc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['emiruc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['emiruc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_emiruc_line" id="hidden_field_data_emiruc" style="<?php echo $sStyleHidden_emiruc; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emiruc_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emirazsoc_label" id="hidden_field_label_emirazsoc" style="<?php echo $sStyleHidden_emirazsoc; ?>"><span id="id_label_emirazsoc"><?php echo $this->nm_new_label['emirazsoc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['emirazsoc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['emirazsoc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_emirazsoc_line" id="hidden_field_data_emirazsoc" style="<?php echo $sStyleHidden_emirazsoc; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emirazsoc_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_eminomcom_label" id="hidden_field_label_eminomcom" style="<?php echo $sStyleHidden_eminomcom; ?>"><span id="id_label_eminomcom"><?php echo $this->nm_new_label['eminomcom']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['eminomcom']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['eminomcom'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_eminomcom_line" id="hidden_field_data_eminomcom" style="<?php echo $sStyleHidden_eminomcom; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_eminomcom_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emidirmat_label" id="hidden_field_label_emidirmat" style="<?php echo $sStyleHidden_emidirmat; ?>"><span id="id_label_emidirmat"><?php echo $this->nm_new_label['emidirmat']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['emidirmat']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['emidirmat'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_emidirmat_line" id="hidden_field_data_emidirmat" style="<?php echo $sStyleHidden_emidirmat; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emidirmat_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emidirest_label" id="hidden_field_label_emidirest" style="<?php echo $sStyleHidden_emidirest; ?>"><span id="id_label_emidirest"><?php echo $this->nm_new_label['emidirest']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['emidirest']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['emidirest'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_emidirest_line" id="hidden_field_data_emidirest" style="<?php echo $sStyleHidden_emidirest; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emidirest_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_eminumconesp_label" id="hidden_field_label_eminumconesp" style="<?php echo $sStyleHidden_eminumconesp; ?>"><span id="id_label_eminumconesp"><?php echo $this->nm_new_label['eminumconesp']; ?></span></TD>
    <TD class="scFormDataOdd css_eminumconesp_line" id="hidden_field_data_eminumconesp" style="<?php echo $sStyleHidden_eminumconesp; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_eminumconesp_line" style="vertical-align: top;padding: 0px">
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emioblicon_label" id="hidden_field_label_emioblicon" style="<?php echo $sStyleHidden_emioblicon; ?>"><span id="id_label_emioblicon"><?php echo $this->nm_new_label['emioblicon']; ?></span></TD>
    <TD class="scFormDataOdd css_emioblicon_line" id="hidden_field_data_emioblicon" style="<?php echo $sStyleHidden_emioblicon; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emioblicon_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['Lookup_emioblicon'][] = '1'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emiestab_label" id="hidden_field_label_emiestab" style="<?php echo $sStyleHidden_emiestab; ?>"><span id="id_label_emiestab"><?php echo $this->nm_new_label['emiestab']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['emiestab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['emiestab'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_emiestab_line" id="hidden_field_data_emiestab" style="<?php echo $sStyleHidden_emiestab; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emiestab_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emiptoemi_label" id="hidden_field_label_emiptoemi" style="<?php echo $sStyleHidden_emiptoemi; ?>"><span id="id_label_emiptoemi"><?php echo $this->nm_new_label['emiptoemi']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['emiptoemi']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['emiptoemi'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_emiptoemi_line" id="hidden_field_data_emiptoemi" style="<?php echo $sStyleHidden_emiptoemi; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emiptoemi_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emiformatoride_label" id="hidden_field_label_emiformatoride" style="<?php echo $sStyleHidden_emiformatoride; ?>"><span id="id_label_emiformatoride"><?php echo $this->nm_new_label['emiformatoride']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['emiformatoride']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['emiformatoride'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_emiformatoride_line" id="hidden_field_data_emiformatoride" style="<?php echo $sStyleHidden_emiformatoride; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emiformatoride_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['Lookup_emiformatoride'][] = ''; ?>
 <option value="">------------------------</option>
 <option  value="1" <?php  if ($this->emiformatoride == "1") { echo " selected" ;} ?>>FORMATO 1 - KV</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['Lookup_emiformatoride'][] = '1'; ?>
 <option  value="2" <?php  if ($this->emiformatoride == "2") { echo " selected" ;} ?>>FORMATO 2 - FM</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['Lookup_emiformatoride'][] = '2'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emiclavetoken_label" id="hidden_field_label_emiclavetoken" style="<?php echo $sStyleHidden_emiclavetoken; ?>"><span id="id_label_emiclavetoken"><?php echo $this->nm_new_label['emiclavetoken']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['emiclavetoken']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['php_cmp_required']['emiclavetoken'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_emiclavetoken_line" id="hidden_field_data_emiclavetoken" style="<?php echo $sStyleHidden_emiclavetoken; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emiclavetoken_line" style="vertical-align: top;padding: 0px">
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emiactivo_label" id="hidden_field_label_emiactivo" style="<?php echo $sStyleHidden_emiactivo; ?>"><span id="id_label_emiactivo"><?php echo $this->nm_new_label['emiactivo']; ?></span></TD>
    <TD class="scFormDataOdd css_emiactivo_line" id="hidden_field_data_emiactivo" style="<?php echo $sStyleHidden_emiactivo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emiactivo_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['Lookup_emiactivo'][] = '1'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emiusucrea_label" id="hidden_field_label_emiusucrea" style="<?php echo $sStyleHidden_emiusucrea; ?>"><span id="id_label_emiusucrea"><?php echo $this->nm_new_label['emiusucrea']; ?></span></TD>
    <TD class="scFormDataOdd css_emiusucrea_line" id="hidden_field_data_emiusucrea" style="<?php echo $sStyleHidden_emiusucrea; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emiusucrea_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emifeccrea_label" id="hidden_field_label_emifeccrea" style="<?php echo $sStyleHidden_emifeccrea; ?>"><span id="id_label_emifeccrea"><?php echo $this->nm_new_label['emifeccrea']; ?></span></TD>
    <TD class="scFormDataOdd css_emifeccrea_line" id="hidden_field_data_emifeccrea" style="<?php echo $sStyleHidden_emifeccrea; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emifeccrea_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emiusumodi_label" id="hidden_field_label_emiusumodi" style="<?php echo $sStyleHidden_emiusumodi; ?>"><span id="id_label_emiusumodi"><?php echo $this->nm_new_label['emiusumodi']; ?></span></TD>
    <TD class="scFormDataOdd css_emiusumodi_line" id="hidden_field_data_emiusumodi" style="<?php echo $sStyleHidden_emiusumodi; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emiusumodi_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emifecmodi_label" id="hidden_field_label_emifecmodi" style="<?php echo $sStyleHidden_emifecmodi; ?>"><span id="id_label_emifecmodi"><?php echo $this->nm_new_label['emifecmodi']; ?></span></TD>
    <TD class="scFormDataOdd css_emifecmodi_line" id="hidden_field_data_emifecmodi" style="<?php echo $sStyleHidden_emifecmodi; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emifecmodi_line" style="vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_fac_emisores");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_fac_emisores");
 parent.scAjaxDetailHeight("form_fac_emisores", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_emisores']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
