...
class grid_ORDENES_TRABAJO_SF_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO_SF']['pivot_group_by'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO_SF']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO_SF']['pivot_tabular'];
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO_SF']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ORDENES_TRABAJO_SF']['arr_export']['data'];
      $b_display = false;
      $contr_rowspan = array();
      $contr_colspan = array();
