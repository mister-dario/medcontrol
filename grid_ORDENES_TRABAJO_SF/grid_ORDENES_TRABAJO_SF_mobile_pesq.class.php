...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span> <span class="scFilterRequiredOdd">*</span><br><span id="id_hide_ruc"  <?php echo $str_hide_ruc?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span> <span class="scFilterRequiredOdd">*</span><br><span id="id_hide_idcomprador"  <?php echo $str_hide_idcomprador?>><?php
      if ($idcomprador != "")
      {
      $idcomprador_look = substr($this->Db->qstr($idcomprador), 1, -1); 
      $nmgp_def_dados = array(); 
