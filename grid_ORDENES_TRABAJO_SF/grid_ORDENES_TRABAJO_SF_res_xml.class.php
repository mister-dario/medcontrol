...
class grid_ORDENES_TRABAJO_SF_res_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function grava_arquivo()
   {
      ...
      if ($this->New_Format)
      {
          fwrite($xml_f, "<grid_ORDENES_TRABAJO_SF>\r\n");
      }
      if ($this->Grava_view)
      {
          ...
          if ($this->New_Format)
          {
              fwrite($xml_v, "<grid_ORDENES_TRABAJO_SF>\r\n");
          }
      }
   ...
   function grava_linha($xml_f)
   {
      ...
      foreach ($this->array_linhas as $lines)
      {
          ...
          if (!$this->New_Format)
          {
              $xml_registro = "<grid_ORDENES_TRABAJO_SF";
          }
          foreach ($lines as $columns)
          {
              if (0 <= $columns['level'])
...
<HEAD>
 <TITLE>SELECCIONAR ÓRDENES DE TRABAJO PARA INCLUIR EN LA FACTURA :: XML</TITLE>
