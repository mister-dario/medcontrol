...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_ORDENES_TRABAJO_SF"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_ORDENES_TRABAJO_SF"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ORDENES_TRABAJO_SF']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ORDENES_TRABAJO_SF']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ORDENES_TRABAJO_SF']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ORDENES_TRABAJO_SF']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ORDENES_TRABAJO_SF']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_ORDENES_TRABAJO_SF</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ORDENES_TRABAJO_SF']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ORDENES_TRABAJO_SF']['embutida_filho'] as $ind => $sc_init)
          {
