...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['sec_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'CIMEDFAC', 1, $this->force_db_utf8); 
      } 
      else 
      { 
...
//
    ...
    else
    {
        ...
        if (isset($_POST["usr_perfil"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['usr_perfil']);
        }
        ...
        if (isset($_POST["usr_medico"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['usr_medico']);
        }
        ...
        if (isset($_POST["porceniva"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['porceniva']);
        }
        ...
        if (isset($_POST["codporceniva"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['codporceniva']);
        }
        ...
        if (isset($_POST["v_ambiente_cod"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['v_ambiente_cod']);
        }
        ...
        if (isset($_POST["v_mincodigoficha"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['v_mincodigoficha']);
        }
        ...
        if (isset($_POST["v_ambiente"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['v_ambiente']);
        }
        ...
        if (isset($_POST["v_perfil"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['v_perfil']);
        }
...
//
    ...
    function ajax_sec_Login_submit_form($login, $pswd, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_sec_Login;
        //register_shutdown_function("sec_Login_pack_ajax_response");
        $inicial_sec_Login->contr_sec_Login->NM_ajax_flag          = true;
