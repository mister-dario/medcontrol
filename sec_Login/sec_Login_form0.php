...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - "); } else { echo strip_tags("MEDCONTROL"); } ?></TITLE>
...
<?php
$str_iframe_body = 'margin-top: 150px;';
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR valign="middle">
        <TD align="left" rowspan="3" class="scFormHeaderFont">
          <?php if ($this->Ini->Export_img_zip) {$this->Ini->Img_export_zip[] = $this->Ini->root . $this->Ini->path_imag_cab . '/sys__NM__img__NM__logo-EXCELDENT_small.jpg';echo '<IMG SRC="sys__NM__img__NM__logo-EXCELDENT_small.jpg';}else{ echo '<IMG SRC="' . $this->Ini->path_imag_cab  . '/sys__NM__img__NM__logo-EXCELDENT_small.jpg';}?>" BORDER="0"/>
        </TD>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bok", "scBtnFn_sys_format_ok()", "scBtnFn_sys_format_ok()", "sub_form_b", "", " ENTRAR", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-1", "", "");?>
