<?php
@session_start() ;
$_SESSION['scriptcase']['grid_servicio']['sc_process_barr'] = true;
require_once('../grid_servicio/index.php');
unset($_SESSION['scriptcase']['grid_servicio']['sc_process_barr']);
$ExportCtrl = new grid_servicio_export_control;
$ExportCtrl->Export_barr();

class grid_servicio_export_control
{
