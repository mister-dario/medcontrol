...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_servicio"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_servicio"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_servicio'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_servicio']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_servicio']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_servicio']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_servicio']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_servicio']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_servicio']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_servicio']['embutida_filho'] as $ind => $sc_init)
          {
