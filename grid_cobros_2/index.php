<?php
   include_once('grid_cobros_2_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class grid_cobros_2_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "grid_cobros_2"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['grid_cobros_2']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['grid_cobros_2']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['grid_cobros_2']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/grid_cobros_2';
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['grid_cobros_2']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['grid_cobros_2']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['grid_cobros_2']['actual_lang']) || $_SESSION['scriptcase']['grid_cobros_2']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['grid_cobros_2']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("grid_cobros_2_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_Link_View'] = true;
          }
      }
    if (!$_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dyn_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dyn_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
      if (isset($_GET['nmgp_opcao']) && $_GET['nmgp_opcao'] == "ajax_aut_comp_dyn_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dyn_search_aut_comp']['cmp'] = $_GET['field'];
          $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['opcao'] = $_GET['origem'];
          $nmgp_opcao = $_GET['origem'];
      }
    }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      $Tmp_apl_lig = "form_cobros";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/form_cobros_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/form_cobros_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/form_cobros_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/form_cobros_ini.txt");
          if (isset($L_md5[6]) && trim($L_md5[6]) == "LigMd5")
          {
              $this->sc_lig_md5["form_cobros"] = 'S';
          }
      }
      $this->sc_lig_target["A_@scinf_"] = '_self';
      $this->sc_lig_target["A_@scinf__@scinf_form_cobros"] = '_self';
      if ($_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_cobros_2"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_cobros_2"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      $this->link_form_cobros =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_cobros') . "/" ; 
      if ($Tp_init == "Path_sub")
      {
          return;
      }
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['grid_cobros_2']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "grid_cobros_2_erro.class.php"); 
      $this->Erro = new grid_cobros_2_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('grid_cobros_2'); 
// 
      ...
      $this->arr_buttons_usr['nuevo']['value']            = "Nuevo";
      $this->arr_buttons_usr['nuevo']['display']          = "only_text";
      ...
      $this->arr_buttons_usr['refresh']['hint']             = "";
      $this->arr_buttons_usr['refresh']['type']             = "button";
      $this->arr_buttons_usr['refresh']['value']            = "Refrescar datos";
      $this->arr_buttons_usr['refresh']['display']          = "only_text";
      $this->arr_buttons_usr['refresh']['display_position'] = "text_right";
      $this->arr_buttons_usr['refresh']['style']            = "default";
      $this->arr_buttons_usr['refresh']['image']            = "";
      ...
      if (isset($_SESSION['scriptcase']['grid_cobros_2']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['grid_cobros_2']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['grid_cobros_2']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['grid_cobros_2']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['grid_cobros_2']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['grid_cobros_2']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      {
          $this->nm_tabela = "cobros C, ficha_cliente F"; 
      }
   }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_conexao']) && $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_perfil']) && $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_cobros_2']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['grid_cobros_2']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_conexao'], $this->root . $this->path_prod, 'CIMEDFAC', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_cobros_2']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
class grid_cobros_2_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['grid_cobros_2']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['grid_cobros_2'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class grid_cobros_2_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_cobros_2']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_cobros_2'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida'] || $Parms_form_pdf)
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_grid_cobros_2($cadapar[1]);
                       nm_protect_num_grid_cobros_2($cadapar[0], $cadapar[1]);
                       if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                       $Tmp_par   = $cadapar[0];
                       $$Tmp_par = $cadapar[1];
                       if ($Tmp_par == "nmgp_opcao")
                       {
                           $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opcao'] = $cadapar[1];
                       }
                   }
              }
          } 
      ...
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_ibase'])) 
      { 
          $this->Ini = new grid_cobros_2_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_cobros_2']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_cobros_2'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_cobros_2']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_cobros_2']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('grid_cobros_2') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_cobros_2']['label'] = "" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " cobros";
      ...
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("es");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "grid_cobros_2/grid_cobros_2_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "grid_cobros_2_erro.class.php"); 
      } 
      $this->Erro      = new grid_cobros_2_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "grid_cobros_2/grid_cobros_2_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "grid_cobros_2_lookup.class.php"); 
      } 
      $this->Lookup       = new grid_cobros_2_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_grid_cobros_2_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['save_grid'] = true;
              }
              ...
              {
                  $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['contr_total_geral'] = "NAO";
                  $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['pivot_tabular']);
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_All_Groupby'] = array('sc_free_total' => 'grid');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_Ind_Groupby'] = $Ind;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_Ind_Groupby'] == "sc_free_total")
      {
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "grid_cobros_2_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "grid_cobros_2_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_Ind_Groupby'] . ".class.php"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_grid_cobros_2_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_grid_cobros_2_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pdf_det'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida_treeview'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['proc_pdf']      = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['proc_pdf_vert'] = false;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['field_order'][] = "c_emiruc";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['field_order'][] = "c_cobnumero";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['field_order'][] = "c_fclnumero";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['field_order'][] = "c_cobfecha";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['field_order'][] = "c_cobvaltotal";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['field_order'][] = "c_cobanula";
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cobros_2']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cobros_2']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['grid_cobros_2']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['use_pass_pdf'] = "";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cobros_2']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cobros_2']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opc_liga'] = $NMSC_conf_apl;  
          }   
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == "dyn_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == "dyn_search_clear")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == "dyn_search_clear")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dyn_search_clear'] = true;
          } 
          $this->SC_proc_dyn_search($_POST['parm']);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq'])
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = 'igual';
          } 
          else 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['contr_array_resumo'] = "NAO";
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['orig_pesq'] = 'grid';
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = 'pesq';
          } 
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = 'inicio';
          } 
      } 
//
      ...
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['prim_cons'] = true;  
      ...
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_cobros_2_html_" . session_id() . "_2.html";
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_grid_cobros_2.pdf";
            $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_cobros_2_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_grid_cobros_2_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['word_name']))
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['word_name'] .= ".doc";
              }
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_grid_cobros_2_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_cobros_2/grid_cobros_2_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_cobros_2_xls.class.php"); 
          } 
          $this->xls  = new grid_cobros_2_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_cobros_2/grid_cobros_2_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_cobros_2_xml.class.php"); 
          } 
          $this->xml  = new grid_cobros_2_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_cobros_2/grid_cobros_2_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_cobros_2_csv.class.php"); 
          } 
          $this->csv  = new grid_cobros_2_csv();
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . grid_cobros_2 . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new grid_cobros_2_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "grid_cobros_2_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_cobros_2_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new grid_cobros_2_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_cobros_2/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
          } 
          $this->Res = new grid_cobros_2_resumo("out");
          $this->prep_modulos("Res");
          $this->Res->monta_resumo();
      }
      else 
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_grid_cobros_2_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_cobros_2/grid_cobros_2_grid.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_cobros_2_grid.class.php"); 
          } 
          $this->grid  = new grid_cobros_2_grid();
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['embutida'])
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['ajax_nav'])
         {
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['opcao'] != "ajax_detalhe")  
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
            ...
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['export_sel_columns']['field_order']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['export_sel_columns']['field_order'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['export_sel_columns']['field_order']);
            }
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['export_sel_columns']['usr_cmp_sel']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['export_sel_columns']['usr_cmp_sel'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['export_sel_columns']['usr_cmp_sel']);
            }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['doc_word'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pdf_res'])
            { 
                $str_pd4ml .= " --outline-depth 0";
            }
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    grid_cobros_2_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                    fwrite($this->grid->progress_fp, ($this->grid->progress_tot) . "_#NM#_" . $lang_protect . "...\n");
                    fclose($this->grid->progress_fp);
                }
            }
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pdf_name']))
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pdf_name'], 1);
                }
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pdf_name']);
            }
            ...
            $str_cmd_qpdf = "";
            $str_zip      = "";
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        grid_cobros_2_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        grid_cobros_2_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['pdf_file'] = $nm_arquivo_pdf_serv;
}
$NM_volta  = "volta_grid";
$NM_target = "_parent";
$downloadFileName = "grid_cobros_2.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
<?php
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('grid_cobros') . "/", $this->nm_location, "","_self", 440, 630);
 };
...
?>
  ...
  function close_emb()
  {
   ...
   function SC_proc_dyn_search($Parms)
   {
       ...
       $ix     = 0;
       $fields = array();
       $Cmps_check_return = array('c_emiruc','c_cobanula');
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dyn_search'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dyn_refresh'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           $dats = explode("_DYN_", $cada_f);
           if ($dats[0] == "NM_operador_Dyn")
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dyn_search_op'] = $dats[1];
           ...
           if (in_array($fields[$ix]['field'], $Cmps_check_return))
           {
               ...
               {
                   if (trim($Cada_val) != '' && !in_array($Cada_val, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['psq_check_ret'][$fields[$ix]['field']]))
                   {
                       $Temp = ob_get_clean();
                       $this->Ini->Arr_result['htmOutput'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['labels'][$fields[$ix]['field']] . " : " . NM_charset_to_utf8($this->Ini->Nm_lang['lang_errm_ajax_data']);
                       $oJson = new Services_JSON();
                       echo $oJson->encode($this->Ini->Arr_result);
                       $this->close_emb();
                       exit;
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dyn_search'][] = array('cmp' => $dats[0], 'opc' => $dats[1], 'val' => $val_sv);
           $ix++;
       }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['campos_busca'][$ind] = $dados;
      }
       $this->NM_case_insensitive = false;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['cond_dyn_search'] = "";
       foreach ($fields as $ind => $dados)
       {
           ...
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dyn_search_label']['c_emiruc'];
           ...
           if ($dados['field'] == "c_cobnumero" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dyn_search_label']['c_cobnumero'];
               $dados['vls'][0] = $dados['vls'][0][0];
               if ($dados['cond'] == "BW")
               {
               ...
               if ($dados['cond'] != "IN")
               {
                   ...
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['decimal_db'] == ".")
                   {
                       $dados['vls'][0] = str_replace(",", ".", $dados['vls'][0]);
                   }
                   if ($dados['cond'] == "BW")
               ...
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "C.cobnumero", 'N', 'INT', $Label_cmp);
           }
           if ($dados['field'] == "f_fclnombres" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dyn_search_label']['f_fclnombres'];
               $dados['vls'][0] = $dados['vls'][0][0];
               if ($dados['cond'] == "BW")
               {
                   $dados['vls'][1] = $dados['vls'][1][0];
           ...
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dyn_search_label']['f_fclapellidos'];
               $dados['vls'][0] = $dados['vls'][0][0];
               if ($dados['cond'] == "BW")
               {
                   $dados['vls'][1] = $dados['vls'][1][0];
           ...
           if ($dados['field'] == "c_cobfecha" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dyn_search_label']['c_cobfecha'];
               if ($dados['cond'] != "BI_TP")
               {
                   ...
                   $this->SC_proc_dyn_search_all($dados['cond'], $val, "C.cobfecha", 'DT', 'DATE', $Label_cmp);
               }
           }
           if ($dados['field'] == "c_cobvaltotal" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dyn_search_label']['c_cobvaltotal'];
               $dados['vls'][0] = $dados['vls'][0][0];
               if ($dados['cond'] == "BW")
               {
                   $dados['vls'][1] = $dados['vls'][1][0];
               ...
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "C.cobvaltotal", 'N', 'DOUBLE', $Label_cmp);
           }
           if ($dados['field'] == "c_cobanula" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['dyn_search_label']['c_cobanula'];
               $dados['vls'][0] = $dados['vls'][0][0];
               $tmp_pos = strpos($dados['vls'][0], "##@@");
               if ($tmp_pos === false)
               {
               ...
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "C.cobanula", 'N', 'TINYINT', $Label_cmp);
           }
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq_dyn'] = $this->Cmd_Dyn_Search;
       if (empty($this->Cmd_Dyn_Search)) 
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['cond_dyn_search']   = "";
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_orig'];
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq_filtro'])) 
           {
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq'])) 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq_filtro'] . ")";
               }
               else 
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq_filtro'] . ")";
               }
           }
           return;
       }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['cond_dyn_search'] .= $this->Dyn_Serarch_and_or;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_orig'];
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq_filtro'])) 
           {
               if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq'])) 
           ...
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq'] .= " and (" . $this->Cmd_Dyn_Search . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['where_pesq'] = " where (" . $this->Cmd_Dyn_Search . ")";
           }
       if (NM_is_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['cond_pesq']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['cond_pesq'] = sc_convert_encoding($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['cond_pesq'], $_SESSION['scriptcase']['charset'], "UTF-8");
       }
   }
   function SC_proc_dyn_search_lookup($cond, $vls, $sql, $tp, $tsql, $lab)
   {
       ...
       if (!empty($nm_cmd))
       {
           ...
           if ($cond == "DF" || $cond == "NP")
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['cond_dyn_search'] .= $lab . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $nm_cond . "##*@@";
           }
           else
           {
               $this->Cmd_Dyn_Search .= "(" . $sql . " in (" . $nm_cmd . "))";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['cond_dyn_search'] .= $lab . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
           }
       }
   }
   function SC_proc_dyn_search_all($cond, $vls, $sql, $tp, $tsql, $lab)
   {
       $nm_aspas  = "'";
       $nm_aspas1 = "'";
       if ($tp == "N" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['decimal_db'] == ".")
       {
           $nm_aspas  = "";
           $nm_aspas1 = "";
       }
      if ($tp == "DT" || $tp == "DH" || $tp == "HH")
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['SC_sep_date1'];
          }
      }
       $nm_ini_lower = "";
       $nm_fim_lower = "";
       ...
       $dados   = $vls[0];
           ...
           if (!empty($nm_cmd))
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['cond_dyn_search'] .= $nm_cond;
           }
   }
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2']['word_file']);
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> cobros :: Doc</TITLE>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
<?php
if ($_SESSION['scriptcase']['proc_mobile'])
{
...
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
?>
 <META http-equiv="Expires" content="Fri, Jan 01 1900 00:00:00 GMT"/>
 <META http-equiv="Last-Modified" content="<?php echo gmdate("D, d M Y H:i:s"); ?> GMT"/>
 <META http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"/>
...
<form name="Fdown" method="get" action="grid_cobros_2_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="grid_cobros_2"> 
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros_2'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['grid_cobros_2']['sc_process_barr'])) {
       return;
   }
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_grid_cobros_2($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_grid_cobros_2($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_imag_temp'] . "/sc_apl_default_CIMEDFAC.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_cobros_2']['glo_nm_path_imag_temp'] . "/sc_apl_default_CIMEDFAC.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "grid_cobros_2") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['grid_cobros_2']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['grid_cobros_2']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['grid_cobros_2']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_CIMEDFAC'])) {
               $_SESSION['scriptcase']['grid_cobros_2']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_CIMEDFAC'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['grid_cobros_2']['master_pai']) && $_SESSION['sc_session'][$init_filho]['grid_cobros_2']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['grid_cobros_2']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['grid_cobros_2']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['grid_cobros_2']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['grid_cobros_2']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['grid_cobros_2']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['grid_cobros_2']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['grid_cobros_2']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_cobros_2']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_cobros_2']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']);
               $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['grid_cobros_2']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['grid_cobros_2']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['grid_cobros_2']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['grid_cobros_2']['protect_modal']) && !empty($_SESSION['scriptcase']['grid_cobros_2']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['grid_cobros_2']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   $_SESSION['sc_session']['grid_cobros_2']['show_skip_charts_option'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "grid_cobros_2";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'grid_cobros_2' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/grid_cobros_2/'))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['contr_total_geral'] = "NAO";
   }
   ...
   {
       $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['b_sair'] = true;
   }
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'grid_cobros_2')
   {
       $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/grid_cobros_2_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opcao'] = $nmgp_opcao ;  
       }   
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['volta_redirect_tp'] = "";
           $nm_url_saida = "grid_cobros_2_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['sc_modal'] = true;
               }
               $nm_url_saida = "grid_cobros_2_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) 
           {
               $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opc_psq'] = false ;   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['mostra_edit'] = "N";   
           } 
       ...
       $contr_grid_cobros_2 = new grid_cobros_2_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opcao'] = "busca";
          $contr_grid_cobros_2->NM_ajax_flag = true;
          $contr_grid_cobros_2->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opcao'] = "busca";
          $contr_grid_cobros_2->NM_ajax_flag = true;
          $contr_grid_cobros_2->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opcao'] = "busca";
          $contr_grid_cobros_2->NM_ajax_flag = true;
          $contr_grid_cobros_2->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opcao'] = "busca";
          $contr_grid_cobros_2->NM_ajax_flag = true;
          $contr_grid_cobros_2->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_grid_cobros_2->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_grid_cobros_2(&$str)
   {
   ...
   function nm_protect_num_grid_cobros_2($name, &$val)
   {
       if (empty($val))
       {
          return;
       ...
       $Nm_numeric = array();
       $Nm_numeric[] = "c_cobnumero";
       $Nm_numeric[] = "c_fclnumero";
       $Nm_numeric[] = "c_cobvalefec";
       $Nm_numeric[] = "c_cobvalcheq";
       $Nm_numeric[] = "c_cobvaltarjcred";
       $Nm_numeric[] = "c_cobvaltransf";
       $Nm_numeric[] = "c_cobvalretfte";
       $Nm_numeric[] = "c_cobvaltotal";
       $Nm_numeric[] = "c_tcrcodigo";
       $Nm_numeric[] = "c_cobvalcruz";
       $Nm_numeric[] = "c_cobanula";
   ...
   function grid_cobros_2_pack_protect_string($sString)
   {
    ...
    function grid_cobros_2_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
