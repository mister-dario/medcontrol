...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_cobros_2"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_cobros_2"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_cobros'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cobros_2']['embutida_filho'] as $ind => $sc_init)
          {
