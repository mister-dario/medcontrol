  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_DETALLE_FACTURA_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_DETALLE_FACTURA_inline_form();
	}
  ...
  // ---------- Validate codigo_
  function do_ajax_form_DETALLE_FACTURA_inline_validate_codigo_()
  {
    var nomeCampo_codigo_ = "codigo_";
    var var_codigo_ = scAjaxGetFieldText(nomeCampo_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_inline_validate_codigo_(var_codigo_, var_script_case_init, do_ajax_form_DETALLE_FACTURA_inline_validate_codigo__cb);
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_codigo_

  function do_ajax_form_DETALLE_FACTURA_inline_validate_codigo__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_codigo__cb

  // ---------- Validate descripcion_
  function do_ajax_form_DETALLE_FACTURA_inline_validate_descripcion_()
  {
    var nomeCampo_descripcion_ = "descripcion_";
    var var_descripcion_ = scAjaxGetFieldText(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_inline_validate_descripcion_(var_descripcion_, var_script_case_init, do_ajax_form_DETALLE_FACTURA_inline_validate_descripcion__cb);
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_descripcion_

  function do_ajax_form_DETALLE_FACTURA_inline_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_descripcion__cb

  // ---------- Validate cantidad_
  function do_ajax_form_DETALLE_FACTURA_inline_validate_cantidad_()
  {
    var nomeCampo_cantidad_ = "cantidad_";
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_inline_validate_cantidad_(var_cantidad_, var_script_case_init, do_ajax_form_DETALLE_FACTURA_inline_validate_cantidad__cb);
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_cantidad_

  function do_ajax_form_DETALLE_FACTURA_inline_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_cantidad__cb

  // ---------- Validate preciounitario_
  function do_ajax_form_DETALLE_FACTURA_inline_validate_preciounitario_()
  {
    var nomeCampo_preciounitario_ = "preciounitario_";
    var var_preciounitario_ = scAjaxGetFieldText(nomeCampo_preciounitario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_inline_validate_preciounitario_(var_preciounitario_, var_script_case_init, do_ajax_form_DETALLE_FACTURA_inline_validate_preciounitario__cb);
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_preciounitario_

  function do_ajax_form_DETALLE_FACTURA_inline_validate_preciounitario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_preciounitario__cb

  // ---------- Validate descuento_
  function do_ajax_form_DETALLE_FACTURA_inline_validate_descuento_()
  {
    var nomeCampo_descuento_ = "descuento_";
    var var_descuento_ = scAjaxGetFieldText(nomeCampo_descuento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_inline_validate_descuento_(var_descuento_, var_script_case_init, do_ajax_form_DETALLE_FACTURA_inline_validate_descuento__cb);
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_descuento_

  function do_ajax_form_DETALLE_FACTURA_inline_validate_descuento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_descuento__cb

  // ---------- Validate estab_
  function do_ajax_form_DETALLE_FACTURA_inline_validate_estab_()
  {
    var nomeCampo_estab_ = "estab_";
    var var_estab_ = scAjaxGetFieldText(nomeCampo_estab_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_inline_validate_estab_(var_estab_, var_script_case_init, do_ajax_form_DETALLE_FACTURA_inline_validate_estab__cb);
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_estab_

  function do_ajax_form_DETALLE_FACTURA_inline_validate_estab__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estab_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_estab__cb

  // ---------- Validate ptoemi_
  function do_ajax_form_DETALLE_FACTURA_inline_validate_ptoemi_()
  {
    var nomeCampo_ptoemi_ = "ptoemi_";
    var var_ptoemi_ = scAjaxGetFieldText(nomeCampo_ptoemi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_inline_validate_ptoemi_(var_ptoemi_, var_script_case_init, do_ajax_form_DETALLE_FACTURA_inline_validate_ptoemi__cb);
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_ptoemi_

  function do_ajax_form_DETALLE_FACTURA_inline_validate_ptoemi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ptoemi_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_ptoemi__cb

  // ---------- Validate secuencial_
  function do_ajax_form_DETALLE_FACTURA_inline_validate_secuencial_()
  {
    var nomeCampo_secuencial_ = "secuencial_";
    var var_secuencial_ = scAjaxGetFieldText(nomeCampo_secuencial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_inline_validate_secuencial_(var_secuencial_, var_script_case_init, do_ajax_form_DETALLE_FACTURA_inline_validate_secuencial__cb);
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_secuencial_

  function do_ajax_form_DETALLE_FACTURA_inline_validate_secuencial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_secuencial__cb

  // ---------- Validate lote_
  function do_ajax_form_DETALLE_FACTURA_inline_validate_lote_()
  {
    var nomeCampo_lote_ = "lote_";
    var var_lote_ = scAjaxGetFieldText(nomeCampo_lote_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_inline_validate_lote_(var_lote_, var_script_case_init, do_ajax_form_DETALLE_FACTURA_inline_validate_lote__cb);
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_lote_

  function do_ajax_form_DETALLE_FACTURA_inline_validate_lote__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lote_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_inline_validate_lote__cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_DETALLE_FACTURA_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_DETALLE_FACTURA_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_DETALLE_FACTURA_inline_submit_form(var_codigo_, var_descripcion_, var_cantidad_, var_preciounitario_, var_descuento_, var_estab_, var_ptoemi_, var_secuencial_, var_lote_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_DETALLE_FACTURA_inline_submit_form_cb);
  } // do_ajax_form_DETALLE_FACTURA_inline_submit_form

  function do_ajax_form_DETALLE_FACTURA_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_DETALLE_FACTURA_inline_submit_form_cb_after_alert);
  } // do_ajax_form_DETALLE_FACTURA_inline_submit_form_cb
  function do_ajax_form_DETALLE_FACTURA_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_DETALLE_FACTURA_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_DETALLE_FACTURA_inline_navigate_form()
  {
    perform_ajax_form_DETALLE_FACTURA_inline_navigate_form();
  }

  function perform_ajax_form_DETALLE_FACTURA_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_DETALLE_FACTURA_inline_navigate_form(var_estab_, var_ptoemi_, var_secuencial_, var_lote_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_DETALLE_FACTURA_inline_navigate_form_cb);
  } // do_ajax_form_DETALLE_FACTURA_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_DETALLE_FACTURA_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_DETALLE_FACTURA_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_DETALLE_FACTURA_inline_navigate_form_cb
  function do_ajax_form_DETALLE_FACTURA_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_DETALLE_FACTURA_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_DETALLE_FACTURA_inline_navigate_form_cb_after_alert
  function sc_hide_form_DETALLE_FACTURA_inline_form()
  {
