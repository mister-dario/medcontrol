<?php
class form_DETALLE_FACTURA_form extends form_DETALLE_FACTURA_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['sc_redir_atualiz'] == 'ok')
{
?>
...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_DETALLE_FACTURA_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_DETALLE_FACTURA_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['recarga'];
}
...
<?php
 include_once("form_DETALLE_FACTURA_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_DETALLE_FACTURA'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_DETALLE_FACTURA'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_DETALLE_FACTURA);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_DETALLE_FACTURA = $this->form_vert_form_DETALLE_FACTURA;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_DETALLE_FACTURA))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_DETALLE_FACTURA as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->ruc_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['ruc_'];
       $this->coddoc_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['coddoc_'];
       $this->preciototalsinimpuesto_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['preciototalsinimpuesto_'];
       $this->nombredetalleadicional1_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['nombredetalleadicional1_'];
       $this->valoradicional1_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['valoradicional1_'];
       $this->nombredetalleadicional2_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['nombredetalleadicional2_'];
       $this->valoradicional2_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['valoradicional2_'];
       $this->nombredetalleadicional3_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['nombredetalleadicional3_'];
       $this->valoradicional3_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['valoradicional3_'];
       $this->nombredetalleadicional4_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['nombredetalleadicional4_'];
       $this->valoradicional4_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['valoradicional4_'];
       $this->nombredetalleadicional5_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['nombredetalleadicional5_'];
       $this->valoradicional5_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['valoradicional5_'];
       $this->nombredetalleadicional6_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['nombredetalleadicional6_'];
       $this->valoradicional6_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['valoradicional6_'];
       $this->nombredetalleadicional7_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['nombredetalleadicional7_'];
       $this->valoradicional7_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['valoradicional7_'];
       $this->nombredetalleadicional8_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['nombredetalleadicional8_'];
       $this->valoradicional8_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['valoradicional8_'];
       $this->nombredetalleadicional9_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['nombredetalleadicional9_'];
       $this->valoradicional9_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['valoradicional9_'];
       $this->nombredetalleadicional10_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['nombredetalleadicional10_'];
       $this->valoradicional10_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['valoradicional10_'];
       $this->nombredetalleadicional11_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['nombredetalleadicional11_'];
       $this->valoradicional11_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['valoradicional11_'];
       $this->nombredetalleadicional12_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['nombredetalleadicional12_'];
       $this->valoradicional12_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['valoradicional12_'];
       $this->nombredetalleadicional13_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['nombredetalleadicional13_'];
       $this->valoradicional13_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['valoradicional13_'];
       $this->nombredetalleadicional14_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['nombredetalleadicional14_'];
       $this->valoradicional14_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['valoradicional14_'];
       $this->nombredetalleadicional15_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['nombredetalleadicional15_'];
       $this->valoradicional15_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['valoradicional15_'];
       $this->codigoimpuesto_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['codigoimpuesto_'];
       $this->codigoporcentajeimp_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['codigoporcentajeimp_'];
       $this->tarifa_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['tarifa_'];
       $this->baseimponible_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['baseimponible_'];
       $this->valor_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['valor_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->codigo_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['codigo_']; 
       ...
       $this->descripcion_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['descripcion_']; 
       ...
       $this->cantidad_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['cantidad_']; 
       ...
       $this->preciounitario_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['preciounitario_']; 
       ...
       $this->descuento_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['descuento_']; 
       ...
       $this->estab_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['estab_']; 
       $estab_ = $this->estab_; 
       if (!isset($this->nmgp_cmp_hidden['estab_']))
       {
           $this->nmgp_cmp_hidden['estab_'] = 'off';
       ...
       $this->ptoemi_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['ptoemi_']; 
       ...
       $this->secuencial_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['secuencial_']; 
       ...
       $this->lote_ = $this->form_vert_form_DETALLE_FACTURA[$sc_seq_vert]['lote_']; 
       $lote_ = $this->lote_; 
       if (!isset($this->nmgp_cmp_hidden['lote_']))
       {
           $this->nmgp_cmp_hidden['lote_'] = 'off';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_DETALLE_FACTURA_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_DETALLE_FACTURA_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_DETALLE_FACTURA_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_DETALLE_FACTURA_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_DETALLE_FACTURA_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_DETALLE_FACTURA_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_DETALLE_FACTURA = $guarda_form_vert_form_DETALLE_FACTURA;
   } 
   if ($Table_refresh) 
   { 
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['run_iframe'] != "R")
{
?>
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_DETALLE_FACTURA");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_DETALLE_FACTURA");
 parent.scAjaxDetailHeight("form_DETALLE_FACTURA", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
