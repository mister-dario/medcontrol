  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_DETALLE_FACTURA" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_DETALLE_FACTURA_form();
	}
  ...
  // ---------- Validate codigo_
  function do_ajax_form_DETALLE_FACTURA_validate_codigo_(iNumLinha)
  {
    var nomeCampo_codigo_ = "codigo_" + iNumLinha;
    var var_codigo_ = scAjaxGetFieldText(nomeCampo_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_validate_codigo_(var_codigo_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_FACTURA_validate_codigo__cb);
  } // do_ajax_form_DETALLE_FACTURA_validate_codigo_

  function do_ajax_form_DETALLE_FACTURA_validate_codigo__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_validate_codigo__cb

  // ---------- Validate descripcion_
  function do_ajax_form_DETALLE_FACTURA_validate_descripcion_(iNumLinha)
  {
    var nomeCampo_descripcion_ = "descripcion_" + iNumLinha;
    var var_descripcion_ = scAjaxGetFieldText(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_FACTURA_validate_descripcion__cb);
  } // do_ajax_form_DETALLE_FACTURA_validate_descripcion_

  function do_ajax_form_DETALLE_FACTURA_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_validate_descripcion__cb

  // ---------- Validate cantidad_
  function do_ajax_form_DETALLE_FACTURA_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_FACTURA_validate_cantidad__cb);
  } // do_ajax_form_DETALLE_FACTURA_validate_cantidad_

  function do_ajax_form_DETALLE_FACTURA_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_validate_cantidad__cb

  // ---------- Validate preciounitario_
  function do_ajax_form_DETALLE_FACTURA_validate_preciounitario_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_validate_preciounitario_(var_preciounitario_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_FACTURA_validate_preciounitario__cb);
  } // do_ajax_form_DETALLE_FACTURA_validate_preciounitario_

  function do_ajax_form_DETALLE_FACTURA_validate_preciounitario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_validate_preciounitario__cb

  // ---------- Validate descuento_
  function do_ajax_form_DETALLE_FACTURA_validate_descuento_(iNumLinha)
  {
    var nomeCampo_descuento_ = "descuento_" + iNumLinha;
    var var_descuento_ = scAjaxGetFieldText(nomeCampo_descuento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_validate_descuento_(var_descuento_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_FACTURA_validate_descuento__cb);
  } // do_ajax_form_DETALLE_FACTURA_validate_descuento_

  function do_ajax_form_DETALLE_FACTURA_validate_descuento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_validate_descuento__cb

  // ---------- Validate estab_
  function do_ajax_form_DETALLE_FACTURA_validate_estab_(iNumLinha)
  {
    var nomeCampo_estab_ = "estab_" + iNumLinha;
    var var_estab_ = scAjaxGetFieldText(nomeCampo_estab_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_validate_estab_(var_estab_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_FACTURA_validate_estab__cb);
  } // do_ajax_form_DETALLE_FACTURA_validate_estab_

  function do_ajax_form_DETALLE_FACTURA_validate_estab__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_validate_estab__cb

  // ---------- Validate ptoemi_
  function do_ajax_form_DETALLE_FACTURA_validate_ptoemi_(iNumLinha)
  {
    var nomeCampo_ptoemi_ = "ptoemi_" + iNumLinha;
    var var_ptoemi_ = scAjaxGetFieldText(nomeCampo_ptoemi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_validate_ptoemi_(var_ptoemi_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_FACTURA_validate_ptoemi__cb);
  } // do_ajax_form_DETALLE_FACTURA_validate_ptoemi_

  function do_ajax_form_DETALLE_FACTURA_validate_ptoemi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_validate_ptoemi__cb

  // ---------- Validate secuencial_
  function do_ajax_form_DETALLE_FACTURA_validate_secuencial_(iNumLinha)
  {
    var nomeCampo_secuencial_ = "secuencial_" + iNumLinha;
    var var_secuencial_ = scAjaxGetFieldText(nomeCampo_secuencial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_validate_secuencial_(var_secuencial_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_FACTURA_validate_secuencial__cb);
  } // do_ajax_form_DETALLE_FACTURA_validate_secuencial_

  function do_ajax_form_DETALLE_FACTURA_validate_secuencial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_validate_secuencial__cb

  // ---------- Validate lote_
  function do_ajax_form_DETALLE_FACTURA_validate_lote_(iNumLinha)
  {
    var nomeCampo_lote_ = "lote_" + iNumLinha;
    var var_lote_ = scAjaxGetFieldText(nomeCampo_lote_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_validate_lote_(var_lote_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_FACTURA_validate_lote__cb);
  } // do_ajax_form_DETALLE_FACTURA_validate_lote_

  function do_ajax_form_DETALLE_FACTURA_validate_lote__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_FACTURA_validate_lote__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_DETALLE_FACTURA_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_DETALLE_FACTURA_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_DETALLE_FACTURA_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_DETALLE_FACTURA_add_new_line_cb);
  } // do_ajax_form_DETALLE_FACTURA_add_new_line

  function do_ajax_form_DETALLE_FACTURA_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_DETALLE_FACTURA_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_DETALLE_FACTURA_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_FACTURA_backup_line(var_estab_, var_ptoemi_, var_secuencial_, var_lote_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_DETALLE_FACTURA_backup_line_cb);
  } // do_ajax_form_DETALLE_FACTURA_backup_line

  function do_ajax_form_DETALLE_FACTURA_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_DETALLE_FACTURA_backup_line_cb

  function do_ajax_form_DETALLE_FACTURA_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_DETALLE_FACTURA_cancel_insert

  function do_ajax_form_DETALLE_FACTURA_cancel_update(iSeqVert)
  {
    do_ajax_form_DETALLE_FACTURA_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_DETALLE_FACTURA_cancel_update

  function do_ajax_form_DETALLE_FACTURA_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_DETALLE_FACTURA_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_DETALLE_FACTURA_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_DETALLE_FACTURA_table_refresh(var_estab_, var_ptoemi_, var_secuencial_, var_lote_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_DETALLE_FACTURA_table_refresh_cb);
  } //  do_ajax_form_DETALLE_FACTURA_table_refresh

  function do_ajax_form_DETALLE_FACTURA_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_DETALLE_FACTURA_table_refresh_cb_after_alert);
  } // do_ajax_form_DETALLE_FACTURA_table_refresh_cb
  function do_ajax_form_DETALLE_FACTURA_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("b");
    sc_insert_open = false;
  } // do_ajax_form_DETALLE_FACTURA_table_refresh_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_DETALLE_FACTURA_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_DETALLE_FACTURA_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_DETALLE_FACTURA_submit_form(var_codigo_, var_descripcion_, var_cantidad_, var_preciounitario_, var_descuento_, var_estab_, var_ptoemi_, var_secuencial_, var_lote_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_DETALLE_FACTURA_submit_form_cb);
  } // do_ajax_form_DETALLE_FACTURA_submit_form

  function do_ajax_form_DETALLE_FACTURA_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_DETALLE_FACTURA_submit_form_cb_after_alert);
  } // do_ajax_form_DETALLE_FACTURA_submit_form_cb
  function do_ajax_form_DETALLE_FACTURA_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_DETALLE_FACTURA_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_DETALLE_FACTURA_navigate_form()
  {
    perform_ajax_form_DETALLE_FACTURA_navigate_form();
  }

  function perform_ajax_form_DETALLE_FACTURA_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_DETALLE_FACTURA_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_DETALLE_FACTURA_navigate_form(var_estab_, var_ptoemi_, var_secuencial_, var_lote_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_DETALLE_FACTURA_navigate_form_cb);
  } // do_ajax_form_DETALLE_FACTURA_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_DETALLE_FACTURA_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_DETALLE_FACTURA_navigate_form_cb_after_alert);
  } // do_ajax_form_DETALLE_FACTURA_navigate_form_cb
  function do_ajax_form_DETALLE_FACTURA_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_DETALLE_FACTURA_navigate_form_cb_after_alert
  function sc_hide_form_DETALLE_FACTURA_form()
  {
