<?php
//
class form_DETALLE_FACTURA_inline_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_DETALLE_FACTURA_inline']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_DETALLE_FACTURA_inline']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_DETALLE_FACTURA_inline']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_DETALLE_FACTURA_inline']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_DETALLE_FACTURA_inline']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_DETALLE_FACTURA_inline']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_DETALLE_FACTURA_inline']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_DETALLE_FACTURA_inline']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_DETALLE_FACTURA_inline']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_DETALLE_FACTURA_inline']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_DETALLE_FACTURA_inline']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_DETALLE_FACTURA_inline']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_DETALLE_FACTURA_inline']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_DETALLE_FACTURA_inline']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_DETALLE_FACTURA_inline']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_DETALLE_FACTURA_inline_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_DETALLE_FACTURA_inline']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_DETALLE_FACTURA_inline']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_DETALLE_FACTURA_inline'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_DETALLE_FACTURA_inline']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_DETALLE_FACTURA_inline']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_DETALLE_FACTURA_inline') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_DETALLE_FACTURA_inline']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - DETALLE_FACTURA";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_DETALLE_FACTURA_inline")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_DETALLE_FACTURA_inline']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_DETALLE_FACTURA_inline'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_FACTURA_inline']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_DETALLE_FACTURA_inline'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_DETALLE_FACTURA_inline'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_DETALLE_FACTURA_inline", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_DETALLE_FACTURA_inline_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_DETALLE_FACTURA_inline_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_DETALLE_FACTURA/form_DETALLE_FACTURA_inline_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_DETALLE_FACTURA_inline_erro.class.php"); 
      }
      $this->Erro      = new form_DETALLE_FACTURA_inline_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opcao']))
         { 
             if ($this->estab_ != "" || $this->ptoemi_ != "" || $this->secuencial_ != "" || $this->lote_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_FACTURA_inline']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_DETALLE_FACTURA_inline.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_DETALLE_FACTURA_inline_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_DETALLE_FACTURA_inline"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_DETALLE_FACTURA_inline.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_DETALLE_FACTURA_inline']) || !is_array($this->NM_ajax_info['errList']['geral_form_DETALLE_FACTURA_inline']))
              {
                  $this->NM_ajax_info['errList']['geral_form_DETALLE_FACTURA_inline'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_DETALLE_FACTURA_inline'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_codigo_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['codigo_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['codigo_'] == "on")) 
      { 
          if ($this->codigo_ == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_descripcion_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['descripcion_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['descripcion_'] == "on")) 
      { 
    ...
    function ValidateField_cantidad_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['cantidad_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['cantidad_'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_preciounitario_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['preciounitario_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['preciounitario_'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_descuento_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['descuento_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['descuento_'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_estab_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['estab_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['estab_'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "ESTAB" ; 
              if (!isset($Campos_Erros['estab_']))
    ...
    function ValidateField_ptoemi_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['ptoemi_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['ptoemi_'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "PTOEMI" ; 
              if (!isset($Campos_Erros['ptoemi_']))
    ...
    function ValidateField_secuencial_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['secuencial_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['secuencial_'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_lote_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (($this->nmgp_opcao == "incluir" || 'validate_lote_' == $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['lote_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['php_cmp_required']['lote_'] == "on"))
      { 
          if ($this->lote_ == "")  
          { 
              $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['estab_']['keyVal'] = form_DETALLE_FACTURA_inline_pack_protect_string($this->nmgp_dados_form['estab_']);
              $this->NM_ajax_info['fldList']['ptoemi_']['keyVal'] = form_DETALLE_FACTURA_inline_pack_protect_string($this->nmgp_dados_form['ptoemi_']);
              $this->NM_ajax_info['fldList']['secuencial_']['keyVal'] = form_DETALLE_FACTURA_inline_pack_protect_string($this->nmgp_dados_form['secuencial_']);
              $this->NM_ajax_info['fldList']['lote_']['keyVal'] = form_DETALLE_FACTURA_inline_pack_protect_string($this->nmgp_dados_form['lote_']);
          }
   } // ajax_return_values
   ...
   function ajax_return_values_lote_($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opcao'] = '';
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['parms'] = "estab_?#?$this->estab_?@?ptoemi_?#?$this->ptoemi_?@?secuencial_?#?$this->secuencial_?@?lote_?#?$this->lote_?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['parms'] = ""; 
          ...
          { 
              $nmgp_select = "SELECT RUC, CODDOC, ESTAB, PTOEMI, SECUENCIAL, LOTE, CODIGO, DESCRIPCION, CANTIDAD, PRECIOUNITARIO, DESCUENTO, PRECIOTOTALSINIMPUESTO, NOMBREDETALLEADICIONAL1, VALORADICIONAL1, NOMBREDETALLEADICIONAL2, VALORADICIONAL2, NOMBREDETALLEADICIONAL3, VALORADICIONAL3, NOMBREDETALLEADICIONAL4, VALORADICIONAL4, NOMBREDETALLEADICIONAL5, VALORADICIONAL5, NOMBREDETALLEADICIONAL6, VALORADICIONAL6, NOMBREDETALLEADICIONAL7, VALORADICIONAL7, NOMBREDETALLEADICIONAL8, VALORADICIONAL8, NOMBREDETALLEADICIONAL9, VALORADICIONAL9, NOMBREDETALLEADICIONAL10, VALORADICIONAL10, NOMBREDETALLEADICIONAL11, VALORADICIONAL11, NOMBREDETALLEADICIONAL12, VALORADICIONAL12, NOMBREDETALLEADICIONAL13, VALORADICIONAL13, NOMBREDETALLEADICIONAL14, VALORADICIONAL14, NOMBREDETALLEADICIONAL15, VALORADICIONAL15, CODIGOIMPUESTO, CODIGOPORCENTAJEIMP, TARIFA, BASEIMPONIBLE, VALOR from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT RUC, CODDOC, ESTAB, PTOEMI, SECUENCIAL, LOTE, CODIGO, DESCRIPCION, CANTIDAD, PRECIOUNITARIO, DESCUENTO, PRECIOTOTALSINIMPUESTO, NOMBREDETALLEADICIONAL1, VALORADICIONAL1, NOMBREDETALLEADICIONAL2, VALORADICIONAL2, NOMBREDETALLEADICIONAL3, VALORADICIONAL3, NOMBREDETALLEADICIONAL4, VALORADICIONAL4, NOMBREDETALLEADICIONAL5, VALORADICIONAL5, NOMBREDETALLEADICIONAL6, VALORADICIONAL6, NOMBREDETALLEADICIONAL7, VALORADICIONAL7, NOMBREDETALLEADICIONAL8, VALORADICIONAL8, NOMBREDETALLEADICIONAL9, VALORADICIONAL9, NOMBREDETALLEADICIONAL10, VALORADICIONAL10, NOMBREDETALLEADICIONAL11, VALORADICIONAL11, NOMBREDETALLEADICIONAL12, VALORADICIONAL12, NOMBREDETALLEADICIONAL13, VALORADICIONAL13, NOMBREDETALLEADICIONAL14, VALORADICIONAL14, NOMBREDETALLEADICIONAL15, VALORADICIONAL15, CODIGOIMPUESTO, CODIGOPORCENTAJEIMP, TARIFA, BASEIMPONIBLE, VALOR from " . $this->Ini->nm_tabela ; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['select'] = ""; 
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['dados_select'] = $this->nmgp_dados_select;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_DETALLE_FACTURA_inline_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_DETALLE_FACTURA_inline = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['total'] = $qt_geral_reg_form_DETALLE_FACTURA_inline;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_DETALLE_FACTURA_inline_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_DETALLE_FACTURA_inline_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_DETALLE_FACTURA_inline_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA_inline']['masterValue']))
{
