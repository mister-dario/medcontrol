 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-medcodigo", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_agenda_mob_event_medcodigo_onchange) { do_ajax_form_agenda_mob_event_medcodigo_onchange(sRow); }
    }
   }
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['fast_search'][2] : "";
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agenombre_line" id="hidden_field_data_agenombre" style="<?php echo $sStyleHidden_agenombre; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agenombre_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agenombre_label" style=""><span id="id_label_agenombre"><?php echo $this->nm_new_label['agenombre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['php_cmp_required']['agenombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['php_cmp_required']['agenombre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
$aLookup = array();
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_medcodigo']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_medcodigo'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_medcodigo']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_medcodigo'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_medcodigo'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ageintervalo_line" id="hidden_field_data_ageintervalo" style="<?php echo $sStyleHidden_ageintervalo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ageintervalo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ageintervalo_label" style=""><span id="id_label_ageintervalo"><?php echo $this->nm_new_label['ageintervalo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['php_cmp_required']['ageintervalo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['php_cmp_required']['ageintervalo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
?> 
    ...
    <TD class="scFormDataOdd css_ageactivo_line" id="hidden_field_data_ageactivo" style="<?php echo $sStyleHidden_ageactivo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ageactivo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ageactivo_label" style=""><span id="id_label_ageactivo"><?php echo $this->nm_new_label['ageactivo']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_ageactivo'][] = '1'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agecolor_line" id="hidden_field_data_agecolor" style="<?php echo $sStyleHidden_agecolor; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agecolor_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agecolor_label" style=""><span id="id_label_agecolor"><?php echo $this->nm_new_label['agecolor']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['php_cmp_required']['agecolor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['php_cmp_required']['agecolor'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $sStyleHidden_agecolor_dumb = ('' == $sStyleHidden_agecolor) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_agecolor_dumb" style="<?php echo $sStyleHidden_agecolor_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ageusucrea_line" id="hidden_field_data_ageusucrea" style="<?php echo $sStyleHidden_ageusucrea; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ageusucrea_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ageusucrea_label" style=""><span id="id_label_ageusucrea"><?php echo $this->nm_new_label['ageusucrea']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agefeccrea_line" id="hidden_field_data_agefeccrea" style="<?php echo $sStyleHidden_agefeccrea; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agefeccrea_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agefeccrea_label" style=""><span id="id_label_agefeccrea"><?php echo $this->nm_new_label['agefeccrea']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ageusumodi_line" id="hidden_field_data_ageusumodi" style="<?php echo $sStyleHidden_ageusumodi; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ageusumodi_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ageusumodi_label" style=""><span id="id_label_ageusumodi"><?php echo $this->nm_new_label['ageusumodi']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agefecmodi_line" id="hidden_field_data_agefecmodi" style="<?php echo $sStyleHidden_agefecmodi; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agefecmodi_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agefecmodi_label" style=""><span id="id_label_agefecmodi"><?php echo $this->nm_new_label['agefecmodi']; ?></span></span><br>
...
<?php $sStyleHidden_agefecmodi_dumb = ('' == $sStyleHidden_agefecmodi) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_agefecmodi_dumb" style="<?php echo $sStyleHidden_agefecmodi_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_agelunactivo'][] = '1'; ?>
<?php  if (in_array("1", $this->agelunactivo_1))  { echo " checked" ;} ?> onClick="do_ajax_form_agenda_mob_event_agelunactivo_onclick();" ><span></span>
<label for="<?php echo $tempOptionId ?>"></label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_agemaractivo'][] = '1'; ?>
<?php  if (in_array("1", $this->agemaractivo_1))  { echo " checked" ;} ?> onClick="do_ajax_form_agenda_mob_event_agemaractivo_onclick();" ><span></span>
<label for="<?php echo $tempOptionId ?>"></label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_agemieactivo'][] = '1'; ?>
<?php  if (in_array("1", $this->agemieactivo_1))  { echo " checked" ;} ?> onClick="do_ajax_form_agenda_mob_event_agemieactivo_onclick();" ><span></span>
<label for="<?php echo $tempOptionId ?>"></label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_agejueactivo'][] = '1'; ?>
<?php  if (in_array("1", $this->agejueactivo_1))  { echo " checked" ;} ?> onClick="do_ajax_form_agenda_mob_event_agejueactivo_onclick();" ><span></span>
<label for="<?php echo $tempOptionId ?>"></label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_agevieactivo'][] = '1'; ?>
<?php  if (in_array("1", $this->agevieactivo_1))  { echo " checked" ;} ?> onClick="do_ajax_form_agenda_mob_event_agevieactivo_onclick();" ><span></span>
<label for="<?php echo $tempOptionId ?>"></label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_agesabactivo'][] = '1'; ?>
<?php  if (in_array("1", $this->agesabactivo_1))  { echo " checked" ;} ?> onClick="do_ajax_form_agenda_mob_event_agesabactivo_onclick();" ><span></span>
<label for="<?php echo $tempOptionId ?>"></label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_agedomactivo'][] = '1'; ?>
<?php  if (in_array("1", $this->agedomactivo_1))  { echo " checked" ;} ?> onClick="do_ajax_form_agenda_mob_event_agedomactivo_onclick();" ><span></span>
<label for="<?php echo $tempOptionId ?>"></label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agelunini_line" id="hidden_field_data_agelunini" style="<?php echo $sStyleHidden_agelunini; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agelunini_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agelunini_label" style=""><span id="id_label_agelunini"><?php echo $this->nm_new_label['agelunini']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agelunfin_line" id="hidden_field_data_agelunfin" style="<?php echo $sStyleHidden_agelunfin; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agelunfin_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agelunfin_label" style=""><span id="id_label_agelunfin"><?php echo $this->nm_new_label['agelunfin']; ?></span></span><br>
...
<?php $sStyleHidden_agelunfin_dumb = ('' == $sStyleHidden_agelunfin) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_agelunfin_dumb" style="<?php echo $sStyleHidden_agelunfin_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agemarini_line" id="hidden_field_data_agemarini" style="<?php echo $sStyleHidden_agemarini; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agemarini_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agemarini_label" style=""><span id="id_label_agemarini"><?php echo $this->nm_new_label['agemarini']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agemarfin_line" id="hidden_field_data_agemarfin" style="<?php echo $sStyleHidden_agemarfin; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agemarfin_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agemarfin_label" style=""><span id="id_label_agemarfin"><?php echo $this->nm_new_label['agemarfin']; ?></span></span><br>
...
<?php $sStyleHidden_agemarfin_dumb = ('' == $sStyleHidden_agemarfin) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_agemarfin_dumb" style="<?php echo $sStyleHidden_agemarfin_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agemieini_line" id="hidden_field_data_agemieini" style="<?php echo $sStyleHidden_agemieini; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agemieini_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agemieini_label" style=""><span id="id_label_agemieini"><?php echo $this->nm_new_label['agemieini']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agemiefin_line" id="hidden_field_data_agemiefin" style="<?php echo $sStyleHidden_agemiefin; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agemiefin_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agemiefin_label" style=""><span id="id_label_agemiefin"><?php echo $this->nm_new_label['agemiefin']; ?></span></span><br>
...
<?php $sStyleHidden_agemiefin_dumb = ('' == $sStyleHidden_agemiefin) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_agemiefin_dumb" style="<?php echo $sStyleHidden_agemiefin_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agejueini_line" id="hidden_field_data_agejueini" style="<?php echo $sStyleHidden_agejueini; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agejueini_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agejueini_label" style=""><span id="id_label_agejueini"><?php echo $this->nm_new_label['agejueini']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agejuefin_line" id="hidden_field_data_agejuefin" style="<?php echo $sStyleHidden_agejuefin; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agejuefin_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agejuefin_label" style=""><span id="id_label_agejuefin"><?php echo $this->nm_new_label['agejuefin']; ?></span></span><br>
...
<?php $sStyleHidden_agejuefin_dumb = ('' == $sStyleHidden_agejuefin) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_agejuefin_dumb" style="<?php echo $sStyleHidden_agejuefin_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agevieini_line" id="hidden_field_data_agevieini" style="<?php echo $sStyleHidden_agevieini; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agevieini_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agevieini_label" style=""><span id="id_label_agevieini"><?php echo $this->nm_new_label['agevieini']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ageviefin_line" id="hidden_field_data_ageviefin" style="<?php echo $sStyleHidden_ageviefin; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ageviefin_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ageviefin_label" style=""><span id="id_label_ageviefin"><?php echo $this->nm_new_label['ageviefin']; ?></span></span><br>
...
<?php $sStyleHidden_ageviefin_dumb = ('' == $sStyleHidden_ageviefin) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_ageviefin_dumb" style="<?php echo $sStyleHidden_ageviefin_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agesabini_line" id="hidden_field_data_agesabini" style="<?php echo $sStyleHidden_agesabini; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agesabini_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agesabini_label" style=""><span id="id_label_agesabini"><?php echo $this->nm_new_label['agesabini']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agesabfin_line" id="hidden_field_data_agesabfin" style="<?php echo $sStyleHidden_agesabfin; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agesabfin_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agesabfin_label" style=""><span id="id_label_agesabfin"><?php echo $this->nm_new_label['agesabfin']; ?></span></span><br>
...
<?php $sStyleHidden_agesabfin_dumb = ('' == $sStyleHidden_agesabfin) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_agesabfin_dumb" style="<?php echo $sStyleHidden_agesabfin_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agedomini_line" id="hidden_field_data_agedomini" style="<?php echo $sStyleHidden_agedomini; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agedomini_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agedomini_label" style=""><span id="id_label_agedomini"><?php echo $this->nm_new_label['agedomini']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_agedomfin_line" id="hidden_field_data_agedomfin" style="<?php echo $sStyleHidden_agedomfin; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_agedomfin_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_agedomfin_label" style=""><span id="id_label_agedomfin"><?php echo $this->nm_new_label['agedomfin']; ?></span></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
