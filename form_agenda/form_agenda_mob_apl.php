...
//----- 
   function ini_controle()
   {
      ...
      $_SESSION['scriptcase']['error_icon']['form_agenda_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      if ($this->nmgp_opcao == "fast_search")  
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['opcao'] = "inicio";
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['opc_ant'];
      } 
...
//
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_agenda_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_agenda_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
...
if ($error_test)
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_agenda_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_agenda_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_agenombre(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['php_cmp_required']['agenombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['php_cmp_required']['agenombre'] == "on")) 
      { 
          if ($this->agenombre == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_medcodigo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['php_cmp_required']['medcodigo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['php_cmp_required']['medcodigo'] == "on")) 
      { 
          if ($this->medcodigo == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_ageintervalo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->ageintervalo, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['php_cmp_required']['ageintervalo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['php_cmp_required']['ageintervalo'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_agecolor(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['php_cmp_required']['agecolor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['php_cmp_required']['agecolor'] == "on") 
          { 
              $hasError = true;
              $Campos_Falta[] = "COLOR" ; 
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['agesecuen']['keyVal'] = form_agenda_mob_pack_protect_string($this->nmgp_dados_form['agesecuen']);
          }
   } // ajax_return_values
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_agenda_mob_pack_protect_string(NM_charset_to_utf8($this->medcodigo))]) ? $aLookup[0][form_agenda_mob_pack_protect_string(NM_charset_to_utf8($this->medcodigo))] : "";
...
$aLookup[] = array(form_agenda_mob_pack_protect_string('1') => str_replace('<', '&lt;',form_agenda_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_ageactivo'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['ageactivo']['valList'][$i] = form_agenda_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_agenda_mob_pack_protect_string('1') => str_replace('<', '&lt;',form_agenda_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_agelunactivo'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['agelunactivo']['valList'][$i] = form_agenda_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_agenda_mob_pack_protect_string('1') => str_replace('<', '&lt;',form_agenda_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_agemaractivo'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['agemaractivo']['valList'][$i] = form_agenda_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_agenda_mob_pack_protect_string('1') => str_replace('<', '&lt;',form_agenda_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_agemieactivo'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['agemieactivo']['valList'][$i] = form_agenda_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_agenda_mob_pack_protect_string('1') => str_replace('<', '&lt;',form_agenda_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_agejueactivo'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['agejueactivo']['valList'][$i] = form_agenda_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_agenda_mob_pack_protect_string('1') => str_replace('<', '&lt;',form_agenda_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_agevieactivo'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['agevieactivo']['valList'][$i] = form_agenda_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_agenda_mob_pack_protect_string('1') => str_replace('<', '&lt;',form_agenda_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_agesabactivo'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['agesabactivo']['valList'][$i] = form_agenda_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_agenda_mob_pack_protect_string('1') => str_replace('<', '&lt;',form_agenda_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['Lookup_agedomactivo'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['agedomactivo']['valList'][$i] = form_agenda_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
  ...
  {
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
...
$_SESSION['scriptcase']['form_agenda_mob']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['parms'] = "agesecuen?#?$this->agesecuen?@?"; 
      }
      $this->NM_commit_db(); 
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['reg_start'] + 1;
