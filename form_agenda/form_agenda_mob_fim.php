...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____form_agenda"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____form_agenda"]);
   }
   ...
   if ((isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['sc_modal'])
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['lig_iframe_modal']))
               {
                   $iframe_master = $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['lig_iframe_modal'];
                   ...
                   unset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['lig_iframe_modal']);
               }
               else
               {
       ...
       if (isset($_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['lig_iframe_modal']))
       {
           $Save_modal = $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['lig_iframe_modal'];
           nm_limpa_arr_session();
           $_SESSION['sc_session'][$script_case_init]['form_agenda_mob']['lig_iframe_modal'] = $Save_modal;
       }
       else
       {
           nm_limpa_arr_session();
