<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="agesecuen" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['agesecuen']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_agenda_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
