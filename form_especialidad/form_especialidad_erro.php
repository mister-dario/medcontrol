...
$old_error_handler = set_error_handler("form_especialidad_scriptcase_error_handler");

function form_especialidad_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_especialidad']['contr_erro']) && $_SESSION['scriptcase']['form_especialidad']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_especialidad->contr_form_especialidad->Apl_com_erro = true;
            if ($inicial_form_especialidad->contr_form_especialidad->NM_ajax_flag)
            {
                $inicial_form_especialidad->contr_form_especialidad->NM_ajax_info['errList']['geral_form_especialidad'][] = $msg;
                return;
            }
            form_especialidad_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_especialidad_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_especialidad'])  && '' != $_SESSION['scriptcase']['error_icon']['form_especialidad'])  ? $_SESSION['scriptcase']['error_icon']['form_especialidad']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_especialidad']) && '' != $_SESSION['scriptcase']['error_close']['form_especialidad']) ? $_SESSION['scriptcase']['error_close']['form_especialidad'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_especialidad']) && '' != $_SESSION['scriptcase']['error_span_title']['form_especialidad']) ? $_SESSION['scriptcase']['error_span_title']['form_especialidad'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_especialidad']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_especialidad']) ? $_SESSION['scriptcase']['error_icon_title']['form_especialidad'] : '';
?>
