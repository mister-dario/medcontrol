  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_especialidad_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_especialidad_mob_form();
	}
  ...
  // ---------- Validate espcodigo
  function do_ajax_form_especialidad_mob_validate_espcodigo()
  {
    var nomeCampo_espcodigo = "espcodigo";
    var var_espcodigo = scAjaxGetFieldHidden(nomeCampo_espcodigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_especialidad_mob_validate_espcodigo(var_espcodigo, var_script_case_init, do_ajax_form_especialidad_mob_validate_espcodigo_cb);
  } // do_ajax_form_especialidad_mob_validate_espcodigo

  function do_ajax_form_especialidad_mob_validate_espcodigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_especialidad_mob_validate_espcodigo_cb

  // ---------- Validate espnombre
  function do_ajax_form_especialidad_mob_validate_espnombre()
  {
    var nomeCampo_espnombre = "espnombre";
    var var_espnombre = scAjaxGetFieldText(nomeCampo_espnombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_especialidad_mob_validate_espnombre(var_espnombre, var_script_case_init, do_ajax_form_especialidad_mob_validate_espnombre_cb);
  } // do_ajax_form_especialidad_mob_validate_espnombre

  function do_ajax_form_especialidad_mob_validate_espnombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "espnombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_especialidad_mob_validate_espnombre_cb

  // ---------- Validate espusucrea
  function do_ajax_form_especialidad_mob_validate_espusucrea()
  {
    var nomeCampo_espusucrea = "espusucrea";
    var var_espusucrea = scAjaxGetFieldText(nomeCampo_espusucrea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_especialidad_mob_validate_espusucrea(var_espusucrea, var_script_case_init, do_ajax_form_especialidad_mob_validate_espusucrea_cb);
  } // do_ajax_form_especialidad_mob_validate_espusucrea

  function do_ajax_form_especialidad_mob_validate_espusucrea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "espusucrea";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_especialidad_mob_validate_espusucrea_cb

  // ---------- Validate espfeccrea
  function do_ajax_form_especialidad_mob_validate_espfeccrea()
  {
    var nomeCampo_espfeccrea = "espfeccrea";
    var var_espfeccrea = scAjaxGetFieldText(nomeCampo_espfeccrea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_especialidad_mob_validate_espfeccrea(var_espfeccrea, var_script_case_init, do_ajax_form_especialidad_mob_validate_espfeccrea_cb);
  } // do_ajax_form_especialidad_mob_validate_espfeccrea

  function do_ajax_form_especialidad_mob_validate_espfeccrea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "espfeccrea";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_especialidad_mob_validate_espfeccrea_cb

  // ---------- Validate espusumodi
  function do_ajax_form_especialidad_mob_validate_espusumodi()
  {
    var nomeCampo_espusumodi = "espusumodi";
    var var_espusumodi = scAjaxGetFieldText(nomeCampo_espusumodi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_especialidad_mob_validate_espusumodi(var_espusumodi, var_script_case_init, do_ajax_form_especialidad_mob_validate_espusumodi_cb);
  } // do_ajax_form_especialidad_mob_validate_espusumodi

  function do_ajax_form_especialidad_mob_validate_espusumodi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "espusumodi";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_especialidad_mob_validate_espusumodi_cb

  // ---------- Validate espfecmodi
  function do_ajax_form_especialidad_mob_validate_espfecmodi()
  {
    var nomeCampo_espfecmodi = "espfecmodi";
    var var_espfecmodi = scAjaxGetFieldText(nomeCampo_espfecmodi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_especialidad_mob_validate_espfecmodi(var_espfecmodi, var_script_case_init, do_ajax_form_especialidad_mob_validate_espfecmodi_cb);
  } // do_ajax_form_especialidad_mob_validate_espfecmodi

  function do_ajax_form_especialidad_mob_validate_espfecmodi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "espfecmodi";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_especialidad_mob_validate_espfecmodi_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_especialidad_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_especialidad_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_espcodigo = scAjaxGetFieldHidden("espcodigo");
    var var_espnombre = scAjaxGetFieldText("espnombre");
    var var_espusucrea = scAjaxGetFieldText("espusucrea");
    var var_espfeccrea = scAjaxGetFieldText("espfeccrea");
    var var_espusumodi = scAjaxGetFieldText("espusumodi");
    var var_espfecmodi = scAjaxGetFieldText("espfecmodi");
    ...
    scAjaxProcOn();
    x_ajax_form_especialidad_mob_submit_form(var_espcodigo, var_espnombre, var_espusucrea, var_espfeccrea, var_espusumodi, var_espfecmodi, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_especialidad_mob_submit_form_cb);
  } // do_ajax_form_especialidad_mob_submit_form

  function do_ajax_form_especialidad_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("espnombre");
      scAjaxHideErrorDisplay("espusucrea");
      scAjaxHideErrorDisplay("espfeccrea");
      scAjaxHideErrorDisplay("espusumodi");
      scAjaxHideErrorDisplay("espfecmodi");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_especialidad_mob_submit_form_cb_after_alert);
  } // do_ajax_form_especialidad_mob_submit_form_cb
  function do_ajax_form_especialidad_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_especialidad_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_especialidad_mob_navigate_form()
  {
    perform_ajax_form_especialidad_mob_navigate_form();
  }

  function perform_ajax_form_especialidad_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("espusumodi");
    scAjaxHideErrorDisplay("espfecmodi");
    var var_espcodigo = document.F2.espcodigo.value;
    ...
    scAjaxProcOn();
    x_ajax_form_especialidad_mob_navigate_form(var_espcodigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_especialidad_mob_navigate_form_cb);
  } // do_ajax_form_especialidad_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_especialidad_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_especialidad_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.espcodigo.value = scAjaxGetKeyValue("espcodigo");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_especialidad_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_especialidad_mob_navigate_form_cb
  function do_ajax_form_especialidad_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_especialidad_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_especialidad_mob_navigate_form_cb_after_alert
  function sc_hide_form_especialidad_mob_form()
  {
  ...
  ajax_field_list[0] = "espcodigo";
  ajax_field_list[1] = "espnombre";
  ajax_field_list[2] = "espusucrea";
  ajax_field_list[3] = "espfeccrea";
  ajax_field_list[4] = "espusumodi";
  ajax_field_list[5] = "espfecmodi";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "espcodigo": {"label": "CÓDIGO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "espnombre": {"label": "NOMBRE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "espusucrea": {"label": "USUARIO CREACIÓN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "espfeccrea": {"label": "FECHA CREACIÓN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "espusumodi": {"label": "USUARIO MODIFICACIÓN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "espfecmodi": {"label": "FECHA MODIFICACIÓN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "espcodigo": new Array(),
    "espnombre": new Array(),
    "espusucrea": new Array(),
    "espfeccrea": new Array(),
    "espusumodi": new Array(),
    "espfecmodi": new Array()
  };
  ajax_field_mult["espcodigo"][1] = "espcodigo";
  ajax_field_mult["espnombre"][1] = "espnombre";
  ajax_field_mult["espusucrea"][1] = "espusucrea";
  ajax_field_mult["espfeccrea"][1] = "espfeccrea";
  ajax_field_mult["espusumodi"][1] = "espusumodi";
  ajax_field_mult["espfecmodi"][1] = "espfecmodi";

  var ajax_field_id = {
    "espcodigo": new Array("hidden_field_label_espcodigo", "hidden_field_data_espcodigo"),
    "espnombre": new Array("hidden_field_label_espnombre", "hidden_field_data_espnombre"),
    "espusucrea": new Array("hidden_field_label_espusucrea", "hidden_field_data_espusucrea"),
    "espfeccrea": new Array("hidden_field_label_espfeccrea", "hidden_field_data_espfeccrea"),
    "espusumodi": new Array("hidden_field_label_espusumodi", "hidden_field_data_espusumodi"),
    "espfecmodi": new Array("hidden_field_label_espfecmodi", "hidden_field_data_espfecmodi")
  };
