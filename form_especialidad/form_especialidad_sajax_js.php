  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_especialidad" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_especialidad_form();
	}
  ...
  // ---------- Validate espcodigo
  function do_ajax_form_especialidad_validate_espcodigo()
  {
    var nomeCampo_espcodigo = "espcodigo";
    var var_espcodigo = scAjaxGetFieldHidden(nomeCampo_espcodigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_especialidad_validate_espcodigo(var_espcodigo, var_script_case_init, do_ajax_form_especialidad_validate_espcodigo_cb);
  } // do_ajax_form_especialidad_validate_espcodigo

  function do_ajax_form_especialidad_validate_espcodigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_especialidad_validate_espcodigo_cb

  // ---------- Validate espnombre
  function do_ajax_form_especialidad_validate_espnombre()
  {
    var nomeCampo_espnombre = "espnombre";
    var var_espnombre = scAjaxGetFieldText(nomeCampo_espnombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_especialidad_validate_espnombre(var_espnombre, var_script_case_init, do_ajax_form_especialidad_validate_espnombre_cb);
  } // do_ajax_form_especialidad_validate_espnombre

  function do_ajax_form_especialidad_validate_espnombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_especialidad_validate_espnombre_cb

  // ---------- Validate espusucrea
  function do_ajax_form_especialidad_validate_espusucrea()
  {
    var nomeCampo_espusucrea = "espusucrea";
    var var_espusucrea = scAjaxGetFieldText(nomeCampo_espusucrea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_especialidad_validate_espusucrea(var_espusucrea, var_script_case_init, do_ajax_form_especialidad_validate_espusucrea_cb);
  } // do_ajax_form_especialidad_validate_espusucrea

  function do_ajax_form_especialidad_validate_espusucrea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_especialidad_validate_espusucrea_cb

  // ---------- Validate espfeccrea
  function do_ajax_form_especialidad_validate_espfeccrea()
  {
    var nomeCampo_espfeccrea = "espfeccrea";
    var var_espfeccrea = scAjaxGetFieldText(nomeCampo_espfeccrea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_especialidad_validate_espfeccrea(var_espfeccrea, var_script_case_init, do_ajax_form_especialidad_validate_espfeccrea_cb);
  } // do_ajax_form_especialidad_validate_espfeccrea

  function do_ajax_form_especialidad_validate_espfeccrea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_especialidad_validate_espfeccrea_cb

  // ---------- Validate espusumodi
  function do_ajax_form_especialidad_validate_espusumodi()
  {
    var nomeCampo_espusumodi = "espusumodi";
    var var_espusumodi = scAjaxGetFieldText(nomeCampo_espusumodi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_especialidad_validate_espusumodi(var_espusumodi, var_script_case_init, do_ajax_form_especialidad_validate_espusumodi_cb);
  } // do_ajax_form_especialidad_validate_espusumodi

  function do_ajax_form_especialidad_validate_espusumodi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_especialidad_validate_espusumodi_cb

  // ---------- Validate espfecmodi
  function do_ajax_form_especialidad_validate_espfecmodi()
  {
    var nomeCampo_espfecmodi = "espfecmodi";
    var var_espfecmodi = scAjaxGetFieldText(nomeCampo_espfecmodi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_especialidad_validate_espfecmodi(var_espfecmodi, var_script_case_init, do_ajax_form_especialidad_validate_espfecmodi_cb);
  } // do_ajax_form_especialidad_validate_espfecmodi

  function do_ajax_form_especialidad_validate_espfecmodi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_especialidad_validate_espfecmodi_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_especialidad_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_especialidad_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_especialidad_submit_form(var_espcodigo, var_espnombre, var_espusucrea, var_espfeccrea, var_espusumodi, var_espfecmodi, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_especialidad_submit_form_cb);
  } // do_ajax_form_especialidad_submit_form

  function do_ajax_form_especialidad_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_especialidad_submit_form_cb_after_alert);
  } // do_ajax_form_especialidad_submit_form_cb
  function do_ajax_form_especialidad_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_especialidad_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_especialidad_navigate_form()
  {
    perform_ajax_form_especialidad_navigate_form();
  }

  function perform_ajax_form_especialidad_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_especialidad_navigate_form(var_espcodigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_especialidad_navigate_form_cb);
  } // do_ajax_form_especialidad_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_especialidad']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_especialidad_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_especialidad_navigate_form_cb_after_alert);
  } // do_ajax_form_especialidad_navigate_form_cb
  function do_ajax_form_especialidad_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_especialidad_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_especialidad_navigate_form_cb_after_alert
  function sc_hide_form_especialidad_form()
  {
