<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_FACTURA_2']['sc_process_barr'] = true;
require_once('../pdfreport_FACTURA_2/index.php');
unset($_SESSION['scriptcase']['pdfreport_FACTURA_2']['sc_process_barr']);
$ExportCtrl = new pdfreport_FACTURA_2_export_control;
$ExportCtrl->Export_barr();

class pdfreport_FACTURA_2_export_control
{
