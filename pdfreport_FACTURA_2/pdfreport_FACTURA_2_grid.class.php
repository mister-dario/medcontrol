<?php
class pdfreport_FACTURA_2_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdfreport_FACTURA_2']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_FACTURA_2", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_FACTURA_2']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_FACTURA_2']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_FACTURA_2']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_FACTURA_2']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['tot_geral'][1] ;  
   }
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['order_grid'] = $nmgp_order_by;
...
// 
 function Pdf_image()
 {
   ...
   $this->Pdf->Image($this->NM_raiz_img . $this->Ini->path_img_global . "/grp__NM__img__NM__facturas_f2.jpg", "0.000000", "0.000000", "210", "297", '', '', '', false, 300, '', false, false, 0);
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_razonsocial'] = "f_razonsocial";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_ruc'] = "f_ruc";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_estab'] = "f_estab";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_ptoemi'] = "f_ptoemi";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_secuencial'] = "f_secuencial";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_lote'] = "f_lote";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_dirmatriz'] = "f_dirmatriz";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_fechaemision'] = "f_fechaemision";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_direstablecimiento'] = "f_direstablecimiento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_numcontribuyenteespecial'] = "f_numcontribuyenteespecial";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_obligadocontabilidad'] = "f_obligadocontabilidad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_guiaremision'] = "f_guiaremision";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_razonsocialcomprador'] = "f_razonsocialcomprador";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_idcomprador'] = "f_idcomprador";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_base_12'] = "f_base_12";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_base_0'] = "f_base_0";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_totalsinimpuestos'] = "f_totalsinimpuestos";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_totaldescuento'] = "f_totaldescuento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_tarifa1'] = "TARIFA1";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valor1'] = "f_valor1";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_propina'] = "f_propina";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_importetotal'] = "f_importetotal";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional1'] = "f_campoadicional1";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional1'] = "f_valoradicional1";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional2'] = "f_campoadicional2";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional2'] = "f_valoradicional2";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional3'] = "f_campoadicional3";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional3'] = "f_valoradicional3";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional4'] = "f_campoadicional4";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional4'] = "f_valoradicional4";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional5'] = "f_campoadicional5";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional5'] = "f_valoradicional5";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional6'] = "f_campoadicional6";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional6'] = "f_valoradicional6";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional7'] = "f_campoadicional7";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional7'] = "f_valoradicional7";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional8'] = "f_campoadicional8";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional8'] = "f_valoradicional8";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional9'] = "f_campoadicional9";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional9'] = "f_valoradicional9";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional10'] = "f_campoadicional10";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional10'] = "f_valoradicional10";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional11'] = "f_campoadicional11";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional11'] = "f_valoradicional11";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional12'] = "CAMPOADICIONAL12";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional12'] = "VALORADICIONAL12";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional13'] = "CAMPOADICIONAL13";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional13'] = "VALORADICIONAL13";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional14'] = "CAMPOADICIONAL14";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional14'] = "VALORADICIONAL14";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional15'] = "CAMPOADICIONAL15";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional15'] = "VALORADICIONAL15";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional16'] = "CAMPOADICIONAL16";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional16'] = "VALORADICIONAL16";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional17'] = "CAMPOADICIONAL17";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional17'] = "VALORADICIONAL17";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional18'] = "CAMPOADICIONAL18";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional18'] = "VALORADICIONAL18";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional19'] = "CAMPOADICIONAL19";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional19'] = "VALORADICIONAL19";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_campoadicional20'] = "CAMPOADICIONAL20";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valoradicional20'] = "VALORADICIONAL20";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['ff_clave_acceso'] = "ff_clave_acceso";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['ff_numeroautorizacion'] = "ff_numeroautorizacion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['ff_fechaautorizacion'] = "ff_fechaautorizacion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_numpagos'] = "NUMPAGOS";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_formapago1'] = "FORMAPAGO1";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valortot1'] = "VALORTOT1";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_plazo1'] = "PLAZO1";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_unidadtiempo1'] = "UNIDADTIEMPO1";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_formapago2'] = "FORMAPAGO2";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_valortot2'] = "VALORTOT2";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_plazo2'] = "PLAZO2";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_unidadtiempo2'] = "UNIDADTIEMPO2";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['f_ambiente'] = "AMBIENTE";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['ice'] = "ICE";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['ca_bar'] = "ca_bar";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['detalle'] = "detalle";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['detalle_cantidad'] = "CANTIDAD";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['detalle_descuento'] = "DESCUENTO";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['detalle_item'] = "ITEM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['detalle_preciototalsinimpuesto'] = "PRECIOTOTALSINIMPUESTO";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['detalle_preciounitario'] = "PRECIOUNITARIO";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['direccion'] = "direccion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['fecha_auth_format'] = "fecha_auth_format";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_atencion'] = "label_atencion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_ca'] = "label_ca";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_codcliente'] = "label_codcliente";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_contr_especial'] = "label_contr_especial";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_descuento'] = "label_descuento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_dircliente'] = "label_dircliente";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_fecha_auth'] = "label_fecha_auth";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_fecha_emision'] = "label_fecha_emision";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_file'] = "label_file";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_formapago'] = "label_formapago";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_guia_remision'] = "label_guia_remision";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_iva'] = "label_iva";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_lote'] = "label_lote";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_nom_cliente'] = "label_nom_cliente";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_num_auth'] = "label_num_auth";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_obligado_cont'] = "label_obligado_cont";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_promo'] = "label_promo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_ruccliente'] = "label_ruccliente";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_stexento'] = "label_stexento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_stgravado'] = "label_stgravado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_subtotal'] = "label_subtotal";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_suma_letras'] = "label_suma_letras";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_telfcliente'] = "label_telfcliente";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_vence'] = "label_vence";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['labels']['label_vendedor'] = "label_vendedor";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_FACTURA_2']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_FACTURA_2']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_FACTURA_2']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_init();
      $this->Pdf_image();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_FACTURA_2']['qt_col_grid']) 
      {  
