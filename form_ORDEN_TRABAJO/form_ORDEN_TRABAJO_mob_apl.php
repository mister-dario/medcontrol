<?php
//
class form_ORDEN_TRABAJO_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_ORDEN_TRABAJO_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_ORDEN_TRABAJO_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_ORDEN_TRABAJO_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_ORDEN_TRABAJO_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_ORDEN_TRABAJO_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_ORDEN_TRABAJO_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_ORDEN_TRABAJO_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_ORDEN_TRABAJO_mob']['label'] = "form_ORDEN_TRABAJO_mob";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['pdf_view'] = false;
      if ($this->nmgp_opcao == "pdf" || $this->nmgp_opcao == "print")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['pdf_view'] = true;
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opc_ant'] == "novo")
          {
              $this->nmgp_opcao = "novo";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opcao'] = "novo";
          }
          else
          {
              $this->nmgp_opcao = "igual";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opcao'] = "igual";
          }
      } 
      $this->Db = $this->Ini->Db; 
      ...
      $this->arr_buttons['facturar']['value']            = "FACTURAR";
      $this->arr_buttons['facturar']['display']          = "only_text";
      ...
      $_SESSION['scriptcase']['error_icon']['form_ORDEN_TRABAJO_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_ORDEN_TRABAJO_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_ORDEN_TRABAJO_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_ORDEN_TRABAJO_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_ORDEN_TRABAJO_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dados_form'];
          ...
          if (!isset($this->ordvalefec)){$this->ordvalefec = $this->nmgp_dados_form['ordvalefec'];} 
          if (!isset($this->ordvalcheq)){$this->ordvalcheq = $this->nmgp_dados_form['ordvalcheq'];} 
          if (!isset($this->ordvaltarjcred)){$this->ordvaltarjcred = $this->nmgp_dados_form['ordvaltarjcred'];} 
          if (!isset($this->ordvaltransf)){$this->ordvaltransf = $this->nmgp_dados_form['ordvaltransf'];} 
          if (!isset($this->ordnumcheq)){$this->ordnumcheq = $this->nmgp_dados_form['ordnumcheq'];} 
          if (!isset($this->ordbancheq)){$this->ordbancheq = $this->nmgp_dados_form['ordbancheq'];} 
          if (!isset($this->tcrcodigo)){$this->tcrcodigo = $this->nmgp_dados_form['tcrcodigo'];} 
          if (!isset($this->ordnumtarjcred)){$this->ordnumtarjcred = $this->nmgp_dados_form['ordnumtarjcred'];} 
          if (!isset($this->ordbantransf)){$this->ordbantransf = $this->nmgp_dados_form['ordbantransf'];} 
          if (!isset($this->ordctatransf)){$this->ordctatransf = $this->nmgp_dados_form['ordctatransf'];} 
          if ($this->nmgp_opcao == "incluir" && $this->nmgp_dados_form['facturado'] != "null"){$this->facturado = $this->nmgp_dados_form['facturado'];} 
          if (!isset($this->num_cita)){$this->num_cita = $this->nmgp_dados_form['num_cita'];} 
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_ORDEN_TRABAJO_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_ORDEN_TRABAJO_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_ORDEN_TRABAJO/form_ORDEN_TRABAJO_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_ORDEN_TRABAJO_mob_erro.class.php"); 
      }
      $this->Erro      = new form_ORDEN_TRABAJO_mob_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opcao']))
         { 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_ORDEN_TRABAJO_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['FACTURAR'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['botoes']['FACTURAR'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_DETALLE_ORDEN_TRABAJO_mob') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_DETALLE_ORDEN_TRABAJO_mob') . "/form_DETALLE_ORDEN_TRABAJO_mob_apl.php");
          $this->form_DETALLE_ORDEN_TRABAJO_mob = new form_DETALLE_ORDEN_TRABAJO_mob_apl;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- ordvalefec
      $this->field_config['ordvalefec']               = array();
      $this->field_config['ordvalefec']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ordvalefec']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ordvalefec']['symbol_dec'] = '';
      $this->field_config['ordvalefec']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ordvalefec']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ordvalcheq
      $this->field_config['ordvalcheq']               = array();
      $this->field_config['ordvalcheq']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ordvalcheq']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ordvalcheq']['symbol_dec'] = '';
      $this->field_config['ordvalcheq']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ordvalcheq']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ordvaltarjcred
      $this->field_config['ordvaltarjcred']               = array();
      $this->field_config['ordvaltarjcred']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ordvaltarjcred']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ordvaltarjcred']['symbol_dec'] = '';
      $this->field_config['ordvaltarjcred']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ordvaltarjcred']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ordvaltransf
      $this->field_config['ordvaltransf']               = array();
      $this->field_config['ordvaltransf']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ordvaltransf']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ordvaltransf']['symbol_dec'] = '';
      $this->field_config['ordvaltransf']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ordvaltransf']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- tcrcodigo
      ...
      $this->field_config['num_cita']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['num_cita']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['num_cita']['symbol_dec'] = '';
      $this->field_config['num_cita']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['num_cita']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          if (is_array($this->facturado))
          {
              $x = 0; 
              ...
              if ($this->facturado_1 != "") 
              { 
                  foreach ($this->facturado_1 as $dados_facturado_1 ) 
                  { 
                      if ($x != 0)
                      { 
                          $this->facturado .= ";";
                      } 
                      $this->facturado .= $dados_facturado_1;
                      $x++ ; 
                  } 
              } 
          } 
          $this->nm_tira_formatacao();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dados_select']['facturado']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->facturado = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dados_select']['facturado'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['recarga'] = $this->nmgp_opcao;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['pdf_view'])
      { 
...
//--------------------------------------------------------------------------------------
   function NM_pdf_output()
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['pdf_view'])
      { 
          $arq_pdf_in = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_form_ORDEN_TRABAJO_mob_html_" . session_id() . ".html";
          $url_pdf_in = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_form_ORDEN_TRABAJO_mob_html_" . session_id() . ".html";
          $str_htm    =  ob_get_contents();
          ob_end_clean();
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['prt_view'])
          { 
              if (isset($this->nmgp_password) && $this->nmgp_password != "")
              { 
                  $arq_prt_base = "/sc_form_ORDEN_TRABAJO_mob_html_" . session_id() . ".html";
          ...
          fwrite($arq_htm, $str_htm); 
          fclose($arq_htm);
          $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "form_ORDEN_TRABAJO_mob";
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['pdf_name']))
          {
              $nm_arquivo_pdf_base = str_replace(".pdf", "", $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['pdf_name']);
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['pdf_name']);
          }
          ...
          $NM_tit_doc = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['pdf_name'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['pdf_name'] : "form_ORDEN_TRABAJO_mob";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob'][$path_doc_md5][0] = $nm_arquivo_pdf_url;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob'][$path_doc_md5][1] = $NM_tit_doc_x;
?>
...
<form name="Fdown" method="get" action="form_ORDEN_TRABAJO_mob_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_ORDEN_TRABAJO_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_ORDEN_TRABAJO_mob.php"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_ORDEN_TRABAJO_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("") ?></TITLE>
...
<form name="Fdown" method="get" action="form_ORDEN_TRABAJO_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_ORDEN_TRABAJO_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_ORDEN_TRABAJO_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nmgp_opcao" value="<?php echo $this->nmgp_opcao ?>"> 
</form> 
         </BODY>
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_ORDEN_TRABAJO_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_ORDEN_TRABAJO_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_ORDEN_TRABAJO_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_ORDEN_TRABAJO_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_fechaemision(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['fechaemision']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['fechaemision'] == "on")) 
      { 
    ...
    function ValidateField_idcomprador(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['idcomprador']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['idcomprador'] == "on")) 
      { 
          if ($this->idcomprador == "")  
          { 
              $hasError = true;
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "ID CLIENTE " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 13 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['idcomprador']))
              {
                  $Campos_Erros['idcomprador'] = array();
              }
    ...
    function ValidateField_razonsocialcomprador(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['razonsocialcomprador']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['razonsocialcomprador'] == "on")) 
      { 
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "NOMBRE CLIENTE " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 300 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['razonsocialcomprador']))
              {
                  $Campos_Erros['razonsocialcomprador'] = array();
              }
    ...
    function ValidateField_totalsinimpuestos(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['totalsinimpuestos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['totalsinimpuestos'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_totaldescuento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['totaldescuento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['totaldescuento'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_base_12(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['base_12']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['base_12'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_base_0(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['base_0']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['base_0'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "BASE 0%" ; 
              if (!isset($Campos_Erros['base_0']))
    ...
    function ValidateField_importetotal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['importetotal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['importetotal'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_facturado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          if (is_array($this->facturado))
          {
              ...
              foreach ($this->facturado as $ind => $dados_facturado_1 ) 
              {
                  if ($dados_facturado_1 != "") 
                  {
                      $this->facturado_1[] = $dados_facturado_1;
                  } 
              } 
              $this->facturado = ""; 
              foreach ($this->facturado_1 as $dados_facturado_1 ) 
    ...
    function ValidateField_campoadicional1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional1'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional1'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional2'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional2'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional3(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional3'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional3(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional3'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional4(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional4'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional4(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional4'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional5(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional5']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional5'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional5(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional5']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional5'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional6(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional6']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional6'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional6(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional6']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional6'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional7(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional7']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional7'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional7(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional7']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional7'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional8(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional8']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional8'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional8(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional8']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional8'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional9(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional9']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional9'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional9(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional9']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional9'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional10(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional10']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional10'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional10(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional10']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional10'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional11(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional11']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional11'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional11(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional11']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional11'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional12(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional12']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional12'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional12(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional12']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional12'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional13(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional13']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional13'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional13(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional13']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional13'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional14(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional14']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional14'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional14(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional14']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional14'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional15(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional15']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional15'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional15(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional15']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional15'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional16(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional16']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional16'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional16(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional16']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional16'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional17(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional17']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional17'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional17(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional17']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional17'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional18(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional18']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional18'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional18(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional18']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional18'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional19(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional19']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional19'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional19(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional19']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional19'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional20(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional20']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['campoadicional20'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional20(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional20']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['php_cmp_required']['valoradicional20'] == "on")) 
      { 
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['ordvalefec'] = $this->ordvalefec;
    $this->nmgp_dados_form['ordvalcheq'] = $this->ordvalcheq;
    $this->nmgp_dados_form['ordvaltarjcred'] = $this->ordvaltarjcred;
    $this->nmgp_dados_form['ordvaltransf'] = $this->ordvaltransf;
    $this->nmgp_dados_form['ordnumcheq'] = $this->ordnumcheq;
    $this->nmgp_dados_form['ordbancheq'] = $this->ordbancheq;
    $this->nmgp_dados_form['tcrcodigo'] = $this->tcrcodigo;
    $this->nmgp_dados_form['ordnumtarjcred'] = $this->ordnumtarjcred;
    $this->nmgp_dados_form['ordbantransf'] = $this->ordbantransf;
    $this->nmgp_dados_form['ordctatransf'] = $this->ordctatransf;
    $this->nmgp_dados_form['num_cita'] = $this->num_cita;
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['ordvalefec'] = $this->ordvalefec;
      nm_limpa_numero($this->ordvalefec, $this->field_config['ordvalefec']['symbol_grp']) ; 
      $this->Before_unformat['ordvalcheq'] = $this->ordvalcheq;
      nm_limpa_numero($this->ordvalcheq, $this->field_config['ordvalcheq']['symbol_grp']) ; 
      $this->Before_unformat['ordvaltarjcred'] = $this->ordvaltarjcred;
      nm_limpa_numero($this->ordvaltarjcred, $this->field_config['ordvaltarjcred']['symbol_grp']) ; 
      $this->Before_unformat['ordvaltransf'] = $this->ordvaltransf;
      nm_limpa_numero($this->ordvaltransf, $this->field_config['ordvaltransf']['symbol_grp']) ; 
   ...
   function nm_clear_val($Nome_Campo)
   {
      ...
      if ($Nome_Campo == "ordvalefec")
      {
          nm_limpa_numero($this->ordvalefec, $this->field_config['ordvalefec']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "ordvalcheq")
      {
          nm_limpa_numero($this->ordvalcheq, $this->field_config['ordvalcheq']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "ordvaltarjcred")
      {
          nm_limpa_numero($this->ordvaltarjcred, $this->field_config['ordvaltarjcred']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "ordvaltransf")
      {
          nm_limpa_numero($this->ordvaltransf, $this->field_config['ordvaltransf']['symbol_grp']) ; 
      }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['estab']['keyVal'] = form_ORDEN_TRABAJO_mob_pack_protect_string($this->nmgp_dados_form['estab']);
              $this->NM_ajax_info['fldList']['ptoemi']['keyVal'] = form_ORDEN_TRABAJO_mob_pack_protect_string($this->nmgp_dados_form['ptoemi']);
              $this->NM_ajax_info['fldList']['secuencial']['keyVal'] = form_ORDEN_TRABAJO_mob_pack_protect_string($this->nmgp_dados_form['secuencial']);
              $this->NM_ajax_info['fldList']['lote']['keyVal'] = form_ORDEN_TRABAJO_mob_pack_protect_string($this->nmgp_dados_form['lote']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['foreign_key']['estab'] = $this->nmgp_dados_form['estab'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['foreign_key']['ptoemi'] = $this->nmgp_dados_form['ptoemi'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['foreign_key']['secuencial'] = $this->nmgp_dados_form['secuencial'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['foreign_key']['lote'] = $this->nmgp_dados_form['lote'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['where_filter'] = "ESTAB = " . $this->nmgp_dados_form['estab'] . " AND PTOEMI = " . $this->nmgp_dados_form['ptoemi'] . " AND SECUENCIAL = " . $this->nmgp_dados_form['secuencial'] . " AND LOTE = '" . $this->nmgp_dados_form['lote'] . "'";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['where_detal']  = "ESTAB = " . $this->nmgp_dados_form['estab'] . " AND PTOEMI = " . $this->nmgp_dados_form['ptoemi'] . " AND SECUENCIAL = " . $this->nmgp_dados_form['secuencial'] . " AND LOTE = '" . $this->nmgp_dados_form['lote'] . "'";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['total']);
              }
          }
...
$aLookup[] = array(form_ORDEN_TRABAJO_mob_pack_protect_string('1') => str_replace('<', '&lt;',form_ORDEN_TRABAJO_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['Lookup_facturado'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['facturado']) && !empty($this->NM_ajax_info['select_html']['facturado']))
          {
              $sOptComp = $this->NM_ajax_info['select_html']['facturado'];
          }
          $this->NM_ajax_info['fldList']['facturado'] = array(
               ...
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-facturado',
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['facturado']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['facturado']['valList'][$i] = form_ORDEN_TRABAJO_mob_pack_protect_string($v);
          }
   ...
   function ajax_return_values_lote($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
   ...
   {
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_citid'] = $this->form_encode_input($this->nmgp_dados_form['num_cita']);
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_v_numcita'] = $this->form_encode_input($this->nmgp_dados_form['num_cita']);
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_v_estab'] = $this->form_encode_input($this->nmgp_dados_form['estab']);
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_v_ptoemi'] = $this->form_encode_input($this->nmgp_dados_form['ptoemi']);
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_v_secuencial'] = $this->form_encode_input($this->nmgp_dados_form['secuencial']);
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_v_lote'] = $this->form_encode_input($this->nmgp_dados_form['lote']);
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_v_emisor_ot'] = $this->form_encode_input($this->nmgp_dados_form['ruc']);
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_v_valorefec'] = $this->form_encode_input($this->nmgp_dados_form['ordvalefec']);
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_v_valorcheq'] = $this->form_encode_input($this->nmgp_dados_form['ordvalcheq']);
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_v_valortarj'] = $this->form_encode_input($this->nmgp_dados_form['ordvaltarjcred']);
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_v_valortrans'] = $this->form_encode_input($this->nmgp_dados_form['ordvaltransf']);
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_v_numcheq'] = $this->form_encode_input($this->nmgp_dados_form['ordnumcheq']);
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_v_bancheq'] = $this->form_encode_input($this->nmgp_dados_form['ordbancheq']);
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_v_tiptarcre'] = $this->form_encode_input($this->nmgp_dados_form['tcrcodigo']);
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_v_numtarcre'] = $this->form_encode_input($this->nmgp_dados_form['ordnumtarjcred']);
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_v_bantran'] = $this->form_encode_input($this->nmgp_dados_form['ordbantransf']);
       $this->NM_ajax_info['btnVars']['var_btn_FACTURAR_v_numctatran'] = $this->form_encode_input($this->nmgp_dados_form['ordctatransf']);
   } // ajax_add_parameters
  function nm_proc_onload($bFormat = true)
  {
      if (!$this->NM_ajax_flag || !isset($this->nmgp_refresh_fields)) {
      $_SESSION['scriptcase']['form_ORDEN_TRABAJO_mob']['contr_erro'] = 'on';
...
$establecimiento=ltrim($this->estab ,'0');
$secuencial=(string)$this->secuencial ;
$secuencial_ok=ltrim($this->secuencial,'0');
...
if($this->facturado ==1 || $this->compareFloatNumbers($valor_pendiente,0,">") || $this->compareFloatNumbers($this->importetotal ,0,"=")) {
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opcao'] = '';
   ...
   { 
      ...
      $NM_val_form['ordvalefec'] = $this->ordvalefec;
      $NM_val_form['ordvalcheq'] = $this->ordvalcheq;
      $NM_val_form['ordvaltarjcred'] = $this->ordvaltarjcred;
      $NM_val_form['ordvaltransf'] = $this->ordvaltransf;
      $NM_val_form['ordnumcheq'] = $this->ordnumcheq;
      $NM_val_form['ordbancheq'] = $this->ordbancheq;
      $NM_val_form['tcrcodigo'] = $this->tcrcodigo;
      $NM_val_form['ordnumtarjcred'] = $this->ordnumtarjcred;
      $NM_val_form['ordbantransf'] = $this->ordbantransf;
      $NM_val_form['ordctatransf'] = $this->ordctatransf;
      ...
      if ($this->ordvalefec === "" || is_null($this->ordvalefec))  
      { 
          $this->ordvalefec = 0;
          $this->sc_force_zero[] = 'ordvalefec';
      } 
      if ($this->ordvalcheq === "" || is_null($this->ordvalcheq))  
      { 
          $this->ordvalcheq = 0;
          $this->sc_force_zero[] = 'ordvalcheq';
      } 
      if ($this->ordvaltarjcred === "" || is_null($this->ordvaltarjcred))  
      { 
          $this->ordvaltarjcred = 0;
          $this->sc_force_zero[] = 'ordvaltarjcred';
      } 
      if ($this->ordvaltransf === "" || is_null($this->ordvaltransf))  
      { 
          $this->ordvaltransf = 0;
          $this->sc_force_zero[] = 'ordvaltransf';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          $this->ordnumcheq_before_qstr = $this->ordnumcheq;
          $this->ordnumcheq = substr($this->Db->qstr($this->ordnumcheq), 1, -1); 
          if ($this->ordnumcheq == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->ordnumcheq = "null"; 
              $NM_val_null[] = "ordnumcheq";
          } 
          $this->ordbancheq_before_qstr = $this->ordbancheq;
          $this->ordbancheq = substr($this->Db->qstr($this->ordbancheq), 1, -1); 
          if ($this->ordbancheq == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->ordbancheq = "null"; 
              $NM_val_null[] = "ordbancheq";
          } 
          $this->ordnumtarjcred_before_qstr = $this->ordnumtarjcred;
          $this->ordnumtarjcred = substr($this->Db->qstr($this->ordnumtarjcred), 1, -1); 
          if ($this->ordnumtarjcred == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->ordnumtarjcred = "null"; 
              $NM_val_null[] = "ordnumtarjcred";
          } 
          $this->ordbantransf_before_qstr = $this->ordbantransf;
          $this->ordbantransf = substr($this->Db->qstr($this->ordbantransf), 1, -1); 
          if ($this->ordbantransf == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->ordbantransf = "null"; 
              $NM_val_null[] = "ordbantransf";
          } 
          $this->ordctatransf_before_qstr = $this->ordctatransf;
          $this->ordctatransf = substr($this->Db->qstr($this->ordctatransf), 1, -1); 
          if ($this->ordctatransf == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->ordctatransf = "null"; 
              $NM_val_null[] = "ordctatransf";
          } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              if (isset($NM_val_form['ordvalefec']) && $NM_val_form['ordvalefec'] != $this->nmgp_dados_select['ordvalefec']) 
              { 
                  $SC_fields_update[] = "ordvalefec = $this->ordvalefec"; 
              } 
              if (isset($NM_val_form['ordvalcheq']) && $NM_val_form['ordvalcheq'] != $this->nmgp_dados_select['ordvalcheq']) 
              { 
                  $SC_fields_update[] = "ordvalcheq = $this->ordvalcheq"; 
              } 
              if (isset($NM_val_form['ordvaltarjcred']) && $NM_val_form['ordvaltarjcred'] != $this->nmgp_dados_select['ordvaltarjcred']) 
              { 
                  $SC_fields_update[] = "ordvaltarjcred = $this->ordvaltarjcred"; 
              } 
              if (isset($NM_val_form['ordvaltransf']) && $NM_val_form['ordvaltransf'] != $this->nmgp_dados_select['ordvaltransf']) 
              { 
                  $SC_fields_update[] = "ordvaltransf = $this->ordvaltransf"; 
              } 
              if (isset($NM_val_form['ordnumcheq']) && $NM_val_form['ordnumcheq'] != $this->nmgp_dados_select['ordnumcheq']) 
              { 
                  $SC_fields_update[] = "ordnumcheq = '$this->ordnumcheq'"; 
              } 
              if (isset($NM_val_form['ordbancheq']) && $NM_val_form['ordbancheq'] != $this->nmgp_dados_select['ordbancheq']) 
              { 
                  $SC_fields_update[] = "ordbancheq = '$this->ordbancheq'"; 
              } 
              ...
              if (isset($NM_val_form['ordnumtarjcred']) && $NM_val_form['ordnumtarjcred'] != $this->nmgp_dados_select['ordnumtarjcred']) 
              { 
                  $SC_fields_update[] = "ordnumtarjcred = '$this->ordnumtarjcred'"; 
              } 
              if (isset($NM_val_form['ordbantransf']) && $NM_val_form['ordbantransf'] != $this->nmgp_dados_select['ordbantransf']) 
              { 
                  $SC_fields_update[] = "ordbantransf = '$this->ordbantransf'"; 
              } 
              if (isset($NM_val_form['ordctatransf']) && $NM_val_form['ordctatransf'] != $this->nmgp_dados_select['ordctatransf']) 
              { 
                  $SC_fields_update[] = "ordctatransf = '$this->ordctatransf'"; 
              } 
              ...
              $this->ordnumcheq = $this->ordnumcheq_before_qstr;
              $this->ordbancheq = $this->ordbancheq_before_qstr;
              $this->ordnumtarjcred = $this->ordnumtarjcred_before_qstr;
              $this->ordbantransf = $this->ordbantransf_before_qstr;
              $this->ordctatransf = $this->ordctatransf_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              { 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "RAZONSOCIAL, NOMBRECOMERCIAL, RUC, CODDOC, ESTAB, PTOEMI, SECUENCIAL, LOTE, DIRMATRIZ, FECHAEMISION, DIRESTABLECIMIENTO, NUMCONTRIBUYENTEESPECIAL, OBLIGADOCONTABILIDAD, TIPOIDENTCOMPRADOR, GUIAREMISION, RAZONSOCIALCOMPRADOR, IDCOMPRADOR, TOTALSINIMPUESTOS, TOTALDESCUENTO, BASE_12, BASE_0, CODIMPUESTO, CODPORCENTAJEIMPUESTO, BASEIMPONIBLE1, TARIFA1, VALOR1, PROPINA, IMPORTETOTAL, FORMATO, CAMPOADICIONAL1, VALORADICIONAL1, CAMPOADICIONAL2, VALORADICIONAL2, CAMPOADICIONAL3, VALORADICIONAL3, CAMPOADICIONAL4, VALORADICIONAL4, CAMPOADICIONAL5, VALORADICIONAL5, CAMPOADICIONAL6, VALORADICIONAL6, CAMPOADICIONAL7, VALORADICIONAL7, CAMPOADICIONAL8, VALORADICIONAL8, CAMPOADICIONAL9, VALORADICIONAL9, CAMPOADICIONAL10, VALORADICIONAL10, CAMPOADICIONAL11, VALORADICIONAL11, CAMPOADICIONAL12, VALORADICIONAL12, CAMPOADICIONAL13, VALORADICIONAL13, CAMPOADICIONAL14, VALORADICIONAL14, CAMPOADICIONAL15, VALORADICIONAL15, CAMPOADICIONAL16, VALORADICIONAL16, CAMPOADICIONAL17, VALORADICIONAL17, CAMPOADICIONAL18, VALORADICIONAL18, CAMPOADICIONAL19, VALORADICIONAL19, CAMPOADICIONAL20, VALORADICIONAL20, ordvalefec, ordvalcheq, ordvaltarjcred, ordvaltransf, ordnumcheq, ordbancheq, tcrcodigo, ordnumtarjcred, ordbantransf, ordctatransf, facturado, num_cita $compl_insert) VALUES (" . $NM_seq_auto . "'$this->razonsocial', '$this->nombrecomercial', '$this->ruc', $this->coddoc, $this->estab, $this->ptoemi, $this->secuencial, '$this->lote', '$this->dirmatriz', '$this->fechaemision', '$this->direstablecimiento', $this->numcontribuyenteespecial, '$this->obligadocontabilidad', $this->tipoidentcomprador, '$this->guiaremision', '$this->razonsocialcomprador', '$this->idcomprador', $this->totalsinimpuestos, $this->totaldescuento, $this->base_12, $this->base_0, $this->codimpuesto, $this->codporcentajeimpuesto, $this->baseimponible1, $this->tarifa1, $this->valor1, $this->propina, $this->importetotal, $this->formato, '$this->campoadicional1', '$this->valoradicional1', '$this->campoadicional2', '$this->valoradicional2', '$this->campoadicional3', '$this->valoradicional3', '$this->campoadicional4', '$this->valoradicional4', '$this->campoadicional5', '$this->valoradicional5', '$this->campoadicional6', '$this->valoradicional6', '$this->campoadicional7', '$this->valoradicional7', '$this->campoadicional8', '$this->valoradicional8', '$this->campoadicional9', '$this->valoradicional9', '$this->campoadicional10', '$this->valoradicional10', '$this->campoadicional11', '$this->valoradicional11', '$this->campoadicional12', '$this->valoradicional12', '$this->campoadicional13', '$this->valoradicional13', '$this->campoadicional14', '$this->valoradicional14', '$this->campoadicional15', '$this->valoradicional15', '$this->campoadicional16', '$this->valoradicional16', '$this->campoadicional17', '$this->valoradicional17', '$this->campoadicional18', '$this->valoradicional18', '$this->campoadicional19', '$this->valoradicional19', '$this->campoadicional20', '$this->valoradicional20', $this->ordvalefec, $this->ordvalcheq, $this->ordvaltarjcred, $this->ordvaltransf, '$this->ordnumcheq', '$this->ordbancheq', $this->tcrcodigo, '$this->ordnumtarjcred', '$this->ordbantransf', '$this->ordctatransf', $this->facturado, $this->num_cita $compl_insert_val)"; 
              }
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_DETALLE_ORDEN_TRABAJO_mob->ini_controle();
              if ($this->form_DETALLE_ORDEN_TRABAJO_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['parms'] = "estab?#?$this->estab?@?ptoemi?#?$this->ptoemi?@?secuencial?#?$this->secuencial?@?lote?#?$this->lote?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['FACTURAR'] = $this->nmgp_botoes['FACTURAR'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              $this->ordvalefec = trim($rs->fields[70]) ; 
              $this->nmgp_dados_select['ordvalefec'] = $this->ordvalefec;
              $this->ordvalcheq = trim($rs->fields[71]) ; 
              $this->nmgp_dados_select['ordvalcheq'] = $this->ordvalcheq;
              $this->ordvaltarjcred = trim($rs->fields[72]) ; 
              $this->nmgp_dados_select['ordvaltarjcred'] = $this->ordvaltarjcred;
              $this->ordvaltransf = trim($rs->fields[73]) ; 
              $this->nmgp_dados_select['ordvaltransf'] = $this->ordvaltransf;
              $this->ordnumcheq = $rs->fields[74] ; 
              $this->nmgp_dados_select['ordnumcheq'] = $this->ordnumcheq;
              $this->ordbancheq = $rs->fields[75] ; 
              $this->nmgp_dados_select['ordbancheq'] = $this->ordbancheq;
              $this->tcrcodigo = $rs->fields[76] ; 
              $this->nmgp_dados_select['tcrcodigo'] = $this->tcrcodigo;
              $this->ordnumtarjcred = $rs->fields[77] ; 
              $this->nmgp_dados_select['ordnumtarjcred'] = $this->ordnumtarjcred;
              $this->ordbantransf = $rs->fields[78] ; 
              $this->nmgp_dados_select['ordbantransf'] = $this->ordbantransf;
              $this->ordctatransf = $rs->fields[79] ; 
              $this->nmgp_dados_select['ordctatransf'] = $this->ordctatransf;
              $this->facturado = $rs->fields[80] ; 
              $this->nmgp_dados_select['facturado'] = $this->facturado;
              $this->num_cita = $rs->fields[81] ; 
              $this->nmgp_dados_select['num_cita'] = $this->num_cita;
              $this->detalle_factura = $rs->fields[82] ; 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dados_select'] = $this->nmgp_dados_select;
...
//-- 
      ...
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_parms'] = "NM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout";
  }
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_ORDEN_TRABAJO_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_ORDEN_TRABAJO_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['total'] = $qt_geral_reg_form_ORDEN_TRABAJO_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_ORDEN_TRABAJO_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $nm_numeric[] = "coddoc";$nm_numeric[] = "estab";$nm_numeric[] = "ptoemi";$nm_numeric[] = "secuencial";$nm_numeric[] = "numcontribuyenteespecial";$nm_numeric[] = "tipoidentcomprador";$nm_numeric[] = "totalsinimpuestos";$nm_numeric[] = "totaldescuento";$nm_numeric[] = "base_12";$nm_numeric[] = "base_0";$nm_numeric[] = "codimpuesto";$nm_numeric[] = "codporcentajeimpuesto";$nm_numeric[] = "baseimponible1";$nm_numeric[] = "tarifa1";$nm_numeric[] = "valor1";$nm_numeric[] = "propina";$nm_numeric[] = "importetotal";$nm_numeric[] = "formato";$nm_numeric[] = "ordvalefec";$nm_numeric[] = "ordvalcheq";$nm_numeric[] = "ordvaltarjcred";$nm_numeric[] = "ordvaltransf";$nm_numeric[] = "tcrcodigo";$nm_numeric[] = "facturado";$nm_numeric[] = "num_cita";
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_ORDEN_TRABAJO_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_ORDEN_TRABAJO_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
