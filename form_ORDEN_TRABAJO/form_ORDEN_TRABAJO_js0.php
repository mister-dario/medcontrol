<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="estab" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['estab']); ?>">
<input type="hidden" name="ptoemi" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['ptoemi']); ?>">
<input type="hidden" name="secuencial" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['secuencial']); ?>">
<input type="hidden" name="lote" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['lote']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_ORDEN_TRABAJO"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_FACTURAR_citid = "<?php echo $this->form_encode_input($this->nmgp_dados_form['num_cita']); ?>";
var var_btn_FACTURAR_v_numcita = "<?php echo $this->form_encode_input($this->nmgp_dados_form['num_cita']); ?>";
var var_btn_FACTURAR_v_estab = "<?php echo $this->form_encode_input($this->nmgp_dados_form['estab']); ?>";
var var_btn_FACTURAR_v_ptoemi = "<?php echo $this->form_encode_input($this->nmgp_dados_form['ptoemi']); ?>";
var var_btn_FACTURAR_v_secuencial = "<?php echo $this->form_encode_input($this->nmgp_dados_form['secuencial']); ?>";
var var_btn_FACTURAR_v_lote = "<?php echo $this->form_encode_input($this->nmgp_dados_form['lote']); ?>";
var var_btn_FACTURAR_v_emisor_ot = "<?php echo $this->form_encode_input($this->nmgp_dados_form['ruc']); ?>";
var var_btn_FACTURAR_v_valorefec = "<?php echo $this->form_encode_input($this->nmgp_dados_form['ordvalefec']); ?>";
var var_btn_FACTURAR_v_valorcheq = "<?php echo $this->form_encode_input($this->nmgp_dados_form['ordvalcheq']); ?>";
var var_btn_FACTURAR_v_valortarj = "<?php echo $this->form_encode_input($this->nmgp_dados_form['ordvaltarjcred']); ?>";
var var_btn_FACTURAR_v_valortrans = "<?php echo $this->form_encode_input($this->nmgp_dados_form['ordvaltransf']); ?>";
var var_btn_FACTURAR_v_numcheq = "<?php echo $this->form_encode_input($this->nmgp_dados_form['ordnumcheq']); ?>";
var var_btn_FACTURAR_v_bancheq = "<?php echo $this->form_encode_input($this->nmgp_dados_form['ordbancheq']); ?>";
var var_btn_FACTURAR_v_tiptarcre = "<?php echo $this->form_encode_input($this->nmgp_dados_form['tcrcodigo']); ?>";
var var_btn_FACTURAR_v_numtarcre = "<?php echo $this->form_encode_input($this->nmgp_dados_form['ordnumtarjcred']); ?>";
var var_btn_FACTURAR_v_bantran = "<?php echo $this->form_encode_input($this->nmgp_dados_form['ordbantransf']); ?>";
var var_btn_FACTURAR_v_numctatran = "<?php echo $this->form_encode_input($this->nmgp_dados_form['ordctatransf']); ?>";
function sc_btn_FACTURAR()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_FACTURAR(); }, 500);
      return;
    }
    sc_btn_FACTURAR_ok();
}
function sc_btn_FACTURAR_cancel()
{
}
function sc_btn_FACTURAR_ok()
{
  nm_gp_submit('<?php echo $this->Ini->link_form_cita_ordtra_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "citid*scin' + var_btn_FACTURAR_citid + '*scoutv_numcita*scin' + var_btn_FACTURAR_v_numcita + '*scoutv_estab*scin' + var_btn_FACTURAR_v_estab + '*scoutv_ptoemi*scin' + var_btn_FACTURAR_v_ptoemi + '*scoutv_secuencial*scin' + var_btn_FACTURAR_v_secuencial + '*scoutv_lote*scin' + var_btn_FACTURAR_v_lote + '*scoutv_emisor_ot*scin' + var_btn_FACTURAR_v_emisor_ot + '*scoutv_valorefec*scin' + var_btn_FACTURAR_v_valorefec + '*scoutv_valorcheq*scin' + var_btn_FACTURAR_v_valorcheq + '*scoutv_valortarj*scin' + var_btn_FACTURAR_v_valortarj + '*scoutv_valortrans*scin' + var_btn_FACTURAR_v_valortrans + '*scoutv_numcheq*scin' + var_btn_FACTURAR_v_numcheq + '*scoutv_bancheq*scin' + var_btn_FACTURAR_v_bancheq + '*scoutv_tiptarcre*scin' + var_btn_FACTURAR_v_tiptarcre + '*scoutv_numtarcre*scin' + var_btn_FACTURAR_v_numtarcre + '*scoutv_bantran*scin' + var_btn_FACTURAR_v_bantran + '*scoutv_numctatran*scin' + var_btn_FACTURAR_v_numctatran + '*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout"; ?>', '', '_self', '0', '0', 'form_cita_ordtra');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO']['where_detal']))
  {
?>  
