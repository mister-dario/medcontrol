...
<style type="text/css">
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_pdf']))
 {
 ?>
<?php
    if ((isset($this->nmgp_tipo_pdf) && $this->nmgp_tipo_pdf == "pb") || (isset($this->nmgp_cor_print) && $this->nmgp_cor_print == "PB"))
    {
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['prt_view'] && $this->Ini->Export_img_zip) 
        {
?>
 <style type="text/css">
<?php
...
<?php
include_once("form_ORDEN_TRABAJO_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_ORDEN_TRABAJO_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    $vertical_center = '';
...
if (isset($_SESSION['scriptcase']['form_ORDEN_TRABAJO']['error_buffer']) && '' != $_SESSION['scriptcase']['form_ORDEN_TRABAJO']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_ORDEN_TRABAJO']['error_buffer'];
}
...
<?php
 include_once("form_ORDEN_TRABAJO_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_ORDEN_TRABAJO_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_ORDEN_TRABAJO_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_ORDEN_TRABAJO_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
?>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bpdf", "scBtnFn_sys_format_pdf()", "scBtnFn_sys_format_pdf()", "sc_b_pdf_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-5", "", "");?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['Lookup_facturado'][] = '1'; ?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_factura'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_factura'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_factura'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_ORDEN_TRABAJO_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_ORDEN_TRABAJO_mob_empty.htm' : $this->Ini->link_form_DETALLE_ORDEN_TRABAJO_mob_edit . '?SC_where_pdf=' . $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['where_filter'] . '&script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['pdf_view'])
 {
     $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_pdf'] = true;
     $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['form_DETALLE_ORDEN_TRABAJO_mob'] = $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_form_parms'] . '?#?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '?@??#?script_case_detail=Y?@?';
     include_once ($this->Ini->root . $this->Ini->link_form_DETALLE_ORDEN_TRABAJO_mob_edit . "index.php");
     $this->form_DETALLE_ORDEN_TRABAJO_mob_pdf_det = new form_DETALLE_ORDEN_TRABAJO_mob_edit;
     if (method_exists($this->form_DETALLE_ORDEN_TRABAJO_mob_pdf_det, "inicializa"))
     {
         $this->form_DETALLE_ORDEN_TRABAJO_mob_pdf_det->inicializa();
     }
     unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['form_DETALLE_ORDEN_TRABAJO_mob_script_case_init'] ]['form_DETALLE_ORDEN_TRABAJO_mob']['embutida_pdf']);
     unset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['form_DETALLE_ORDEN_TRABAJO_mob']);
 }
 else
 {
?>
    <iframe border="0" id="nmsc_iframe_liga_form_DETALLE_ORDEN_TRABAJO_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_DETALLE_ORDEN_TRABAJO_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
 }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_ORDEN_TRABAJO_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_ORDEN_TRABAJO_mob");
 parent.scAjaxDetailHeight("form_ORDEN_TRABAJO_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ORDEN_TRABAJO_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
