...
<?php
   ...
   $Ord_Cmp = new grid_NUEVAS_FACTURAS_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_NUEVAS_FACTURAS_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['f_estab'] = "f_estab";
   }
   else
   {
       $tab_def_campos['f_estab'] = "F.ESTAB";
   }
   $tab_labels["f_estab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['labels']["f_estab"])) ? $_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['labels']["f_estab"] : "ESTAB";
   $tab_ger_campos['f_ptoemi'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['f_ptoemi'] = "f_ptoemi";
   }
   else
   {
       $tab_def_campos['f_ptoemi'] = "F.PTOEMI";
   }
   $tab_labels["f_ptoemi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['labels']["f_ptoemi"])) ? $_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['labels']["f_ptoemi"] : "PTOEMI";
   $tab_ger_campos['f_secuencial'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['f_secuencial'] = "f_secuencial";
   }
   else
   {
       $tab_def_campos['f_secuencial'] = "F.SECUENCIAL";
   }
   $tab_labels["f_secuencial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['labels']["f_secuencial"])) ? $_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['labels']["f_secuencial"] : "SECUENCIAL";
   $tab_ger_campos['f_lote'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['f_lote'] = "f_lote";
   }
   else
   {
       $tab_def_campos['f_lote'] = "F.LOTE";
   }
   $tab_labels["f_lote"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['labels']["f_lote"])) ? $_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['labels']["f_lote"] : "LOTE";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_NUEVAS_FACTURAS_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_NUEVAS_FACTURAS']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
