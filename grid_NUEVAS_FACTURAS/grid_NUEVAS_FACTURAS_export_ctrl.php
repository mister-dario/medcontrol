<?php
@session_start() ;
$_SESSION['scriptcase']['grid_NUEVAS_FACTURAS']['sc_process_barr'] = true;
require_once('../grid_NUEVAS_FACTURAS/index.php');
unset($_SESSION['scriptcase']['grid_NUEVAS_FACTURAS']['sc_process_barr']);
$ExportCtrl = new grid_NUEVAS_FACTURAS_export_control;
$ExportCtrl->Export_barr();

class grid_NUEVAS_FACTURAS_export_control
{
