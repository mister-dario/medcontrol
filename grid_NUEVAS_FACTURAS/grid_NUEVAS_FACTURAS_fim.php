...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_NUEVAS_FACTURAS"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_NUEVAS_FACTURAS"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_NUEVAS_FACTURAS']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_NUEVAS_FACTURAS']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_NUEVAS_FACTURAS']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_NUEVAS_FACTURAS']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_NUEVAS_FACTURAS']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_NUEVAS_FACTURAS</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_NUEVAS_FACTURAS']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_NUEVAS_FACTURAS']['embutida_filho'] as $ind => $sc_init)
          {
