...
class grid_NUEVAS_FACTURAS_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NUEVAS_FACTURAS']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NUEVAS_FACTURAS']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_grid_NUEVAS_FACTURAS" . $this->Xls_tp;
      ...
      require_once($this->Ini->path_aplicacao . "grid_NUEVAS_FACTURAS_total.class.php"); 
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NUEVAS_FACTURAS']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NUEVAS_FACTURAS']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NUEVAS_FACTURAS']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_NUEVAS_FACTURAS']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NUEVAS_FACTURAS']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NUEVAS_FACTURAS']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_NUEVAS_FACTURAS']['embutida'])
      { 
   ...
   function NM_export_f_estab()
   {
         ...
         if (is_numeric($this->f_estab))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->f_estab);
         $this->Xls_col++;
   }
   //----- f_ptoemi
   function NM_export_f_ptoemi()
   {
         ...
         if (is_numeric($this->f_ptoemi))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->f_ptoemi);
         $this->Xls_col++;
   }
   //----- f_secuencial
   function NM_export_f_secuencial()
   {
         ...
         if (is_numeric($this->f_secuencial))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->f_secuencial);
         $this->Xls_col++;
   }
   //----- f_lote
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_NUEVAS_FACTURAS']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_NUEVAS_FACTURAS']['nolabel'])
       {
