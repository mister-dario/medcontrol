...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_presupuesto_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['where_detal']))
  {
?>  
...
{
    window.open('<?php echo $this->Ini->path_link . "" . SC_dir_app_name('form_presupue') . "/form_presupue_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . $this->form_encode_input($this->Ini->sc_page);?>"&apl_prt=form_presupuesto_mob.php&opcao=print&cor_print=CO','','location=no,menubar,resizable,scrollbars,status=no,toolbar');
}
