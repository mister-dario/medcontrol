<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="prenumero" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['prenumero']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_presupuesto"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto']['where_detal']))
  {
?>  
...
{
    window.open('<?php echo $this->Ini->path_link . "" . SC_dir_app_name('form_presupuesto') . "/form_presupuesto_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . $this->form_encode_input($this->Ini->sc_page);?>"&apl_prt=form_presupuesto.php&opcao=print&cor_print=CO','','location=no,menubar,resizable,scrollbars,status=no,toolbar');
}
...
{
   nm_field_disabled("total=disabled;total_realizado=disabled;total_faltante=disabled", "");
