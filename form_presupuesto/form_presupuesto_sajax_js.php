  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_presupuesto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate cliente
  function do_ajax_form_presupuesto_validate_cliente()
  {
  } // do_ajax_form_presupuesto_validate_cliente

  function do_ajax_form_presupuesto_validate_cliente_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_validate_cliente_cb

  // ---------- Validate prenumero
  function do_ajax_form_presupuesto_validate_prenumero()
  {
    var nomeCampo_prenumero = "prenumero";
    var var_prenumero = scAjaxGetFieldHidden(nomeCampo_prenumero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_validate_prenumero(var_prenumero, var_script_case_init, do_ajax_form_presupuesto_validate_prenumero_cb);
  } // do_ajax_form_presupuesto_validate_prenumero

  function do_ajax_form_presupuesto_validate_prenumero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_validate_prenumero_cb

  // ---------- Validate prenombre
  function do_ajax_form_presupuesto_validate_prenombre()
  {
    var nomeCampo_prenombre = "prenombre";
    var var_prenombre = scAjaxGetFieldText(nomeCampo_prenombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_validate_prenombre(var_prenombre, var_script_case_init, do_ajax_form_presupuesto_validate_prenombre_cb);
  } // do_ajax_form_presupuesto_validate_prenombre

  function do_ajax_form_presupuesto_validate_prenombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_validate_prenombre_cb

  // ---------- Validate preestado
  function do_ajax_form_presupuesto_validate_preestado()
  {
    var nomeCampo_preestado = "preestado";
    var var_preestado = scAjaxGetFieldSelect(nomeCampo_preestado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_validate_preestado(var_preestado, var_script_case_init, do_ajax_form_presupuesto_validate_preestado_cb);
  } // do_ajax_form_presupuesto_validate_preestado

  function do_ajax_form_presupuesto_validate_preestado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_validate_preestado_cb

  // ---------- Validate medcodigo
  function do_ajax_form_presupuesto_validate_medcodigo()
  {
  } // do_ajax_form_presupuesto_validate_medcodigo

  function do_ajax_form_presupuesto_validate_medcodigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_validate_medcodigo_cb

  // ---------- Validate preobserv
  function do_ajax_form_presupuesto_validate_preobserv()
  {
    var nomeCampo_preobserv = "preobserv";
    var var_preobserv = scAjaxGetFieldText(nomeCampo_preobserv);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_validate_preobserv(var_preobserv, var_script_case_init, do_ajax_form_presupuesto_validate_preobserv_cb);
  } // do_ajax_form_presupuesto_validate_preobserv

  function do_ajax_form_presupuesto_validate_preobserv_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_validate_preobserv_cb

  // ---------- Validate fclnumero
  function do_ajax_form_presupuesto_validate_fclnumero()
  {
    var nomeCampo_fclnumero = "fclnumero";
    var var_fclnumero = scAjaxGetFieldText(nomeCampo_fclnumero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_validate_fclnumero(var_fclnumero, var_script_case_init, do_ajax_form_presupuesto_validate_fclnumero_cb);
  } // do_ajax_form_presupuesto_validate_fclnumero

  function do_ajax_form_presupuesto_validate_fclnumero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_validate_fclnumero_cb

  // ---------- Validate preusucrea
  function do_ajax_form_presupuesto_validate_preusucrea()
  {
    var nomeCampo_preusucrea = "preusucrea";
    var var_preusucrea = scAjaxGetFieldText(nomeCampo_preusucrea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_validate_preusucrea(var_preusucrea, var_script_case_init, do_ajax_form_presupuesto_validate_preusucrea_cb);
  } // do_ajax_form_presupuesto_validate_preusucrea

  function do_ajax_form_presupuesto_validate_preusucrea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_validate_preusucrea_cb

  // ---------- Validate prefeccrea
  function do_ajax_form_presupuesto_validate_prefeccrea()
  {
    var nomeCampo_prefeccrea = "prefeccrea";
    var var_prefeccrea = scAjaxGetFieldText(nomeCampo_prefeccrea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_validate_prefeccrea(var_prefeccrea, var_script_case_init, do_ajax_form_presupuesto_validate_prefeccrea_cb);
  } // do_ajax_form_presupuesto_validate_prefeccrea

  function do_ajax_form_presupuesto_validate_prefeccrea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_validate_prefeccrea_cb

  // ---------- Validate preusumodi
  function do_ajax_form_presupuesto_validate_preusumodi()
  {
    var nomeCampo_preusumodi = "preusumodi";
    var var_preusumodi = scAjaxGetFieldText(nomeCampo_preusumodi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_validate_preusumodi(var_preusumodi, var_script_case_init, do_ajax_form_presupuesto_validate_preusumodi_cb);
  } // do_ajax_form_presupuesto_validate_preusumodi

  function do_ajax_form_presupuesto_validate_preusumodi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_validate_preusumodi_cb

  // ---------- Validate prefecmodi
  function do_ajax_form_presupuesto_validate_prefecmodi()
  {
    var nomeCampo_prefecmodi = "prefecmodi";
    var var_prefecmodi = scAjaxGetFieldText(nomeCampo_prefecmodi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_validate_prefecmodi(var_prefecmodi, var_script_case_init, do_ajax_form_presupuesto_validate_prefecmodi_cb);
  } // do_ajax_form_presupuesto_validate_prefecmodi

  function do_ajax_form_presupuesto_validate_prefecmodi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_validate_prefecmodi_cb

  // ---------- Validate total
  function do_ajax_form_presupuesto_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_validate_total(var_total, var_script_case_init, do_ajax_form_presupuesto_validate_total_cb);
  } // do_ajax_form_presupuesto_validate_total

  function do_ajax_form_presupuesto_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_validate_total_cb

  // ---------- Validate total_realizado
  function do_ajax_form_presupuesto_validate_total_realizado()
  {
    var nomeCampo_total_realizado = "total_realizado";
    var var_total_realizado = scAjaxGetFieldText(nomeCampo_total_realizado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_validate_total_realizado(var_total_realizado, var_script_case_init, do_ajax_form_presupuesto_validate_total_realizado_cb);
  } // do_ajax_form_presupuesto_validate_total_realizado

  function do_ajax_form_presupuesto_validate_total_realizado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_validate_total_realizado_cb

  // ---------- Validate total_faltante
  function do_ajax_form_presupuesto_validate_total_faltante()
  {
    var nomeCampo_total_faltante = "total_faltante";
    var var_total_faltante = scAjaxGetFieldText(nomeCampo_total_faltante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_validate_total_faltante(var_total_faltante, var_script_case_init, do_ajax_form_presupuesto_validate_total_faltante_cb);
  } // do_ajax_form_presupuesto_validate_total_faltante

  function do_ajax_form_presupuesto_validate_total_faltante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_validate_total_faltante_cb

  // ---------- Validate detalle
  function do_ajax_form_presupuesto_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_presupuesto_validate_detalle_cb);
  } // do_ajax_form_presupuesto_validate_detalle

  function do_ajax_form_presupuesto_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_validate_detalle_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_presupuesto_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_presupuesto_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_presupuesto_submit_form(var_cliente, var_prenumero, var_prenombre, var_preestado, var_medcodigo, var_preobserv, var_fclnumero, var_preusucrea, var_prefeccrea, var_preusumodi, var_prefecmodi, var_total, var_total_realizado, var_total_faltante, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_presupuesto_submit_form_cb);
  } // do_ajax_form_presupuesto_submit_form

  function do_ajax_form_presupuesto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_presupuesto_submit_form_cb_after_alert);
  } // do_ajax_form_presupuesto_submit_form_cb
  function do_ajax_form_presupuesto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_presupuesto_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_detalle_presupuesto"] = "off";

  function do_ajax_form_presupuesto_navigate_form()
  {
    perform_ajax_form_presupuesto_navigate_form();
  }

  function perform_ajax_form_presupuesto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_presupuesto_navigate_form(var_prenumero, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_presupuesto_navigate_form_cb);
  } // do_ajax_form_presupuesto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_presupuesto_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_presupuesto_navigate_form_cb_after_alert);
  } // do_ajax_form_presupuesto_navigate_form_cb
  function do_ajax_form_presupuesto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_presupuesto_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_presupuesto_navigate_form_cb_after_alert
  function sc_hide_form_presupuesto_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_detalle_presupuesto"])
    {
      return true;
    }
    return false;
