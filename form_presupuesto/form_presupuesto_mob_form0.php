...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['embutida_pdf']))
 {
 ?>
<?php
    if ((isset($this->nmgp_tipo_pdf) && $this->nmgp_tipo_pdf == "pb") || (isset($this->nmgp_cor_print) && $this->nmgp_cor_print == "PB"))
    {
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['prt_view'] && $this->Ini->Export_img_zip) 
        {
?>
 <style type="text/css">
<?php
...
<?php
include_once("form_presupuesto_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_presupuesto_mob_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-medcodigo", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_presupuesto_mob_event_medcodigo_onchange) { do_ajax_form_presupuesto_mob_event_medcodigo_onchange(sRow); }
    }
   }
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['recarga'];
}
...
if (isset($_SESSION['scriptcase']['form_presupuesto']['error_buffer']) && '' != $_SESSION['scriptcase']['form_presupuesto']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_presupuesto']['error_buffer'];
}
...
<?php
 include_once("form_presupuesto_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_presupuesto_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_presupuesto_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_presupuesto_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
?>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bnovo", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Enter)", "sc-unique-btn-16", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bincluir", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_ins_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Enter)", "sc-unique-btn-17", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bcancelar", "scBtnFn_sys_format_cnl()", "scBtnFn_sys_format_cnl()", "sc_b_sai_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Escape)", "sc-unique-btn-18", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "balterar", "scBtnFn_sys_format_alt()", "scBtnFn_sys_format_alt()", "sc_b_upd_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + S)", "sc-unique-btn-19", "", "");?>
...
<?php echo nmButtonOutput($this->arr_buttons, "bpdf", "scBtnFn_sys_format_pdf()", "scBtnFn_sys_format_pdf()", "sc_b_pdf_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-20", "", "group_1");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bprint", "scBtnFn_sys_format_imp()", "scBtnFn_sys_format_imp()", "sc_b_prt_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-21", "", "group_1");?>
  </div>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['Lookup_preestado'][] = ''; ?>
 <option value="">------------------------</option>
 <option  value="P" <?php  if ($this->preestado == "P") { echo " selected" ;} ?>>PRELIMINAR</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['Lookup_preestado'][] = 'P'; ?>
 <option  value="E" <?php  if ($this->preestado == "E") { echo " selected" ;} ?>>EJECUCIÓN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['Lookup_preestado'][] = 'E'; ?>
 <option  value="T" <?php  if ($this->preestado == "T") { echo " selected" ;} ?>>TERMINADO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['Lookup_preestado'][] = 'T'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_total_realizado_line" id="hidden_field_data_total_realizado" style="<?php echo $sStyleHidden_total_realizado; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_total_realizado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_total_realizado_label" style=""><span id="id_label_total_realizado"><?php echo $this->nm_new_label['total_realizado']; ?></span></span><br>
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_total_realizado_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_total_realizado_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_total_faltante_line" id="hidden_field_data_total_faltante" style="<?php echo $sStyleHidden_total_faltante; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_total_faltante_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_total_faltante_label" style=""><span id="id_label_total_faltante"><?php echo $this->nm_new_label['total_faltante']; ?></span></span><br>
...
<span id="id_read_on_total_faltante" class="sc-ui-readonly-total_faltante css_total_faltante_line" style="<?php echo $sStyleReadLab_total_faltante; ?>"><?php echo $this->form_format_readonly("total_faltante", $this->form_encode_input($this->total_faltante)); ?></span><span id="id_read_off_total_faltante" class="css_read_off_total_faltante" style="white-space: nowrap;<?php echo $sStyleReadInp_total_faltante; ?>">
 ...
 size=10 maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_total_faltante_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_total_faltante_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php $sStyleHidden_total_faltante_dumb = ('' == $sStyleHidden_total_faltante) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_total_faltante_dumb" style="<?php echo $sStyleHidden_total_faltante_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_liga_qtd_reg'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_presupuesto_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_presupuesto_mob_empty.htm' : $this->Ini->link_form_detalle_presupuesto_mob_edit . '?SC_where_pdf=' . $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['where_filter'] . '&script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['pdf_view'])
 {
     $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_pdf'] = true;
     $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['form_detalle_presupuesto_mob'] = $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_form_parms'] . '?#?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '?@??#?script_case_detail=Y?@?';
     include_once ($this->Ini->root . $this->Ini->link_form_detalle_presupuesto_mob_edit . "index.php");
     $this->form_detalle_presupuesto_mob_pdf_det = new form_detalle_presupuesto_mob_edit;
     if (method_exists($this->form_detalle_presupuesto_mob_pdf_det, "inicializa"))
     {
         $this->form_detalle_presupuesto_mob_pdf_det->inicializa();
     }
     unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_pdf']);
     unset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['form_detalle_presupuesto_mob']);
 }
 else
 {
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_presupuesto_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_presupuesto_mob");
 parent.scAjaxDetailHeight("form_presupuesto_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	...
	function scBtnFn_sys_format_pdf() {
		...
		if ($("#sc_b_pdf_t.sc-unique-btn-20").length && $("#sc_b_pdf_t.sc-unique-btn-20").is(":visible")) {
			tb_show('', "<?php echo  $this->Ini->path_link . SC_dir_app_name('form_presupue')  ?>/form_presupue_config_pdf.php?nm_opc=pdf&nm_target=2&nm_cor=cor&papel=8&lpapel=0&apapel=0&orientacao=1&bookmarks=XX&largura=800&conf_larg=10&conf_fonte=N&grafico=XX&language=es&conf_socor=N&password=n&pdf_zip=N&sc_ver_93=n&KeepThis=true&TB_iframe=true&modal=true");
			 return;
		}
	}
	function scBtnFn_sys_format_imp() {
		...
		if ($("#sc_b_prt_t.sc-unique-btn-21").length && $("#sc_b_prt_t.sc-unique-btn-21").is(":visible")) {
			nm_gp_form_print()
			 return;
		}
	}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
