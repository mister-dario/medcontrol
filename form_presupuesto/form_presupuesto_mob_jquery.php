...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_prefeccrea_hora' + iSeqRow).bind('blur', function() { sc_form_presupuesto_prefeccrea_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_presupuesto_prefeccrea_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_prefecmodi_hora' + iSeqRow).bind('blur', function() { sc_form_presupuesto_prefecmodi_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_presupuesto_prefecmodi_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_presupuesto_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_prefeccrea" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_presupuesto_mob_validate_prefeccrea(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_prefecmodi" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_presupuesto_mob_validate_prefecmodi(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_presupuesto_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
