<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ficha_cliente_capture']['sc_process_barr'] = true;
require_once('../grid_ficha_cliente_capture/index.php');
unset($_SESSION['scriptcase']['grid_ficha_cliente_capture']['sc_process_barr']);
$ExportCtrl = new grid_ficha_cliente_capture_export_control;
$ExportCtrl->Export_barr();

class grid_ficha_cliente_capture_export_control
{
