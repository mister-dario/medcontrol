...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_ficha_cliente_capture"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_ficha_cliente_capture"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ficha_cliente_capture']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ficha_cliente_capture']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ficha_cliente_capture']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ficha_cliente_capture']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ficha_cliente_capture']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_ficha_cliente_capture</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ficha_cliente_capture']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ficha_cliente_capture']['embutida_filho'] as $ind => $sc_init)
          {
