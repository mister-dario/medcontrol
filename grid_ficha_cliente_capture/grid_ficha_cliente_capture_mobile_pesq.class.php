...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_fclnumero_cond" name="fclnumero_cond" onChange="nm_campos_between(document.getElementById('id_vis_fclnumero'), this, 'fclnumero')">
       <OPTION value="eq" <?php if ("eq" == $fclnumero_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_fclnumero"  <?php echo $str_hide_fclnumero?>><INPUT  type="text" id="SC_fclnumero" name="fclnumero" value="<?php echo NM_encode_input($fclnumero) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '', allowNegative: false, onlyNegative: false, enterSubmit: true}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectEven" alt="{autoTab: false, enterSubmit: true}" id="SC_fclnombres_cond" name="fclnombres_cond" onChange="nm_campos_between(document.getElementById('id_vis_fclnombres'), this, 'fclnombres')">
      ...
      <br><span id="id_hide_fclnombres"  <?php echo $str_hide_fclnombres?>><INPUT  type="text" id="SC_fclnombres" name="fclnombres" value="<?php echo NM_encode_input($fclnombres) ?>"  size=25 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterSubmit: true}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_fclapellidos_cond" name="fclapellidos_cond" onChange="nm_campos_between(document.getElementById('id_vis_fclapellidos'), this, 'fclapellidos')">
      ...
      <br><span id="id_hide_fclapellidos"  <?php echo $str_hide_fclapellidos?>><INPUT  type="text" id="SC_fclapellidos" name="fclapellidos" value="<?php echo NM_encode_input($fclapellidos) ?>"  size=25 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterSubmit: true}" class="sc-js-input scFilterObjectOdd">
 </TD>
