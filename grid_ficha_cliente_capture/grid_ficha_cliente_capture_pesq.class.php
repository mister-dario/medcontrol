...
class grid_ficha_cliente_capture_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$campo_join]);
              return;
          }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "fclfechareg";$Nm_datas[] = "fclfechareg";$Nm_datas[] = "fclfechanac";$Nm_datas[] = "fclfechanac";$Nm_datas[] = "fclfeccrea";$Nm_datas[] = "fclfeccrea";$Nm_datas[] = "fclfecmodi";$Nm_datas[] = "fclfecmodi";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> ficha_cliente</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_ficha_cliente_capture/grid_ficha_cliente_capture_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_ficha_cliente_capture_ajax_search.js"></script>
 <script type="text/javascript" src="grid_ficha_cliente_capture_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_ficha_cliente_capture_message.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo "BÚSQUEDA DE PACIENTE" ?></div>
...
<?php
   ...
   {
      global 
             $fclnumero_cond, $fclnumero,
             $fclnombres_cond, $fclnombres,
             $fclapellidos_cond, $fclapellidos,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $fclnumero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']['fclnumero']; 
          $fclnumero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']['fclnumero_cond']; 
          $fclnombres = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']['fclnombres']; 
          $fclnombres_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']['fclnombres_cond']; 
          $fclapellidos = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']['fclapellidos']; 
          $fclapellidos_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']['fclapellidos_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']['NM_operador']; 
          if (strtoupper($fclnumero_cond) != "II" && strtoupper($fclnumero_cond) != "QP" && strtoupper($fclnumero_cond) != "NP" && strtoupper($fclnumero_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($fclnumero, "", ",", "0", "S", "1", "", "N:2", "-") ; 
          } 
      } 
      ...
      if (!isset($fclnumero_cond) || empty($fclnumero_cond))
      {
         $fclnumero_cond = "eq";
      }
      if (!isset($fclnombres_cond) || empty($fclnombres_cond))
      {
         $fclnombres_cond = "qp";
      }
      if (!isset($fclapellidos_cond) || empty($fclapellidos_cond))
      {
         $fclapellidos_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_fclnumero = (in_array($fclnumero_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_fclnombres = (in_array($fclnombres_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_fclapellidos = (in_array($fclapellidos_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($fclnumero) || $fclnumero == "")
      {
          $fclnumero = "";
      }
      if (isset($fclnumero) && !empty($fclnumero))
      {
         $tmp_pos = strpos($fclnumero, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $fclnumero = substr($fclnumero, 0, $tmp_pos);
         }
      }
      if (!isset($fclnombres) || $fclnombres == "")
      {
          $fclnombres = "";
      }
      if (isset($fclnombres) && !empty($fclnombres))
      {
         $tmp_pos = strpos($fclnombres, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $fclnombres = substr($fclnombres, 0, $tmp_pos);
         }
      }
      if (!isset($fclapellidos) || $fclapellidos == "")
      {
          $fclapellidos = "";
      }
      if (isset($fclapellidos) && !empty($fclapellidos))
      {
         $tmp_pos = strpos($fclapellidos, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $fclapellidos = substr($fclapellidos, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_fclnumero_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fclnumero'])) ? $this->New_label['fclnumero'] : "No. FICHA"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="sc-js-input scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_fclnumero_cond" name="fclnumero_cond" onChange="nm_campos_between(document.getElementById('id_vis_fclnumero'), this, 'fclnumero')">
       <OPTION value="eq" <?php if ("eq" == $fclnumero_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fclnumero" <?php echo $str_hide_fclnumero?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fclnumero'])) ? $this->New_label['fclnumero'] : "No. FICHA";
 $nmgp_tab_label .= "fclnumero?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_fclnumero" name="fclnumero" value="<?php echo NM_encode_input($fclnumero) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '', allowNegative: false, onlyNegative: false, enterSubmit: true}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_fclnombres_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fclnombres'])) ? $this->New_label['fclnombres'] : "NOMBRES"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="sc-js-input scFilterObjectEven" alt="{autoTab: false, enterSubmit: true}" id="SC_fclnombres_cond" name="fclnombres_cond" onChange="nm_campos_between(document.getElementById('id_vis_fclnombres'), this, 'fclnombres')">
       <OPTION value="qp" <?php if ("qp" == $fclnombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $fclnombres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fclnombres" <?php echo $str_hide_fclnombres?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['fclnombres'])) ? $this->New_label['fclnombres'] : "NOMBRES";
 $nmgp_tab_label .= "fclnombres?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_fclnombres" name="fclnombres" value="<?php echo NM_encode_input($fclnombres) ?>"  size=25 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterSubmit: true}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_fclapellidos_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fclapellidos'])) ? $this->New_label['fclapellidos'] : "APELLIDOS"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="sc-js-input scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_fclapellidos_cond" name="fclapellidos_cond" onChange="nm_campos_between(document.getElementById('id_vis_fclapellidos'), this, 'fclapellidos')">
       <OPTION value="qp" <?php if ("qp" == $fclapellidos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $fclapellidos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fclapellidos" <?php echo $str_hide_fclapellidos?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fclapellidos'])) ? $this->New_label['fclapellidos'] : "APELLIDOS";
 $nmgp_tab_label .= "fclapellidos?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_fclapellidos" name="fclapellidos" value="<?php echo NM_encode_input($fclapellidos) ?>"  size=25 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterSubmit: true}" class="sc-js-input scFilterObjectOdd">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_ficha_cliente_capture_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 ...
 {
   document.F1.reset();
   document.F1.fclnumero_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_fclnumero'), document.F1.fclnumero_cond, 'fclnumero');
   document.F1.fclnumero.value = "";
   document.F1.fclnombres_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_fclnombres'), document.F1.fclnombres_cond, 'fclnombres');
   document.F1.fclnombres.value = "";
   document.F1.fclapellidos_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_fclapellidos'), document.F1.fclapellidos_cond, 'fclapellidos');
   document.F1.fclapellidos.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   {
      global $fclnumero_cond, $fclnumero,
             $fclnombres_cond, $fclnombres,
             $fclapellidos_cond, $fclapellidos, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq'] = array();
      $fclnumero_cond_salva = $fclnumero_cond; 
      if (!isset($fclnumero_input_2) || $fclnumero_input_2 == "")
      {
          $fclnumero_input_2 = $fclnumero;
      }
      $fclnombres_cond_salva = $fclnombres_cond; 
      if (!isset($fclnombres_input_2) || $fclnombres_input_2 == "")
      {
          $fclnombres_input_2 = $fclnombres;
      }
      $fclapellidos_cond_salva = $fclapellidos_cond; 
      if (!isset($fclapellidos_input_2) || $fclapellidos_input_2 == "")
      {
          $fclapellidos_input_2 = $fclapellidos;
      }
      if ($fclnumero_cond != "in")
      {
          nm_limpa_numero($fclnumero, "") ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']['fclnumero'] = $fclnumero; 
      if (is_array($fclnumero) && !empty($fclnumero))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['Grid_search'][$I_Grid]['val'][0] = $fclnumero;
      }
      elseif ($fclnumero_cond_salva == "nu" || $fclnumero_cond_salva == "nn" || $fclnumero_cond_salva == "ep" || $fclnumero_cond_salva == "ne" || !empty($fclnumero))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['Grid_search'][$I_Grid]['val'][0][0] = $fclnumero;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']['fclnumero_cond'] = $fclnumero_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['Grid_search'][$I_Grid]['cmp'] = "fclnumero"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['Grid_search'][$I_Grid]['opc'] = $fclnumero_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq']['fclnumero'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']['fclnombres'] = $fclnombres; 
      if (is_array($fclnombres) && !empty($fclnombres))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['Grid_search'][$I_Grid]['val'][0] = $fclnombres;
      }
      elseif ($fclnombres_cond_salva == "nu" || $fclnombres_cond_salva == "nn" || $fclnombres_cond_salva == "ep" || $fclnombres_cond_salva == "ne" || !empty($fclnombres))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['Grid_search'][$I_Grid]['val'][0][0] = $fclnombres;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']['fclnombres_cond'] = $fclnombres_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['Grid_search'][$I_Grid]['cmp'] = "fclnombres"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['Grid_search'][$I_Grid]['opc'] = $fclnombres_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq']['fclnombres'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']['fclapellidos'] = $fclapellidos; 
      if (is_array($fclapellidos) && !empty($fclapellidos))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['Grid_search'][$I_Grid]['val'][0] = $fclapellidos;
      }
      elseif ($fclapellidos_cond_salva == "nu" || $fclapellidos_cond_salva == "nn" || $fclapellidos_cond_salva == "ep" || $fclapellidos_cond_salva == "ne" || !empty($fclapellidos))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['Grid_search'][$I_Grid]['val'][0][0] = $fclapellidos;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']['fclapellidos_cond'] = $fclapellidos_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['Grid_search'][$I_Grid]['cmp'] = "fclapellidos"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['Grid_search'][$I_Grid]['opc'] = $fclapellidos_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['grid_pesq']['fclapellidos'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['fclnumero'] = $Conteudo;
      $Conteudo = $fclnombres;
      $this->cmp_formatado['fclnombres'] = $Conteudo;
      $Conteudo = $fclapellidos;
      $this->cmp_formatado['fclapellidos'] = $Conteudo;

      //----- $fclnumero
      $this->Date_part = false;
      if (isset($fclnumero) || $fclnumero_cond == "nu" || $fclnumero_cond == "nn" || $fclnumero_cond == "ep" || $fclnumero_cond == "ne")
      {
         $this->monta_condicao("fclnumero", $fclnumero_cond, $fclnumero, "", "fclnumero");
      }

      //----- $fclnombres
      $this->Date_part = false;
      if (isset($fclnombres) || $fclnombres_cond == "nu" || $fclnombres_cond == "nn" || $fclnombres_cond == "ep" || $fclnombres_cond == "ne")
      {
         $this->monta_condicao("fclnombres", $fclnombres_cond, $fclnombres, "", "fclnombres");
      }

      //----- $fclapellidos
      $this->Date_part = false;
      if (isset($fclapellidos) || $fclapellidos_cond == "nu" || $fclapellidos_cond == "nn" || $fclapellidos_cond == "ep" || $fclapellidos_cond == "ne")
      {
         $this->monta_condicao("fclapellidos", $fclapellidos_cond, $fclapellidos, "", "fclapellidos");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['where_pesq'] = $this->comando;
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_dyn_search'] = "";
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ficha_cliente_capture']['cond_pesq'] .= $this->NM_operador;
