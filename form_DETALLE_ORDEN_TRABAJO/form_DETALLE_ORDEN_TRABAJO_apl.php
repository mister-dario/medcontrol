<?php
//
class form_DETALLE_ORDEN_TRABAJO_apl
{
   ...
   var $form_vert_form_DETALLE_ORDEN_TRABAJO = array();
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_DETALLE_ORDEN_TRABAJO']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_DETALLE_ORDEN_TRABAJO']['embutida_parms'];
      ...
      { 
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 if ($cadapar[0] == "ESTAB_")
                 {
                     ...
                     $this->NM_where_filter .= " = '" . $this->ESTAB_ . "'";
                 ...
                 if ($cadapar[0] == "PTOEMI_")
                 {
                     $this->NM_where_filter .= (empty($this->NM_where_filter)) ? "(" : " and ";
                     $this->NM_where_filter .= " = '" . $this->PTOEMI_ . "'";
                     $this->has_where_params = true;
                     $tem_where_parms        = true;
                 }
                 elseif ($cadapar[0] == "NM_where_filter")
                 ...
                 if ($cadapar[0] == "SECUENCIAL_")
                 {
                     $this->NM_where_filter .= (empty($this->NM_where_filter)) ? "(" : " and ";
                     $this->NM_where_filter .= " = '" . $this->SECUENCIAL_ . "'";
                     $this->has_where_params = true;
                     $tem_where_parms        = true;
                 }
                 elseif ($cadapar[0] == "NM_where_filter")
                 ...
                 {
                     $this->NM_where_filter .= (empty($this->NM_where_filter)) ? "(" : " and ";
                     $this->NM_where_filter .= " = '" . $this->LOTE_ . "'";
                     $this->has_where_params = true;
                     $tem_where_parms        = true;
                 }
                 elseif ($cadapar[0] == "NM_where_filter")
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_DETALLE_ORDEN_TRABAJO']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_DETALLE_ORDEN_TRABAJO']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_DETALLE_ORDEN_TRABAJO']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_DETALLE_ORDEN_TRABAJO']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_DETALLE_ORDEN_TRABAJO']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_DETALLE_ORDEN_TRABAJO']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_DETALLE_ORDEN_TRABAJO']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_DETALLE_ORDEN_TRABAJO']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_DETALLE_ORDEN_TRABAJO']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_DETALLE_ORDEN_TRABAJO']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_DETALLE_ORDEN_TRABAJO']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_DETALLE_ORDEN_TRABAJO']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_DETALLE_ORDEN_TRABAJO']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_DETALLE_ORDEN_TRABAJO_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_DETALLE_ORDEN_TRABAJO']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_DETALLE_ORDEN_TRABAJO']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_DETALLE_ORDEN_TRABAJO'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_DETALLE_ORDEN_TRABAJO']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_DETALLE_ORDEN_TRABAJO']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_DETALLE_ORDEN_TRABAJO') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_DETALLE_ORDEN_TRABAJO']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - DETALLE_FACTURA";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_DETALLE_ORDEN_TRABAJO")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_DETALLE_ORDEN_TRABAJO']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_DETALLE_ORDEN_TRABAJO'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_DETALLE_ORDEN_TRABAJO']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_DETALLE_ORDEN_TRABAJO'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_DETALLE_ORDEN_TRABAJO'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['exit'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_DETALLE_ORDEN_TRABAJO_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_DETALLE_ORDEN_TRABAJO_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_DETALLE_ORDEN_TRABAJO/form_DETALLE_ORDEN_TRABAJO_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_DETALLE_ORDEN_TRABAJO_erro.class.php"); 
      }
      $this->Erro      = new form_DETALLE_ORDEN_TRABAJO_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['opcao']))
         { 
             if ($this->estab_ != "" || $this->ptoemi_ != "" || $this->secuencial_ != "" || $this->lote_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['final'];
      }
      else
      {
      }
...
//
   ...
   function controle()
   {
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_form'][$sc_seq_vert];
             $this->ruc_ = $this->nmgp_dados_form['ruc_']; 
             $this->coddoc_ = $this->nmgp_dados_form['coddoc_']; 
             $this->preciototalsinimpuesto_ = $this->nmgp_dados_form['preciototalsinimpuesto_']; 
             $this->nombredetalleadicional1_ = $this->nmgp_dados_form['nombredetalleadicional1_']; 
             $this->valoradicional1_ = $this->nmgp_dados_form['valoradicional1_']; 
             $this->nombredetalleadicional2_ = $this->nmgp_dados_form['nombredetalleadicional2_']; 
             $this->valoradicional2_ = $this->nmgp_dados_form['valoradicional2_']; 
             $this->nombredetalleadicional3_ = $this->nmgp_dados_form['nombredetalleadicional3_']; 
             $this->valoradicional3_ = $this->nmgp_dados_form['valoradicional3_']; 
             $this->nombredetalleadicional4_ = $this->nmgp_dados_form['nombredetalleadicional4_']; 
             $this->valoradicional4_ = $this->nmgp_dados_form['valoradicional4_']; 
             $this->nombredetalleadicional5_ = $this->nmgp_dados_form['nombredetalleadicional5_']; 
             $this->valoradicional5_ = $this->nmgp_dados_form['valoradicional5_']; 
             $this->nombredetalleadicional6_ = $this->nmgp_dados_form['nombredetalleadicional6_']; 
             $this->valoradicional6_ = $this->nmgp_dados_form['valoradicional6_']; 
             $this->nombredetalleadicional7_ = $this->nmgp_dados_form['nombredetalleadicional7_']; 
             $this->valoradicional7_ = $this->nmgp_dados_form['valoradicional7_']; 
             $this->nombredetalleadicional8_ = $this->nmgp_dados_form['nombredetalleadicional8_']; 
             $this->valoradicional8_ = $this->nmgp_dados_form['valoradicional8_']; 
             $this->nombredetalleadicional9_ = $this->nmgp_dados_form['nombredetalleadicional9_']; 
             $this->valoradicional9_ = $this->nmgp_dados_form['valoradicional9_']; 
             $this->nombredetalleadicional10_ = $this->nmgp_dados_form['nombredetalleadicional10_']; 
             $this->valoradicional10_ = $this->nmgp_dados_form['valoradicional10_']; 
             $this->nombredetalleadicional11_ = $this->nmgp_dados_form['nombredetalleadicional11_']; 
             $this->valoradicional11_ = $this->nmgp_dados_form['valoradicional11_']; 
             $this->nombredetalleadicional12_ = $this->nmgp_dados_form['nombredetalleadicional12_']; 
             $this->valoradicional12_ = $this->nmgp_dados_form['valoradicional12_']; 
             $this->nombredetalleadicional13_ = $this->nmgp_dados_form['nombredetalleadicional13_']; 
             $this->valoradicional13_ = $this->nmgp_dados_form['valoradicional13_']; 
             $this->nombredetalleadicional14_ = $this->nmgp_dados_form['nombredetalleadicional14_']; 
             $this->valoradicional14_ = $this->nmgp_dados_form['valoradicional14_']; 
             $this->nombredetalleadicional15_ = $this->nmgp_dados_form['nombredetalleadicional15_']; 
             $this->valoradicional15_ = $this->nmgp_dados_form['valoradicional15_']; 
             $this->codigoimpuesto_ = $this->nmgp_dados_form['codigoimpuesto_']; 
             $this->codigoporcentajeimp_ = $this->nmgp_dados_form['codigoporcentajeimp_']; 
             $this->tarifa_ = $this->nmgp_dados_form['tarifa_']; 
             $this->baseimponible_ = $this->nmgp_dados_form['baseimponible_']; 
             $this->valor_ = $this->nmgp_dados_form['valor_']; 
             $this->codimpice_ = $this->nmgp_dados_form['codimpice_']; 
             $this->codporcenice_ = $this->nmgp_dados_form['codporcenice_']; 
             $this->baseice_ = $this->nmgp_dados_form['baseice_']; 
             $this->porcenice_ = $this->nmgp_dados_form['porcenice_']; 
             $this->valorice_ = $this->nmgp_dados_form['valorice_']; 
         }
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_DETALLE_ORDEN_TRABAJO']) || !is_array($this->NM_ajax_info['errList']['geral_form_DETALLE_ORDEN_TRABAJO']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_DETALLE_ORDEN_TRABAJO'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_DETALLE_ORDEN_TRABAJO'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_DETALLE_ORDEN_TRABAJO'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_DETALLE_ORDEN_TRABAJO'][] = $this->Campos_Mens_erro;
                  }
              }
         }
         else
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['sc_redir_atualiz'] == "ok")
          {
      ...
      { 
         ...
         $this->secuencial_ = $GLOBALS["secuencial_" . $sc_seq_vert]; 
         ...
         if (isset($this->preciounitario_)) { $this->nm_limpa_alfa($this->preciounitario_); }
         if (isset($this->descuento_)) { $this->nm_limpa_alfa($this->descuento_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_select'][$sc_seq_vert];
         }
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['codigo_'] =  $this->codigo_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['descripcion_'] =  $this->descripcion_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['cantidad_'] =  $this->cantidad_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['preciounitario_'] =  $this->preciounitario_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['descuento_'] =  $this->descuento_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['ruc_'] =  $this->ruc_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['coddoc_'] =  $this->coddoc_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['estab_'] =  $this->estab_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['ptoemi_'] =  $this->ptoemi_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['secuencial_'] =  $this->secuencial_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['lote_'] =  $this->lote_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['preciototalsinimpuesto_'] =  $this->preciototalsinimpuesto_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['nombredetalleadicional1_'] =  $this->nombredetalleadicional1_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valoradicional1_'] =  $this->valoradicional1_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['nombredetalleadicional2_'] =  $this->nombredetalleadicional2_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valoradicional2_'] =  $this->valoradicional2_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['nombredetalleadicional3_'] =  $this->nombredetalleadicional3_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valoradicional3_'] =  $this->valoradicional3_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['nombredetalleadicional4_'] =  $this->nombredetalleadicional4_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valoradicional4_'] =  $this->valoradicional4_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['nombredetalleadicional5_'] =  $this->nombredetalleadicional5_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valoradicional5_'] =  $this->valoradicional5_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['nombredetalleadicional6_'] =  $this->nombredetalleadicional6_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valoradicional6_'] =  $this->valoradicional6_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['nombredetalleadicional7_'] =  $this->nombredetalleadicional7_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valoradicional7_'] =  $this->valoradicional7_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['nombredetalleadicional8_'] =  $this->nombredetalleadicional8_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valoradicional8_'] =  $this->valoradicional8_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['nombredetalleadicional9_'] =  $this->nombredetalleadicional9_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valoradicional9_'] =  $this->valoradicional9_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['nombredetalleadicional10_'] =  $this->nombredetalleadicional10_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valoradicional10_'] =  $this->valoradicional10_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['nombredetalleadicional11_'] =  $this->nombredetalleadicional11_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valoradicional11_'] =  $this->valoradicional11_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['nombredetalleadicional12_'] =  $this->nombredetalleadicional12_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valoradicional12_'] =  $this->valoradicional12_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['nombredetalleadicional13_'] =  $this->nombredetalleadicional13_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valoradicional13_'] =  $this->valoradicional13_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['nombredetalleadicional14_'] =  $this->nombredetalleadicional14_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valoradicional14_'] =  $this->valoradicional14_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['nombredetalleadicional15_'] =  $this->nombredetalleadicional15_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valoradicional15_'] =  $this->valoradicional15_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['codigoimpuesto_'] =  $this->codigoimpuesto_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['codigoporcentajeimp_'] =  $this->codigoporcentajeimp_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['tarifa_'] =  $this->tarifa_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['baseimponible_'] =  $this->baseimponible_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valor_'] =  $this->valor_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['codimpice_'] =  $this->codimpice_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['codporcenice_'] =  $this->codporcenice_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['baseice_'] =  $this->baseice_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['porcenice_'] =  $this->porcenice_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['valorice_'] =  $this->valorice_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_DETALLE_ORDEN_TRABAJO);
          $this->NM_ajax_info['fldList']['estab_']['keyVal'] = sc_htmlentities($this->nmgp_dados_form['estab_']);
          $this->NM_ajax_info['fldList']['ptoemi_']['keyVal'] = sc_htmlentities($this->nmgp_dados_form['ptoemi_']);
          $this->NM_ajax_info['fldList']['secuencial_']['keyVal'] = sc_htmlentities($this->nmgp_dados_form['secuencial_']);
          $this->NM_ajax_info['fldList']['lote_']['keyVal'] = sc_htmlentities($this->nmgp_dados_form['lote_']);
          $this->NM_close_db();
          form_DETALLE_ORDEN_TRABAJO_pack_ajax_response();
          exit;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_DETALLE_ORDEN_TRABAJO.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_DETALLE_ORDEN_TRABAJO_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_DETALLE_ORDEN_TRABAJO"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_DETALLE_ORDEN_TRABAJO'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_codigo_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['codigo_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['codigo_'] == "on")) 
      { 
          if ($this->codigo_ == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_descripcion_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['descripcion_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['descripcion_'] == "on")) 
      { 
    ...
    function ValidateField_cantidad_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->cantidad_, 11, 1, 0, 0, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['cantidad_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['cantidad_'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_preciounitario_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->preciounitario_, 10, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['preciounitario_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['preciounitario_'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_descuento_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->descuento_, 10, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['descuento_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['descuento_'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_estab_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->estab_, 3, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "ESTAB; " ; 
                  if (!isset($Campos_Erros['estab_']))
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['estab_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['estab_'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "ESTAB" ; 
              if (!isset($Campos_Erros['estab_']))
    ...
    function ValidateField_ptoemi_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->ptoemi_, 3, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "PTOEMI; " ; 
                  if (!isset($Campos_Erros['ptoemi_']))
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['ptoemi_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['ptoemi_'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "PTOEMI" ; 
              if (!isset($Campos_Erros['ptoemi_']))
    ...
    function ValidateField_secuencial_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->secuencial_, 9, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['secuencial_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['secuencial_'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_lote_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (($this->nmgp_opcao == "incluir" || 'validate_lote_' == $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['lote_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['php_cmp_required']['lote_'] == "on"))
      { 
          if ($this->lote_ == "")  
          { 
              $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['estab_']['keyVal'] = form_DETALLE_ORDEN_TRABAJO_pack_protect_string($this->nmgp_dados_form['estab_']);
              $this->NM_ajax_info['fldList']['ptoemi_']['keyVal'] = form_DETALLE_ORDEN_TRABAJO_pack_protect_string($this->nmgp_dados_form['ptoemi_']);
              $this->NM_ajax_info['fldList']['secuencial_']['keyVal'] = form_DETALLE_ORDEN_TRABAJO_pack_protect_string($this->nmgp_dados_form['secuencial_']);
              $this->NM_ajax_info['fldList']['lote_']['keyVal'] = form_DETALLE_ORDEN_TRABAJO_pack_protect_string($this->nmgp_dados_form['lote_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$this->nmgp_refresh_row]['codigo_'] = $this->codigo_;
                  }
                  if (isset($this->NM_ajax_changed['descripcion_']) && $this->NM_ajax_changed['descripcion_'])
                  {
                      $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$this->nmgp_refresh_row]['descripcion_'] = $this->descripcion_;
                  }
                  if (isset($this->NM_ajax_changed['cantidad_']) && $this->NM_ajax_changed['cantidad_'])
                  {
                      $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$this->nmgp_refresh_row]['cantidad_'] = $this->cantidad_;
                  }
                  if (isset($this->NM_ajax_changed['preciounitario_']) && $this->NM_ajax_changed['preciounitario_'])
                  {
                      $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$this->nmgp_refresh_row]['preciounitario_'] = $this->preciounitario_;
                  }
                  if (isset($this->NM_ajax_changed['descuento_']) && $this->NM_ajax_changed['descuento_'])
                  {
                      $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$this->nmgp_refresh_row]['descuento_'] = $this->descuento_;
                  }
                  if (isset($this->NM_ajax_changed['estab_']) && $this->NM_ajax_changed['estab_'])
                  {
                      $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$this->nmgp_refresh_row]['estab_'] = $this->estab_;
                  }
                  if (isset($this->NM_ajax_changed['ptoemi_']) && $this->NM_ajax_changed['ptoemi_'])
                  {
                      $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$this->nmgp_refresh_row]['ptoemi_'] = $this->ptoemi_;
                  }
                  if (isset($this->NM_ajax_changed['secuencial_']) && $this->NM_ajax_changed['secuencial_'])
                  {
                      $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$this->nmgp_refresh_row]['secuencial_'] = $this->secuencial_;
                  }
                  if (isset($this->NM_ajax_changed['lote_']) && $this->NM_ajax_changed['lote_'])
                  {
                      $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$this->nmgp_refresh_row]['lote_'] = $this->lote_;
                  }
              }
          }
          ...
          foreach($this->form_vert_form_DETALLE_ORDEN_TRABAJO as $sc_seq_vert => $aRecData)
          {
          ...
          $aLookupOrig = $aLookup;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("secuencial_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['secuencial_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['secuencial_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'label',
                       'valList' => array($sTmpValue),
                       );
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  function nm_proc_onload_record($sc_seq_vert=0)
  {
          ...
          $_SESSION['scriptcase']['form_DETALLE_ORDEN_TRABAJO']['contr_erro'] = 'on';
 if ($this->nombredetalleadicional1_  != "")
{
	$this->nmgp_cmp_hidden["nombredetalleadicional1_"] = "on"; $this->NM_ajax_info['fieldDisplay']['nombredetalleadicional1_'] = 'on';
	$this->nmgp_cmp_hidden["valoradicional1_"] = "on"; $this->NM_ajax_info['fieldDisplay']['valoradicional1_'] = 'on';
}

if ($this->nombredetalleadicional2_  != "")
{
	$this->nmgp_cmp_hidden["nombredetalleadicional2_"] = "on"; $this->NM_ajax_info['fieldDisplay']['nombredetalleadicional2_'] = 'on';
	$this->nmgp_cmp_hidden["valoradicional2_"] = "on"; $this->NM_ajax_info['fieldDisplay']['valoradicional2_'] = 'on';
}

if ($this->nombredetalleadicional3_  != "")
{
	$this->nmgp_cmp_hidden["nombredetalleadicional3_"] = "on"; $this->NM_ajax_info['fieldDisplay']['nombredetalleadicional3_'] = 'on';
	$this->nmgp_cmp_hidden["valoradicional3_"] = "on"; $this->NM_ajax_info['fieldDisplay']['valoradicional3_'] = 'on';
}

if ($this->nombredetalleadicional4_  != "")
{
	$this->nmgp_cmp_hidden["nombredetalleadicional4_"] = "on"; $this->NM_ajax_info['fieldDisplay']['nombredetalleadicional4_'] = 'on';
	$this->nmgp_cmp_hidden["valoradicional4_"] = "on"; $this->NM_ajax_info['fieldDisplay']['valoradicional4_'] = 'on';
}

if ($this->nombredetalleadicional5_  != "")
{
	$this->nmgp_cmp_hidden["nombredetalleadicional5_"] = "on"; $this->NM_ajax_info['fieldDisplay']['nombredetalleadicional5_'] = 'on';
	$this->nmgp_cmp_hidden["valoradicional5_"] = "on"; $this->NM_ajax_info['fieldDisplay']['valoradicional5_'] = 'on';
}

if ($this->nombredetalleadicional6_  != "")
{
	$this->nmgp_cmp_hidden["nombredetalleadicional6_"] = "on"; $this->NM_ajax_info['fieldDisplay']['nombredetalleadicional6_'] = 'on';
	$this->nmgp_cmp_hidden["valoradicional6_"] = "on"; $this->NM_ajax_info['fieldDisplay']['valoradicional6_'] = 'on';
}

if ($this->nombredetalleadicional7_  != "")
{
	$this->nmgp_cmp_hidden["nombredetalleadicional7_"] = "on"; $this->NM_ajax_info['fieldDisplay']['nombredetalleadicional7_'] = 'on';
	$this->nmgp_cmp_hidden["valoradicional7_"] = "on"; $this->NM_ajax_info['fieldDisplay']['valoradicional7_'] = 'on';
}

if ($this->nombredetalleadicional8_  != "")
{
	$this->nmgp_cmp_hidden["nombredetalleadicional8_"] = "on"; $this->NM_ajax_info['fieldDisplay']['nombredetalleadicional8_'] = 'on';
	$this->nmgp_cmp_hidden["valoradicional8_"] = "on"; $this->NM_ajax_info['fieldDisplay']['valoradicional8_'] = 'on';
}

if ($this->nombredetalleadicional9_  != "")
{
	$this->nmgp_cmp_hidden["nombredetalleadicional9_"] = "on"; $this->NM_ajax_info['fieldDisplay']['nombredetalleadicional9_'] = 'on';
	$this->nmgp_cmp_hidden["valoradicional9_"] = "on"; $this->NM_ajax_info['fieldDisplay']['valoradicional9_'] = 'on';
}

if ($this->nombredetalleadicional10_  != "")
{
	$this->nmgp_cmp_hidden["nombredetalleadicional10_"] = "on"; $this->NM_ajax_info['fieldDisplay']['nombredetalleadicional10_'] = 'on';
	$this->nmgp_cmp_hidden["valoradicional10_"] = "on"; $this->NM_ajax_info['fieldDisplay']['valoradicional10_'] = 'on';
}

if ($this->nombredetalleadicional11_  != "")
{
	$this->nmgp_cmp_hidden["nombredetalleadicional11_"] = "on"; $this->NM_ajax_info['fieldDisplay']['nombredetalleadicional11_'] = 'on';
	$this->nmgp_cmp_hidden["valoradicional11_"] = "on"; $this->NM_ajax_info['fieldDisplay']['valoradicional11_'] = 'on';
}

if ($this->nombredetalleadicional12_  != "")
{
	$this->nmgp_cmp_hidden["nombredetalleadicional12_"] = "on"; $this->NM_ajax_info['fieldDisplay']['nombredetalleadicional12_'] = 'on';
	$this->nmgp_cmp_hidden["valoradicional12_"] = "on"; $this->NM_ajax_info['fieldDisplay']['valoradicional12_'] = 'on';
}

if ($this->nombredetalleadicional13_  != "")
{
	$this->nmgp_cmp_hidden["nombredetalleadicional13_"] = "on"; $this->NM_ajax_info['fieldDisplay']['nombredetalleadicional13_'] = 'on';
	$this->nmgp_cmp_hidden["valoradicional13_"] = "on"; $this->NM_ajax_info['fieldDisplay']['valoradicional13_'] = 'on';
}

if ($this->nombredetalleadicional14_  != "")
{
	$this->nmgp_cmp_hidden["nombredetalleadicional14_"] = "on"; $this->NM_ajax_info['fieldDisplay']['nombredetalleadicional14_'] = 'on';
	$this->nmgp_cmp_hidden["valoradicional14_"] = "on"; $this->NM_ajax_info['fieldDisplay']['valoradicional14_'] = 'on';
}

if ($this->nombredetalleadicional15_  != "")
{
	$this->nmgp_cmp_hidden["nombredetalleadicional15_"] = "on"; $this->NM_ajax_info['fieldDisplay']['nombredetalleadicional15_'] = 'on';
	$this->nmgp_cmp_hidden["valoradicional15_"] = "on"; $this->NM_ajax_info['fieldDisplay']['valoradicional15_'] = 'on';
}
$_SESSION['scriptcase']['form_DETALLE_ORDEN_TRABAJO']['contr_erro'] = 'off'; 
          }
  }
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_select'][$sc_seq_vert]['codigo_'] = $this->codigo_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_select'][$sc_seq_vert]['descripcion_'] = $this->descripcion_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_select'][$sc_seq_vert]['cantidad_'] = $this->cantidad_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_select'][$sc_seq_vert]['preciounitario_'] = $this->preciounitario_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_select'][$sc_seq_vert]['descuento_'] = $this->descuento_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_select'][$sc_seq_vert]['estab_'] = $this->estab_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_select'][$sc_seq_vert]['ptoemi_'] = $this->ptoemi_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_select'][$sc_seq_vert]['secuencial_'] = $this->secuencial_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_select'][$sc_seq_vert]['lote_'] = $this->lote_;
          }
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              if (isset($this->Embutida_ronly) && $this->Embutida_ronly)
              {
                  ...
                  $this->NM_ajax_info['readOnly']['secuencial_' . $this->nmgp_refresh_row] = 'on';
      ...
      { 
          ...
          { 
              ...
              $this->nombredetalleadicional15_ = $this->nombredetalleadicional15__before_qstr;
              $this->valoradicional15_ = $this->valoradicional15__before_qstr;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['total']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_qtd']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_I_E']++; 
              ...
              if (isset($this->Embutida_form) && $this->Embutida_form)
              {
                  ...
                  $this->NM_ajax_info['fldList']['secuencial_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['secuencial_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->secuencial_)));
                  $this->NM_ajax_info['fldList']['secuencial_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_secuencial_)));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['secuencial_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['secuencial_' . $this->nmgp_refresh_row] = "on";
                      }
                  }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['parms'] = "estab_?#?$this->estab_?@?ptoemi_?#?$this->ptoemi_?@?secuencial_?#?$this->secuencial_?@?lote_?#?$this->lote_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_DETALLE_ORDEN_TRABAJO']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_liga_qtd_reg'];
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_DETALLE_ORDEN_TRABAJO = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['parms'] = ""; 
      } 
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          $this->NM_where_filter = str_replace("@percent@", "%", $this->NM_where_filter);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_filter'] . ")";
          }
      }
      $sc_where = "";
      if ('' != $sc_where_filter)
      ...
      if (((isset($this->NM_ajax_opcao) && 'backup_line' == $this->NM_ajax_opcao) || (isset($this->NM_btn_navega) && 'N' == $this->NM_btn_navega)) && !$this->has_where_params && 'novo' != $this->nmgp_opcao)
      {
          ...
          if (null != $this->estab_)
          {
              $aNewWhereCond[] = "ESTAB = " . $this->estab_;
          }
          if (null != $this->ptoemi_)
          {
              $aNewWhereCond[] = "PTOEMI = " . $this->ptoemi_;
          }
          if (null != $this->secuencial_)
          {
              $aNewWhereCond[] = "SECUENCIAL = " . $this->secuencial_;
          }
          if (null != $this->lote_)
          {
              $aNewWhereCond[] = "LOTE = '" . substr($this->Db->qstr($this->lote_), 1, -1) . "'";
          }
          if (!$this->NM_ajax_flag)
          {
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['total']))
          {
              ...
              $qt_geral_reg_form_DETALLE_ORDEN_TRABAJO = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['total'] = $qt_geral_reg_form_DETALLE_ORDEN_TRABAJO;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['total']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_I_E'] = 0; 
          if (!$this->sc_teve_excl && !$this->sc_teve_incl) 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] = 0; 
          } 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->estab_) && !empty($this->ptoemi_) && !empty($this->secuencial_) && !empty($this->lote_))
          {
              $Reg_OK      = false;
              $Count_start = -1;
              $sc_order_by = "";
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              {
                  $Sel_Chave = "ESTAB, PTOEMI, SECUENCIAL, LOTE"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              {
                  $Sel_Chave = "ESTAB, PTOEMI, SECUENCIAL, LOTE"; 
              ...
              while (!$rt->EOF && !$Reg_OK)
              { 
                  if ($rt->fields[0] == $this->estab_ && $rt->fields[1] == $this->ptoemi_ && $rt->fields[2] == $this->secuencial_ && $rt->fields[3] == $this->lote_)
                  { 
                      $Reg_OK = true;
                  }  
                  $Count_start++;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_DETALLE_ORDEN_TRABAJO = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_DETALLE_ORDEN_TRABAJO) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] += ($this->sc_max_reg + $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_I_E']); 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] > $qt_geral_reg_form_DETALLE_ORDEN_TRABAJO)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] = $qt_geral_reg_form_DETALLE_ORDEN_TRABAJO - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] = 0; 
              }
          }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] = ($qt_geral_reg_form_DETALLE_ORDEN_TRABAJO + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['ordem_ord']; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nmgp_select = "SELECT RUC, CODDOC, ESTAB, PTOEMI, SECUENCIAL, LOTE, CODIGO, DESCRIPCION, CANTIDAD, PRECIOUNITARIO, DESCUENTO, PRECIOTOTALSINIMPUESTO, NOMBREDETALLEADICIONAL1, VALORADICIONAL1, NOMBREDETALLEADICIONAL2, VALORADICIONAL2, NOMBREDETALLEADICIONAL3, VALORADICIONAL3, NOMBREDETALLEADICIONAL4, VALORADICIONAL4, NOMBREDETALLEADICIONAL5, VALORADICIONAL5, NOMBREDETALLEADICIONAL6, VALORADICIONAL6, NOMBREDETALLEADICIONAL7, VALORADICIONAL7, NOMBREDETALLEADICIONAL8, VALORADICIONAL8, NOMBREDETALLEADICIONAL9, VALORADICIONAL9, NOMBREDETALLEADICIONAL10, VALORADICIONAL10, NOMBREDETALLEADICIONAL11, VALORADICIONAL11, NOMBREDETALLEADICIONAL12, VALORADICIONAL12, NOMBREDETALLEADICIONAL13, VALORADICIONAL13, NOMBREDETALLEADICIONAL14, VALORADICIONAL14, NOMBREDETALLEADICIONAL15, VALORADICIONAL15, CODIGOIMPUESTO, CODIGOPORCENTAJEIMP, TARIFA, BASEIMPONIBLE, VALOR, CODIMPICE, CODPORCENICE, BASEICE, PORCENICE, VALORICE from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nmgp_select = "SELECT RUC, CODDOC, ESTAB, PTOEMI, SECUENCIAL, LOTE, CODIGO, DESCRIPCION, CANTIDAD, PRECIOUNITARIO, DESCUENTO, PRECIOTOTALSINIMPUESTO, NOMBREDETALLEADICIONAL1, VALORADICIONAL1, NOMBREDETALLEADICIONAL2, VALORADICIONAL2, NOMBREDETALLEADICIONAL3, VALORADICIONAL3, NOMBREDETALLEADICIONAL4, VALORADICIONAL4, NOMBREDETALLEADICIONAL5, VALORADICIONAL5, NOMBREDETALLEADICIONAL6, VALORADICIONAL6, NOMBREDETALLEADICIONAL7, VALORADICIONAL7, NOMBREDETALLEADICIONAL8, VALORADICIONAL8, NOMBREDETALLEADICIONAL9, VALORADICIONAL9, NOMBREDETALLEADICIONAL10, VALORADICIONAL10, NOMBREDETALLEADICIONAL11, VALORADICIONAL11, NOMBREDETALLEADICIONAL12, VALORADICIONAL12, NOMBREDETALLEADICIONAL13, VALORADICIONAL13, NOMBREDETALLEADICIONAL14, VALORADICIONAL14, NOMBREDETALLEADICIONAL15, VALORADICIONAL15, CODIGOIMPUESTO, CODIGOPORCENTAJEIMP, TARIFA, BASEIMPONIBLE, VALOR, CODIMPICE, CODPORCENICE, BASEICE, PORCENICE, VALORICE from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      ...
      else
      {
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          { 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['parms'] = "estab_?#?$this->estab_?@?ptoemi_?#?$this->ptoemi_?@?secuencial_?#?$this->secuencial_?@?lote_?#?$this->lote_?@?";
              } 
              $this->nm_proc_onload_record($sc_seq_vert);
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['codigo_'] =  $this->codigo_; 
             $this->form_vert_form_DETALLE_ORDEN_TRABAJO[$sc_seq_vert]['descripcion_'] =  $this->descripcion_; 
          ...
          ksort ($this->form_vert_form_DETALLE_ORDEN_TRABAJO); 
          $rs->Close(); 
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['reg_start'] < (($qt_geral_reg_form_DETALLE_ORDEN_TRABAJO + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['embutida_multi']) 
          { 
          } 
          else 
          { 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_DETALLE_ORDEN_TRABAJO = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['total'] = $qt_geral_reg_form_DETALLE_ORDEN_TRABAJO;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_DETALLE_ORDEN_TRABAJO_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_DETALLE_ORDEN_TRABAJO_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_DETALLE_ORDEN_TRABAJO_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['masterValue']))
{
