...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_DETALLE_ORDEN_TRABAJO_inline_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_DETALLE_ORDEN_TRABAJO_inline_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    $vertical_center = '';
...
if (isset($_SESSION['scriptcase']['form_DETALLE_ORDEN_TRABAJO']['error_buffer']) && '' != $_SESSION['scriptcase']['form_DETALLE_ORDEN_TRABAJO']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_DETALLE_ORDEN_TRABAJO']['error_buffer'];
}
...
<?php
 include_once("form_DETALLE_ORDEN_TRABAJO_inline_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_DETALLE_ORDEN_TRABAJO_inline'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_DETALLE_ORDEN_TRABAJO_inline'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['run_iframe'] != "R")
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_DETALLE_ORDEN_TRABAJO_inline");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_DETALLE_ORDEN_TRABAJO_inline");
 parent.scAjaxDetailHeight("form_DETALLE_ORDEN_TRABAJO_inline", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
