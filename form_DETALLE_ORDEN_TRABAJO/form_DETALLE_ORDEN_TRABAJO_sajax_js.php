  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_DETALLE_ORDEN_TRABAJO" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_DETALLE_ORDEN_TRABAJO_form();
	}
  ...
  // ---------- Validate codigo_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_codigo_(iNumLinha)
  {
    var nomeCampo_codigo_ = "codigo_" + iNumLinha;
    var var_codigo_ = scAjaxGetFieldText(nomeCampo_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_validate_codigo_(var_codigo_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_codigo__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_codigo_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_codigo__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_codigo__cb

  // ---------- Validate descripcion_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_descripcion_(iNumLinha)
  {
    var nomeCampo_descripcion_ = "descripcion_" + iNumLinha;
    var var_descripcion_ = scAjaxGetFieldText(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_descripcion__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_descripcion_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_descripcion__cb

  // ---------- Validate cantidad_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_cantidad__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_cantidad_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_cantidad__cb

  // ---------- Validate preciounitario_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_preciounitario_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_validate_preciounitario_(var_preciounitario_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_preciounitario__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_preciounitario_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_preciounitario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_preciounitario__cb

  // ---------- Validate descuento_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_descuento_(iNumLinha)
  {
    var nomeCampo_descuento_ = "descuento_" + iNumLinha;
    var var_descuento_ = scAjaxGetFieldText(nomeCampo_descuento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_validate_descuento_(var_descuento_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_descuento__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_descuento_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_descuento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_descuento__cb

  // ---------- Validate estab_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_estab_(iNumLinha)
  {
    var nomeCampo_estab_ = "estab_" + iNumLinha;
    var var_estab_ = scAjaxGetFieldText(nomeCampo_estab_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_validate_estab_(var_estab_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_estab__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_estab_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_estab__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_estab__cb

  // ---------- Validate ptoemi_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_ptoemi_(iNumLinha)
  {
    var nomeCampo_ptoemi_ = "ptoemi_" + iNumLinha;
    var var_ptoemi_ = scAjaxGetFieldText(nomeCampo_ptoemi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_validate_ptoemi_(var_ptoemi_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_ptoemi__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_ptoemi_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_ptoemi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_ptoemi__cb

  // ---------- Validate secuencial_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_secuencial_(iNumLinha)
  {
    var nomeCampo_secuencial_ = "secuencial_" + iNumLinha;
    var var_secuencial_ = scAjaxGetFieldText(nomeCampo_secuencial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_validate_secuencial_(var_secuencial_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_secuencial__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_secuencial_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_secuencial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "secuencial_" + iLineNumber;
    }
    else
    {
      sFieldValid = "secuencial_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "secuencial_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "secuencial_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_secuencial__cb

  // ---------- Validate lote_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_lote_(iNumLinha)
  {
    var nomeCampo_lote_ = "lote_" + iNumLinha;
    var var_lote_ = scAjaxGetFieldText(nomeCampo_lote_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_validate_lote_(var_lote_, iNumLinha, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_lote__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_lote_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_lote__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_validate_lote__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_DETALLE_ORDEN_TRABAJO_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_DETALLE_ORDEN_TRABAJO_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_add_new_line_cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_add_new_line

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_backup_line(iNumLinha)
  {
    var var_estab_ = scAjaxGetFieldText("estab_" + iNumLinha);
    var var_ptoemi_ = scAjaxGetFieldText("ptoemi_" + iNumLinha);
    var var_secuencial_ = scAjaxGetFieldText("secuencial_" + iNumLinha);
    var var_lote_ = scAjaxGetFieldText("lote_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_backup_line(var_estab_, var_ptoemi_, var_secuencial_, var_lote_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_backup_line_cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_backup_line

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_backup_line_cb

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_cancel_insert

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_cancel_update(iSeqVert)
  {
    do_ajax_form_DETALLE_ORDEN_TRABAJO_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_cancel_update

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_table_refresh()
  {
    var var_estab_ = document.F2.estab_.value;
    var var_ptoemi_ = document.F2.ptoemi_.value;
    var var_secuencial_ = document.F2.secuencial_.value;
    var var_lote_ = document.F2.lote_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_DETALLE_ORDEN_TRABAJO_table_refresh(var_estab_, var_ptoemi_, var_secuencial_, var_lote_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_table_refresh_cb);
  } //  do_ajax_form_DETALLE_ORDEN_TRABAJO_table_refresh

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.estab_.value = scAjaxGetKeyValue("estab_");
    document.F2.ptoemi_.value = scAjaxGetKeyValue("ptoemi_");
    document.F2.secuencial_.value = scAjaxGetKeyValue("secuencial_");
    document.F2.lote_.value = scAjaxGetKeyValue("lote_");
    ...
    scAjaxAlert(do_ajax_form_DETALLE_ORDEN_TRABAJO_table_refresh_cb_after_alert);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_table_refresh_cb
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("b");
    sc_insert_open = false;
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_table_refresh_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_DETALLE_ORDEN_TRABAJO_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_DETALLE_ORDEN_TRABAJO_submit_form(var_codigo_, var_descripcion_, var_cantidad_, var_preciounitario_, var_descuento_, var_estab_, var_ptoemi_, var_secuencial_, var_lote_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_DETALLE_ORDEN_TRABAJO_submit_form_cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_submit_form

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("secuencial_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_DETALLE_ORDEN_TRABAJO_submit_form_cb_after_alert);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_submit_form_cb
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_navigate_form()
  {
    perform_ajax_form_DETALLE_ORDEN_TRABAJO_navigate_form();
  }

  function perform_ajax_form_DETALLE_ORDEN_TRABAJO_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_DETALLE_ORDEN_TRABAJO_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("secuencial_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_DETALLE_ORDEN_TRABAJO_navigate_form(var_estab_, var_ptoemi_, var_secuencial_, var_lote_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_navigate_form_cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.estab_.value = scAjaxGetKeyValue("estab_" + var_last_index);
    document.F2.ptoemi_.value = scAjaxGetKeyValue("ptoemi_" + var_last_index);
    document.F2.secuencial_.value = scAjaxGetKeyValue("secuencial_" + var_last_index);
    document.F2.lote_.value = scAjaxGetKeyValue("lote_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_DETALLE_ORDEN_TRABAJO_navigate_form_cb_after_alert);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_navigate_form_cb
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_navigate_form_cb_after_alert
  function sc_hide_form_DETALLE_ORDEN_TRABAJO_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "secuencial_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "lote_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["codigo_" + iNumLinha] = {"label": "CÓDIGO PRODUCTO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["ptoemi_" + iNumLinha] = {"label": "PTOEMI<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["secuencial_" + iNumLinha] = {"label": "SECUENCIAL<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["secuencial_"][iNumLinha] = "secuencial_" + iNumLinha;
    ...
    ajax_error_count["secuencial_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["secuencial_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["secuencial_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["secuencial_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["secuencial_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["secuencial_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["secuencial_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["secuencial_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['estab_'])) ? $this->nmgp_cmp_readonly['estab_'] : 'on';
?>
    scAjaxFieldRead("estab_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ptoemi_'])) ? $this->nmgp_cmp_readonly['ptoemi_'] : 'on';
?>
    scAjaxFieldRead("ptoemi_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['secuencial_'])) ? $this->nmgp_cmp_readonly['secuencial_'] : 'on';
?>
    scAjaxFieldRead("secuencial_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("secuencial_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["codigo_" + iRow] || "on" == ajax_error_count["descripcion_" + iRow] || "on" == ajax_error_count["cantidad_" + iRow] || "on" == ajax_error_count["preciounitario_" + iRow] || "on" == ajax_error_count["descuento_" + iRow] || "on" == ajax_error_count["estab_" + iRow] || "on" == ajax_error_count["ptoemi_" + iRow] || "on" == ajax_error_count["secuencial_" + iRow] || "on" == ajax_error_count["lote_" + iRow]))
    {
      ...
      $("#hidden_field_data_secuencial_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["codigo_" + iRow] && "off" == ajax_error_count["descripcion_" + iRow] && "off" == ajax_error_count["cantidad_" + iRow] && "off" == ajax_error_count["preciounitario_" + iRow] && "off" == ajax_error_count["descuento_" + iRow] && "off" == ajax_error_count["estab_" + iRow] && "off" == ajax_error_count["ptoemi_" + iRow] && "off" == ajax_error_count["secuencial_" + iRow] && "off" == ajax_error_count["lote_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["secuencial_" + iRow] = "off";
      ...
      $("#hidden_field_data_secuencial_" + iRow).removeClass("scFormErrorLine");
