  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_DETALLE_ORDEN_TRABAJO_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_DETALLE_ORDEN_TRABAJO_inline_form();
	}
  ...
  // ---------- Validate codigo_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_codigo_()
  {
    var nomeCampo_codigo_ = "codigo_";
    var var_codigo_ = scAjaxGetFieldText(nomeCampo_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_codigo_(var_codigo_, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_codigo__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_codigo_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_codigo__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_codigo__cb

  // ---------- Validate descripcion_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_descripcion_()
  {
    var nomeCampo_descripcion_ = "descripcion_";
    var var_descripcion_ = scAjaxGetFieldText(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_descripcion_(var_descripcion_, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_descripcion__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_descripcion_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_descripcion__cb

  // ---------- Validate cantidad_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_cantidad_()
  {
    var nomeCampo_cantidad_ = "cantidad_";
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_cantidad_(var_cantidad_, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_cantidad__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_cantidad_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_cantidad__cb

  // ---------- Validate preciounitario_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_preciounitario_()
  {
    var nomeCampo_preciounitario_ = "preciounitario_";
    var var_preciounitario_ = scAjaxGetFieldText(nomeCampo_preciounitario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_preciounitario_(var_preciounitario_, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_preciounitario__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_preciounitario_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_preciounitario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_preciounitario__cb

  // ---------- Validate descuento_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_descuento_()
  {
    var nomeCampo_descuento_ = "descuento_";
    var var_descuento_ = scAjaxGetFieldText(nomeCampo_descuento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_descuento_(var_descuento_, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_descuento__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_descuento_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_descuento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_descuento__cb

  // ---------- Validate estab_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_estab_()
  {
    var nomeCampo_estab_ = "estab_";
    var var_estab_ = scAjaxGetFieldText(nomeCampo_estab_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_estab_(var_estab_, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_estab__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_estab_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_estab__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estab_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_estab__cb

  // ---------- Validate ptoemi_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_ptoemi_()
  {
    var nomeCampo_ptoemi_ = "ptoemi_";
    var var_ptoemi_ = scAjaxGetFieldText(nomeCampo_ptoemi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_ptoemi_(var_ptoemi_, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_ptoemi__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_ptoemi_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_ptoemi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ptoemi_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_ptoemi__cb

  // ---------- Validate secuencial_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_secuencial_()
  {
    var nomeCampo_secuencial_ = "secuencial_";
    var var_secuencial_ = scAjaxGetFieldText(nomeCampo_secuencial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_secuencial_(var_secuencial_, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_secuencial__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_secuencial_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_secuencial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_secuencial__cb

  // ---------- Validate lote_
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_lote_()
  {
    var nomeCampo_lote_ = "lote_";
    var var_lote_ = scAjaxGetFieldText(nomeCampo_lote_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_lote_(var_lote_, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_lote__cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_lote_

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_lote__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lote_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_validate_lote__cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_codigo_ = scAjaxGetFieldText("codigo_");
    var var_descripcion_ = scAjaxGetFieldText("descripcion_");
    var var_cantidad_ = scAjaxGetFieldText("cantidad_");
    var var_preciounitario_ = scAjaxGetFieldText("preciounitario_");
    var var_descuento_ = scAjaxGetFieldText("descuento_");
    var var_estab_ = scAjaxGetFieldText("estab_");
    var var_ptoemi_ = scAjaxGetFieldText("ptoemi_");
    var var_secuencial_ = scAjaxGetFieldText("secuencial_");
    var var_lote_ = scAjaxGetFieldText("lote_");
    ...
    scAjaxProcOn();
    x_ajax_form_DETALLE_ORDEN_TRABAJO_inline_submit_form(var_codigo_, var_descripcion_, var_cantidad_, var_preciounitario_, var_descuento_, var_estab_, var_ptoemi_, var_secuencial_, var_lote_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_submit_form_cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_submit_form

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("descripcion_");
      scAjaxHideErrorDisplay("cantidad_");
      scAjaxHideErrorDisplay("preciounitario_");
      scAjaxHideErrorDisplay("descuento_");
      scAjaxHideErrorDisplay("estab_");
      scAjaxHideErrorDisplay("ptoemi_");
      scAjaxHideErrorDisplay("secuencial_");
      scAjaxHideErrorDisplay("lote_");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_submit_form_cb_after_alert);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_submit_form_cb
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_navigate_form()
  {
    perform_ajax_form_DETALLE_ORDEN_TRABAJO_inline_navigate_form();
  }

  function perform_ajax_form_DETALLE_ORDEN_TRABAJO_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_DETALLE_ORDEN_TRABAJO_inline_navigate_form(var_estab_, var_ptoemi_, var_secuencial_, var_lote_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_navigate_form_cb);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_navigate_form_cb
  function do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_DETALLE_ORDEN_TRABAJO_inline_navigate_form_cb_after_alert
  function sc_hide_form_DETALLE_ORDEN_TRABAJO_inline_form()
  {
  ...
  ajax_field_list[0] = "codigo_";
  ajax_field_list[1] = "descripcion_";
  ajax_field_list[2] = "cantidad_";
  ajax_field_list[3] = "preciounitario_";
  ajax_field_list[4] = "descuento_";
  ajax_field_list[5] = "estab_";
  ajax_field_list[6] = "ptoemi_";
  ajax_field_list[7] = "secuencial_";
  ajax_field_list[8] = "lote_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "codigo_": {"label": "CÓDIGO PRODUCTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descripcion_": {"label": "DESCRIPCIÓN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cantidad_": {"label": "CANTIDAD", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "preciounitario_": {"label": "PRECIO UNITARIO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descuento_": {"label": "DESCUENTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "estab_": {"label": "ESTAB", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ptoemi_": {"label": "PTOEMI", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "secuencial_": {"label": "SECUENCIAL", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lote_": {"label": "LOTE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["descripcion_"][1] = "descripcion_";
  ajax_field_mult["cantidad_"][1] = "cantidad_";
  ajax_field_mult["preciounitario_"][1] = "preciounitario_";
  ajax_field_mult["descuento_"][1] = "descuento_";
  ajax_field_mult["estab_"][1] = "estab_";
  ajax_field_mult["ptoemi_"][1] = "ptoemi_";
  ajax_field_mult["secuencial_"][1] = "secuencial_";
  ajax_field_mult["lote_"][1] = "lote_";

  var ajax_field_id = {
    "codigo_": new Array("hidden_field_label_codigo_", "hidden_field_data_codigo_"),
    "descripcion_": new Array("hidden_field_label_descripcion_", "hidden_field_data_descripcion_"),
    "cantidad_": new Array("hidden_field_label_cantidad_", "hidden_field_data_cantidad_"),
    "preciounitario_": new Array("hidden_field_label_preciounitario_", "hidden_field_data_preciounitario_"),
    "descuento_": new Array("hidden_field_label_descuento_", "hidden_field_data_descuento_")
  };
