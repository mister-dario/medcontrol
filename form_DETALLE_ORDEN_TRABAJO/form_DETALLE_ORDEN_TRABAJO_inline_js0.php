<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="estab_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['estab_']); ?>">
<input type="hidden" name="ptoemi_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['ptoemi_']); ?>">
<input type="hidden" name="secuencial_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['secuencial_']); ?>">
<input type="hidden" name="lote_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['lote_']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_DETALLE_ORDEN_TRABAJO_inline"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO']['where_detal']))
  {
?>  
  if (parent && parent.nmsc_iframe_liga_form_DETALLE_ORDEN_TRABAJO.scInlineFormReceive)
  {
    parent.nmsc_iframe_liga_form_DETALLE_ORDEN_TRABAJO.scInlineFormReceive(oResp, <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['inline_form_seq'] ?>);
    return true;
  }
<?php
  }
...
?>  
  ...
  {
    parent.scInlineFormReceive(oResp, <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_ORDEN_TRABAJO_inline']['inline_form_seq'] ?>);
    return true;
  }
<?php
  }
