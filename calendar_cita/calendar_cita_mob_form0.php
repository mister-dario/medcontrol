...
<style type="text/css">
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("calendar_cita_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('calendar_cita_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['recarga'];
}
if ('' != $this->fclnumero)
{
...
if (isset($_SESSION['scriptcase']['calendar_cita']['error_buffer']) && '' != $_SESSION['scriptcase']['calendar_cita']['error_buffer'])
{
    echo $_SESSION['scriptcase']['calendar_cita']['error_buffer'];
}
...
<?php
 include_once("calendar_cita_mob_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/nm_rpc.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="calendar_cita_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['calendar_cita_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['calendar_cita_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_citid_line" id="hidden_field_data_citid" style="<?php echo $sStyleHidden_citid; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_citid_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_citid_label" style=""><span id="id_label_citid"><?php echo $this->nm_new_label['citid']; ?></span></span><br><span id="id_read_on_citid" class="css_citid_line" style="<?php echo $sStyleReadLab_citid; ?>"><?php echo $this->form_format_readonly("citid", $this->form_encode_input($this->citid)); ?></span><span id="id_read_off_citid" class="css_read_off_citid" style="<?php echo $sStyleReadInp_citid; ?>"><input type="hidden" name="citid" value="<?php echo $this->form_encode_input($citid) . "\">"?><span id="id_ajax_label_citid"><?php echo nl2br($citid); ?></span>
</span></span></td><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none; position: absolute" id="id_error_display_citid_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_citid_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }
      else
      {
         $sc_hidden_no--;
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['Lookup_citfactur'][] = '0'; ?>
 <option  value="1" <?php  if ($this->citfactur == "1") { echo " selected" ;} ?>>FACTURADA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['Lookup_citfactur'][] = '1'; ?>
 <option  value="2" <?php  if ($this->citfactur == "2") { echo " selected" ;} ?>>ORDEN DE TRAB. GENERADA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['Lookup_citfactur'][] = '2'; ?>
 <option  value="3" <?php  if ($this->citfactur == "3") { echo " selected" ;} ?>>CANCELADA POR CLÍNICA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['Lookup_citfactur'][] = '3'; ?>
 <option  value="4" <?php  if ($this->citfactur == "4") { echo " selected" ;} ?>>CANCELADA POR PACIENTE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['Lookup_citfactur'][] = '4'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fclnumero_line" id="hidden_field_data_fclnumero" style="<?php echo $sStyleHidden_fclnumero; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclnumero_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fclnumero_label" style=""><span id="id_label_fclnumero"><?php echo $this->nm_new_label['fclnumero']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['php_cmp_required']['fclnumero']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['php_cmp_required']['fclnumero'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br><input type="hidden" name="fclnumero" value="<?php echo $this->form_encode_input($fclnumero); ?>"><span id="id_ajax_label_fclnumero"><?php echo nl2br($fclnumero); ?></span>
<?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_calendar_cita_mob*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_ficha_cliente_capture"]) && $this->Ini->sc_lig_md5["grid_ficha_cliente_capture"] == "S") {
       ...
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@calendar_cita_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
...
<?php if (!$this->Ini->Export_img_zip) { ?><?php echo nmButtonOutput($this->arr_buttons, "bform_captura", "scModalCapture('" . $this->Ini->link_grid_ficha_cliente_capture_cons_psq . "?script_case_init=" . $this->Ini->sc_page . "&nmgp_parms=" . $Md5_Lig . "&SC_lig_apl_orig=calendar_cita_mob&KeepThis=true&TB_iframe=true&height=300&width=700&modal=true')", "scModalCapture('" . $this->Ini->link_grid_ficha_cliente_capture_cons_psq . "?script_case_init=" . $this->Ini->sc_page . "&nmgp_parms=" . $Md5_Lig . "&SC_lig_apl_orig=calendar_cita_mob&KeepThis=true&TB_iframe=true&height=300&width=700&modal=true')", "cap_fclnumero", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php } ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['Lookup_paciente_nuevo'][] = '1'; ?>
<?php  if (in_array("1", $this->paciente_nuevo_1))  { echo " checked" ;} ?> onClick="do_ajax_calendar_cita_mob_event_paciente_nuevo_onclick();" ><span></span>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['Lookup_cittipo'][] = ''; ?>
 <option value="">------------------------</option>
 <option  value="D" <?php  if ($this->cittipo == "D") { echo " selected" ;} ?>>DIAGNÓSTICO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['Lookup_cittipo'][] = 'D'; ?>
 <option  value="P" <?php  if ($this->cittipo == "P") { echo " selected" ;} ?>>PROGRAMADO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['Lookup_cittipo'][] = 'P'; ?>
 <option  value="C" <?php  if ($this->cittipo == "C") { echo " selected" ;} ?>>CONTROL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['Lookup_cittipo'][] = 'C'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['Lookup_cancelar_cita'][] = ''; ?>
 <option value="">------------------------</option>
 <option  value="CLIN" <?php  if ($this->cancelar_cita == "CLIN") { echo " selected" ;} ?>>CANCELA CLÍNICA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['Lookup_cancelar_cita'][] = 'CLIN'; ?>
 <option  value="CLIE" <?php  if ($this->cancelar_cita == "CLIE") { echo " selected" ;} ?>>CANCELA PACIENTE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['Lookup_cancelar_cita'][] = 'CLIE'; ?>
 </select></span>
</span><?php  }?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bnovo", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_new_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Enter)", "sc-unique-btn-7", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bincluir", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_ins_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Enter)", "sc-unique-btn-8", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "balterar", "scBtnFn_sys_format_alt()", "scBtnFn_sys_format_alt()", "sc_b_upd_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + S)", "sc-unique-btn-9", "", "");?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "scBtnFn_sys_format_sai()", "scBtnFn_sys_format_sai()", "sc_b_sai_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + Q)", "sc-unique-btn-10", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "scBtnFn_sys_format_sai()", "scBtnFn_sys_format_sai()", "sc_b_sai_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + Q)", "sc-unique-btn-12", "", "");?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("calendar_cita_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("calendar_cita_mob");
 parent.scAjaxDetailHeight("calendar_cita_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
