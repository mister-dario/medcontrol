...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_cita']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['calendar_cita']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_cita']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['calendar_cita']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_cita']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_cita']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->usr_login)) 
          {
              $_SESSION['usr_login'] = $this->usr_login;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['calendar_cita']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['calendar_cita']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['calendar_cita']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['calendar_cita']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['calendar_cita']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_cita']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['calendar_cita']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['calendar_cita']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['calendar_cita']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new calendar_cita_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['calendar_cita']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_cita']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_cita'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_cita']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_cita']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('calendar_cita') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_cita']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " cita";
      ...
      $_SESSION['scriptcase']['error_icon']['calendar_cita']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['calendar_cita'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_orig'] = " where citanula=0 and citfactur<3";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_pesq'] = " where citanula=0 and citfactur<3";
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_cita']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_cita'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_cita'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("calendar_cita", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'calendar_cita/calendar_cita_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'calendar_cita_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'calendar_cita_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'calendar_cita_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'calendar_cita/calendar_cita_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "calendar_cita_erro.class.php"); 
      }
      $this->Erro      = new calendar_cita_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['calendar_cita']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['final'];
      }
      else
      {
      }
...
//
      ...
      {
          $_SESSION['scriptcase']['calendar_cita']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['calendar_cita']['contr_erro'] = 'off'; 
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['dados_select']['hora_fin_mostrar']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->hora_fin_mostrar = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['dados_select']['hora_fin_mostrar'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['dados_select']['fclnumero']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fclnumero = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['dados_select']['fclnumero'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "calendar_cita.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="calendar_cita_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="calendar_cita"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_calendar_cita']) || !is_array($this->NM_ajax_info['errList']['geral_calendar_cita']))
              {
                  $this->NM_ajax_info['errList']['geral_calendar_cita'] = array();
              }
              $this->NM_ajax_info['errList']['geral_calendar_cita'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if (isset($this->__calend_all_day__) && 'Y' == $this->__calend_all_day__)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['bypass_required_time']['cithoraini'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['bypass_required_time']['cithorafin'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['bypass_required_time']['cithoraini'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['bypass_required_time']['cithorafin'] = false;
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_calendar_cita' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['calendar_cita']['contr_erro'] = 'off'; 
    ...
    function ValidateField_citfecha(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['php_cmp_required']['citfecha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['php_cmp_required']['citfecha'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "FECHA" ; 
              if (!isset($Campos_Erros['citfecha']))
    ...
    function ValidateField_agesecuen(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->agesecuen == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['php_cmp_required']['agesecuen']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['php_cmp_required']['agesecuen'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "AGENDA" ; 
          ...
          if (!empty($this->agesecuen) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['Lookup_agesecuen']) && !in_array($this->agesecuen, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['Lookup_agesecuen']))
          {
              $hasError = true;
    ...
    function ValidateField_cithoraini(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['php_cmp_required']['cithoraini']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['php_cmp_required']['cithoraini'] == "on") 
           { 
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['bypass_required_time']['cithoraini']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['bypass_required_time']['cithoraini'])
              {
              $hasError = true;
    ...
    function ValidateField_citduracion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->citduracion, 11, 0, 5, 0, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['php_cmp_required']['citduracion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['php_cmp_required']['citduracion'] == "on") 
           { 
              $hasError = true;
   ...
   if ($this->nmgp_opcao == "incluir")
   {
    ...
    function ValidateField_fclnumero(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['php_cmp_required']['fclnumero']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['php_cmp_required']['fclnumero'] == "on")) 
      { 
          if ($this->fclnumero == "")  
          { 
              $hasError = true;
   ...
   if ($this->nmgp_opcao == "incluir")
   {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['php_cmp_required']['cittipo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['php_cmp_required']['cittipo'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "TIPO" ;
   ...
   if ($this->nmgp_opcao == "incluir")
   {
               if (!empty($this->prenumero) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['Lookup_prenumero']) && !in_array($this->prenumero, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['Lookup_prenumero']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['citid']['keyVal'] = calendar_cita_pack_protect_string($this->nmgp_dados_form['citid']);
          }
   } // ajax_return_values
...
$aLookup[] = array(calendar_cita_pack_protect_string('') => str_replace('<', '&lt;',calendar_cita_pack_protect_string('------------------------')));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['Lookup_agesecuen'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(calendar_cita_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', calendar_cita_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['agesecuen']['valList'][$i] = calendar_cita_pack_protect_string($v);
          }
...
$aLookup[] = array(calendar_cita_pack_protect_string('0') => str_replace('<', '&lt;',calendar_cita_pack_protect_string("NO PROCESADA")));
$aLookup[] = array(calendar_cita_pack_protect_string('1') => str_replace('<', '&lt;',calendar_cita_pack_protect_string("FACTURADA")));
$aLookup[] = array(calendar_cita_pack_protect_string('2') => str_replace('<', '&lt;',calendar_cita_pack_protect_string("ORDEN DE TRAB. GENERADA")));
$aLookup[] = array(calendar_cita_pack_protect_string('3') => str_replace('<', '&lt;',calendar_cita_pack_protect_string("CANCELADA POR CLÍNICA")));
$aLookup[] = array(calendar_cita_pack_protect_string('4') => str_replace('<', '&lt;',calendar_cita_pack_protect_string("CANCELADA POR PACIENTE")));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['Lookup_citfactur'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['Lookup_citfactur'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['Lookup_citfactur'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['Lookup_citfactur'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['Lookup_citfactur'][] = '4';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['citfactur']['valList'][$i] = calendar_cita_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_fclnumero($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['fclnumero'] = array(
              ...
              $this->NM_ajax_info['fldList']['fclnumero']['lookupCons'] = calendar_cita_pack_protect_string(NM_charset_to_utf8($conteudo));
          }
   }
...
$aLookup[] = array(calendar_cita_pack_protect_string('1') => str_replace('<', '&lt;',calendar_cita_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['Lookup_paciente_nuevo'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['paciente_nuevo']['valList'][$i] = calendar_cita_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(calendar_cita_pack_protect_string('D') => str_replace('<', '&lt;',calendar_cita_pack_protect_string("DIAGNÓSTICO")));
$aLookup[] = array(calendar_cita_pack_protect_string('P') => str_replace('<', '&lt;',calendar_cita_pack_protect_string("PROGRAMADO")));
$aLookup[] = array(calendar_cita_pack_protect_string('C') => str_replace('<', '&lt;',calendar_cita_pack_protect_string("CONTROL")));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['Lookup_cittipo'][] = 'D';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['Lookup_cittipo'][] = 'P';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['Lookup_cittipo'][] = 'C';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['cittipo']['valList'][$i] = calendar_cita_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(calendar_cita_pack_protect_string('null') => str_replace('<', '&lt;',calendar_cita_pack_protect_string('------------------------')));
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['prenumero']['valList'][$i] = calendar_cita_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(calendar_cita_pack_protect_string('CLIN') => str_replace('<', '&lt;',calendar_cita_pack_protect_string("CANCELA CLÍNICA")));
$aLookup[] = array(calendar_cita_pack_protect_string('CLIE') => str_replace('<', '&lt;',calendar_cita_pack_protect_string("CANCELA PACIENTE")));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['Lookup_cancelar_cita'][] = 'CLIN';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['Lookup_cancelar_cita'][] = 'CLIE';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['cancelar_cita']['valList'][$i] = calendar_cita_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
...
$_SESSION['scriptcase']['calendar_cita']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          {
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['calendar_cita']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['parms'] = "citid?#?$this->citid?@?"; 
      }
      $this->NM_commit_db(); 
      if (isset($this->google_calendar_insert) && $this->google_calendar_insert)
      {
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['reg_start']) ;  
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['reg_start'] < $qt_geral_reg_calendar_cita;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['opcao']   = '';
          }
      } 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("calendar_cita_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['table_refresh'])
        {
   ...
   function calendarOutputDisplay()
   {
       ...
       $appReturn = '';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['sc_outra_jan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['sc_outra_jan'] != 'calendar_cita')) {
           global $nm_url_saida, $nm_apl_dependente;
           if ((!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe'] == "R" || $this->aba_iframe) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['run_iframe'] != "F") && ($nm_apl_dependente == 1)) {
...
?>
      events: 'calendar_cita.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false),
...
{
?>
        tb_show('', 'calendar_cita.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
...
{
?>
        tb_show('', 'calendar_cita.php?nmgp_opcao=igual_calendar&citid=' + calEvent.id + '&__orig_citid=' + calEvent.id + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
<?php
}
  ...
  function scEditEvent(sEventId) {
    ...
    $("#sc-ui-form").submit();
        ...
        function refreshFilterCategories() {
                $('#calendar').fullCalendar('removeEventSource', 'calendar_cita.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));

                setCategory();

                $('#calendar').fullCalendar('addEventSource', 'calendar_cita.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
        }
...
<div class='scCalendarBorder sc-cal-page-container'>
    <?php
if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['dashboard_info']['under_dashboard']) {
?>
<style type="text/css">
...
<?php
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['csrf_token'];
    }
...
{ 
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_filter_form'] . " and (citanula=0 and citfactur<3) and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_calendar_cita = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['total'] = $qt_geral_reg_calendar_cita;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          calendar_cita_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "calendar_cita_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['nm_run_menu'] = 2;
       $nmgp_saida_form = "calendar_cita_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_cita']['masterValue']))
{
