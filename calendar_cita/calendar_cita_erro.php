...
$old_error_handler = set_error_handler("calendar_cita_scriptcase_error_handler");

function calendar_cita_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['calendar_cita']['contr_erro']) && $_SESSION['scriptcase']['calendar_cita']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_calendar_cita->contr_calendar_cita->Apl_com_erro = true;
            if ($inicial_calendar_cita->contr_calendar_cita->NM_ajax_flag)
            {
                $inicial_calendar_cita->contr_calendar_cita->NM_ajax_info['errList']['geral_calendar_cita'][] = $msg;
                return;
            }
            calendar_cita_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function calendar_cita_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['calendar_cita'])  && '' != $_SESSION['scriptcase']['error_icon']['calendar_cita'])  ? $_SESSION['scriptcase']['error_icon']['calendar_cita']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['calendar_cita']) && '' != $_SESSION['scriptcase']['error_span_title']['calendar_cita']) ? $_SESSION['scriptcase']['error_span_title']['calendar_cita'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['calendar_cita']) && '' != $_SESSION['scriptcase']['error_icon_title']['calendar_cita']) ? $_SESSION['scriptcase']['error_icon_title']['calendar_cita'] : '';
?>
