...
function Sel_cmp_process()
{
   ...
   function Sel_cmp_init_fields()
   {
      ...
      $tab_ger_campos['medapellidos'] = "on";
      $tab_ger_campos['mednombres'] = "on";
      $tab_ger_campos['medemail'] = "on";
      $tab_ger_campos['medtelefonos'] = "on";
      $tab_ger_campos['medusucrea'] = "on";
...
?>
                        <li class="sc_ui_litem <?php echo $str_class; ?>" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['grid_medico']['labels'][$NM_cada_field]; ?></li>
<?php
           }
       }
   }
