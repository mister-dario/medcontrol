<?php
class form_detalle_presupuesto_form extends form_detalle_presupuesto_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['sc_redir_atualiz'] == 'ok')
{
?>
...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_detalle_presupuesto/form_detalle_presupuesto_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_detalle_presupuesto_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_detalle_presupuesto_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-sercodigo_", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_detalle_presupuesto_event_sercodigo__onchange) { do_ajax_form_detalle_presupuesto_event_sercodigo__onchange(sRow); }
    }
   }
   ...
   source: function (request, response) {
    $.ajax({
     url: "form_detalle_presupuesto.php",
     dataType: "json",
     data: {
      term: request.term,
   ...
   change: function (event, ui) {
    var sId = $(this).attr("id").substr(6), sRow = 'sercodigo_' != sId ? sId.substr(10) : '';
    if ("" == $(this).val()) {
     do_ajax_form_detalle_presupuesto_event_sercodigo__onchange(sRow);
    }
   },
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['recarga'];
}
...
<?php
 include_once("form_detalle_presupuesto_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_detalle_presupuesto'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_detalle_presupuesto'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<?php
   if (!isset($this->nmgp_cmp_hidden['dprsecuen_']))
   {
       $this->nmgp_cmp_hidden['dprsecuen_'] = 'off';
   }
?>
...
<?php
 ...
 ?>
   ...
   <?php if ((!isset($this->nmgp_cmp_hidden['dprsecuen_']) || $this->nmgp_cmp_hidden['dprsecuen_'] == 'on') && ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir"))) { 
      if (!isset($this->nm_new_label['dprsecuen_'])) {
          $this->nm_new_label['dprsecuen_'] = "Dprsecuen"; } ?>

    <TD class="scFormLabelOddMult css_dprsecuen__label" id="hidden_field_label_dprsecuen_" style="<?php echo $sStyleHidden_dprsecuen_; ?>" > <?php echo $this->nm_new_label['dprsecuen_'] ?> </TD>
   <?php }?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_detalle_presupuesto);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_detalle_presupuesto = $this->form_vert_form_detalle_presupuesto;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_detalle_presupuesto))
   {
       $sc_seq_vert = 0;
   }
           ...
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['dprsecuen_']))
           {
               $this->nmgp_cmp_readonly['dprsecuen_'] = 'on';
           }
   foreach ($this->form_vert_form_detalle_presupuesto as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->prenumero_ = $this->form_vert_form_detalle_presupuesto[$sc_seq_vert]['prenumero_'];
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           ...
           $this->nmgp_cmp_readonly['dprsecuen_'] = true;
       }
       elseif ($Line_Add)
       {
           ...
           if (!isset($this->nmgp_cmp_readonly['dprsecuen_']) || $this->nmgp_cmp_readonly['dprsecuen_'] != "on") {$this->nmgp_cmp_readonly['dprsecuen_'] = false;}
       }
              foreach ($this->form_vert_form_preenchimento[$sc_seq_vert] as $sCmpNome => $mCmpVal)
              {
                  eval("\$this->" . $sCmpNome . " = \$mCmpVal;");
              }
        $this->sercodigo_ = $this->form_vert_form_detalle_presupuesto[$sc_seq_vert]['sercodigo_']; 
       ...
       $this->dprcantidad_ = $this->form_vert_form_detalle_presupuesto[$sc_seq_vert]['dprcantidad_']; 
       ...
       $this->dprprecio_ = $this->form_vert_form_detalle_presupuesto[$sc_seq_vert]['dprprecio_']; 
       ...
       $this->dprporcendesc_ = $this->form_vert_form_detalle_presupuesto[$sc_seq_vert]['dprporcendesc_']; 
       ...
       $this->dprtotal_ = $this->form_vert_form_detalle_presupuesto[$sc_seq_vert]['dprtotal_']; 
       ...
       $this->dprabonado_ = $this->form_vert_form_detalle_presupuesto[$sc_seq_vert]['dprabonado_']; 
       ...
       $this->dprsaldo_ = $this->form_vert_form_detalle_presupuesto[$sc_seq_vert]['dprsaldo_']; 
       ...
       $this->dproriginal_ = $this->form_vert_form_detalle_presupuesto[$sc_seq_vert]['dproriginal_']; 
       ...
       $this->dprsecuen_ = $this->form_vert_form_detalle_presupuesto[$sc_seq_vert]['dprsecuen_']; 
       $dprsecuen_ = $this->dprsecuen_; 
       if (!isset($this->nmgp_cmp_hidden['dprsecuen_']))
       {
           $this->nmgp_cmp_hidden['dprsecuen_'] = 'off';
       }
       $sStyleHidden_dprsecuen_ = '';
       if (isset($sCheckRead_dprsecuen_))
       {
           unset($sCheckRead_dprsecuen_);
       }
       if (isset($this->nmgp_cmp_readonly['dprsecuen_']))
       {
           $sCheckRead_dprsecuen_ = $this->nmgp_cmp_readonly['dprsecuen_'];
       }
       if (isset($this->nmgp_cmp_hidden['dprsecuen_']) && $this->nmgp_cmp_hidden['dprsecuen_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['dprsecuen_']);
           $sStyleHidden_dprsecuen_ = 'display: none;';
       }
       $bTestReadOnly_dprsecuen_ = true;
       $sStyleReadLab_dprsecuen_ = 'display: none;';
       $sStyleReadInp_dprsecuen_ = '';
       if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["dprsecuen_"]) &&  $this->nmgp_cmp_readonly["dprsecuen_"] == "on"))
       {
           $bTestReadOnly_dprsecuen_ = false;
           unset($this->nmgp_cmp_readonly['dprsecuen_']);
           $sStyleReadLab_dprsecuen_ = '';
           $sStyleReadInp_dprsecuen_ = 'display: none;';
       }
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_detalle_presupuesto_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_detalle_presupuesto_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_detalle_presupuesto_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_detalle_presupuesto_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_detalle_presupuesto_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_detalle_presupuesto_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['Lookup_dproriginal_'][] = '1'; ?>
 <option  value="0" <?php  if ($this->dproriginal_ == "0") { echo " selected" ;} ?>>NO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['Lookup_dproriginal_'][] = '0'; ?>
 </select></span>
</span><?php  }?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['dprsecuen_']) && $this->nmgp_cmp_hidden['dprsecuen_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="dprsecuen_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($dprsecuen_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>

    <TD class="scFormDataOddMult css_dprsecuen__line" id="hidden_field_data_dprsecuen_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_dprsecuen_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_dprsecuen__line" style="vertical-align: top;padding: 0px"><span id="id_read_on_dprsecuen_<?php echo $sc_seq_vert ?>" class="css_dprsecuen__line" style="<?php echo $sStyleReadLab_dprsecuen_; ?>"><?php echo $this->form_format_readonly("dprsecuen_", $this->form_encode_input($this->dprsecuen_)); ?></span><span id="id_read_off_dprsecuen_<?php echo $sc_seq_vert ?>" class="css_read_off_dprsecuen_" style="<?php echo $sStyleReadInp_dprsecuen_; ?>"><input type="hidden" id="id_sc_field_dprsecuen_<?php echo $sc_seq_vert ?>" name="dprsecuen_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($dprsecuen_) . "\">"?>
<span id="id_ajax_label_dprsecuen_<?php echo $sc_seq_vert; ?>"><?php echo nl2br($dprsecuen_); ?></span>
</span></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_dprsecuen_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_dprsecuen_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
<?php }?>
...
<?php   
       ...
       if (isset($sCheckRead_dprsecuen_))
       {
           $this->nmgp_cmp_readonly['dprsecuen_'] = $sCheckRead_dprsecuen_;
       }
       if ('display: none;' == $sStyleHidden_dprsecuen_)
       {
           $this->nmgp_cmp_hidden['dprsecuen_'] = 'off';
       }
   ...
   { 
       ...
       $this->form_vert_form_detalle_presupuesto = $guarda_form_vert_form_detalle_presupuesto;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_detalle_presupuesto");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_detalle_presupuesto");
 parent.scAjaxDetailHeight("form_detalle_presupuesto", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_detalle_presupuesto_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_presupuesto']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
