<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="emiruc" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['emiruc']); ?>">
<input type="hidden" name="cobnumero" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['cobnumero']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_cobros"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_ANULAR()
{
    ...
    if (Crtl_btn_ANULAR) {return;}
    scJs_confirm("<?php echo html_entity_decode('¿Está seguro(a) que desea continuar?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_ANULAR_ok, sc_btn_ANULAR_cancel)
}
...
{
    Crtl_btn_ANULAR = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?ANULAR?@?";
    document.F1.action = "./";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros']['where_detal']))
  {
?>  
