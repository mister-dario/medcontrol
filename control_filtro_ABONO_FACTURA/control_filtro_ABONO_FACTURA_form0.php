...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("control_filtro_ABONO_FACTURA_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_filtro_ABONO_FACTURA_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-num_doc_fac", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_control_filtro_ABONO_FACTURA_event_num_doc_fac_onchange) { do_ajax_control_filtro_ABONO_FACTURA_event_num_doc_fac_onchange(sRow); }
    }
   }
   ...
   source: function (request, response) {
    $.ajax({
     url: "control_filtro_ABONO_FACTURA.php",
     dataType: "json",
     data: {
      term: request.term,
   ...
   change: function (event, ui) {
    var sId = $(this).attr("id").substr(6), sRow = 'num_doc_fac' != sId ? sId.substr(11) : '';
    if ("" == $(this).val()) {
     do_ajax_control_filtro_ABONO_FACTURA_event_num_doc_fac_onchange(sRow);
    }
   },
  ...
  $(".sc-ui-autocomp-num_doc_ot", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    $("#id_sc_field_" + sId).val("");
    if (hasChanged) {
     if ('function' == typeof do_ajax_control_filtro_ABONO_FACTURA_event_num_doc_ot_onchange) { do_ajax_control_filtro_ABONO_FACTURA_event_num_doc_ot_onchange(sRow); }
    }
   }
   scEventControl_data[sId]["autocomp"] = false;
  }).on("keydown", function(e) {
   ...
   change: function (event, ui) {
    var sId = $(this).attr("id").substr(6), sRow = 'num_doc_ot' != sId ? sId.substr(10) : '';
    if ("" == $(this).val()) {
     do_ajax_control_filtro_ABONO_FACTURA_event_num_doc_ot_onchange(sRow);
    }
   },
   focus: function (event, ui) {
    var sId = $(this).attr("id").substr(6), sRow = 'num_doc_ot' != sId ? sId.substr(10) : '';
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    $vertical_center = '';
...
<?php
 include_once("control_filtro_ABONO_FACTURA_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_filtro_ABONO_FACTURA'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_filtro_ABONO_FACTURA'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emisor_label" id="hidden_field_label_emisor" style="<?php echo $sStyleHidden_emisor; ?>"><span id="id_label_emisor"><?php echo $this->nm_new_label['emisor']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['php_cmp_required']['emisor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['php_cmp_required']['emisor'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_emisor_line" id="hidden_field_data_emisor" style="<?php echo $sStyleHidden_emisor; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_doc_label" id="hidden_field_label_tipo_doc" style="<?php echo $sStyleHidden_tipo_doc; ?>"><span id="id_label_tipo_doc"><?php echo $this->nm_new_label['tipo_doc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['php_cmp_required']['tipo_doc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['php_cmp_required']['tipo_doc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tipo_doc_line" id="hidden_field_data_tipo_doc" style="<?php echo $sStyleHidden_tipo_doc; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['Lookup_tipo_doc'][] = ''; ?>
 <option value="">------------------------</option>
 <option  value="F" <?php  if ($this->tipo_doc == "F") { echo " selected" ;} ?>>FACTURA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['Lookup_tipo_doc'][] = 'F'; ?>
 <option  value="O" <?php  if ($this->tipo_doc == "O") { echo " selected" ;} ?>>ORDEN DE TRABAJO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['Lookup_tipo_doc'][] = 'O'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_num_doc_fac_label" id="hidden_field_label_num_doc_fac" style="<?php echo $sStyleHidden_num_doc_fac; ?>"><span id="id_label_num_doc_fac"><?php echo $this->nm_new_label['num_doc_fac']; ?></span></TD>
    <TD class="scFormDataOdd css_num_doc_fac_line" id="hidden_field_data_num_doc_fac" style="<?php echo $sStyleHidden_num_doc_fac; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_num_doc_ot_label" id="hidden_field_label_num_doc_ot" style="<?php echo $sStyleHidden_num_doc_ot; ?>"><span id="id_label_num_doc_ot"><?php echo $this->nm_new_label['num_doc_ot']; ?></span></TD>
    <TD class="scFormDataOdd css_num_doc_ot_line" id="hidden_field_data_num_doc_ot" style="<?php echo $sStyleHidden_num_doc_ot; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_secuencial_line" id="hidden_field_data_secuencial" style="<?php echo $sStyleHidden_secuencial; ?>">
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("control_filtro_ABONO_FACTURA");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("control_filtro_ABONO_FACTURA");
 parent.scAjaxDetailHeight("control_filtro_ABONO_FACTURA", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
