  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_filtro_ABONO_FACTURA_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_filtro_ABONO_FACTURA_mob_form();
	}
  ...
  // ---------- Validate emisor
  function do_ajax_control_filtro_ABONO_FACTURA_mob_validate_emisor()
  {
    var nomeCampo_emisor = "emisor";
    var var_emisor = scAjaxGetFieldSelect(nomeCampo_emisor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_filtro_ABONO_FACTURA_mob_validate_emisor(var_emisor, var_script_case_init, do_ajax_control_filtro_ABONO_FACTURA_mob_validate_emisor_cb);
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_validate_emisor

  function do_ajax_control_filtro_ABONO_FACTURA_mob_validate_emisor_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_validate_emisor_cb

  // ---------- Validate tipo_doc
  function do_ajax_control_filtro_ABONO_FACTURA_mob_validate_tipo_doc()
  {
    var nomeCampo_tipo_doc = "tipo_doc";
    var var_tipo_doc = scAjaxGetFieldSelect(nomeCampo_tipo_doc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_filtro_ABONO_FACTURA_mob_validate_tipo_doc(var_tipo_doc, var_script_case_init, do_ajax_control_filtro_ABONO_FACTURA_mob_validate_tipo_doc_cb);
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_validate_tipo_doc

  function do_ajax_control_filtro_ABONO_FACTURA_mob_validate_tipo_doc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_validate_tipo_doc_cb

  // ---------- Validate num_doc_fac
  function do_ajax_control_filtro_ABONO_FACTURA_mob_validate_num_doc_fac()
  {
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_validate_num_doc_fac

  function do_ajax_control_filtro_ABONO_FACTURA_mob_validate_num_doc_fac_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_validate_num_doc_fac_cb

  // ---------- Validate num_doc_ot
  function do_ajax_control_filtro_ABONO_FACTURA_mob_validate_num_doc_ot()
  {
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_validate_num_doc_ot

  function do_ajax_control_filtro_ABONO_FACTURA_mob_validate_num_doc_ot_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_validate_num_doc_ot_cb

  // ---------- Validate secuencial
  function do_ajax_control_filtro_ABONO_FACTURA_mob_validate_secuencial()
  {
    var nomeCampo_secuencial = "secuencial";
    var var_secuencial = scAjaxGetFieldText(nomeCampo_secuencial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_filtro_ABONO_FACTURA_mob_validate_secuencial(var_secuencial, var_script_case_init, do_ajax_control_filtro_ABONO_FACTURA_mob_validate_secuencial_cb);
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_validate_secuencial

  function do_ajax_control_filtro_ABONO_FACTURA_mob_validate_secuencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_validate_secuencial_cb

  // ---------- Event onchange emisor
  function do_ajax_control_filtro_ABONO_FACTURA_mob_event_emisor_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_control_filtro_ABONO_FACTURA_mob_event_emisor_onchange(var_tipo_doc, var_emisor, var_num_doc_ot, var_num_doc_fac, var_script_case_init, do_ajax_control_filtro_ABONO_FACTURA_mob_event_emisor_onchange_cb);
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_event_emisor_onchange

  function do_ajax_control_filtro_ABONO_FACTURA_mob_event_emisor_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "emisor";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_filtro_ABONO_FACTURA_mob_event_emisor_onchange_cb_after_alert);
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_event_emisor_onchange_cb
  function do_ajax_control_filtro_ABONO_FACTURA_mob_event_emisor_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_event_emisor_onchange_cb_after_alert

  // ---------- Event onchange num_doc_fac
  function do_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_fac_onchange()
  {
    var var_secuencial = scAjaxGetFieldText("secuencial");
    var var_num_doc_fac = scAjaxGetFieldText("num_doc_fac");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_fac_onchange(var_secuencial, var_num_doc_fac, var_script_case_init, do_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_fac_onchange_cb);
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_fac_onchange

  function do_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_fac_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "num_doc_fac";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_fac_onchange_cb_after_alert);
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_fac_onchange_cb
  function do_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_fac_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_fac_onchange_cb_after_alert

  // ---------- Event onchange num_doc_ot
  function do_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_ot_onchange()
  {
    var var_secuencial = scAjaxGetFieldText("secuencial");
    var var_num_doc_ot = scAjaxGetFieldText("num_doc_ot");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_ot_onchange(var_secuencial, var_num_doc_ot, var_script_case_init, do_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_ot_onchange_cb);
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_ot_onchange

  function do_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_ot_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "num_doc_ot";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_ot_onchange_cb_after_alert);
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_ot_onchange_cb
  function do_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_ot_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_event_num_doc_ot_onchange_cb_after_alert

  // ---------- Event onchange tipo_doc
  function do_ajax_control_filtro_ABONO_FACTURA_mob_event_tipo_doc_onchange()
  {
    var var_tipo_doc = scAjaxGetFieldSelect("tipo_doc");
    var var_emisor = scAjaxGetFieldSelect("emisor");
    var var_num_doc_ot = scAjaxGetFieldText("num_doc_ot");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_filtro_ABONO_FACTURA_mob_event_tipo_doc_onchange(var_tipo_doc, var_emisor, var_num_doc_ot, var_num_doc_fac, var_secuencial, var_script_case_init, do_ajax_control_filtro_ABONO_FACTURA_mob_event_tipo_doc_onchange_cb);
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_event_tipo_doc_onchange

  function do_ajax_control_filtro_ABONO_FACTURA_mob_event_tipo_doc_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tipo_doc";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_filtro_ABONO_FACTURA_mob_event_tipo_doc_onchange_cb_after_alert);
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_event_tipo_doc_onchange_cb
  function do_ajax_control_filtro_ABONO_FACTURA_mob_event_tipo_doc_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_event_tipo_doc_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_control_filtro_ABONO_FACTURA_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_filtro_ABONO_FACTURA_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_emisor = scAjaxGetFieldSelect("emisor");
    ...
    scAjaxProcOn();
    x_ajax_control_filtro_ABONO_FACTURA_mob_submit_form(var_emisor, var_tipo_doc, var_num_doc_fac, var_num_doc_ot, var_secuencial, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_filtro_ABONO_FACTURA_mob_submit_form_cb);
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_submit_form

  function do_ajax_control_filtro_ABONO_FACTURA_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_filtro_ABONO_FACTURA_mob_submit_form_cb_after_alert);
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_submit_form_cb
  function do_ajax_control_filtro_ABONO_FACTURA_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_filtro_ABONO_FACTURA_mob_navigate_form()
  {
    perform_ajax_control_filtro_ABONO_FACTURA_mob_navigate_form();
  }

  function perform_ajax_control_filtro_ABONO_FACTURA_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_ABONO_FACTURA_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_filtro_ABONO_FACTURA_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_filtro_ABONO_FACTURA_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_navigate_form_cb
  function do_ajax_control_filtro_ABONO_FACTURA_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_filtro_ABONO_FACTURA_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_filtro_ABONO_FACTURA_mob_navigate_form_cb_after_alert
  function sc_hide_control_filtro_ABONO_FACTURA_mob_form()
  {
