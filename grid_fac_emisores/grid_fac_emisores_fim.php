...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_fac_emisores"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_fac_emisores"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_fac_emisores'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_fac_emisores']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_fac_emisores']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_fac_emisores']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_fac_emisores']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_fac_emisores']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_fac_emisores']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_fac_emisores']['embutida_filho'] as $ind => $sc_init)
          {
