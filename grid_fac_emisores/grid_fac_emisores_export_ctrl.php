<?php
@session_start() ;
$_SESSION['scriptcase']['grid_fac_emisores']['sc_process_barr'] = true;
require_once('../grid_fac_emisores/index.php');
unset($_SESSION['scriptcase']['grid_fac_emisores']['sc_process_barr']);
$ExportCtrl = new grid_fac_emisores_export_control;
$ExportCtrl->Export_barr();

class grid_fac_emisores_export_control
{
