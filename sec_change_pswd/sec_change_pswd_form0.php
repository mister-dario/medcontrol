...
<span id="id_read_on_old_pswd" class="sc-ui-readonly-old_pswd css_old_pswd_line" style="<?php echo $sStyleReadLab_old_pswd; ?>"><?php echo $this->form_format_readonly("old_pswd", $this->form_encode_input($this->old_pswd)); ?></span><span id="id_read_off_old_pswd" class="css_read_off_old_pswd" style="white-space: nowrap;<?php echo $sStyleReadInp_old_pswd; ?>"><input class="sc-js-input scFormObjectOdd css_old_pswd_obj" style="" id="id_sc_field_old_pswd" type="password" autocomplete="off" name="old_pswd" value="" 
 size=20 maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['pswd'] = "Contraseña nueva";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<span id="id_read_on_pswd" class="sc-ui-readonly-pswd css_pswd_line" style="<?php echo $sStyleReadLab_pswd; ?>"><?php echo $this->form_format_readonly("pswd", $this->form_encode_input($this->pswd)); ?></span><span id="id_read_off_pswd" class="css_read_off_pswd" style="white-space: nowrap;<?php echo $sStyleReadInp_pswd; ?>"><input class="sc-js-input scFormObjectOdd css_pswd_obj" style="" id="id_sc_field_pswd" type="password" autocomplete="off" name="pswd" value="" 
 size=20 maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '<?php echo $this->allowedCharsCharset("abcdefghijklmnopqrstuvwxyz0123456789.") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</TD>
   <?php }?>
