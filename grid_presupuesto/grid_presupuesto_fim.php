...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_presupuesto"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_presupuesto"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_presupuesto'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_presupuesto']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_presupuesto']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_presupuesto']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_presupuesto']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_presupuesto']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_presupuesto']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_presupuesto']['embutida_filho'] as $ind => $sc_init)
          {
