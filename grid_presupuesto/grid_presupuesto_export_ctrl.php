<?php
@session_start() ;
$_SESSION['scriptcase']['grid_presupuesto']['sc_process_barr'] = true;
require_once('../grid_presupuesto/index.php');
unset($_SESSION['scriptcase']['grid_presupuesto']['sc_process_barr']);
$ExportCtrl = new grid_presupuesto_export_control;
$ExportCtrl->Export_barr();

class grid_presupuesto_export_control
{
