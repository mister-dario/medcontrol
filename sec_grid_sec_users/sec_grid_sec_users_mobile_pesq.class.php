...
class sec_grid_sec_users_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . sec_grid_sec_users_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . sec_grid_sec_users_pack_protect_string($Tipo_filter[0]) . "\">.." . sec_grid_sec_users_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "tipo";$Nm_numeric[] = "tipo";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>sec_grid_sec_users/sec_grid_sec_users_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="sec_grid_sec_users_ajax_search.js"></script>
 <script type="text/javascript" src="sec_grid_sec_users_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="sec_grid_sec_users_message.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $login = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['login']; 
          $login_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['login_cond']; 
          $name = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['name']; 
          $name_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['name_cond']; 
          $email = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['email']; 
          $email_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['email_cond']; 
          $active = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['active']; 
          $active_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['active_cond']; 
          $priv_admin = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['priv_admin']; 
          $priv_admin_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['priv_admin_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['NM_operador']; 
      } 
...
?>
<?php
   if (is_file("sec_grid_sec_users_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['sec_grid_sec_users']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['sec_grid_sec_users']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "CIMEDFAC/sec_grid_sec_users";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['login'] = $login; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['login_cond'] = $login_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['name'] = $name; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['name_cond'] = $name_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['email'] = $email; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['email_cond'] = $email_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['active'] = $active; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['active_cond'] = $active_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['priv_admin'] = $priv_admin; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['priv_admin_cond'] = $priv_admin_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cond_pesq'] .= $this->NM_operador;
