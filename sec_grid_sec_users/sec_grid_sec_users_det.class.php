...
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['where_dinamico']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['where_dinamico'] != $this->nm_where_dinamico) {
    $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['where_dinamico'] = $this->nm_where_dinamico;
    unset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['inicio']);
}
...
$_SESSION['scriptcase']['sec_grid_sec_users']['contr_erro'] = 'off'; 
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['seq_dir'] = 0; 
    $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['sub_dir'] = array(); 
   ...
   { 
       $nmgp_select = "SELECT login, name, email, active, priv_admin, TIPO from " . $this->Ini->nm_tabela; 
   } 
   ...
   $parms_det = explode("*PDet*", $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['chave_det']) ; 
   ...
   $this->Lookup->lookup_tipo($this->tipo); 
   $this->Lookup->lookup_priv_admin($this->priv_admin); 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cmp_acum']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cmp_acum']))
   {
       $parms_acum = explode(";", $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['cmp_acum']);
...
//--- 
   ...
   if (($this->Ini->sc_export_ajax || $this->Ini->Export_det_zip) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['det_print'] == "print")
   {
       ...
       $NM_css_cmp  = $this->Ini->path_link . "sec_grid_sec_users/sec_grid_sec_users_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css";
   ...
   elseif (($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['det_print'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
   {
       ...
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "sec_grid_sec_users/sec_grid_sec_users_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
   }
   else
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['pdf_det'] && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['det_print'] != "print")
   {
   ...
   $nm_saida->saida("</HEAD>\r\n");
   if (!$this->Ini->Export_html_zip && !$this->Ini->Export_det_zip && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['det_print'] == "print")
   {
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
   ...
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   $SC_Label = (isset($this->New_label['tipo'])) ? $this->New_label['tipo'] : "Perfil"; 
   $conteudo = trim(NM_encode_input(sc_strip_script($this->tipo))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
   ...
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_tipo_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("</TABLE>\r\n");
   if(isset($_SESSION['scriptcase']['proc_mobile']) && $_SESSION['scriptcase']['proc_mobile'])
...
//--- 
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       NovaJanela = window.open (\"sec_grid_sec_users_doc.php?nmgp_parms=\" + campo1, \"ScriptCase\", \"resizable\");\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   $nm_saida->saida("           window.location = \"" . $this->Ini->path_link . "sec_grid_sec_users/index.php?nmgp_opcao=pdf_det&nmgp_tipo_pdf=\" + z + \"&nmgp_parms_pdf=\" + p +  \"&nmgp_graf_pdf=\" + g + \"&Det_use_pass_pdf=\" + use_pass_pdf + \"&Det_pdf_zip=\" + pdf_zip + \"&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "\";\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   {
      global $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['det_print'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['pdf_det']) 
   { 
       $nm_saida->saida("   <tr><td class=\"scGridTabelaTd\">\r\n");
       ...
       {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Dpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "sec_grid_sec_users/sec_grid_sec_users_config_pdf.php?nm_opc=pdf_det&nm_target=0&nm_cor=cor&papel=1&orientacao=1&largura=800&conf_larg=N&conf_fonte=10&language=es&conf_socor=S&sc_ver_93=" . n . "&password=n&pdf_zip=N&KeepThis=false&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
       if ($this->nmgp_botoes['det_print'] == "on")
       {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Dprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "sec_grid_sec_users/sec_grid_sec_users_config_print.php?nm_opc=detalhe&nm_cor=PB&password=n&language=es&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
