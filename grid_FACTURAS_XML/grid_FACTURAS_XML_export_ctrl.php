<?php
@session_start() ;
$_SESSION['scriptcase']['grid_FACTURAS_XML']['sc_process_barr'] = true;
require_once('../grid_FACTURAS_XML/index.php');
unset($_SESSION['scriptcase']['grid_FACTURAS_XML']['sc_process_barr']);
$ExportCtrl = new grid_FACTURAS_XML_export_control;
$ExportCtrl->Export_barr();

class grid_FACTURAS_XML_export_control
{
