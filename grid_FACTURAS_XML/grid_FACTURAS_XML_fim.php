...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_FACTURAS_XML"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_FACTURAS_XML"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_XML']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_XML']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_XML']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_XML']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_XML']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_XML']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_FACTURAS_XML']['embutida_filho'] as $ind => $sc_init)
          {
