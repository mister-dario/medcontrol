<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cobros']['sc_process_barr'] = true;
require_once('../grid_cobros/index.php');
unset($_SESSION['scriptcase']['grid_cobros']['sc_process_barr']);
$ExportCtrl = new grid_cobros_export_control;
$ExportCtrl->Export_barr();

class grid_cobros_export_control
{
