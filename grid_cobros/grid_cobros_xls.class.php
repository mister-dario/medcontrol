...
class grid_cobros_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Arquivo   .= "_grid_cobros" . $this->Xls_tp;
      ...
      require_once($this->Ini->path_aplicacao . "grid_cobros_total.class.php"); 
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_cobros']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros']['embutida'])
      { 
   ...
   function NM_export_emiruc()
   {
         ...
         $this->look_emiruc = html_entity_decode($this->look_emiruc, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_emiruc = strip_tags($this->look_emiruc);
         $this->look_emiruc = NM_charset_to_utf8($this->look_emiruc);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_emiruc, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_emiruc, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- cobnumero
   ...
   function NM_export_cobfecha()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->cobfecha = substr($this->cobfecha, 0, 10);
         if (empty($this->cobfecha) || $this->cobfecha == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->cobfecha, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->cobfecha, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->cobfecha);
   ...
   function NM_export_cobvaltotal()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->cobvaltotal = NM_charset_to_utf8($this->cobvaltotal);
         if (is_numeric($this->cobvaltotal))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->cobvaltotal);
         $this->Xls_col++;
   }
   //----- cobanula
   function NM_export_cobanula()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_cobanula, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_cobanula, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- cobvalefec
   function NM_export_cobvalefec()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->cobvalefec = NM_charset_to_utf8($this->cobvalefec);
         if (is_numeric($this->cobvalefec))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->cobvalefec);
         $this->Xls_col++;
   }
   //----- cobvalcheq
   function NM_export_cobvalcheq()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->cobvalcheq = NM_charset_to_utf8($this->cobvalcheq);
         if (is_numeric($this->cobvalcheq))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->cobvalcheq);
         $this->Xls_col++;
   }
   //----- emiruc
   function NM_sub_cons_emiruc()
   {
         ...
         $this->look_emiruc = strip_tags($this->look_emiruc);
         $this->look_emiruc = NM_charset_to_utf8($this->look_emiruc);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_emiruc;
   ...
   //----- cobfecha
   function NM_sub_cons_cobfecha()
   {
         $this->cobfecha = substr($this->cobfecha, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cobfecha;
   ...
   //----- cobvaltotal
   function NM_sub_cons_cobvaltotal()
   {
         $this->cobvaltotal = NM_charset_to_utf8($this->cobvaltotal);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cobvaltotal;
   ...
   //----- cobanula
   function NM_sub_cons_cobanula()
   {
         $this->look_cobanula = NM_charset_to_utf8($this->look_cobanula);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_cobanula;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- cobvalefec
   function NM_sub_cons_cobvalefec()
   {
         $this->cobvalefec = NM_charset_to_utf8($this->cobvalefec);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cobvalefec;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- cobvalcheq
   function NM_sub_cons_cobvalcheq()
   {
         $this->cobvalcheq = NM_charset_to_utf8($this->cobvalcheq);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cobvalcheq;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cobros']['nolabel'])
       {
