...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_cobros"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CIMEDFAC_____grid_cobros"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cobros']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cobros']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cobros']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cobros']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cobros']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cobros']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cobros']['embutida_filho'] as $ind => $sc_init)
          {
