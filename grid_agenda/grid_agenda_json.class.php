...
$_SESSION['scriptcase']['grid_agenda']['contr_erro'] = 'off'; 
   ...
   function NM_export_ageactivo()
   {
         ...
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->look_ageactivo;
   }
   //----- medcodigo
   ...
   function NM_export_agenombre()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->agenombre;
   }
   //----- color
   ...
   function NM_export_agesecuen()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->agesecuen;
   }
   //----- ageintervalo
   function NM_export_ageintervalo()
   {
         ...
         {
             $SC_Label = "ageintervalo"; 
         }
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->ageintervalo;
   }
   //----- agelunactivo
   function NM_export_agelunactivo()
   {
         ...
         {
             $SC_Label = "agelunactivo"; 
         }
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->agelunactivo;
   }
