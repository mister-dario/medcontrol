<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_agenda']['glo_nm_perfil']          = "conn_mysql";
...
// 
      ...
      $this->Cmp_Sql_Time     = array('agelunini','agelunfin','agemarini','agemarfin','agemieini','agemiefin','agejueini','agejuefin','agevieini','ageviefin','agesabini','agesabfin','agedomini','agedomfin');
    ...
    if (!$_SESSION['sc_session'][$this->sc_page]['grid_agenda']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda']['dyn_search_aut_comp']['cmp'] = $_GET['field'];
          $_SESSION['sc_session'][$this->sc_page]['grid_agenda']['opcao'] = $_GET['origem'];
...
<?php
      ...
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/form_agenda_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/form_agenda_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/form_agenda_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/form_agenda_ini.txt");
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_agenda']['glo_nm_conexao'], $this->root . $this->path_prod, 'CIMEDFAC', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['proc_pdf']      = false;
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "ageactivo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "medcodigo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "agenombre";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "color";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "agesecuen";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "ageintervalo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['field_order'][] = "agelunactivo";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['usr_cmp_sel']['agesecuen'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['usr_cmp_sel']['ageintervalo'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['usr_cmp_sel']['agelunactivo'] = "off";
...
//----------------------------------->
      ...
      { 
          ...
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['dashboard_refresh_after_chart'])) {
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['embutida'])
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['ajax_nav'])
         {
             ...
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_proc_dyn_search($Parms)
   {
       ...
       $ix     = 0;
       $fields = array();
       $Cmps_check_return = array('ageactivo');
       ...
       foreach ($tmp as $cada_f)
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['dyn_search'][] = array('cmp' => $dats[0], 'opc' => $dats[1], 'val' => $val_sv);
           $ix++;
       }
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['tmp_busca'] as $ind => $dados)
      {
       ...
       foreach ($fields as $ind => $dados)
       {
           ...
           if ($dados['field'] == "agenombre" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['dyn_search_label']['agenombre'];
               ...
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "agenombre", 'A', 'VARCHAR', $Label_cmp);
           }
           if ($dados['field'] == "medcodigo" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['dyn_search_label']['medcodigo'];
               $dados['vls'][0] = $dados['vls'][0][0];
               if ($dados['cond'] == "BW")
               {
                   $dados['vls'][1] = $dados['vls'][1][0];
           ...
           if ($dados['field'] == "ageactivo" && !empty($dados['vls']))
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['dyn_search_label']['ageactivo'];
               $dados['vls'][0] = $dados['vls'][0][0];
               if ($dados['cond'] == "BW")
               {
                   $dados['vls'][1] = $dados['vls'][1][0];
               ...
               $this->SC_proc_dyn_search_all($dados['cond'], $dados['vls'], "ageactivo", 'N', 'TINYINT', $Label_cmp);
           }
       }
       ...
       if (NM_is_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['cond_pesq']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['cond_pesq'] = sc_convert_encoding($_SESSION['sc_session'][$this->Ini->sc_page]['grid_agenda']['cond_pesq'], $_SESSION['scriptcase']['charset'], "UTF-8");
       }
   }
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_agenda']['glo_nm_path_imag_temp'] . "/sc_apl_default_CIMEDFAC.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_agenda']['glo_nm_path_imag_temp'] . "/sc_apl_default_CIMEDFAC.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_CIMEDFAC'])) {
               $_SESSION['scriptcase']['grid_agenda']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_CIMEDFAC'];
           }
       }
   }
   ...
   $_SESSION['sc_session']['grid_agenda']['show_skip_charts_option'] = false;
   ...
   {
       $_SESSION['sc_session'][$script_case_init]['grid_agenda']['orig_pesq'] = $nmgp_orig_pesq;
   }
...
//
   ...
   function nm_protect_num_grid_agenda($name, &$val)
   {
       ...
       $Nm_numeric = array();
       $Nm_numeric[] = "agesecuen";
       $Nm_numeric[] = "medcodigo";
       $Nm_numeric[] = "ageactivo";
       $Nm_numeric[] = "ageintervalo";
       $Nm_numeric[] = "agelunactivo";
       $Nm_numeric[] = "agemaractivo";
       $Nm_numeric[] = "agemieactivo";
       $Nm_numeric[] = "agejueactivo";
       $Nm_numeric[] = "agevieactivo";
       $Nm_numeric[] = "agesabactivo";
       $Nm_numeric[] = "agedomactivo";
