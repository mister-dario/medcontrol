<?php
   ...
   if(!$bol_sel_campos_include)
   {
     ...
     if (!isset($_SESSION['sc_session']))
     {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_agenda']['glo_nm_path_imag_temp'] . "/sc_apl_default_CIMEDFAC.txt"))
       {
?>
...
function Sel_cmp_process()
{
   ...
   function Sel_cmp_init_fields()
   {
      ...
      $tab_blk_campos = array();
            ...
            $tab_ger_campos['ageactivo'] = "on";
      $tab_ger_campos['medcodigo'] = "on";
      $tab_ger_campos['agenombre'] = "on";
      $tab_ger_campos['color'] = "on";
      $tab_blk_campos[] = "color";
      $tab_ger_campos['agesecuen'] = "on";
      $tab_ger_campos['ageintervalo'] = "on";
      $tab_ger_campos['agelunactivo'] = "on";
