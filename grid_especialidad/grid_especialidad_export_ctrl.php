<?php
@session_start() ;
$_SESSION['scriptcase']['grid_especialidad']['sc_process_barr'] = true;
require_once('../grid_especialidad/index.php');
unset($_SESSION['scriptcase']['grid_especialidad']['sc_process_barr']);
$ExportCtrl = new grid_especialidad_export_control;
$ExportCtrl->Export_barr();

class grid_especialidad_export_control
{
