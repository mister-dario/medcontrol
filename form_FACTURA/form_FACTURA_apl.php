...
//----- 
   function ini_controle()
   {
      ...
      { 
          ...
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_FACTURA']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['total']);
          }
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_FACTURA']['parms']))
      {
          ...
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_FACTURA']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_FACTURA']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_FACTURA']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_FACTURA']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_FACTURA'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_FACTURA']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_FACTURA']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_FACTURA') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_FACTURA']['label'] = "form_FACTURA";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['table_refresh'] = false;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['first_time'])
      {
          ...
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA']['dynsearch']);
      ...
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          if ('N' == $this->NM_btn_navega)
          {
              ...
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA']['dynsearch'] = 'off';
          ...
          else
          {
              ...
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA']['dynsearch'] = 'on';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['buttonStatus'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA']['dynsearch'];
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_FACTURA'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_FACTURA'];
      ...
      {
          $this->nmgp_botoes['redo_xml'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['botoes']['redo_xml'];
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_DETALLE_FACTURA') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_DETALLE_FACTURA') . "/form_DETALLE_FACTURA_apl.php");
          $this->form_DETALLE_FACTURA = new form_DETALLE_FACTURA_apl;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_FACTURA.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_FACTURA_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_FACTURA"> 
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->estab) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dados_form']['estab']))
          {
              $varloc_btn_php['estab'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dados_form']['estab'];
          }
          if (!isset($this->ptoemi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dados_form']['ptoemi']))
          {
              $varloc_btn_php['ptoemi'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dados_form']['ptoemi'];
          }
          if (!isset($this->secuencial) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dados_form']['secuencial']))
          {
              $varloc_btn_php['secuencial'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dados_form']['secuencial'];
          }
          if (!isset($this->lote) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dados_form']['lote']))
          {
              $varloc_btn_php['lote'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dados_form']['lote'];
          }
          if (!isset($this->valoradicional4) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dados_form']['valoradicional4']))
          {
              $varloc_btn_php['valoradicional4'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dados_form']['valoradicional4'];
          }
          if (!isset($this->estab) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dados_form']['estab']))
          {
              $varloc_btn_php['estab'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dados_form']['estab'];
          ...
          if (!isset($this->num_cita) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dados_form']['num_cita']))
          {
              $varloc_btn_php['num_cita'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dados_form']['num_cita'];
          }
      }
      $nm_f_saida = "./";
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_FACTURA']) || !is_array($this->NM_ajax_info['errList']['geral_form_FACTURA']))
              {
                  $this->NM_ajax_info['errList']['geral_form_FACTURA'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_FACTURA'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_fechaemision(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['fechaemision']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['fechaemision'] == "on")) 
      { 
    ...
    function ValidateField_idcomprador(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['idcomprador']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['idcomprador'] == "on")) 
      { 
          if ($this->idcomprador == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_razonsocialcomprador(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['razonsocialcomprador']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['razonsocialcomprador'] == "on")) 
      { 
    ...
    function ValidateField_num_cita(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->num_cita, 11, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "No. CITA; " ; 
                  if (!isset($Campos_Erros['num_cita']))
    ...
    function ValidateField_totalsinimpuestos(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['totalsinimpuestos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['totalsinimpuestos'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_totaldescuento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['totaldescuento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['totaldescuento'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_base_12(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['base_12']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['base_12'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_base_0(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['base_0']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['base_0'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "BASE 0%" ; 
              if (!isset($Campos_Erros['base_0']))
    ...
    function ValidateField_importetotal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['importetotal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['importetotal'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_campoadicional1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional1'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional1'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional2'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional2'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional3(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional3'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional3(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional3'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional4(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional4'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional4(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional4'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional5(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional5']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional5'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional5(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional5']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional5'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional6(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional6']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional6'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional6(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional6']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional6'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional7(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional7']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional7'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional7(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional7']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional7'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional8(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional8']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional8'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional8(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional8']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional8'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional9(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional9']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional9'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional9(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional9']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional9'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional10(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional10']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional10'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional10(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional10']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional10'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional11(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional11']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional11'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional11(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional11']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional11'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional12(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional12']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional12'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional12(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional12']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional12'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional13(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional13']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional13'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional13(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional13']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional13'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional14(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional14']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional14'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional14(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional14']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional14'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional15(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional15']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional15'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional15(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional15']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional15'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional16(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional16']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional16'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional16(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional16']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional16'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional17(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional17']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional17'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional17(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional17']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional17'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional18(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional18']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional18'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional18(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional18']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional18'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional19(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional19']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional19'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional19(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional19']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional19'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional20(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional20']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['campoadicional20'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional20(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional20']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['php_cmp_required']['valoradicional20'] == "on")) 
      { 
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['estab']['keyVal'] = form_FACTURA_pack_protect_string($this->nmgp_dados_form['estab']);
              $this->NM_ajax_info['fldList']['ptoemi']['keyVal'] = form_FACTURA_pack_protect_string($this->nmgp_dados_form['ptoemi']);
              $this->NM_ajax_info['fldList']['secuencial']['keyVal'] = form_FACTURA_pack_protect_string($this->nmgp_dados_form['secuencial']);
              $this->NM_ajax_info['fldList']['lote']['keyVal'] = form_FACTURA_pack_protect_string($this->nmgp_dados_form['lote']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['foreign_key']['estab'] = $this->nmgp_dados_form['estab'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['foreign_key']['ptoemi'] = $this->nmgp_dados_form['ptoemi'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['foreign_key']['secuencial'] = $this->nmgp_dados_form['secuencial'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['foreign_key']['lote'] = $this->nmgp_dados_form['lote'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['where_filter'] = "ESTAB = " . $this->nmgp_dados_form['estab'] . " AND PTOEMI = " . $this->nmgp_dados_form['ptoemi'] . " AND SECUENCIAL = " . $this->nmgp_dados_form['secuencial'] . " AND LOTE = '" . $this->nmgp_dados_form['lote'] . "'";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['where_detal']  = "ESTAB = " . $this->nmgp_dados_form['estab'] . " AND PTOEMI = " . $this->nmgp_dados_form['ptoemi'] . " AND SECUENCIAL = " . $this->nmgp_dados_form['secuencial'] . " AND LOTE = '" . $this->nmgp_dados_form['lote'] . "'";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['total']);
          }
   ...
   function ajax_return_values_detalle_factura($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['opcao'] = '';
   ...
   { 
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_DETALLE_FACTURA->ini_controle();
              if ($this->form_DETALLE_FACTURA->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['parms'] = "estab?#?$this->estab?@?ptoemi?#?$this->ptoemi?@?secuencial?#?$this->secuencial?@?lote?#?$this->lote?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['where_filter'])
      {
...
//---------- 
      ...
      { 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['redo_xml'] = $this->nmgp_botoes['redo_xml'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['empty_filter'] = true;
                  return; 
              }
...
//-- 
      ...
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_parms'] = "NM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout";
  }
...
<?php
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_FACTURA_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_FACTURA_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_DETALLE_FACTURA']['reg_start'] = "";
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['retorno_edit'] = "";
   }
