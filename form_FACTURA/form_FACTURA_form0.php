...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['embutida_pdf']))
 {
 ?>
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['insert_validation']; ?>">
<?php
}
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php $sStyleHidden_num_cita_dumb = ('' == $sStyleHidden_num_cita) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_num_cita_dumb" style="<?php echo $sStyleHidden_num_cita_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
<?php
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_factura'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_factura'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_factura'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init'] ]['form_FACTURA']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_FACTURA_empty.htm' : $this->Ini->link_form_DETALLE_FACTURA_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_detalle_factura']) && 'nmsc_iframe_liga_form_DETALLE_FACTURA' != $this->Ini->sc_lig_target['C_@scinf_detalle_factura'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detalle_factura'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['form_DETALLE_FACTURA_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_FACTURA");
</script>
<?php
    }
    else {
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
