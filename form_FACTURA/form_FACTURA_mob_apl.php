...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['num_cita']))
          {
              $this->num_cita = $this->NM_ajax_info['param']['num_cita'];
          }
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_FACTURA_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->v_aplicacion_link)) 
          {
              $_SESSION['v_aplicacion_link'] = $this->v_aplicacion_link;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_FACTURA_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_FACTURA_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_FACTURA_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_FACTURA_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_FACTURA_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_FACTURA_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_FACTURA_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_FACTURA_mob']['label'] = "form_FACTURA_mob";
      ...
      $this->arr_buttons['redo_xml']['hint']             = "Utilizar esta opción si se modificó algún dato del cliente.";
      $this->arr_buttons['redo_xml']['type']             = "button";
      $this->arr_buttons['redo_xml']['value']            = "REHACER XML Y ENVIAR A SRI";
      ...
      $_SESSION['scriptcase']['error_icon']['form_FACTURA_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_FACTURA_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_FACTURA_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_FACTURA_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form'];
          ...
          if (!isset($this->guiaremision)){$this->guiaremision = $this->nmgp_dados_form['guiaremision'];} 
          ...
          if (!isset($this->numpagos)){$this->numpagos = $this->nmgp_dados_form['numpagos'];} 
          if (!isset($this->formapago1)){$this->formapago1 = $this->nmgp_dados_form['formapago1'];} 
          if (!isset($this->valortot1)){$this->valortot1 = $this->nmgp_dados_form['valortot1'];} 
          if (!isset($this->plazo1)){$this->plazo1 = $this->nmgp_dados_form['plazo1'];} 
          if (!isset($this->unidadtiempo1)){$this->unidadtiempo1 = $this->nmgp_dados_form['unidadtiempo1'];} 
          if (!isset($this->formapago2)){$this->formapago2 = $this->nmgp_dados_form['formapago2'];} 
          if (!isset($this->valortot2)){$this->valortot2 = $this->nmgp_dados_form['valortot2'];} 
          if (!isset($this->plazo2)){$this->plazo2 = $this->nmgp_dados_form['plazo2'];} 
          if (!isset($this->unidadtiempo2)){$this->unidadtiempo2 = $this->nmgp_dados_form['unidadtiempo2'];} 
          if (!isset($this->ambiente)){$this->ambiente = $this->nmgp_dados_form['ambiente'];} 
          if (!isset($this->facvalefec)){$this->facvalefec = $this->nmgp_dados_form['facvalefec'];} 
          if (!isset($this->facvalcheq)){$this->facvalcheq = $this->nmgp_dados_form['facvalcheq'];} 
          if (!isset($this->facvaltarjcred)){$this->facvaltarjcred = $this->nmgp_dados_form['facvaltarjcred'];} 
          if (!isset($this->facvaltransf)){$this->facvaltransf = $this->nmgp_dados_form['facvaltransf'];} 
          if (!isset($this->facvalretfte)){$this->facvalretfte = $this->nmgp_dados_form['facvalretfte'];} 
          if (!isset($this->facnumcheq)){$this->facnumcheq = $this->nmgp_dados_form['facnumcheq'];} 
          if (!isset($this->facbancheq)){$this->facbancheq = $this->nmgp_dados_form['facbancheq'];} 
          if (!isset($this->tcrcodigo)){$this->tcrcodigo = $this->nmgp_dados_form['tcrcodigo'];} 
          if (!isset($this->facnumtarjcred)){$this->facnumtarjcred = $this->nmgp_dados_form['facnumtarjcred'];} 
          if (!isset($this->facbantransf)){$this->facbantransf = $this->nmgp_dados_form['facbantransf'];} 
          if (!isset($this->facctatransf)){$this->facctatransf = $this->nmgp_dados_form['facctatransf'];} 
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_FACTURA_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_FACTURA_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_FACTURA_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_FACTURA/form_FACTURA_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_FACTURA_mob_erro.class.php"); 
      }
      $this->Erro      = new form_FACTURA_mob_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opcao']))
         { 
             if ($this->estab != "" || $this->ptoemi != "" || $this->secuencial != "" || $this->lote != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['redo_xml'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['botoes']['redo_xml'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['total']);
      ...
      if (isset($this->num_cita)) { $this->nm_limpa_alfa($this->num_cita); }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- num_cita
      $this->field_config['num_cita']               = array();
      $this->field_config['num_cita']['symbol_grp'] = '';
      $this->field_config['num_cita']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['num_cita']['symbol_dec'] = '';
      $this->field_config['num_cita']['symbol_neg'] = '-';
      $this->field_config['num_cita']['format_neg'] = '2';
      //-- totalsinimpuestos
      ...
      //-- numpagos
      $this->field_config['numpagos']               = array();
      $this->field_config['numpagos']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['numpagos']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['numpagos']['symbol_dec'] = '';
      $this->field_config['numpagos']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['numpagos']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- formapago1
      $this->field_config['formapago1']               = array();
      $this->field_config['formapago1']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['formapago1']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['formapago1']['symbol_dec'] = '';
      $this->field_config['formapago1']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['formapago1']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- valortot1
      $this->field_config['valortot1']               = array();
      $this->field_config['valortot1']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['valortot1']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['valortot1']['symbol_dec'] = '';
      $this->field_config['valortot1']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['valortot1']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- plazo1
      $this->field_config['plazo1']               = array();
      $this->field_config['plazo1']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['plazo1']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['plazo1']['symbol_dec'] = '';
      $this->field_config['plazo1']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['plazo1']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- formapago2
      $this->field_config['formapago2']               = array();
      $this->field_config['formapago2']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['formapago2']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['formapago2']['symbol_dec'] = '';
      $this->field_config['formapago2']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['formapago2']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- valortot2
      $this->field_config['valortot2']               = array();
      $this->field_config['valortot2']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['valortot2']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['valortot2']['symbol_dec'] = '';
      $this->field_config['valortot2']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['valortot2']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- plazo2
      $this->field_config['plazo2']               = array();
      $this->field_config['plazo2']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['plazo2']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['plazo2']['symbol_dec'] = '';
      $this->field_config['plazo2']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['plazo2']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- ambiente
      $this->field_config['ambiente']               = array();
      $this->field_config['ambiente']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['ambiente']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['ambiente']['symbol_dec'] = '';
      $this->field_config['ambiente']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['ambiente']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- facvalefec
      $this->field_config['facvalefec']               = array();
      $this->field_config['facvalefec']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['facvalefec']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['facvalefec']['symbol_dec'] = '';
      $this->field_config['facvalefec']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['facvalefec']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- facvalcheq
      $this->field_config['facvalcheq']               = array();
      $this->field_config['facvalcheq']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['facvalcheq']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['facvalcheq']['symbol_dec'] = '';
      $this->field_config['facvalcheq']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['facvalcheq']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- facvaltarjcred
      $this->field_config['facvaltarjcred']               = array();
      $this->field_config['facvaltarjcred']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['facvaltarjcred']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['facvaltarjcred']['symbol_dec'] = '';
      $this->field_config['facvaltarjcred']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['facvaltarjcred']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- facvaltransf
      $this->field_config['facvaltransf']               = array();
      $this->field_config['facvaltransf']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['facvaltransf']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['facvaltransf']['symbol_dec'] = '';
      $this->field_config['facvaltransf']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['facvaltransf']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- facvalretfte
      $this->field_config['facvalretfte']               = array();
      $this->field_config['facvalretfte']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['facvalretfte']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['facvalretfte']['symbol_dec'] = '';
      $this->field_config['facvalretfte']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['facvalretfte']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- tcrcodigo
      $this->field_config['tcrcodigo']               = array();
      $this->field_config['tcrcodigo']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['tcrcodigo']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['tcrcodigo']['symbol_dec'] = '';
      $this->field_config['tcrcodigo']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['tcrcodigo']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_num_cita' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'num_cita');
          }
          ...
          form_FACTURA_mob_pack_ajax_response();
          exit;
      }
      if (isset($this->sc_inline_call) && 'Y' == $this->sc_inline_call)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['form_FACTURA_mob']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_FACTURA_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_FACTURA_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_FACTURA_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_FACTURA_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->estab) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form']['estab']))
          {
              $varloc_btn_php['estab'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form']['estab'];
          }
          if (!isset($this->ptoemi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form']['ptoemi']))
          {
              $varloc_btn_php['ptoemi'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form']['ptoemi'];
          }
          if (!isset($this->secuencial) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form']['secuencial']))
          {
              $varloc_btn_php['secuencial'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form']['secuencial'];
          }
          if (!isset($this->lote) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form']['lote']))
          {
              $varloc_btn_php['lote'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form']['lote'];
          }
          if (!isset($this->valoradicional4) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form']['valoradicional4']))
          {
              $varloc_btn_php['valoradicional4'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form']['valoradicional4'];
          }
          if (!isset($this->estab) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form']['estab']))
          {
              $varloc_btn_php['estab'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form']['estab'];
          ...
          if (!isset($this->num_cita) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form']['num_cita']))
          {
              $varloc_btn_php['num_cita'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form']['num_cita'];
          }
      }
      $nm_f_saida = "form_FACTURA_mob.php";
      nm_limpa_numero($this->num_cita, $this->field_config['num_cita']['symbol_grp']) ; 
      ...
      $_SESSION['scriptcase']['form_FACTURA_mob']['contr_erro'] = 'on';
...
$sql="update FACTURA_FLAGS set XML=0, FIRMADO=0, CONTENIDO='', CONTENIDO_FIRMADO='' where ESTAB=".$this->estab ." AND PTOEMI=".$this->ptoemi ." AND SECUENCIAL=".$this->secuencial ." AND LOTE='".$this->lote ."'";
...
$sql3="SELECT fcldireccion, fclciudad, fcltelefono, fclcelular, fclemail, fclapellidos, fclnombres, fclcedula, fclfacigual, fclfacnombre, fclfacruc, fclfacdir, fclfactelf, fclfacmail  FROM ficha_cliente WHERE fclnumero=".$this->valoradicional4 ;
...
$update="UPDATE FACTURA SET CAMPOADICIONAL2='".$campoad2."', VALORADICIONAL2='".$direccion."', CAMPOADICIONAL3='".$campoad3."', VALORADICIONAL3='".$telefonos."', VALORADICIONAL1='".$mail_fac."', RAZONSOCIALCOMPRADOR='".$nombre_fac."', IDCOMPRADOR='".$ruc_fac."', TIPOIDENTCOMPRADOR=".$tipoidcli.", VALORADICIONAL5='".$nombre_paciente."' WHERE ESTAB=".$this->estab ." AND PTOEMI=".$this->ptoemi ." AND SECUENCIAL=".$this->secuencial ." AND LOTE='".$this->lote ."'";
...
if ($this->Ini->sc_tem_trans_banco)
{
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('blank_crea_xml_fac') . "/", $this->nm_location, "v_estab?#?" . NM_encode_input($this->estab ) . "?@?" . "v_ptoemi?#?" . NM_encode_input($this->ptoemi ) . "?@?" . "v_numfactura?#?" . NM_encode_input($this->secuencial ) . "?@?" . "v_feclote?#?" . NM_encode_input($this->lote ) . "?@?" . "v_numcita?#?" . NM_encode_input($this->num_cita ) . "?@?" . "v_app_calling?#?" . NM_encode_input('form_FACTURA') . "?@?","_self", '', 440, 630);
 };
$_SESSION['scriptcase']['form_FACTURA_mob']['contr_erro'] = 'off'; 
    echo ob_get_clean();
?>
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_FACTURA_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_FACTURA_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_FACTURA_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_FACTURA_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ('' == $filtro || 'num_cita' == $filtro)
        $this->ValidateField_num_cita($Campos_Crit, $Campos_Falta, $Campos_Erros);
    ...
    function ValidateField_fechaemision(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['fechaemision']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['fechaemision'] == "on")) 
      { 
    ...
    function ValidateField_idcomprador(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['idcomprador']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['idcomprador'] == "on")) 
      { 
          if ($this->idcomprador == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_razonsocialcomprador(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['razonsocialcomprador']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['razonsocialcomprador'] == "on")) 
      { 
    ...
    function ValidateField_num_cita(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->num_cita === "" || is_null($this->num_cita))  
      { 
          $this->num_cita = 0;
          $this->sc_force_zero[] = 'num_cita';
      } 
      nm_limpa_numero($this->num_cita, $this->field_config['num_cita']['symbol_grp']) ; 
      if ($this->nmgp_opcao == "incluir")
      { 
          ...
          { 
              $iTestSize = 11;
              if (strlen($this->num_cita) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "No. CITA: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['num_cita']))
                  {
                      $Campos_Erros['num_cita'] = array();
                  }
                  $Campos_Erros['num_cita'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['num_cita']) || !is_array($this->NM_ajax_info['errList']['num_cita']))
                  {
                      $this->NM_ajax_info['errList']['num_cita'] = array();
                  }
                  $this->NM_ajax_info['errList']['num_cita'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->num_cita, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "No. CITA; " ; 
                  if (!isset($Campos_Erros['num_cita']))
                  ...
                  $Campos_Erros['num_cita'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['num_cita']) || !is_array($this->NM_ajax_info['errList']['num_cita']))
                  {
                      $this->NM_ajax_info['errList']['num_cita'] = array();
                  }
                  $this->NM_ajax_info['errList']['num_cita'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
    ...
    function ValidateField_totalsinimpuestos(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['totalsinimpuestos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['totalsinimpuestos'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_totaldescuento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['totaldescuento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['totaldescuento'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_base_12(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['base_12']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['base_12'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_base_0(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['base_0']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['base_0'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "BASE 0%" ; 
              if (!isset($Campos_Erros['base_0']))
    ...
    function ValidateField_importetotal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['importetotal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['importetotal'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_campoadicional1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional1'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional1'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional2'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional2'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional3(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional3'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional3(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional3'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional4(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional4'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional4(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional4'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional5(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional5']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional5'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional5(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional5']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional5'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional6(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional6']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional6'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional6(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional6']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional6'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional7(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional7']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional7'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional7(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional7']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional7'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional8(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional8']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional8'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional8(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional8']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional8'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional9(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional9']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional9'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional9(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional9']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional9'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional10(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional10']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional10'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional10(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional10']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional10'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional11(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional11']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional11'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional11(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional11']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional11'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional12(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional12']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional12'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional12(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional12']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional12'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional13(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional13']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional13'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional13(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional13']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional13'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional14(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional14']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional14'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional14(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional14']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional14'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional15(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional15']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional15'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional15(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional15']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional15'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional16(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional16']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional16'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional16(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional16']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional16'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional17(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional17']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional17'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional17(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional17']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional17'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional18(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional18']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional18'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional18(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional18']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional18'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional19(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional19']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional19'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional19(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional19']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional19'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional20(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional20']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['campoadicional20'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional20(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional20']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['php_cmp_required']['valoradicional20'] == "on")) 
      { 
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['num_cita'] = $this->num_cita;
    ...
    $this->nmgp_dados_form['numpagos'] = $this->numpagos;
    $this->nmgp_dados_form['formapago1'] = $this->formapago1;
    $this->nmgp_dados_form['valortot1'] = $this->valortot1;
    $this->nmgp_dados_form['plazo1'] = $this->plazo1;
    $this->nmgp_dados_form['unidadtiempo1'] = $this->unidadtiempo1;
    $this->nmgp_dados_form['formapago2'] = $this->formapago2;
    $this->nmgp_dados_form['valortot2'] = $this->valortot2;
    $this->nmgp_dados_form['plazo2'] = $this->plazo2;
    $this->nmgp_dados_form['unidadtiempo2'] = $this->unidadtiempo2;
    $this->nmgp_dados_form['ambiente'] = $this->ambiente;
    $this->nmgp_dados_form['facvalefec'] = $this->facvalefec;
    $this->nmgp_dados_form['facvalcheq'] = $this->facvalcheq;
    $this->nmgp_dados_form['facvaltarjcred'] = $this->facvaltarjcred;
    $this->nmgp_dados_form['facvaltransf'] = $this->facvaltransf;
    $this->nmgp_dados_form['facvalretfte'] = $this->facvalretfte;
    $this->nmgp_dados_form['facnumcheq'] = $this->facnumcheq;
    $this->nmgp_dados_form['facbancheq'] = $this->facbancheq;
    $this->nmgp_dados_form['tcrcodigo'] = $this->tcrcodigo;
    $this->nmgp_dados_form['facnumtarjcred'] = $this->facnumtarjcred;
    $this->nmgp_dados_form['facbantransf'] = $this->facbantransf;
    $this->nmgp_dados_form['facctatransf'] = $this->facctatransf;
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['num_cita'] = $this->num_cita;
      nm_limpa_numero($this->num_cita, $this->field_config['num_cita']['symbol_grp']) ; 
      ...
      $this->Before_unformat['numpagos'] = $this->numpagos;
      nm_limpa_numero($this->numpagos, $this->field_config['numpagos']['symbol_grp']) ; 
      $this->Before_unformat['formapago1'] = $this->formapago1;
      nm_limpa_numero($this->formapago1, $this->field_config['formapago1']['symbol_grp']) ; 
      $this->Before_unformat['valortot1'] = $this->valortot1;
      nm_limpa_numero($this->valortot1, $this->field_config['valortot1']['symbol_grp']) ; 
      $this->Before_unformat['plazo1'] = $this->plazo1;
      nm_limpa_numero($this->plazo1, $this->field_config['plazo1']['symbol_grp']) ; 
      $this->Before_unformat['formapago2'] = $this->formapago2;
      nm_limpa_numero($this->formapago2, $this->field_config['formapago2']['symbol_grp']) ; 
      $this->Before_unformat['valortot2'] = $this->valortot2;
      nm_limpa_numero($this->valortot2, $this->field_config['valortot2']['symbol_grp']) ; 
      $this->Before_unformat['plazo2'] = $this->plazo2;
      nm_limpa_numero($this->plazo2, $this->field_config['plazo2']['symbol_grp']) ; 
      $this->Before_unformat['ambiente'] = $this->ambiente;
      nm_limpa_numero($this->ambiente, $this->field_config['ambiente']['symbol_grp']) ; 
      $this->Before_unformat['facvalefec'] = $this->facvalefec;
      nm_limpa_numero($this->facvalefec, $this->field_config['facvalefec']['symbol_grp']) ; 
      $this->Before_unformat['facvalcheq'] = $this->facvalcheq;
      nm_limpa_numero($this->facvalcheq, $this->field_config['facvalcheq']['symbol_grp']) ; 
      $this->Before_unformat['facvaltarjcred'] = $this->facvaltarjcred;
      nm_limpa_numero($this->facvaltarjcred, $this->field_config['facvaltarjcred']['symbol_grp']) ; 
      $this->Before_unformat['facvaltransf'] = $this->facvaltransf;
      nm_limpa_numero($this->facvaltransf, $this->field_config['facvaltransf']['symbol_grp']) ; 
      $this->Before_unformat['facvalretfte'] = $this->facvalretfte;
      nm_limpa_numero($this->facvalretfte, $this->field_config['facvalretfte']['symbol_grp']) ; 
      $this->Before_unformat['tcrcodigo'] = $this->tcrcodigo;
      nm_limpa_numero($this->tcrcodigo, $this->field_config['tcrcodigo']['symbol_grp']) ; 
   }
   ...
   function nm_clear_val($Nome_Campo)
   {
      ...
      if ($Nome_Campo == "numpagos")
      {
          nm_limpa_numero($this->numpagos, $this->field_config['numpagos']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "formapago1")
      {
          nm_limpa_numero($this->formapago1, $this->field_config['formapago1']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "valortot1")
      {
          nm_limpa_numero($this->valortot1, $this->field_config['valortot1']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "plazo1")
      {
          nm_limpa_numero($this->plazo1, $this->field_config['plazo1']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "formapago2")
      {
          nm_limpa_numero($this->formapago2, $this->field_config['formapago2']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "valortot2")
      {
          nm_limpa_numero($this->valortot2, $this->field_config['valortot2']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "plazo2")
      {
          nm_limpa_numero($this->plazo2, $this->field_config['plazo2']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "ambiente")
      {
          nm_limpa_numero($this->ambiente, $this->field_config['ambiente']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "facvalefec")
      {
          nm_limpa_numero($this->facvalefec, $this->field_config['facvalefec']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "facvalcheq")
      {
          nm_limpa_numero($this->facvalcheq, $this->field_config['facvalcheq']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "facvaltarjcred")
      {
          nm_limpa_numero($this->facvaltarjcred, $this->field_config['facvaltarjcred']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "facvaltransf")
      {
          nm_limpa_numero($this->facvaltransf, $this->field_config['facvaltransf']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "facvalretfte")
      {
          nm_limpa_numero($this->facvalretfte, $this->field_config['facvalretfte']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "tcrcodigo")
      {
          nm_limpa_numero($this->tcrcodigo, $this->field_config['tcrcodigo']['symbol_grp']) ; 
      }
   }
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      if ('' !== $this->num_cita || (!empty($format_fields) && isset($format_fields['num_cita'])))
      {
          nmgp_Form_Num_Val($this->num_cita, $this->field_config['num_cita']['symbol_grp'], $this->field_config['num_cita']['symbol_dec'], "0", "S", $this->field_config['num_cita']['format_neg'], "", "", "-", $this->field_config['num_cita']['symbol_fmt']) ; 
      }
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_num_cita();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['estab']['keyVal'] = form_FACTURA_mob_pack_protect_string($this->nmgp_dados_form['estab']);
              $this->NM_ajax_info['fldList']['ptoemi']['keyVal'] = form_FACTURA_mob_pack_protect_string($this->nmgp_dados_form['ptoemi']);
              $this->NM_ajax_info['fldList']['secuencial']['keyVal'] = form_FACTURA_mob_pack_protect_string($this->nmgp_dados_form['secuencial']);
              $this->NM_ajax_info['fldList']['lote']['keyVal'] = form_FACTURA_mob_pack_protect_string($this->nmgp_dados_form['lote']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['foreign_key']['estab'] = $this->nmgp_dados_form['estab'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['foreign_key']['ptoemi'] = $this->nmgp_dados_form['ptoemi'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['foreign_key']['secuencial'] = $this->nmgp_dados_form['secuencial'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['foreign_key']['lote'] = $this->nmgp_dados_form['lote'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['where_filter'] = "ESTAB = " . $this->nmgp_dados_form['estab'] . " AND PTOEMI = " . $this->nmgp_dados_form['ptoemi'] . " AND SECUENCIAL = " . $this->nmgp_dados_form['secuencial'] . " AND LOTE = '" . $this->nmgp_dados_form['lote'] . "'";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['where_detal']  = "ESTAB = " . $this->nmgp_dados_form['estab'] . " AND PTOEMI = " . $this->nmgp_dados_form['ptoemi'] . " AND SECUENCIAL = " . $this->nmgp_dados_form['secuencial'] . " AND LOTE = '" . $this->nmgp_dados_form['lote'] . "'";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['total']);
              }
          }
   ...
   function ajax_return_values_razonsocialcomprador($bForce = false)
   {
          ...
          //----- num_cita
   function ajax_return_values_num_cita($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("num_cita", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->num_cita);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['num_cita'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
               'labList' => array($this->form_format_readonly("num_cita", $this->form_encode_input($sTmpValue))),
              );
          }
   }
   ...
   function ajax_return_values_lote($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opcao'] = '';
   ...
   { 
      ...
      $NM_val_form['num_cita'] = $this->num_cita;
      ...
      $NM_val_form['numpagos'] = $this->numpagos;
      $NM_val_form['formapago1'] = $this->formapago1;
      $NM_val_form['valortot1'] = $this->valortot1;
      $NM_val_form['plazo1'] = $this->plazo1;
      $NM_val_form['unidadtiempo1'] = $this->unidadtiempo1;
      $NM_val_form['formapago2'] = $this->formapago2;
      $NM_val_form['valortot2'] = $this->valortot2;
      $NM_val_form['plazo2'] = $this->plazo2;
      $NM_val_form['unidadtiempo2'] = $this->unidadtiempo2;
      $NM_val_form['ambiente'] = $this->ambiente;
      $NM_val_form['facvalefec'] = $this->facvalefec;
      $NM_val_form['facvalcheq'] = $this->facvalcheq;
      $NM_val_form['facvaltarjcred'] = $this->facvaltarjcred;
      $NM_val_form['facvaltransf'] = $this->facvaltransf;
      $NM_val_form['facvalretfte'] = $this->facvalretfte;
      $NM_val_form['facnumcheq'] = $this->facnumcheq;
      $NM_val_form['facbancheq'] = $this->facbancheq;
      $NM_val_form['tcrcodigo'] = $this->tcrcodigo;
      $NM_val_form['facnumtarjcred'] = $this->facnumtarjcred;
      $NM_val_form['facbantransf'] = $this->facbantransf;
      $NM_val_form['facctatransf'] = $this->facctatransf;
      ...
      if ($this->numpagos === "" || is_null($this->numpagos))  
      { 
          $this->numpagos = 0;
          $this->sc_force_zero[] = 'numpagos';
      } 
      if ($this->formapago1 === "" || is_null($this->formapago1))  
      { 
          $this->formapago1 = 0;
          $this->sc_force_zero[] = 'formapago1';
      } 
      if ($this->valortot1 === "" || is_null($this->valortot1))  
      { 
          $this->valortot1 = 0;
          $this->sc_force_zero[] = 'valortot1';
      } 
      if ($this->plazo1 === "" || is_null($this->plazo1))  
      { 
          $this->plazo1 = 0;
          $this->sc_force_zero[] = 'plazo1';
      } 
      if ($this->formapago2 === "" || is_null($this->formapago2))  
      { 
          $this->formapago2 = 0;
          $this->sc_force_zero[] = 'formapago2';
      } 
      if ($this->valortot2 === "" || is_null($this->valortot2))  
      { 
          $this->valortot2 = 0;
          $this->sc_force_zero[] = 'valortot2';
      } 
      if ($this->plazo2 === "" || is_null($this->plazo2))  
      { 
          $this->plazo2 = 0;
          $this->sc_force_zero[] = 'plazo2';
      } 
      if ($this->ambiente === "" || is_null($this->ambiente))  
      { 
          $this->ambiente = 0;
          $this->sc_force_zero[] = 'ambiente';
      } 
      if ($this->facvalefec === "" || is_null($this->facvalefec))  
      { 
          $this->facvalefec = 0;
          $this->sc_force_zero[] = 'facvalefec';
      } 
      if ($this->facvalcheq === "" || is_null($this->facvalcheq))  
      { 
          $this->facvalcheq = 0;
          $this->sc_force_zero[] = 'facvalcheq';
      } 
      if ($this->facvaltarjcred === "" || is_null($this->facvaltarjcred))  
      { 
          $this->facvaltarjcred = 0;
          $this->sc_force_zero[] = 'facvaltarjcred';
      } 
      if ($this->facvaltransf === "" || is_null($this->facvaltransf))  
      { 
          $this->facvaltransf = 0;
          $this->sc_force_zero[] = 'facvaltransf';
      } 
      if ($this->facvalretfte === "" || is_null($this->facvalretfte))  
      { 
          $this->facvalretfte = 0;
          $this->sc_force_zero[] = 'facvalretfte';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          $this->unidadtiempo1_before_qstr = $this->unidadtiempo1;
          $this->unidadtiempo1 = substr($this->Db->qstr($this->unidadtiempo1), 1, -1); 
          if ($this->unidadtiempo1 == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->unidadtiempo1 = "null"; 
              $NM_val_null[] = "unidadtiempo1";
          } 
          $this->unidadtiempo2_before_qstr = $this->unidadtiempo2;
          $this->unidadtiempo2 = substr($this->Db->qstr($this->unidadtiempo2), 1, -1); 
          if ($this->unidadtiempo2 == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->unidadtiempo2 = "null"; 
              $NM_val_null[] = "unidadtiempo2";
          } 
          $this->facnumcheq_before_qstr = $this->facnumcheq;
          $this->facnumcheq = substr($this->Db->qstr($this->facnumcheq), 1, -1); 
          if ($this->facnumcheq == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->facnumcheq = "null"; 
              $NM_val_null[] = "facnumcheq";
          } 
          $this->facbancheq_before_qstr = $this->facbancheq;
          $this->facbancheq = substr($this->Db->qstr($this->facbancheq), 1, -1); 
          if ($this->facbancheq == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->facbancheq = "null"; 
              $NM_val_null[] = "facbancheq";
          } 
          $this->facnumtarjcred_before_qstr = $this->facnumtarjcred;
          $this->facnumtarjcred = substr($this->Db->qstr($this->facnumtarjcred), 1, -1); 
          if ($this->facnumtarjcred == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->facnumtarjcred = "null"; 
              $NM_val_null[] = "facnumtarjcred";
          } 
          $this->facbantransf_before_qstr = $this->facbantransf;
          $this->facbantransf = substr($this->Db->qstr($this->facbantransf), 1, -1); 
          if ($this->facbantransf == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->facbantransf = "null"; 
              $NM_val_null[] = "facbantransf";
          } 
          $this->facctatransf_before_qstr = $this->facctatransf;
          $this->facctatransf = substr($this->Db->qstr($this->facctatransf), 1, -1); 
          if ($this->facctatransf == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->facctatransf = "null"; 
              $NM_val_null[] = "facctatransf";
          } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              if (isset($NM_val_form['numpagos']) && $NM_val_form['numpagos'] != $this->nmgp_dados_select['numpagos']) 
              { 
                  $SC_fields_update[] = "NUMPAGOS = $this->numpagos"; 
              } 
              if (isset($NM_val_form['formapago1']) && $NM_val_form['formapago1'] != $this->nmgp_dados_select['formapago1']) 
              { 
                  $SC_fields_update[] = "FORMAPAGO1 = $this->formapago1"; 
              } 
              if (isset($NM_val_form['valortot1']) && $NM_val_form['valortot1'] != $this->nmgp_dados_select['valortot1']) 
              { 
                  $SC_fields_update[] = "VALORTOT1 = $this->valortot1"; 
              } 
              if (isset($NM_val_form['plazo1']) && $NM_val_form['plazo1'] != $this->nmgp_dados_select['plazo1']) 
              { 
                  $SC_fields_update[] = "PLAZO1 = $this->plazo1"; 
              } 
              if (isset($NM_val_form['unidadtiempo1']) && $NM_val_form['unidadtiempo1'] != $this->nmgp_dados_select['unidadtiempo1']) 
              { 
                  $SC_fields_update[] = "UNIDADTIEMPO1 = '$this->unidadtiempo1'"; 
              } 
              if (isset($NM_val_form['formapago2']) && $NM_val_form['formapago2'] != $this->nmgp_dados_select['formapago2']) 
              { 
                  $SC_fields_update[] = "FORMAPAGO2 = $this->formapago2"; 
              } 
              if (isset($NM_val_form['valortot2']) && $NM_val_form['valortot2'] != $this->nmgp_dados_select['valortot2']) 
              { 
                  $SC_fields_update[] = "VALORTOT2 = $this->valortot2"; 
              } 
              if (isset($NM_val_form['plazo2']) && $NM_val_form['plazo2'] != $this->nmgp_dados_select['plazo2']) 
              { 
                  $SC_fields_update[] = "PLAZO2 = $this->plazo2"; 
              } 
              if (isset($NM_val_form['unidadtiempo2']) && $NM_val_form['unidadtiempo2'] != $this->nmgp_dados_select['unidadtiempo2']) 
              { 
                  $SC_fields_update[] = "UNIDADTIEMPO2 = '$this->unidadtiempo2'"; 
              } 
              ...
              if (isset($NM_val_form['facvalefec']) && $NM_val_form['facvalefec'] != $this->nmgp_dados_select['facvalefec']) 
              { 
                  $SC_fields_update[] = "facvalefec = $this->facvalefec"; 
              } 
              if (isset($NM_val_form['facvalcheq']) && $NM_val_form['facvalcheq'] != $this->nmgp_dados_select['facvalcheq']) 
              { 
                  $SC_fields_update[] = "facvalcheq = $this->facvalcheq"; 
              } 
              if (isset($NM_val_form['facvaltarjcred']) && $NM_val_form['facvaltarjcred'] != $this->nmgp_dados_select['facvaltarjcred']) 
              { 
                  $SC_fields_update[] = "facvaltarjcred = $this->facvaltarjcred"; 
              } 
              if (isset($NM_val_form['facvaltransf']) && $NM_val_form['facvaltransf'] != $this->nmgp_dados_select['facvaltransf']) 
              { 
                  $SC_fields_update[] = "facvaltransf = $this->facvaltransf"; 
              } 
              if (isset($NM_val_form['facvalretfte']) && $NM_val_form['facvalretfte'] != $this->nmgp_dados_select['facvalretfte']) 
              { 
                  $SC_fields_update[] = "facvalretfte = $this->facvalretfte"; 
              } 
              if (isset($NM_val_form['facnumcheq']) && $NM_val_form['facnumcheq'] != $this->nmgp_dados_select['facnumcheq']) 
              { 
                  $SC_fields_update[] = "facnumcheq = '$this->facnumcheq'"; 
              } 
              if (isset($NM_val_form['facbancheq']) && $NM_val_form['facbancheq'] != $this->nmgp_dados_select['facbancheq']) 
              { 
                  $SC_fields_update[] = "facbancheq = '$this->facbancheq'"; 
              } 
              ...
              if (isset($NM_val_form['facnumtarjcred']) && $NM_val_form['facnumtarjcred'] != $this->nmgp_dados_select['facnumtarjcred']) 
              { 
                  $SC_fields_update[] = "facnumtarjcred = '$this->facnumtarjcred'"; 
              } 
              if (isset($NM_val_form['facbantransf']) && $NM_val_form['facbantransf'] != $this->nmgp_dados_select['facbantransf']) 
              { 
                  $SC_fields_update[] = "facbantransf = '$this->facbantransf'"; 
              } 
              if (isset($NM_val_form['facctatransf']) && $NM_val_form['facctatransf'] != $this->nmgp_dados_select['facctatransf']) 
              { 
                  $SC_fields_update[] = "facctatransf = '$this->facctatransf'"; 
              } 
              if (isset($NM_val_form['num_cita']) && $NM_val_form['num_cita'] != $this->nmgp_dados_select['num_cita']) 
              { 
                  $SC_fields_update[] = "num_cita = $this->num_cita"; 
              } 
              $aDoNotUpdate = array();
              ...
              $this->unidadtiempo1 = $this->unidadtiempo1_before_qstr;
              $this->unidadtiempo2 = $this->unidadtiempo2_before_qstr;
              $this->facnumcheq = $this->facnumcheq_before_qstr;
              $this->facbancheq = $this->facbancheq_before_qstr;
              $this->facnumtarjcred = $this->facnumtarjcred_before_qstr;
              $this->facbantransf = $this->facbantransf_before_qstr;
              $this->facctatransf = $this->facctatransf_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['num_cita'])) { $this->num_cita = $NM_val_form['num_cita']; }
              elseif (isset($this->num_cita)) { $this->nm_limpa_alfa($this->num_cita); }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              { 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "RAZONSOCIAL, NOMBRECOMERCIAL, RUC, CODDOC, ESTAB, PTOEMI, SECUENCIAL, LOTE, DIRMATRIZ, FECHAEMISION, DIRESTABLECIMIENTO, NUMCONTRIBUYENTEESPECIAL, OBLIGADOCONTABILIDAD, TIPOIDENTCOMPRADOR, GUIAREMISION, RAZONSOCIALCOMPRADOR, IDCOMPRADOR, TOTALSINIMPUESTOS, TOTALDESCUENTO, BASE_12, BASE_0, CODIMPUESTO, CODPORCENTAJEIMPUESTO, BASEIMPONIBLE1, TARIFA1, VALOR1, PROPINA, IMPORTETOTAL, FORMATO, CAMPOADICIONAL1, VALORADICIONAL1, CAMPOADICIONAL2, VALORADICIONAL2, CAMPOADICIONAL3, VALORADICIONAL3, CAMPOADICIONAL4, VALORADICIONAL4, CAMPOADICIONAL5, VALORADICIONAL5, CAMPOADICIONAL6, VALORADICIONAL6, CAMPOADICIONAL7, VALORADICIONAL7, CAMPOADICIONAL8, VALORADICIONAL8, CAMPOADICIONAL9, VALORADICIONAL9, CAMPOADICIONAL10, VALORADICIONAL10, CAMPOADICIONAL11, VALORADICIONAL11, CAMPOADICIONAL12, VALORADICIONAL12, CAMPOADICIONAL13, VALORADICIONAL13, CAMPOADICIONAL14, VALORADICIONAL14, CAMPOADICIONAL15, VALORADICIONAL15, CAMPOADICIONAL16, VALORADICIONAL16, CAMPOADICIONAL17, VALORADICIONAL17, CAMPOADICIONAL18, VALORADICIONAL18, CAMPOADICIONAL19, VALORADICIONAL19, CAMPOADICIONAL20, VALORADICIONAL20, NUMPAGOS, FORMAPAGO1, VALORTOT1, PLAZO1, UNIDADTIEMPO1, FORMAPAGO2, VALORTOT2, PLAZO2, UNIDADTIEMPO2, AMBIENTE, facvalefec, facvalcheq, facvaltarjcred, facvaltransf, facvalretfte, facnumcheq, facbancheq, tcrcodigo, facnumtarjcred, facbantransf, facctatransf, num_cita $compl_insert) VALUES (" . $NM_seq_auto . "'$this->razonsocial', '$this->nombrecomercial', '$this->ruc', $this->coddoc, $this->estab, $this->ptoemi, $this->secuencial, '$this->lote', '$this->dirmatriz', '$this->fechaemision', '$this->direstablecimiento', $this->numcontribuyenteespecial, '$this->obligadocontabilidad', $this->tipoidentcomprador, '$this->guiaremision', '$this->razonsocialcomprador', '$this->idcomprador', $this->totalsinimpuestos, $this->totaldescuento, $this->base_12, $this->base_0, $this->codimpuesto, $this->codporcentajeimpuesto, $this->baseimponible1, $this->tarifa1, $this->valor1, $this->propina, $this->importetotal, $this->formato, '$this->campoadicional1', '$this->valoradicional1', '$this->campoadicional2', '$this->valoradicional2', '$this->campoadicional3', '$this->valoradicional3', '$this->campoadicional4', '$this->valoradicional4', '$this->campoadicional5', '$this->valoradicional5', '$this->campoadicional6', '$this->valoradicional6', '$this->campoadicional7', '$this->valoradicional7', '$this->campoadicional8', '$this->valoradicional8', '$this->campoadicional9', '$this->valoradicional9', '$this->campoadicional10', '$this->valoradicional10', '$this->campoadicional11', '$this->valoradicional11', '$this->campoadicional12', '$this->valoradicional12', '$this->campoadicional13', '$this->valoradicional13', '$this->campoadicional14', '$this->valoradicional14', '$this->campoadicional15', '$this->valoradicional15', '$this->campoadicional16', '$this->valoradicional16', '$this->campoadicional17', '$this->valoradicional17', '$this->campoadicional18', '$this->valoradicional18', '$this->campoadicional19', '$this->valoradicional19', '$this->campoadicional20', '$this->valoradicional20', $this->numpagos, $this->formapago1, $this->valortot1, $this->plazo1, '$this->unidadtiempo1', $this->formapago2, $this->valortot2, $this->plazo2, '$this->unidadtiempo2', $this->ambiente, $this->facvalefec, $this->facvalcheq, $this->facvaltarjcred, $this->facvaltransf, $this->facvalretfte, '$this->facnumcheq', '$this->facbancheq', $this->tcrcodigo, '$this->facnumtarjcred', '$this->facbantransf', '$this->facctatransf', $this->num_cita $compl_insert_val)"; 
              }
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['parms'] = "estab?#?$this->estab?@?ptoemi?#?$this->ptoemi?@?secuencial?#?$this->secuencial?@?lote?#?$this->lote?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['redo_xml'] = $this->nmgp_botoes['redo_xml'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              $this->numpagos = $rs->fields[70] ; 
              $this->nmgp_dados_select['numpagos'] = $this->numpagos;
              $this->formapago1 = $rs->fields[71] ; 
              $this->nmgp_dados_select['formapago1'] = $this->formapago1;
              $this->valortot1 = trim($rs->fields[72]) ; 
              $this->nmgp_dados_select['valortot1'] = $this->valortot1;
              $this->plazo1 = $rs->fields[73] ; 
              $this->nmgp_dados_select['plazo1'] = $this->plazo1;
              $this->unidadtiempo1 = $rs->fields[74] ; 
              $this->nmgp_dados_select['unidadtiempo1'] = $this->unidadtiempo1;
              $this->formapago2 = $rs->fields[75] ; 
              $this->nmgp_dados_select['formapago2'] = $this->formapago2;
              $this->valortot2 = trim($rs->fields[76]) ; 
              $this->nmgp_dados_select['valortot2'] = $this->valortot2;
              $this->plazo2 = $rs->fields[77] ; 
              $this->nmgp_dados_select['plazo2'] = $this->plazo2;
              $this->unidadtiempo2 = $rs->fields[78] ; 
              $this->nmgp_dados_select['unidadtiempo2'] = $this->unidadtiempo2;
              $this->ambiente = $rs->fields[79] ; 
              $this->nmgp_dados_select['ambiente'] = $this->ambiente;
              $this->facvalefec = trim($rs->fields[80]) ; 
              $this->nmgp_dados_select['facvalefec'] = $this->facvalefec;
              $this->facvalcheq = trim($rs->fields[81]) ; 
              $this->nmgp_dados_select['facvalcheq'] = $this->facvalcheq;
              $this->facvaltarjcred = trim($rs->fields[82]) ; 
              $this->nmgp_dados_select['facvaltarjcred'] = $this->facvaltarjcred;
              $this->facvaltransf = trim($rs->fields[83]) ; 
              $this->nmgp_dados_select['facvaltransf'] = $this->facvaltransf;
              $this->facvalretfte = trim($rs->fields[84]) ; 
              $this->nmgp_dados_select['facvalretfte'] = $this->facvalretfte;
              $this->facnumcheq = $rs->fields[85] ; 
              $this->nmgp_dados_select['facnumcheq'] = $this->facnumcheq;
              $this->facbancheq = $rs->fields[86] ; 
              $this->nmgp_dados_select['facbancheq'] = $this->facbancheq;
              $this->tcrcodigo = $rs->fields[87] ; 
              $this->nmgp_dados_select['tcrcodigo'] = $this->tcrcodigo;
              $this->facnumtarjcred = $rs->fields[88] ; 
              $this->nmgp_dados_select['facnumtarjcred'] = $this->facnumtarjcred;
              $this->facbantransf = $rs->fields[89] ; 
              $this->nmgp_dados_select['facbantransf'] = $this->facbantransf;
              $this->facctatransf = $rs->fields[90] ; 
              $this->nmgp_dados_select['facctatransf'] = $this->facctatransf;
              $this->num_cita = $rs->fields[91] ; 
              $this->nmgp_dados_select['num_cita'] = $this->num_cita;
              $this->detalle_factura = $rs->fields[92] ; 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $this->numpagos = (string)$this->numpagos; 
              $this->formapago1 = (string)$this->formapago1; 
              $this->valortot1 = (strpos(strtolower($this->valortot1), "e")) ? (float)$this->valortot1 : $this->valortot1; 
              $this->valortot1 = (string)$this->valortot1; 
              $this->plazo1 = (string)$this->plazo1; 
              $this->formapago2 = (string)$this->formapago2; 
              $this->valortot2 = (strpos(strtolower($this->valortot2), "e")) ? (float)$this->valortot2 : $this->valortot2; 
              $this->valortot2 = (string)$this->valortot2; 
              $this->plazo2 = (string)$this->plazo2; 
              $this->ambiente = (string)$this->ambiente; 
              $this->facvalefec = (strpos(strtolower($this->facvalefec), "e")) ? (float)$this->facvalefec : $this->facvalefec; 
              $this->facvalefec = (string)$this->facvalefec; 
              $this->facvalcheq = (strpos(strtolower($this->facvalcheq), "e")) ? (float)$this->facvalcheq : $this->facvalcheq; 
              $this->facvalcheq = (string)$this->facvalcheq; 
              $this->facvaltarjcred = (strpos(strtolower($this->facvaltarjcred), "e")) ? (float)$this->facvaltarjcred : $this->facvaltarjcred; 
              $this->facvaltarjcred = (string)$this->facvaltarjcred; 
              $this->facvaltransf = (strpos(strtolower($this->facvaltransf), "e")) ? (float)$this->facvaltransf : $this->facvaltransf; 
              $this->facvaltransf = (string)$this->facvaltransf; 
              $this->facvalretfte = (strpos(strtolower($this->facvalretfte), "e")) ? (float)$this->facvalretfte : $this->facvalretfte; 
              $this->facvalretfte = (string)$this->facvalretfte; 
              $this->tcrcodigo = (string)$this->tcrcodigo; 
              $this->num_cita = (string)$this->num_cita; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['parms'] = "estab?#?$this->estab?@?ptoemi?#?$this->ptoemi?@?secuencial?#?$this->secuencial?@?lote?#?$this->lote?@?";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['dados_select'] = $this->nmgp_dados_select;
...
//-- 
      ...
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['form_DETALLE_FACTURA_mob_script_case_init'] ]['form_DETALLE_FACTURA_mob']['embutida_parms'] = "NM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout";
  }
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_FACTURA_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_FACTURA_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['total'] = $qt_geral_reg_form_FACTURA_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_FACTURA_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $nm_numeric[] = "coddoc";$nm_numeric[] = "estab";$nm_numeric[] = "ptoemi";$nm_numeric[] = "secuencial";$nm_numeric[] = "numcontribuyenteespecial";$nm_numeric[] = "tipoidentcomprador";$nm_numeric[] = "totalsinimpuestos";$nm_numeric[] = "totaldescuento";$nm_numeric[] = "base_12";$nm_numeric[] = "base_0";$nm_numeric[] = "codimpuesto";$nm_numeric[] = "codporcentajeimpuesto";$nm_numeric[] = "baseimponible1";$nm_numeric[] = "tarifa1";$nm_numeric[] = "valor1";$nm_numeric[] = "propina";$nm_numeric[] = "importetotal";$nm_numeric[] = "formato";$nm_numeric[] = "numpagos";$nm_numeric[] = "formapago1";$nm_numeric[] = "valortot1";$nm_numeric[] = "plazo1";$nm_numeric[] = "formapago2";$nm_numeric[] = "valortot2";$nm_numeric[] = "plazo2";$nm_numeric[] = "ambiente";$nm_numeric[] = "facvalefec";$nm_numeric[] = "facvalcheq";$nm_numeric[] = "facvaltarjcred";$nm_numeric[] = "facvaltransf";$nm_numeric[] = "facvalretfte";$nm_numeric[] = "tcrcodigo";$nm_numeric[] = "num_cita";
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_FACTURA_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_FACTURA_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['masterValue']))
{
...
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_mob']['retorno_edit'] = "";
   }
