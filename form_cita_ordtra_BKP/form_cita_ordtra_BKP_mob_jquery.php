...
function scHidePage(pageNo) {
	$("#id_form_cita_ordtra_BKP_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fech_vence" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_form_cita_ordtra_BKP_mob_validate_fech_vence(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_citfecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_cita_ordtra_BKP_mob_validate_citfecha(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_citfeccrea" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_cita_ordtra_BKP_mob_validate_citfeccrea(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_citfecmodi" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_cita_ordtra_BKP_mob_validate_citfecmodi(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_cita_ordtra_BKP_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
