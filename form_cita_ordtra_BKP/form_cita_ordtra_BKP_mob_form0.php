...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_cita_ordtra_BKP/form_cita_ordtra_BKP_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_cita_ordtra_BKP_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cita_ordtra_BKP_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    $vertical_center = '';
...
if (isset($_SESSION['scriptcase']['form_cita_ordtra_BKP']['error_buffer']) && '' != $_SESSION['scriptcase']['form_cita_ordtra_BKP']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_cita_ordtra_BKP']['error_buffer'];
}
...
<?php
 include_once("form_cita_ordtra_BKP_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_cita_ordtra_BKP_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cita_ordtra_BKP_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cita_ordtra_BKP_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['fast_search'][2] : "";
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['Lookup_procesar_factura'][] = 'F'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['Lookup_tipo_pago'][] = '1'; ?>
<?php  if ("1" == $this->tipo_pago)  { echo " checked" ;} ?><?php  if (empty($this->tipo_pago)) { echo " checked" ;} ?>  onClick="do_ajax_form_cita_ordtra_BKP_mob_event_tipo_pago_onclick();" ><label for="<?php echo $tempOptionId ?>">CONTADO</label></TD>
</TR></TABLE>
</div>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['Lookup_forma_factura'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['Lookup_forma_factura'][] = '2'; ?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_presupuesto'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_presupuesto'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_presupuesto_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_presupuesto'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_presupuesto_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_liga_qtd_reg'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_detalle_presupuesto_mob']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_presupuesto_mob_script_case_init'] ]['form_cita_ordtra_BKP_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_cita_ordtra_BKP_mob_empty.htm' : $this->Ini->link_form_detalle_presupuesto_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_detalle_presupuesto']) && 'nmsc_iframe_liga_form_detalle_presupuesto_mob' != $this->Ini->sc_lig_target['C_@scinf_detalle_presupuesto'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detalle_presupuesto'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_presupuesto_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_servicios'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_servicios'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_citadiagnos_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_servicios'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_citadiagnos_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_detalle_citadiagnos_mob']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_citadiagnos_mob_script_case_init'] ]['form_cita_ordtra_BKP_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_cita_ordtra_BKP_mob_empty.htm' : $this->Ini->link_form_detalle_citadiagnos_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=500';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_servicios']) && 'nmsc_iframe_liga_form_detalle_citadiagnos_mob' != $this->Ini->sc_lig_target['C_@scinf_servicios'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_servicios'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['form_detalle_citadiagnos_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_cita_ordtra_BKP_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_cita_ordtra_BKP_mob");
 parent.scAjaxDetailHeight("form_cita_ordtra_BKP_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cita_ordtra_BKP_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
