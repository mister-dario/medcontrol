...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_hisfeccrea_hora' + iSeqRow).bind('blur', function() { sc_form_historia_hisfeccrea_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_historia_hisfeccrea_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_historia_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_hisfecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_historia_mob_validate_hisfecha(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_hisfeccrea" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_historia_mob_validate_hisfeccrea(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_hisfecmodi" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_historia_mob_validate_hisfecmodi(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_historia_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
