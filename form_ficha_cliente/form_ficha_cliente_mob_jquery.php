...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fclfeccrea_hora' + iSeqRow).bind('blur', function() { sc_form_ficha_cliente_fclfeccrea_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_ficha_cliente_fclfeccrea_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_fclfecmodi_hora' + iSeqRow).bind('blur', function() { sc_form_ficha_cliente_fclfecmodi_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_ficha_cliente_fclfecmodi_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_ficha_cliente_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fclfechareg" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_ficha_cliente_mob_validate_fclfechareg(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fclfechanac" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_ficha_cliente_mob_validate_fclfechanac(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fclfeccrea" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_ficha_cliente_mob_validate_fclfeccrea(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fclfecmodi" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_ficha_cliente_mob_validate_fclfecmodi(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_ficha_cliente_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
