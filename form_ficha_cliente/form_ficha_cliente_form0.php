...
<style type="text/css">
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_ficha_cliente_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_ficha_cliente_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    $vertical_center = '';
...
<?php
 include_once("form_ficha_cliente_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_ficha_cliente'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_ficha_cliente'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['fast_search'][2] : "";
  ...
  if (document.getElementById(sTabId)) {
    if (bTabDisp) {
      ...
      if ("hidden_bloco_11" == sTabId) {
        scAjaxDetailHeight("grid_historia", $($("#nmsc_iframe_liga_grid_historia")[0].contentWindow.document).innerHeight());
      }
      if ("hidden_bloco_12" == sTabId) {
        scAjaxDetailHeight("grid_presupuesto", $($("#nmsc_iframe_liga_grid_presupuesto")[0].contentWindow.document).innerHeight());
      }
      if ("hidden_bloco_13" == sTabId) {
        scAjaxDetailHeight("grid_cobros", $($("#nmsc_iframe_liga_grid_cobros")[0].contentWindow.document).innerHeight());
      }
    }
    else {
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclactivo'][] = '1'; ?>
...
<?php $sStyleHidden_fclfechareg_dumb = ('' == $sStyleHidden_fclfechareg) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclfechareg_dumb" style="<?php echo $sStyleHidden_fclfechareg_dumb; ?>"></TD>
<?php $sStyleHidden_fclcedula_dumb = ('' == $sStyleHidden_fclcedula) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclcedula_dumb" style="<?php echo $sStyleHidden_fclcedula_dumb; ?>"></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_update_titulo_citas'][] = '1'; ?>
...
<?php $sStyleHidden_fclapellidos_dumb = ('' == $sStyleHidden_fclapellidos) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclapellidos_dumb" style="<?php echo $sStyleHidden_fclapellidos_dumb; ?>"></TD>
<?php $sStyleHidden_fclnombres_dumb = ('' == $sStyleHidden_fclnombres) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclnombres_dumb" style="<?php echo $sStyleHidden_fclnombres_dumb; ?>"></TD>
<?php $sStyleHidden_update_titulo_citas_dumb = ('' == $sStyleHidden_update_titulo_citas) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_update_titulo_citas_dumb" style="<?php echo $sStyleHidden_update_titulo_citas_dumb; ?>"></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclsexo'][] = 'M'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclsexo'][] = 'F'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclestciv'][] = ''; ?>
 <option value="">------------------------</option>
 <option  value="S" <?php  if ($this->fclestciv == "S") { echo " selected" ;} ?>>SOLTERO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclestciv'][] = 'S'; ?>
 <option  value="C" <?php  if ($this->fclestciv == "C") { echo " selected" ;} ?>>CASADO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclestciv'][] = 'C'; ?>
 <option  value="V" <?php  if ($this->fclestciv == "V") { echo " selected" ;} ?>>VIUDO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclestciv'][] = 'V'; ?>
 <option  value="D" <?php  if ($this->fclestciv == "D") { echo " selected" ;} ?>>DIVORCIADO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclestciv'][] = 'D'; ?>
 <option  value="U" <?php  if ($this->fclestciv == "U") { echo " selected" ;} ?>>UNIÓN LIBRE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclestciv'][] = 'U'; ?>
 </select></span>
</span><?php  }?>
...
<?php } 
?> 
<?php $sStyleHidden_fclsexo_dumb = ('' == $sStyleHidden_fclsexo) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclsexo_dumb" style="<?php echo $sStyleHidden_fclsexo_dumb; ?>"></TD>
<?php $sStyleHidden_fclestciv_dumb = ('' == $sStyleHidden_fclestciv) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclestciv_dumb" style="<?php echo $sStyleHidden_fclestciv_dumb; ?>"></TD>
<?php $sStyleHidden_fcldireccion_dumb = ('' == $sStyleHidden_fcldireccion) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fcldireccion_dumb" style="<?php echo $sStyleHidden_fcldireccion_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_fclciudad_dumb = ('' == $sStyleHidden_fclciudad) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclciudad_dumb" style="<?php echo $sStyleHidden_fclciudad_dumb; ?>"></TD>
<?php $sStyleHidden_fcltelefono_dumb = ('' == $sStyleHidden_fcltelefono) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fcltelefono_dumb" style="<?php echo $sStyleHidden_fcltelefono_dumb; ?>"></TD>
<?php $sStyleHidden_fclcelular_dumb = ('' == $sStyleHidden_fclcelular) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclcelular_dumb" style="<?php echo $sStyleHidden_fclcelular_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_fclemail_dumb = ('' == $sStyleHidden_fclemail) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclemail_dumb" style="<?php echo $sStyleHidden_fclemail_dumb; ?>"></TD>
<?php $sStyleHidden_fclprofesion_dumb = ('' == $sStyleHidden_fclprofesion) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclprofesion_dumb" style="<?php echo $sStyleHidden_fclprofesion_dumb; ?>"></TD>
<?php $sStyleHidden_fcllugartrab_dumb = ('' == $sStyleHidden_fcllugartrab) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fcllugartrab_dumb" style="<?php echo $sStyleHidden_fcllugartrab_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclfacigual'][] = '1'; ?>
<?php  if (in_array("1", $this->fclfacigual_1))  { echo " checked" ;} ?> onClick="do_ajax_form_ficha_cliente_event_fclfacigual_onclick();" ><span></span>
<label for="<?php echo $tempOptionId ?>"></label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php } 
?> 
<?php $sStyleHidden_fclfacruc_dumb = ('' == $sStyleHidden_fclfacruc) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclfacruc_dumb" style="<?php echo $sStyleHidden_fclfacruc_dumb; ?>"></TD>
<?php $sStyleHidden_fclfacnombre_dumb = ('' == $sStyleHidden_fclfacnombre) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclfacnombre_dumb" style="<?php echo $sStyleHidden_fclfacnombre_dumb; ?>"></TD>
<?php $sStyleHidden_fclfacdir_dumb = ('' == $sStyleHidden_fclfacdir) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclfacdir_dumb" style="<?php echo $sStyleHidden_fclfacdir_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } ?>
<?php $sStyleHidden_fclfactelf_dumb = ('' == $sStyleHidden_fclfactelf) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclfactelf_dumb" style="<?php echo $sStyleHidden_fclfactelf_dumb; ?>"></TD>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclreferpub_label" id="hidden_field_label_fclreferpub" style="<?php echo $sStyleHidden_fclreferpub; ?>"><span id="id_label_fclreferpub"><?php echo $this->nm_new_label['fclreferpub']; ?></span></TD>
    <TD class="scFormDataOdd css_fclreferpub_line" id="hidden_field_data_fclreferpub" style="<?php echo $sStyleHidden_fclreferpub; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclreferpub_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclreferpub'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclreferface_label" id="hidden_field_label_fclreferface" style="<?php echo $sStyleHidden_fclreferface; ?>"><span id="id_label_fclreferface"><?php echo $this->nm_new_label['fclreferface']; ?></span></TD>
    <TD class="scFormDataOdd css_fclreferface_line" id="hidden_field_data_fclreferface" style="<?php echo $sStyleHidden_fclreferface; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclreferface_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclreferface'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclreferweb_label" id="hidden_field_label_fclreferweb" style="<?php echo $sStyleHidden_fclreferweb; ?>"><span id="id_label_fclreferweb"><?php echo $this->nm_new_label['fclreferweb']; ?></span></TD>
    <TD class="scFormDataOdd css_fclreferweb_line" id="hidden_field_data_fclreferweb" style="<?php echo $sStyleHidden_fclreferweb; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclreferweb_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclreferweb'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclreferremit_label" id="hidden_field_label_fclreferremit" style="<?php echo $sStyleHidden_fclreferremit; ?>"><span id="id_label_fclreferremit"><?php echo $this->nm_new_label['fclreferremit']; ?></span></TD>
    <TD class="scFormDataOdd css_fclreferremit_line" id="hidden_field_data_fclreferremit" style="<?php echo $sStyleHidden_fclreferremit; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclreferremit_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclreferremit'][] = '1'; ?>
<?php  if (in_array("1", $this->fclreferremit_1))  { echo " checked" ;} ?> onClick="do_ajax_form_ficha_cliente_event_fclreferremit_onclick();" ><label for="<?php echo $tempOptionId ?>"></label></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclreferremitnom_label" id="hidden_field_label_fclreferremitnom" style="<?php echo $sStyleHidden_fclreferremitnom; ?>"><span id="id_label_fclreferremitnom"><?php echo $this->nm_new_label['fclreferremitnom']; ?></span></TD>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclbajotratmed_label" id="hidden_field_label_fclbajotratmed" style="<?php echo $sStyleHidden_fclbajotratmed; ?>"><span id="id_label_fclbajotratmed"><?php echo $this->nm_new_label['fclbajotratmed']; ?></span></TD>
    <TD class="scFormDataOdd css_fclbajotratmed_line" id="hidden_field_data_fclbajotratmed" style="<?php echo $sStyleHidden_fclbajotratmed; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclbajotratmed_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclbajotratmed'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclalerganest_label" id="hidden_field_label_fclalerganest" style="<?php echo $sStyleHidden_fclalerganest; ?>"><span id="id_label_fclalerganest"><?php echo $this->nm_new_label['fclalerganest']; ?></span></TD>
    <TD class="scFormDataOdd css_fclalerganest_line" id="hidden_field_data_fclalerganest" style="<?php echo $sStyleHidden_fclalerganest; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclalerganest_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclalerganest'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclprophemor_label" id="hidden_field_label_fclprophemor" style="<?php echo $sStyleHidden_fclprophemor; ?>"><span id="id_label_fclprophemor"><?php echo $this->nm_new_label['fclprophemor']; ?></span></TD>
    <TD class="scFormDataOdd css_fclprophemor_line" id="hidden_field_data_fclprophemor" style="<?php echo $sStyleHidden_fclprophemor; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclprophemor_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclprophemor'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclintervquir_label" id="hidden_field_label_fclintervquir" style="<?php echo $sStyleHidden_fclintervquir; ?>"><span id="id_label_fclintervquir"><?php echo $this->nm_new_label['fclintervquir']; ?></span></TD>
    <TD class="scFormDataOdd css_fclintervquir_line" id="hidden_field_data_fclintervquir" style="<?php echo $sStyleHidden_fclintervquir; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclintervquir_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclintervquir'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclmediesp_label" id="hidden_field_label_fclmediesp" style="<?php echo $sStyleHidden_fclmediesp; ?>"><span id="id_label_fclmediesp"><?php echo $this->nm_new_label['fclmediesp']; ?></span></TD>
    <TD class="scFormDataOdd css_fclmediesp_line" id="hidden_field_data_fclmediesp" style="<?php echo $sStyleHidden_fclmediesp; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclmediesp_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclmediesp'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclhiperten_label" id="hidden_field_label_fclhiperten" style="<?php echo $sStyleHidden_fclhiperten; ?>"><span id="id_label_fclhiperten"><?php echo $this->nm_new_label['fclhiperten']; ?></span></TD>
    <TD class="scFormDataOdd css_fclhiperten_line" id="hidden_field_data_fclhiperten" style="<?php echo $sStyleHidden_fclhiperten; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclhiperten_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclhiperten'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclhipotiro_label" id="hidden_field_label_fclhipotiro" style="<?php echo $sStyleHidden_fclhipotiro; ?>"><span id="id_label_fclhipotiro"><?php echo $this->nm_new_label['fclhipotiro']; ?></span></TD>
    <TD class="scFormDataOdd css_fclhipotiro_line" id="hidden_field_data_fclhipotiro" style="<?php echo $sStyleHidden_fclhipotiro; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclhipotiro_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclhipotiro'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclaltercora_label" id="hidden_field_label_fclaltercora" style="<?php echo $sStyleHidden_fclaltercora; ?>"><span id="id_label_fclaltercora"><?php echo $this->nm_new_label['fclaltercora']; ?></span></TD>
    <TD class="scFormDataOdd css_fclaltercora_line" id="hidden_field_data_fclaltercora" style="<?php echo $sStyleHidden_fclaltercora; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclaltercora_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclaltercora'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclgastrit_label" id="hidden_field_label_fclgastrit" style="<?php echo $sStyleHidden_fclgastrit; ?>"><span id="id_label_fclgastrit"><?php echo $this->nm_new_label['fclgastrit']; ?></span></TD>
    <TD class="scFormDataOdd css_fclgastrit_line" id="hidden_field_data_fclgastrit" style="<?php echo $sStyleHidden_fclgastrit; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclgastrit_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclgastrit'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclenfsangre_label" id="hidden_field_label_fclenfsangre" style="<?php echo $sStyleHidden_fclenfsangre; ?>"><span id="id_label_fclenfsangre"><?php echo $this->nm_new_label['fclenfsangre']; ?></span></TD>
    <TD class="scFormDataOdd css_fclenfsangre_line" id="hidden_field_data_fclenfsangre" style="<?php echo $sStyleHidden_fclenfsangre; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclenfsangre_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclenfsangre'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fcldiabet_label" id="hidden_field_label_fcldiabet" style="<?php echo $sStyleHidden_fcldiabet; ?>"><span id="id_label_fcldiabet"><?php echo $this->nm_new_label['fcldiabet']; ?></span></TD>
    <TD class="scFormDataOdd css_fcldiabet_line" id="hidden_field_data_fcldiabet" style="<?php echo $sStyleHidden_fcldiabet; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fcldiabet_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fcldiabet'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclhepatit_label" id="hidden_field_label_fclhepatit" style="<?php echo $sStyleHidden_fclhepatit; ?>"><span id="id_label_fclhepatit"><?php echo $this->nm_new_label['fclhepatit']; ?></span></TD>
    <TD class="scFormDataOdd css_fclhepatit_line" id="hidden_field_data_fclhepatit" style="<?php echo $sStyleHidden_fclhepatit; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclhepatit_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclhepatit'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclcancer_label" id="hidden_field_label_fclcancer" style="<?php echo $sStyleHidden_fclcancer; ?>"><span id="id_label_fclcancer"><?php echo $this->nm_new_label['fclcancer']; ?></span></TD>
    <TD class="scFormDataOdd css_fclcancer_line" id="hidden_field_data_fclcancer" style="<?php echo $sStyleHidden_fclcancer; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclcancer_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclcancer'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclvih_label" id="hidden_field_label_fclvih" style="<?php echo $sStyleHidden_fclvih; ?>"><span id="id_label_fclvih"><?php echo $this->nm_new_label['fclvih']; ?></span></TD>
    <TD class="scFormDataOdd css_fclvih_line" id="hidden_field_data_fclvih" style="<?php echo $sStyleHidden_fclvih; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclvih_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclvih'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclartrit_label" id="hidden_field_label_fclartrit" style="<?php echo $sStyleHidden_fclartrit; ?>"><span id="id_label_fclartrit"><?php echo $this->nm_new_label['fclartrit']; ?></span></TD>
    <TD class="scFormDataOdd css_fclartrit_line" id="hidden_field_data_fclartrit" style="<?php echo $sStyleHidden_fclartrit; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclartrit_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclartrit'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclinsufren_label" id="hidden_field_label_fclinsufren" style="<?php echo $sStyleHidden_fclinsufren; ?>"><span id="id_label_fclinsufren"><?php echo $this->nm_new_label['fclinsufren']; ?></span></TD>
    <TD class="scFormDataOdd css_fclinsufren_line" id="hidden_field_data_fclinsufren" style="<?php echo $sStyleHidden_fclinsufren; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclinsufren_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclinsufren'][] = '1'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclotrasenf_label" id="hidden_field_label_fclotrasenf" style="<?php echo $sStyleHidden_fclotrasenf; ?>"><span id="id_label_fclotrasenf"><?php echo $this->nm_new_label['fclotrasenf']; ?></span></TD>
    <TD class="scFormDataOdd css_fclotrasenf_line" id="hidden_field_data_fclotrasenf" style="<?php echo $sStyleHidden_fclotrasenf; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclotrasenf_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lookup_fclotrasenf'][] = '1'; ?>
<?php  if (in_array("1", $this->fclotrasenf_1))  { echo " checked" ;} ?> onClick="do_ajax_form_ficha_cliente_event_fclotrasenf_onclick();" ><label for="<?php echo $tempOptionId ?>"></label></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php $sc_hidden_no = 1; ?>
   ...
   <a name="bloco_8"></a>
   <table width="100%" height="100%" cellpadding="0" cellspacing=0><tr valign="top"><td width="10%" height="">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fclotrasenfdesc_label" id="hidden_field_label_fclotrasenfdesc" style="<?php echo $sStyleHidden_fclotrasenfdesc; ?>"><span id="id_label_fclotrasenfdesc"><?php echo $this->nm_new_label['fclotrasenfdesc']; ?></span></TD>
    <TD class="scFormDataOdd css_fclotrasenfdesc_line" id="hidden_field_data_fclotrasenfdesc" style="<?php echo $sStyleHidden_fclotrasenfdesc; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fclotrasenfdesc_line" style="vertical-align: top;padding: 0px">
...
<?php $sStyleHidden_fclusucrea_dumb = ('' == $sStyleHidden_fclusucrea) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclusucrea_dumb" style="<?php echo $sStyleHidden_fclusucrea_dumb; ?>"></TD>
<?php $sStyleHidden_fclfeccrea_dumb = ('' == $sStyleHidden_fclfeccrea) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclfeccrea_dumb" style="<?php echo $sStyleHidden_fclfeccrea_dumb; ?>"></TD>
<?php $sStyleHidden_fclusumodi_dumb = ('' == $sStyleHidden_fclusumodi) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fclusumodi_dumb" style="<?php echo $sStyleHidden_fclusumodi_dumb; ?>"></TD>
...
<?php $sc_hidden_no = 1; ?>
   ...
   <a name="bloco_11"></a>
<script type="text/javascript">
function sc_control_tabs_11(iTabIndex)
{
  sc_change_tabs(iTabIndex == 11, 'hidden_bloco_11', 'id_tabs_11_11');
  if (iTabIndex == 11) {
    displayChange_block("11", "on");
  }
  sc_change_tabs(iTabIndex == 12, 'hidden_bloco_12', 'id_tabs_11_12');
  if (iTabIndex == 12) {
    displayChange_block("12", "on");
  }
  sc_change_tabs(iTabIndex == 13, 'hidden_bloco_13', 'id_tabs_11_13');
  if (iTabIndex == 13) {
    displayChange_block("13", "on");
  }
}
</script>
<ul class="scTabLine">
<li id="id_tabs_11_11" class="scTabActive"><a href="javascript: sc_control_tabs_11(11)">HISTORIAS</a></li>
<li id="id_tabs_11_12" class="scTabInactive"><a href="javascript: sc_control_tabs_11(12)">PRESUPUESTOS</a></li>
<li id="id_tabs_11_13" class="scTabInactive"><a href="javascript: sc_control_tabs_11(13)"> COBROS</a></li>
</ul>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_historias'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_historias'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['grid_historia_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_historias'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['grid_historia_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_historia"]) && $this->Ini->sc_lig_md5["grid_historia"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_ficha_cliente@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_ficha_cliente_empty.htm' : $this->Ini->link_grid_historia_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_historias']) && 'nmsc_iframe_liga_grid_historia' != $this->Ini->sc_lig_target['C_@scinf_historias'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_historias'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['grid_historia_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php $sc_hidden_no = 1; ?>
   ...
   <a name="bloco_12"></a>
<div id="div_hidden_bloco_12" style="display: none; width: 1px; height: 0px; overflow: scroll"><!-- bloco_c -->
<TABLE align="center" id="hidden_bloco_12" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_presupuestos'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_presupuestos'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['grid_presupuesto_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_presupuestos'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['grid_presupuesto_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_ficha_cliente_empty.htm' : $this->Ini->link_grid_presupuesto_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_presupuestos']) && 'nmsc_iframe_liga_grid_presupuesto' != $this->Ini->sc_lig_target['C_@scinf_presupuestos'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_presupuestos'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['grid_presupuesto_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php $sc_hidden_no = 1; ?>
   ...
   <a name="bloco_13"></a>
<div id="div_hidden_bloco_13" style="display: none; width: 1px; height: 0px; overflow: scroll"><!-- bloco_c -->
<TABLE align="center" id="hidden_bloco_13" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cobros'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cobros'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['grid_cobros_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cobros'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['grid_cobros_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_ficha_cliente_empty.htm' : $this->Ini->link_grid_cobros_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_cobros']) && 'nmsc_iframe_liga_grid_cobros' != $this->Ini->sc_lig_target['C_@scinf_cobros'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_cobros'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['grid_cobros_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
  ...
  $nm_sc_blocos_aba    = array(11 => 11,12 => 11,13 => 11);
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_ficha_cliente");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_ficha_cliente");
 parent.scAjaxDetailHeight("form_ficha_cliente", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
