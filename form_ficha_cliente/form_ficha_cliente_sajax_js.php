  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ficha_cliente" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ficha_cliente_form();
	}
  ...
  // ---------- Validate fclnumero
  function do_ajax_form_ficha_cliente_validate_fclnumero()
  {
    var nomeCampo_fclnumero = "fclnumero";
    var var_fclnumero = scAjaxGetFieldText(nomeCampo_fclnumero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclnumero(var_fclnumero, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclnumero_cb);
  } // do_ajax_form_ficha_cliente_validate_fclnumero

  function do_ajax_form_ficha_cliente_validate_fclnumero_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclnumero_cb

  // ---------- Validate fclfechareg
  function do_ajax_form_ficha_cliente_validate_fclfechareg()
  {
    ...
    setTimeout(function() {
      var var_fclfechareg = scAjaxGetFieldText(nomeCampo_fclfechareg);
      x_ajax_form_ficha_cliente_validate_fclfechareg(var_fclfechareg, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclfechareg_cb);
    }, 200);
  } // do_ajax_form_ficha_cliente_validate_fclfechareg

  function do_ajax_form_ficha_cliente_validate_fclfechareg_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclfechareg_cb

  // ---------- Validate fclcedula
  function do_ajax_form_ficha_cliente_validate_fclcedula()
  {
    var nomeCampo_fclcedula = "fclcedula";
    var var_fclcedula = scAjaxGetFieldText(nomeCampo_fclcedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclcedula(var_fclcedula, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclcedula_cb);
  } // do_ajax_form_ficha_cliente_validate_fclcedula

  function do_ajax_form_ficha_cliente_validate_fclcedula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclcedula_cb

  // ---------- Validate fclactivo
  function do_ajax_form_ficha_cliente_validate_fclactivo()
  {
    var nomeCampo_fclactivo = "fclactivo";
    var var_fclactivo = scAjaxGetFieldCheckbox(nomeCampo_fclactivo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclactivo(var_fclactivo, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclactivo_cb);
  } // do_ajax_form_ficha_cliente_validate_fclactivo

  function do_ajax_form_ficha_cliente_validate_fclactivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclactivo_cb

  // ---------- Validate fclapellidos
  function do_ajax_form_ficha_cliente_validate_fclapellidos()
  {
    var nomeCampo_fclapellidos = "fclapellidos";
    var var_fclapellidos = scAjaxGetFieldText(nomeCampo_fclapellidos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclapellidos(var_fclapellidos, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclapellidos_cb);
  } // do_ajax_form_ficha_cliente_validate_fclapellidos

  function do_ajax_form_ficha_cliente_validate_fclapellidos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclapellidos_cb

  // ---------- Validate fclnombres
  function do_ajax_form_ficha_cliente_validate_fclnombres()
  {
    var nomeCampo_fclnombres = "fclnombres";
    var var_fclnombres = scAjaxGetFieldText(nomeCampo_fclnombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclnombres(var_fclnombres, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclnombres_cb);
  } // do_ajax_form_ficha_cliente_validate_fclnombres

  function do_ajax_form_ficha_cliente_validate_fclnombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclnombres_cb

  // ---------- Validate update_titulo_citas
  function do_ajax_form_ficha_cliente_validate_update_titulo_citas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_update_titulo_citas(var_update_titulo_citas, var_script_case_init, do_ajax_form_ficha_cliente_validate_update_titulo_citas_cb);
  } // do_ajax_form_ficha_cliente_validate_update_titulo_citas

  function do_ajax_form_ficha_cliente_validate_update_titulo_citas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_update_titulo_citas_cb

  // ---------- Validate fclfechanac
  function do_ajax_form_ficha_cliente_validate_fclfechanac()
  {
    ...
    setTimeout(function() {
      var var_fclfechanac = scAjaxGetFieldText(nomeCampo_fclfechanac);
      x_ajax_form_ficha_cliente_validate_fclfechanac(var_fclfechanac, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclfechanac_cb);
    }, 200);
  } // do_ajax_form_ficha_cliente_validate_fclfechanac

  function do_ajax_form_ficha_cliente_validate_fclfechanac_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclfechanac_cb

  // ---------- Validate fclsexo
  function do_ajax_form_ficha_cliente_validate_fclsexo()
  {
    var nomeCampo_fclsexo = "fclsexo";
    var var_fclsexo = scAjaxGetFieldRadio(nomeCampo_fclsexo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclsexo(var_fclsexo, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclsexo_cb);
  } // do_ajax_form_ficha_cliente_validate_fclsexo

  function do_ajax_form_ficha_cliente_validate_fclsexo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fclsexo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclsexo_cb

  // ---------- Validate fclestciv
  function do_ajax_form_ficha_cliente_validate_fclestciv()
  {
    var nomeCampo_fclestciv = "fclestciv";
    var var_fclestciv = scAjaxGetFieldSelect(nomeCampo_fclestciv);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclestciv(var_fclestciv, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclestciv_cb);
  } // do_ajax_form_ficha_cliente_validate_fclestciv

  function do_ajax_form_ficha_cliente_validate_fclestciv_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclestciv_cb

  // ---------- Validate fcldireccion
  function do_ajax_form_ficha_cliente_validate_fcldireccion()
  {
    var nomeCampo_fcldireccion = "fcldireccion";
    var var_fcldireccion = scAjaxGetFieldText(nomeCampo_fcldireccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fcldireccion(var_fcldireccion, var_script_case_init, do_ajax_form_ficha_cliente_validate_fcldireccion_cb);
  } // do_ajax_form_ficha_cliente_validate_fcldireccion

  function do_ajax_form_ficha_cliente_validate_fcldireccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fcldireccion_cb

  // ---------- Validate fclciudad
  function do_ajax_form_ficha_cliente_validate_fclciudad()
  {
    var nomeCampo_fclciudad = "fclciudad";
    var var_fclciudad = scAjaxGetFieldText(nomeCampo_fclciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclciudad(var_fclciudad, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclciudad_cb);
  } // do_ajax_form_ficha_cliente_validate_fclciudad

  function do_ajax_form_ficha_cliente_validate_fclciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclciudad_cb

  // ---------- Validate fcltelefono
  function do_ajax_form_ficha_cliente_validate_fcltelefono()
  {
    var nomeCampo_fcltelefono = "fcltelefono";
    var var_fcltelefono = scAjaxGetFieldText(nomeCampo_fcltelefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fcltelefono(var_fcltelefono, var_script_case_init, do_ajax_form_ficha_cliente_validate_fcltelefono_cb);
  } // do_ajax_form_ficha_cliente_validate_fcltelefono

  function do_ajax_form_ficha_cliente_validate_fcltelefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fcltelefono_cb

  // ---------- Validate fclcelular
  function do_ajax_form_ficha_cliente_validate_fclcelular()
  {
    var nomeCampo_fclcelular = "fclcelular";
    var var_fclcelular = scAjaxGetFieldText(nomeCampo_fclcelular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclcelular(var_fclcelular, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclcelular_cb);
  } // do_ajax_form_ficha_cliente_validate_fclcelular

  function do_ajax_form_ficha_cliente_validate_fclcelular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclcelular_cb

  // ---------- Validate fclemail
  function do_ajax_form_ficha_cliente_validate_fclemail()
  {
    var nomeCampo_fclemail = "fclemail";
    var var_fclemail = scAjaxGetFieldText(nomeCampo_fclemail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclemail(var_fclemail, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclemail_cb);
  } // do_ajax_form_ficha_cliente_validate_fclemail

  function do_ajax_form_ficha_cliente_validate_fclemail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclemail_cb

  // ---------- Validate fclprofesion
  function do_ajax_form_ficha_cliente_validate_fclprofesion()
  {
    var nomeCampo_fclprofesion = "fclprofesion";
    var var_fclprofesion = scAjaxGetFieldText(nomeCampo_fclprofesion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclprofesion(var_fclprofesion, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclprofesion_cb);
  } // do_ajax_form_ficha_cliente_validate_fclprofesion

  function do_ajax_form_ficha_cliente_validate_fclprofesion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclprofesion_cb

  // ---------- Validate fcllugartrab
  function do_ajax_form_ficha_cliente_validate_fcllugartrab()
  {
    var nomeCampo_fcllugartrab = "fcllugartrab";
    var var_fcllugartrab = scAjaxGetFieldText(nomeCampo_fcllugartrab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fcllugartrab(var_fcllugartrab, var_script_case_init, do_ajax_form_ficha_cliente_validate_fcllugartrab_cb);
  } // do_ajax_form_ficha_cliente_validate_fcllugartrab

  function do_ajax_form_ficha_cliente_validate_fcllugartrab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fcllugartrab_cb

  // ---------- Validate fclfacigual
  function do_ajax_form_ficha_cliente_validate_fclfacigual()
  {
    var nomeCampo_fclfacigual = "fclfacigual";
    var var_fclfacigual = scAjaxGetFieldCheckbox(nomeCampo_fclfacigual, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclfacigual(var_fclfacigual, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclfacigual_cb);
  } // do_ajax_form_ficha_cliente_validate_fclfacigual

  function do_ajax_form_ficha_cliente_validate_fclfacigual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclfacigual_cb

  // ---------- Validate fclfacruc
  function do_ajax_form_ficha_cliente_validate_fclfacruc()
  {
    var nomeCampo_fclfacruc = "fclfacruc";
    var var_fclfacruc = scAjaxGetFieldText(nomeCampo_fclfacruc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclfacruc(var_fclfacruc, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclfacruc_cb);
  } // do_ajax_form_ficha_cliente_validate_fclfacruc

  function do_ajax_form_ficha_cliente_validate_fclfacruc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclfacruc_cb

  // ---------- Validate fclfacnombre
  function do_ajax_form_ficha_cliente_validate_fclfacnombre()
  {
    var nomeCampo_fclfacnombre = "fclfacnombre";
    var var_fclfacnombre = scAjaxGetFieldText(nomeCampo_fclfacnombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclfacnombre(var_fclfacnombre, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclfacnombre_cb);
  } // do_ajax_form_ficha_cliente_validate_fclfacnombre

  function do_ajax_form_ficha_cliente_validate_fclfacnombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclfacnombre_cb

  // ---------- Validate fclfacdir
  function do_ajax_form_ficha_cliente_validate_fclfacdir()
  {
    var nomeCampo_fclfacdir = "fclfacdir";
    var var_fclfacdir = scAjaxGetFieldText(nomeCampo_fclfacdir);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclfacdir(var_fclfacdir, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclfacdir_cb);
  } // do_ajax_form_ficha_cliente_validate_fclfacdir

  function do_ajax_form_ficha_cliente_validate_fclfacdir_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclfacdir_cb

  // ---------- Validate fclfactelf
  function do_ajax_form_ficha_cliente_validate_fclfactelf()
  {
    var nomeCampo_fclfactelf = "fclfactelf";
    var var_fclfactelf = scAjaxGetFieldText(nomeCampo_fclfactelf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclfactelf(var_fclfactelf, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclfactelf_cb);
  } // do_ajax_form_ficha_cliente_validate_fclfactelf

  function do_ajax_form_ficha_cliente_validate_fclfactelf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclfactelf_cb

  // ---------- Validate fclfacmail
  function do_ajax_form_ficha_cliente_validate_fclfacmail()
  {
    var nomeCampo_fclfacmail = "fclfacmail";
    var var_fclfacmail = scAjaxGetFieldText(nomeCampo_fclfacmail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclfacmail(var_fclfacmail, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclfacmail_cb);
  } // do_ajax_form_ficha_cliente_validate_fclfacmail

  function do_ajax_form_ficha_cliente_validate_fclfacmail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclfacmail_cb

  // ---------- Validate fclreferpub
  function do_ajax_form_ficha_cliente_validate_fclreferpub()
  {
    var nomeCampo_fclreferpub = "fclreferpub";
    var var_fclreferpub = scAjaxGetFieldCheckbox(nomeCampo_fclreferpub, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclreferpub(var_fclreferpub, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclreferpub_cb);
  } // do_ajax_form_ficha_cliente_validate_fclreferpub

  function do_ajax_form_ficha_cliente_validate_fclreferpub_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclreferpub_cb

  // ---------- Validate fclreferface
  function do_ajax_form_ficha_cliente_validate_fclreferface()
  {
    var nomeCampo_fclreferface = "fclreferface";
    var var_fclreferface = scAjaxGetFieldCheckbox(nomeCampo_fclreferface, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclreferface(var_fclreferface, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclreferface_cb);
  } // do_ajax_form_ficha_cliente_validate_fclreferface

  function do_ajax_form_ficha_cliente_validate_fclreferface_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclreferface_cb

  // ---------- Validate fclreferweb
  function do_ajax_form_ficha_cliente_validate_fclreferweb()
  {
    var nomeCampo_fclreferweb = "fclreferweb";
    var var_fclreferweb = scAjaxGetFieldCheckbox(nomeCampo_fclreferweb, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclreferweb(var_fclreferweb, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclreferweb_cb);
  } // do_ajax_form_ficha_cliente_validate_fclreferweb

  function do_ajax_form_ficha_cliente_validate_fclreferweb_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclreferweb_cb

  // ---------- Validate fclreferremit
  function do_ajax_form_ficha_cliente_validate_fclreferremit()
  {
    var nomeCampo_fclreferremit = "fclreferremit";
    var var_fclreferremit = scAjaxGetFieldCheckbox(nomeCampo_fclreferremit, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclreferremit(var_fclreferremit, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclreferremit_cb);
  } // do_ajax_form_ficha_cliente_validate_fclreferremit

  function do_ajax_form_ficha_cliente_validate_fclreferremit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclreferremit_cb

  // ---------- Validate fclreferremitnom
  function do_ajax_form_ficha_cliente_validate_fclreferremitnom()
  {
    var nomeCampo_fclreferremitnom = "fclreferremitnom";
    var var_fclreferremitnom = scAjaxGetFieldText(nomeCampo_fclreferremitnom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclreferremitnom(var_fclreferremitnom, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclreferremitnom_cb);
  } // do_ajax_form_ficha_cliente_validate_fclreferremitnom

  function do_ajax_form_ficha_cliente_validate_fclreferremitnom_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclreferremitnom_cb

  // ---------- Validate fclmotivprimcons
  function do_ajax_form_ficha_cliente_validate_fclmotivprimcons()
  {
    var nomeCampo_fclmotivprimcons = "fclmotivprimcons";
    var var_fclmotivprimcons = scAjaxGetFieldText(nomeCampo_fclmotivprimcons);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclmotivprimcons(var_fclmotivprimcons, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclmotivprimcons_cb);
  } // do_ajax_form_ficha_cliente_validate_fclmotivprimcons

  function do_ajax_form_ficha_cliente_validate_fclmotivprimcons_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclmotivprimcons_cb

  // ---------- Validate fclproblemactual
  function do_ajax_form_ficha_cliente_validate_fclproblemactual()
  {
    var nomeCampo_fclproblemactual = "fclproblemactual";
    var var_fclproblemactual = scAjaxGetFieldText(nomeCampo_fclproblemactual);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclproblemactual(var_fclproblemactual, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclproblemactual_cb);
  } // do_ajax_form_ficha_cliente_validate_fclproblemactual

  function do_ajax_form_ficha_cliente_validate_fclproblemactual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclproblemactual_cb

  // ---------- Validate fclbajotratmed
  function do_ajax_form_ficha_cliente_validate_fclbajotratmed()
  {
    var nomeCampo_fclbajotratmed = "fclbajotratmed";
    var var_fclbajotratmed = scAjaxGetFieldCheckbox(nomeCampo_fclbajotratmed, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclbajotratmed(var_fclbajotratmed, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclbajotratmed_cb);
  } // do_ajax_form_ficha_cliente_validate_fclbajotratmed

  function do_ajax_form_ficha_cliente_validate_fclbajotratmed_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclbajotratmed_cb

  // ---------- Validate fclalerganest
  function do_ajax_form_ficha_cliente_validate_fclalerganest()
  {
    var nomeCampo_fclalerganest = "fclalerganest";
    var var_fclalerganest = scAjaxGetFieldCheckbox(nomeCampo_fclalerganest, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclalerganest(var_fclalerganest, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclalerganest_cb);
  } // do_ajax_form_ficha_cliente_validate_fclalerganest

  function do_ajax_form_ficha_cliente_validate_fclalerganest_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclalerganest_cb

  // ---------- Validate fclprophemor
  function do_ajax_form_ficha_cliente_validate_fclprophemor()
  {
    var nomeCampo_fclprophemor = "fclprophemor";
    var var_fclprophemor = scAjaxGetFieldCheckbox(nomeCampo_fclprophemor, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclprophemor(var_fclprophemor, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclprophemor_cb);
  } // do_ajax_form_ficha_cliente_validate_fclprophemor

  function do_ajax_form_ficha_cliente_validate_fclprophemor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclprophemor_cb

  // ---------- Validate fclintervquir
  function do_ajax_form_ficha_cliente_validate_fclintervquir()
  {
    var nomeCampo_fclintervquir = "fclintervquir";
    var var_fclintervquir = scAjaxGetFieldCheckbox(nomeCampo_fclintervquir, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclintervquir(var_fclintervquir, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclintervquir_cb);
  } // do_ajax_form_ficha_cliente_validate_fclintervquir

  function do_ajax_form_ficha_cliente_validate_fclintervquir_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclintervquir_cb

  // ---------- Validate fclmediesp
  function do_ajax_form_ficha_cliente_validate_fclmediesp()
  {
    var nomeCampo_fclmediesp = "fclmediesp";
    var var_fclmediesp = scAjaxGetFieldCheckbox(nomeCampo_fclmediesp, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclmediesp(var_fclmediesp, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclmediesp_cb);
  } // do_ajax_form_ficha_cliente_validate_fclmediesp

  function do_ajax_form_ficha_cliente_validate_fclmediesp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclmediesp_cb

  // ---------- Validate fclhiperten
  function do_ajax_form_ficha_cliente_validate_fclhiperten()
  {
    var nomeCampo_fclhiperten = "fclhiperten";
    var var_fclhiperten = scAjaxGetFieldCheckbox(nomeCampo_fclhiperten, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclhiperten(var_fclhiperten, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclhiperten_cb);
  } // do_ajax_form_ficha_cliente_validate_fclhiperten

  function do_ajax_form_ficha_cliente_validate_fclhiperten_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclhiperten_cb

  // ---------- Validate fclhipotiro
  function do_ajax_form_ficha_cliente_validate_fclhipotiro()
  {
    var nomeCampo_fclhipotiro = "fclhipotiro";
    var var_fclhipotiro = scAjaxGetFieldCheckbox(nomeCampo_fclhipotiro, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclhipotiro(var_fclhipotiro, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclhipotiro_cb);
  } // do_ajax_form_ficha_cliente_validate_fclhipotiro

  function do_ajax_form_ficha_cliente_validate_fclhipotiro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclhipotiro_cb

  // ---------- Validate fclaltercora
  function do_ajax_form_ficha_cliente_validate_fclaltercora()
  {
    var nomeCampo_fclaltercora = "fclaltercora";
    var var_fclaltercora = scAjaxGetFieldCheckbox(nomeCampo_fclaltercora, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclaltercora(var_fclaltercora, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclaltercora_cb);
  } // do_ajax_form_ficha_cliente_validate_fclaltercora

  function do_ajax_form_ficha_cliente_validate_fclaltercora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclaltercora_cb

  // ---------- Validate fclgastrit
  function do_ajax_form_ficha_cliente_validate_fclgastrit()
  {
    var nomeCampo_fclgastrit = "fclgastrit";
    var var_fclgastrit = scAjaxGetFieldCheckbox(nomeCampo_fclgastrit, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclgastrit(var_fclgastrit, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclgastrit_cb);
  } // do_ajax_form_ficha_cliente_validate_fclgastrit

  function do_ajax_form_ficha_cliente_validate_fclgastrit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclgastrit_cb

  // ---------- Validate fclenfsangre
  function do_ajax_form_ficha_cliente_validate_fclenfsangre()
  {
    var nomeCampo_fclenfsangre = "fclenfsangre";
    var var_fclenfsangre = scAjaxGetFieldCheckbox(nomeCampo_fclenfsangre, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclenfsangre(var_fclenfsangre, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclenfsangre_cb);
  } // do_ajax_form_ficha_cliente_validate_fclenfsangre

  function do_ajax_form_ficha_cliente_validate_fclenfsangre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclenfsangre_cb

  // ---------- Validate fcldiabet
  function do_ajax_form_ficha_cliente_validate_fcldiabet()
  {
    var nomeCampo_fcldiabet = "fcldiabet";
    var var_fcldiabet = scAjaxGetFieldCheckbox(nomeCampo_fcldiabet, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fcldiabet(var_fcldiabet, var_script_case_init, do_ajax_form_ficha_cliente_validate_fcldiabet_cb);
  } // do_ajax_form_ficha_cliente_validate_fcldiabet

  function do_ajax_form_ficha_cliente_validate_fcldiabet_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fcldiabet_cb

  // ---------- Validate fclhepatit
  function do_ajax_form_ficha_cliente_validate_fclhepatit()
  {
    var nomeCampo_fclhepatit = "fclhepatit";
    var var_fclhepatit = scAjaxGetFieldCheckbox(nomeCampo_fclhepatit, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclhepatit(var_fclhepatit, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclhepatit_cb);
  } // do_ajax_form_ficha_cliente_validate_fclhepatit

  function do_ajax_form_ficha_cliente_validate_fclhepatit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclhepatit_cb

  // ---------- Validate fclcancer
  function do_ajax_form_ficha_cliente_validate_fclcancer()
  {
    var nomeCampo_fclcancer = "fclcancer";
    var var_fclcancer = scAjaxGetFieldCheckbox(nomeCampo_fclcancer, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclcancer(var_fclcancer, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclcancer_cb);
  } // do_ajax_form_ficha_cliente_validate_fclcancer

  function do_ajax_form_ficha_cliente_validate_fclcancer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclcancer_cb

  // ---------- Validate fclvih
  function do_ajax_form_ficha_cliente_validate_fclvih()
  {
    var nomeCampo_fclvih = "fclvih";
    var var_fclvih = scAjaxGetFieldCheckbox(nomeCampo_fclvih, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclvih(var_fclvih, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclvih_cb);
  } // do_ajax_form_ficha_cliente_validate_fclvih

  function do_ajax_form_ficha_cliente_validate_fclvih_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fclvih";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclvih_cb

  // ---------- Validate fclartrit
  function do_ajax_form_ficha_cliente_validate_fclartrit()
  {
    var nomeCampo_fclartrit = "fclartrit";
    var var_fclartrit = scAjaxGetFieldCheckbox(nomeCampo_fclartrit, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclartrit(var_fclartrit, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclartrit_cb);
  } // do_ajax_form_ficha_cliente_validate_fclartrit

  function do_ajax_form_ficha_cliente_validate_fclartrit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclartrit_cb

  // ---------- Validate fclinsufren
  function do_ajax_form_ficha_cliente_validate_fclinsufren()
  {
    var nomeCampo_fclinsufren = "fclinsufren";
    var var_fclinsufren = scAjaxGetFieldCheckbox(nomeCampo_fclinsufren, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclinsufren(var_fclinsufren, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclinsufren_cb);
  } // do_ajax_form_ficha_cliente_validate_fclinsufren

  function do_ajax_form_ficha_cliente_validate_fclinsufren_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclinsufren_cb

  // ---------- Validate fclotrasenf
  function do_ajax_form_ficha_cliente_validate_fclotrasenf()
  {
    var nomeCampo_fclotrasenf = "fclotrasenf";
    var var_fclotrasenf = scAjaxGetFieldCheckbox(nomeCampo_fclotrasenf, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclotrasenf(var_fclotrasenf, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclotrasenf_cb);
  } // do_ajax_form_ficha_cliente_validate_fclotrasenf

  function do_ajax_form_ficha_cliente_validate_fclotrasenf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclotrasenf_cb

  // ---------- Validate fclotrasenfdesc
  function do_ajax_form_ficha_cliente_validate_fclotrasenfdesc()
  {
    var nomeCampo_fclotrasenfdesc = "fclotrasenfdesc";
    var var_fclotrasenfdesc = scAjaxGetFieldText(nomeCampo_fclotrasenfdesc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclotrasenfdesc(var_fclotrasenfdesc, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclotrasenfdesc_cb);
  } // do_ajax_form_ficha_cliente_validate_fclotrasenfdesc

  function do_ajax_form_ficha_cliente_validate_fclotrasenfdesc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclotrasenfdesc_cb

  // ---------- Validate fclobserv
  function do_ajax_form_ficha_cliente_validate_fclobserv()
  {
    var nomeCampo_fclobserv = "fclobserv";
    var var_fclobserv = scAjaxGetFieldText(nomeCampo_fclobserv);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclobserv(var_fclobserv, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclobserv_cb);
  } // do_ajax_form_ficha_cliente_validate_fclobserv

  function do_ajax_form_ficha_cliente_validate_fclobserv_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclobserv_cb

  // ---------- Validate fclusucrea
  function do_ajax_form_ficha_cliente_validate_fclusucrea()
  {
    var nomeCampo_fclusucrea = "fclusucrea";
    var var_fclusucrea = scAjaxGetFieldText(nomeCampo_fclusucrea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclusucrea(var_fclusucrea, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclusucrea_cb);
  } // do_ajax_form_ficha_cliente_validate_fclusucrea

  function do_ajax_form_ficha_cliente_validate_fclusucrea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclusucrea_cb

  // ---------- Validate fclfeccrea
  function do_ajax_form_ficha_cliente_validate_fclfeccrea()
  {
    var nomeCampo_fclfeccrea = "fclfeccrea";
    var var_fclfeccrea = scAjaxGetFieldText(nomeCampo_fclfeccrea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclfeccrea(var_fclfeccrea, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclfeccrea_cb);
  } // do_ajax_form_ficha_cliente_validate_fclfeccrea

  function do_ajax_form_ficha_cliente_validate_fclfeccrea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclfeccrea_cb

  // ---------- Validate fclusumodi
  function do_ajax_form_ficha_cliente_validate_fclusumodi()
  {
    var nomeCampo_fclusumodi = "fclusumodi";
    var var_fclusumodi = scAjaxGetFieldText(nomeCampo_fclusumodi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclusumodi(var_fclusumodi, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclusumodi_cb);
  } // do_ajax_form_ficha_cliente_validate_fclusumodi

  function do_ajax_form_ficha_cliente_validate_fclusumodi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclusumodi_cb

  // ---------- Validate fclfecmodi
  function do_ajax_form_ficha_cliente_validate_fclfecmodi()
  {
    var nomeCampo_fclfecmodi = "fclfecmodi";
    var var_fclfecmodi = scAjaxGetFieldText(nomeCampo_fclfecmodi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_fclfecmodi(var_fclfecmodi, var_script_case_init, do_ajax_form_ficha_cliente_validate_fclfecmodi_cb);
  } // do_ajax_form_ficha_cliente_validate_fclfecmodi

  function do_ajax_form_ficha_cliente_validate_fclfecmodi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_fclfecmodi_cb

  // ---------- Validate historias
  function do_ajax_form_ficha_cliente_validate_historias()
  {
    var nomeCampo_historias = "historias";
    var var_historias = scAjaxGetFieldText(nomeCampo_historias);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_historias(var_historias, var_script_case_init, do_ajax_form_ficha_cliente_validate_historias_cb);
  } // do_ajax_form_ficha_cliente_validate_historias

  function do_ajax_form_ficha_cliente_validate_historias_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_historias_cb

  // ---------- Validate presupuestos
  function do_ajax_form_ficha_cliente_validate_presupuestos()
  {
    var nomeCampo_presupuestos = "presupuestos";
    var var_presupuestos = scAjaxGetFieldText(nomeCampo_presupuestos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_presupuestos(var_presupuestos, var_script_case_init, do_ajax_form_ficha_cliente_validate_presupuestos_cb);
  } // do_ajax_form_ficha_cliente_validate_presupuestos

  function do_ajax_form_ficha_cliente_validate_presupuestos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_presupuestos_cb

  // ---------- Validate cobros
  function do_ajax_form_ficha_cliente_validate_cobros()
  {
    var nomeCampo_cobros = "cobros";
    var var_cobros = scAjaxGetFieldText(nomeCampo_cobros);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ficha_cliente_validate_cobros(var_cobros, var_script_case_init, do_ajax_form_ficha_cliente_validate_cobros_cb);
  } // do_ajax_form_ficha_cliente_validate_cobros

  function do_ajax_form_ficha_cliente_validate_cobros_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cobros";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ficha_cliente_validate_cobros_cb

  // ---------- Event onclick fclfacigual
  function do_ajax_form_ficha_cliente_event_fclfacigual_onclick()
  {
    var var_fclfacigual = scAjaxGetFieldCheckbox("fclfacigual", ";");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_ficha_cliente_event_fclfacigual_onclick(var_fclfacigual, var_script_case_init, do_ajax_form_ficha_cliente_event_fclfacigual_onclick_cb);
  } // do_ajax_form_ficha_cliente_event_fclfacigual_onclick

  function do_ajax_form_ficha_cliente_event_fclfacigual_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fclfacigual";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_ficha_cliente_event_fclfacigual_onclick_cb_after_alert);
  } // do_ajax_form_ficha_cliente_event_fclfacigual_onclick_cb
  function do_ajax_form_ficha_cliente_event_fclfacigual_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_ficha_cliente_event_fclfacigual_onclick_cb_after_alert

  // ---------- Event onclick fclotrasenf
  function do_ajax_form_ficha_cliente_event_fclotrasenf_onclick()
  {
    var var_fclotrasenf = scAjaxGetFieldCheckbox("fclotrasenf", ";");
    var var_fclotrasenfdesc = scAjaxGetFieldText("fclotrasenfdesc");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_ficha_cliente_event_fclotrasenf_onclick(var_fclotrasenf, var_fclotrasenfdesc, var_script_case_init, do_ajax_form_ficha_cliente_event_fclotrasenf_onclick_cb);
  } // do_ajax_form_ficha_cliente_event_fclotrasenf_onclick

  function do_ajax_form_ficha_cliente_event_fclotrasenf_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fclotrasenf";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_ficha_cliente_event_fclotrasenf_onclick_cb_after_alert);
  } // do_ajax_form_ficha_cliente_event_fclotrasenf_onclick_cb
  function do_ajax_form_ficha_cliente_event_fclotrasenf_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_ficha_cliente_event_fclotrasenf_onclick_cb_after_alert

  // ---------- Event onclick fclreferremit
  function do_ajax_form_ficha_cliente_event_fclreferremit_onclick()
  {
    var var_fclreferremit = scAjaxGetFieldCheckbox("fclreferremit", ";");
    var var_fclreferremitnom = scAjaxGetFieldText("fclreferremitnom");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_ficha_cliente_event_fclreferremit_onclick(var_fclreferremit, var_fclreferremitnom, var_script_case_init, do_ajax_form_ficha_cliente_event_fclreferremit_onclick_cb);
  } // do_ajax_form_ficha_cliente_event_fclreferremit_onclick

  function do_ajax_form_ficha_cliente_event_fclreferremit_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fclreferremit";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_ficha_cliente_event_fclreferremit_onclick_cb_after_alert);
  } // do_ajax_form_ficha_cliente_event_fclreferremit_onclick_cb
  function do_ajax_form_ficha_cliente_event_fclreferremit_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_ficha_cliente_event_fclreferremit_onclick_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_ficha_cliente_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ficha_cliente_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ficha_cliente_submit_form_cb_after_alert);
  } // do_ajax_form_ficha_cliente_submit_form_cb
  function do_ajax_form_ficha_cliente_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ficha_cliente_submit_form_cb_after_alert
  ...
  function do_ajax_form_ficha_cliente_navigate_form()
  {
    perform_ajax_form_ficha_cliente_navigate_form();
  }

  function perform_ajax_form_ficha_cliente_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_ficha_cliente_navigate_form(var_fclnumero, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ficha_cliente_navigate_form_cb);
  } // do_ajax_form_ficha_cliente_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ficha_cliente']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ficha_cliente_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    sc_change_tabs(true, 'hidden_bloco_11', 'id_tabs_11_11');
    sc_change_tabs(false, 'hidden_bloco_12', 'id_tabs_11_12');
    sc_change_tabs(false, 'hidden_bloco_13', 'id_tabs_11_13');
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ficha_cliente_navigate_form_cb_after_alert);
  } // do_ajax_form_ficha_cliente_navigate_form_cb
  function do_ajax_form_ficha_cliente_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_ficha_cliente_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_ficha_cliente_navigate_form_cb_after_alert
  function sc_hide_form_ficha_cliente_form()
  {
  ...
  var ajax_block_tab = {
    ...
    "hidden_bloco_9": "",
    "hidden_bloco_10": "",
    "hidden_bloco_11": "id_tabs_11_11",
    "hidden_bloco_12": "id_tabs_11_12",
    "hidden_bloco_13": "id_tabs_11_13"
  };
