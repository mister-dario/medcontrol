  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_FACTURA_bkp_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_FACTURA_bkp_mob_form();
	}
  ...
  // ---------- Validate num_fact
  function do_ajax_form_FACTURA_bkp_mob_validate_num_fact()
  {
    var nomeCampo_num_fact = "num_fact";
    var var_num_fact = scAjaxGetFieldText(nomeCampo_num_fact);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_num_fact(var_num_fact, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_num_fact_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_num_fact

  function do_ajax_form_FACTURA_bkp_mob_validate_num_fact_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_num_fact_cb

  // ---------- Validate fechaemision
  function do_ajax_form_FACTURA_bkp_mob_validate_fechaemision()
  {
    var nomeCampo_fechaemision = "fechaemision";
    var var_fechaemision = scAjaxGetFieldText(nomeCampo_fechaemision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_fechaemision(var_fechaemision, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_fechaemision_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_fechaemision

  function do_ajax_form_FACTURA_bkp_mob_validate_fechaemision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_fechaemision_cb

  // ---------- Validate guiaremision
  function do_ajax_form_FACTURA_bkp_mob_validate_guiaremision()
  {
    var nomeCampo_guiaremision = "guiaremision";
    var var_guiaremision = scAjaxGetFieldText(nomeCampo_guiaremision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_guiaremision(var_guiaremision, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_guiaremision_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_guiaremision

  function do_ajax_form_FACTURA_bkp_mob_validate_guiaremision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_guiaremision_cb

  // ---------- Validate idcomprador
  function do_ajax_form_FACTURA_bkp_mob_validate_idcomprador()
  {
    var nomeCampo_idcomprador = "idcomprador";
    var var_idcomprador = scAjaxGetFieldText(nomeCampo_idcomprador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_idcomprador(var_idcomprador, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_idcomprador_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_idcomprador

  function do_ajax_form_FACTURA_bkp_mob_validate_idcomprador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_idcomprador_cb

  // ---------- Validate razonsocialcomprador
  function do_ajax_form_FACTURA_bkp_mob_validate_razonsocialcomprador()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_razonsocialcomprador(var_razonsocialcomprador, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_razonsocialcomprador_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_razonsocialcomprador

  function do_ajax_form_FACTURA_bkp_mob_validate_razonsocialcomprador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_razonsocialcomprador_cb

  // ---------- Validate totalsinimpuestos
  function do_ajax_form_FACTURA_bkp_mob_validate_totalsinimpuestos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_totalsinimpuestos(var_totalsinimpuestos, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_totalsinimpuestos_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_totalsinimpuestos

  function do_ajax_form_FACTURA_bkp_mob_validate_totalsinimpuestos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_totalsinimpuestos_cb

  // ---------- Validate totaldescuento
  function do_ajax_form_FACTURA_bkp_mob_validate_totaldescuento()
  {
    var nomeCampo_totaldescuento = "totaldescuento";
    var var_totaldescuento = scAjaxGetFieldText(nomeCampo_totaldescuento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_totaldescuento(var_totaldescuento, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_totaldescuento_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_totaldescuento

  function do_ajax_form_FACTURA_bkp_mob_validate_totaldescuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_totaldescuento_cb

  // ---------- Validate base_12
  function do_ajax_form_FACTURA_bkp_mob_validate_base_12()
  {
    var nomeCampo_base_12 = "base_12";
    var var_base_12 = scAjaxGetFieldText(nomeCampo_base_12);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_base_12(var_base_12, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_base_12_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_base_12

  function do_ajax_form_FACTURA_bkp_mob_validate_base_12_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "base_12";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_base_12_cb

  // ---------- Validate base_0
  function do_ajax_form_FACTURA_bkp_mob_validate_base_0()
  {
    var nomeCampo_base_0 = "base_0";
    var var_base_0 = scAjaxGetFieldText(nomeCampo_base_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_base_0(var_base_0, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_base_0_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_base_0

  function do_ajax_form_FACTURA_bkp_mob_validate_base_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "base_0";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_base_0_cb

  // ---------- Validate propina
  function do_ajax_form_FACTURA_bkp_mob_validate_propina()
  {
    var nomeCampo_propina = "propina";
    var var_propina = scAjaxGetFieldText(nomeCampo_propina);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_propina(var_propina, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_propina_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_propina

  function do_ajax_form_FACTURA_bkp_mob_validate_propina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "propina";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_propina_cb

  // ---------- Validate importetotal
  function do_ajax_form_FACTURA_bkp_mob_validate_importetotal()
  {
    var nomeCampo_importetotal = "importetotal";
    var var_importetotal = scAjaxGetFieldText(nomeCampo_importetotal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_importetotal(var_importetotal, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_importetotal_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_importetotal

  function do_ajax_form_FACTURA_bkp_mob_validate_importetotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_importetotal_cb

  // ---------- Validate campoadicional1
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional1()
  {
    var nomeCampo_campoadicional1 = "campoadicional1";
    var var_campoadicional1 = scAjaxGetFieldText(nomeCampo_campoadicional1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional1(var_campoadicional1, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional1_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional1

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional1_cb

  // ---------- Validate valoradicional1
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional1()
  {
    var nomeCampo_valoradicional1 = "valoradicional1";
    var var_valoradicional1 = scAjaxGetFieldText(nomeCampo_valoradicional1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional1(var_valoradicional1, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional1_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional1

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional1_cb

  // ---------- Validate campoadicional2
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional2()
  {
    var nomeCampo_campoadicional2 = "campoadicional2";
    var var_campoadicional2 = scAjaxGetFieldText(nomeCampo_campoadicional2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional2(var_campoadicional2, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional2_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional2

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional2_cb

  // ---------- Validate valoradicional2
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional2()
  {
    var nomeCampo_valoradicional2 = "valoradicional2";
    var var_valoradicional2 = scAjaxGetFieldText(nomeCampo_valoradicional2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional2(var_valoradicional2, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional2_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional2

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional2_cb

  // ---------- Validate campoadicional3
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional3()
  {
    var nomeCampo_campoadicional3 = "campoadicional3";
    var var_campoadicional3 = scAjaxGetFieldText(nomeCampo_campoadicional3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional3(var_campoadicional3, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional3_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional3

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional3_cb

  // ---------- Validate valoradicional3
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional3()
  {
    var nomeCampo_valoradicional3 = "valoradicional3";
    var var_valoradicional3 = scAjaxGetFieldText(nomeCampo_valoradicional3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional3(var_valoradicional3, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional3_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional3

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional3_cb

  // ---------- Validate campoadicional4
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional4()
  {
    var nomeCampo_campoadicional4 = "campoadicional4";
    var var_campoadicional4 = scAjaxGetFieldText(nomeCampo_campoadicional4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional4(var_campoadicional4, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional4_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional4

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional4_cb

  // ---------- Validate valoradicional4
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional4()
  {
    var nomeCampo_valoradicional4 = "valoradicional4";
    var var_valoradicional4 = scAjaxGetFieldText(nomeCampo_valoradicional4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional4(var_valoradicional4, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional4_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional4

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional4_cb

  // ---------- Validate campoadicional5
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional5()
  {
    var nomeCampo_campoadicional5 = "campoadicional5";
    var var_campoadicional5 = scAjaxGetFieldText(nomeCampo_campoadicional5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional5(var_campoadicional5, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional5_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional5

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional5_cb

  // ---------- Validate valoradicional5
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional5()
  {
    var nomeCampo_valoradicional5 = "valoradicional5";
    var var_valoradicional5 = scAjaxGetFieldText(nomeCampo_valoradicional5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional5(var_valoradicional5, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional5_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional5

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional5_cb

  // ---------- Validate campoadicional6
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional6()
  {
    var nomeCampo_campoadicional6 = "campoadicional6";
    var var_campoadicional6 = scAjaxGetFieldText(nomeCampo_campoadicional6);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional6(var_campoadicional6, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional6_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional6

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional6_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional6_cb

  // ---------- Validate valoradicional6
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional6()
  {
    var nomeCampo_valoradicional6 = "valoradicional6";
    var var_valoradicional6 = scAjaxGetFieldText(nomeCampo_valoradicional6);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional6(var_valoradicional6, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional6_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional6

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional6_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional6_cb

  // ---------- Validate campoadicional7
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional7()
  {
    var nomeCampo_campoadicional7 = "campoadicional7";
    var var_campoadicional7 = scAjaxGetFieldText(nomeCampo_campoadicional7);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional7(var_campoadicional7, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional7_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional7

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional7_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional7_cb

  // ---------- Validate valoradicional7
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional7()
  {
    var nomeCampo_valoradicional7 = "valoradicional7";
    var var_valoradicional7 = scAjaxGetFieldText(nomeCampo_valoradicional7);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional7(var_valoradicional7, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional7_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional7

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional7_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional7_cb

  // ---------- Validate campoadicional8
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional8()
  {
    var nomeCampo_campoadicional8 = "campoadicional8";
    var var_campoadicional8 = scAjaxGetFieldText(nomeCampo_campoadicional8);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional8(var_campoadicional8, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional8_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional8

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional8_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional8_cb

  // ---------- Validate valoradicional8
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional8()
  {
    var nomeCampo_valoradicional8 = "valoradicional8";
    var var_valoradicional8 = scAjaxGetFieldText(nomeCampo_valoradicional8);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional8(var_valoradicional8, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional8_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional8

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional8_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional8_cb

  // ---------- Validate campoadicional9
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional9()
  {
    var nomeCampo_campoadicional9 = "campoadicional9";
    var var_campoadicional9 = scAjaxGetFieldText(nomeCampo_campoadicional9);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional9(var_campoadicional9, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional9_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional9

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional9_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional9_cb

  // ---------- Validate valoradicional9
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional9()
  {
    var nomeCampo_valoradicional9 = "valoradicional9";
    var var_valoradicional9 = scAjaxGetFieldText(nomeCampo_valoradicional9);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional9(var_valoradicional9, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional9_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional9

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional9_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional9_cb

  // ---------- Validate campoadicional10
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional10()
  {
    var nomeCampo_campoadicional10 = "campoadicional10";
    var var_campoadicional10 = scAjaxGetFieldText(nomeCampo_campoadicional10);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional10(var_campoadicional10, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional10_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional10

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional10_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional10_cb

  // ---------- Validate valoradicional10
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional10()
  {
    var nomeCampo_valoradicional10 = "valoradicional10";
    var var_valoradicional10 = scAjaxGetFieldText(nomeCampo_valoradicional10);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional10(var_valoradicional10, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional10_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional10

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional10_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional10_cb

  // ---------- Validate campoadicional11
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional11()
  {
    var nomeCampo_campoadicional11 = "campoadicional11";
    var var_campoadicional11 = scAjaxGetFieldText(nomeCampo_campoadicional11);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional11(var_campoadicional11, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional11_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional11

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional11_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional11_cb

  // ---------- Validate valoradicional11
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional11()
  {
    var nomeCampo_valoradicional11 = "valoradicional11";
    var var_valoradicional11 = scAjaxGetFieldText(nomeCampo_valoradicional11);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional11(var_valoradicional11, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional11_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional11

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional11_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional11_cb

  // ---------- Validate campoadicional12
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional12()
  {
    var nomeCampo_campoadicional12 = "campoadicional12";
    var var_campoadicional12 = scAjaxGetFieldText(nomeCampo_campoadicional12);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional12(var_campoadicional12, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional12_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional12

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional12_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional12_cb

  // ---------- Validate valoradicional12
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional12()
  {
    var nomeCampo_valoradicional12 = "valoradicional12";
    var var_valoradicional12 = scAjaxGetFieldText(nomeCampo_valoradicional12);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional12(var_valoradicional12, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional12_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional12

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional12_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional12_cb

  // ---------- Validate campoadicional13
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional13()
  {
    var nomeCampo_campoadicional13 = "campoadicional13";
    var var_campoadicional13 = scAjaxGetFieldText(nomeCampo_campoadicional13);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional13(var_campoadicional13, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional13_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional13

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional13_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional13_cb

  // ---------- Validate valoradicional13
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional13()
  {
    var nomeCampo_valoradicional13 = "valoradicional13";
    var var_valoradicional13 = scAjaxGetFieldText(nomeCampo_valoradicional13);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional13(var_valoradicional13, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional13_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional13

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional13_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional13_cb

  // ---------- Validate campoadicional14
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional14()
  {
    var nomeCampo_campoadicional14 = "campoadicional14";
    var var_campoadicional14 = scAjaxGetFieldText(nomeCampo_campoadicional14);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional14(var_campoadicional14, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional14_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional14

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional14_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional14_cb

  // ---------- Validate valoradicional14
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional14()
  {
    var nomeCampo_valoradicional14 = "valoradicional14";
    var var_valoradicional14 = scAjaxGetFieldText(nomeCampo_valoradicional14);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional14(var_valoradicional14, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional14_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional14

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional14_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional14_cb

  // ---------- Validate campoadicional15
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional15()
  {
    var nomeCampo_campoadicional15 = "campoadicional15";
    var var_campoadicional15 = scAjaxGetFieldText(nomeCampo_campoadicional15);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional15(var_campoadicional15, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional15_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional15

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional15_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional15_cb

  // ---------- Validate valoradicional15
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional15()
  {
    var nomeCampo_valoradicional15 = "valoradicional15";
    var var_valoradicional15 = scAjaxGetFieldText(nomeCampo_valoradicional15);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional15(var_valoradicional15, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional15_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional15

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional15_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional15_cb

  // ---------- Validate campoadicional16
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional16()
  {
    var nomeCampo_campoadicional16 = "campoadicional16";
    var var_campoadicional16 = scAjaxGetFieldText(nomeCampo_campoadicional16);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional16(var_campoadicional16, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional16_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional16

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional16_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional16_cb

  // ---------- Validate valoradicional16
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional16()
  {
    var nomeCampo_valoradicional16 = "valoradicional16";
    var var_valoradicional16 = scAjaxGetFieldText(nomeCampo_valoradicional16);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional16(var_valoradicional16, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional16_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional16

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional16_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional16_cb

  // ---------- Validate campoadicional17
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional17()
  {
    var nomeCampo_campoadicional17 = "campoadicional17";
    var var_campoadicional17 = scAjaxGetFieldText(nomeCampo_campoadicional17);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional17(var_campoadicional17, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional17_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional17

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional17_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional17_cb

  // ---------- Validate valoradicional17
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional17()
  {
    var nomeCampo_valoradicional17 = "valoradicional17";
    var var_valoradicional17 = scAjaxGetFieldText(nomeCampo_valoradicional17);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional17(var_valoradicional17, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional17_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional17

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional17_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional17_cb

  // ---------- Validate campoadicional18
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional18()
  {
    var nomeCampo_campoadicional18 = "campoadicional18";
    var var_campoadicional18 = scAjaxGetFieldText(nomeCampo_campoadicional18);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional18(var_campoadicional18, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional18_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional18

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional18_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional18_cb

  // ---------- Validate valoradicional18
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional18()
  {
    var nomeCampo_valoradicional18 = "valoradicional18";
    var var_valoradicional18 = scAjaxGetFieldText(nomeCampo_valoradicional18);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional18(var_valoradicional18, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional18_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional18

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional18_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional18_cb

  // ---------- Validate campoadicional19
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional19()
  {
    var nomeCampo_campoadicional19 = "campoadicional19";
    var var_campoadicional19 = scAjaxGetFieldText(nomeCampo_campoadicional19);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional19(var_campoadicional19, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional19_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional19

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional19_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional19_cb

  // ---------- Validate valoradicional19
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional19()
  {
    var nomeCampo_valoradicional19 = "valoradicional19";
    var var_valoradicional19 = scAjaxGetFieldText(nomeCampo_valoradicional19);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional19(var_valoradicional19, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional19_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional19

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional19_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional19_cb

  // ---------- Validate campoadicional20
  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional20()
  {
    var nomeCampo_campoadicional20 = "campoadicional20";
    var var_campoadicional20 = scAjaxGetFieldText(nomeCampo_campoadicional20);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_campoadicional20(var_campoadicional20, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_campoadicional20_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional20

  function do_ajax_form_FACTURA_bkp_mob_validate_campoadicional20_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_campoadicional20_cb

  // ---------- Validate valoradicional20
  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional20()
  {
    var nomeCampo_valoradicional20 = "valoradicional20";
    var var_valoradicional20 = scAjaxGetFieldText(nomeCampo_valoradicional20);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_valoradicional20(var_valoradicional20, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_valoradicional20_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional20

  function do_ajax_form_FACTURA_bkp_mob_validate_valoradicional20_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_valoradicional20_cb

  // ---------- Validate detalle_factura
  function do_ajax_form_FACTURA_bkp_mob_validate_detalle_factura()
  {
    var nomeCampo_detalle_factura = "detalle_factura";
    var var_detalle_factura = scAjaxGetFieldText(nomeCampo_detalle_factura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_FACTURA_bkp_mob_validate_detalle_factura(var_detalle_factura, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_validate_detalle_factura_cb);
  } // do_ajax_form_FACTURA_bkp_mob_validate_detalle_factura

  function do_ajax_form_FACTURA_bkp_mob_validate_detalle_factura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_FACTURA_bkp_mob_validate_detalle_factura_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_FACTURA_bkp_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_FACTURA_bkp_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_FACTURA_bkp_mob_submit_form_cb_after_alert);
  } // do_ajax_form_FACTURA_bkp_mob_submit_form_cb
  function do_ajax_form_FACTURA_bkp_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_FACTURA_bkp_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_DETALLE_FACTURA_mob"] = "off";

  function do_ajax_form_FACTURA_bkp_mob_navigate_form()
  {
    perform_ajax_form_FACTURA_bkp_mob_navigate_form();
  }

  function perform_ajax_form_FACTURA_bkp_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_FACTURA_bkp_mob_navigate_form(var_estab, var_ptoemi, var_secuencial, var_lote, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_FACTURA_bkp_mob_navigate_form_cb);
  } // do_ajax_form_FACTURA_bkp_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_FACTURA_bkp_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_FACTURA_bkp_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_FACTURA_bkp_mob_navigate_form_cb
  function do_ajax_form_FACTURA_bkp_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_FACTURA_bkp_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_FACTURA_bkp_mob_navigate_form_cb_after_alert
  function sc_hide_form_FACTURA_bkp_mob_form()
  {
