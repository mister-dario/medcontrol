...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->v_aplicacion_link)) 
          {
              $_SESSION['v_aplicacion_link'] = $this->v_aplicacion_link;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_FACTURA_bkp_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_FACTURA_bkp']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_FACTURA_bkp']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_FACTURA_bkp'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_FACTURA_bkp']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_FACTURA_bkp']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_FACTURA_bkp') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_FACTURA_bkp']['label'] = "form_FACTURA_bkp";
      ...
      $_SESSION['scriptcase']['error_icon']['form_FACTURA_bkp']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_FACTURA_bkp'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_FACTURA_bkp']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_FACTURA_bkp'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_FACTURA_bkp'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_FACTURA_bkp_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_FACTURA_bkp_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_FACTURA_bkp/form_FACTURA_bkp_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_FACTURA_bkp_erro.class.php"); 
      }
      $this->Erro      = new form_FACTURA_bkp_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opcao']))
         { 
             if ($this->estab != "" || $this->ptoemi != "" || $this->secuencial != "" || $this->lote != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_FACTURA_bkp']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['redo_xml'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['botoes']['redo_xml'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['total']);
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_FACTURA_bkp.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_FACTURA_bkp_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_FACTURA_bkp"> 
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->estab) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dados_form']['estab']))
          {
              $varloc_btn_php['estab'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dados_form']['estab'];
          }
          if (!isset($this->ptoemi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dados_form']['ptoemi']))
          {
              $varloc_btn_php['ptoemi'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dados_form']['ptoemi'];
          }
          if (!isset($this->secuencial) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dados_form']['secuencial']))
          {
              $varloc_btn_php['secuencial'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dados_form']['secuencial'];
          }
          if (!isset($this->lote) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dados_form']['lote']))
          {
              $varloc_btn_php['lote'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dados_form']['lote'];
          }
          if (!isset($this->citid) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dados_form']['citid']))
          {
              $varloc_btn_php['citid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dados_form']['citid'];
          }
      }
      $nm_f_saida = "./";
      ...
      $_SESSION['scriptcase']['form_FACTURA_bkp']['contr_erro'] = 'on';
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_FACTURA_bkp']) || !is_array($this->NM_ajax_info['errList']['geral_form_FACTURA_bkp']))
              {
                  $this->NM_ajax_info['errList']['geral_form_FACTURA_bkp'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_FACTURA_bkp'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_fechaemision(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['fechaemision']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['fechaemision'] == "on")) 
      { 
    ...
    function ValidateField_guiaremision(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['guiaremision']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['guiaremision'] == "on")) 
      { 
    ...
    function ValidateField_idcomprador(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['idcomprador']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['idcomprador'] == "on")) 
      { 
          if ($this->idcomprador == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_razonsocialcomprador(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['razonsocialcomprador']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['razonsocialcomprador'] == "on")) 
      { 
    ...
    function ValidateField_totalsinimpuestos(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['totalsinimpuestos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['totalsinimpuestos'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_totaldescuento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['totaldescuento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['totaldescuento'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_base_12(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['base_12']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['base_12'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_base_0(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['base_0']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['base_0'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "BASE 0%" ; 
              if (!isset($Campos_Erros['base_0']))
    ...
    function ValidateField_propina(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['propina']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['propina'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_importetotal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['importetotal']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['importetotal'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_campoadicional1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional1'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional1(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional1'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional2'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional2'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional3(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional3'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional3(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional3'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional4(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional4'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional4(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional4']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional4'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional5(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional5']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional5'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional5(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional5']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional5'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional6(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional6']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional6'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional6(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional6']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional6'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional7(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional7']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional7'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional7(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional7']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional7'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional8(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional8']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional8'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional8(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional8']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional8'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional9(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional9']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional9'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional9(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional9']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional9'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional10(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional10']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional10'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional10(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional10']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional10'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional11(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional11']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional11'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional11(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional11']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional11'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional12(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional12']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional12'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional12(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional12']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional12'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional13(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional13']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional13'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional13(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional13']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional13'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional14(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional14']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional14'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional14(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional14']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional14'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional15(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional15']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional15'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional15(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional15']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional15'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional16(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional16']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional16'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional16(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional16']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional16'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional17(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional17']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional17'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional17(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional17']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional17'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional18(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional18']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional18'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional18(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional18']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional18'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional19(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional19']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional19'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional19(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional19']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional19'] == "on")) 
      { 
    ...
    function ValidateField_campoadicional20(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional20']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['campoadicional20'] == "on")) 
      { 
    ...
    function ValidateField_valoradicional20(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional20']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['php_cmp_required']['valoradicional20'] == "on")) 
      { 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['estab']['keyVal'] = form_FACTURA_bkp_pack_protect_string($this->nmgp_dados_form['estab']);
              $this->NM_ajax_info['fldList']['ptoemi']['keyVal'] = form_FACTURA_bkp_pack_protect_string($this->nmgp_dados_form['ptoemi']);
              $this->NM_ajax_info['fldList']['secuencial']['keyVal'] = form_FACTURA_bkp_pack_protect_string($this->nmgp_dados_form['secuencial']);
              $this->NM_ajax_info['fldList']['lote']['keyVal'] = form_FACTURA_bkp_pack_protect_string($this->nmgp_dados_form['lote']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['foreign_key']['estab'] = $this->nmgp_dados_form['estab'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['foreign_key']['ptoemi'] = $this->nmgp_dados_form['ptoemi'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['foreign_key']['secuencial'] = $this->nmgp_dados_form['secuencial'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['foreign_key']['lote'] = $this->nmgp_dados_form['lote'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['where_filter'] = "ESTAB = " . $this->nmgp_dados_form['estab'] . " AND PTOEMI = " . $this->nmgp_dados_form['ptoemi'] . " AND SECUENCIAL = " . $this->nmgp_dados_form['secuencial'] . " AND LOTE = '" . $this->nmgp_dados_form['lote'] . "'";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['where_detal']  = "ESTAB = " . $this->nmgp_dados_form['estab'] . " AND PTOEMI = " . $this->nmgp_dados_form['ptoemi'] . " AND SECUENCIAL = " . $this->nmgp_dados_form['secuencial'] . " AND LOTE = '" . $this->nmgp_dados_form['lote'] . "'";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['total']);
          }
   ...
   function ajax_return_values_detalle_factura($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opcao'] = '';
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['parms'] = "estab?#?$this->estab?@?ptoemi?#?$this->ptoemi?@?secuencial?#?$this->secuencial?@?lote?#?$this->lote?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['redo_xml'] = $this->nmgp_botoes['redo_xml'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dados_select'] = $this->nmgp_dados_select;
...
//-- 
      ...
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_parms'] = "NM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout";
  }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_FACTURA_bkp_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_FACTURA_bkp = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['total'] = $qt_geral_reg_form_FACTURA_bkp;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_FACTURA_bkp_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_FACTURA_bkp_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_FACTURA_bkp_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['retorno_edit'] = "";
   }
