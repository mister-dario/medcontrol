...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - FACTURA"); } else { echo strip_tags(""); } ?></TITLE>
...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_FACTURA_bkp/form_FACTURA_bkp_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_FACTURA_bkp_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_FACTURA_bkp_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    $vertical_center = '';
...
<?php
 include_once("form_FACTURA_bkp_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_FACTURA_bkp'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_FACTURA_bkp'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] != "R")
{
?>
...
<?php 
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['redo_xml'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "redo_xml", "scBtnFn_redo_xml()", "scBtnFn_redo_xml()", "sc_redo_xml_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
   ...
   <tr>
    ...
    <TD colspan="5" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont">DATOS FACTURA</TD>
...
?>
<?php
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['guiaremision']))
           {
               $this->nmgp_cmp_readonly['guiaremision'] = 'on';
           }
?>
<?php
...
<span id="id_read_on_fechaemision" class="sc-ui-readonly-fechaemision css_fechaemision_line" style="<?php echo $sStyleReadLab_fechaemision; ?>"><?php echo $this->form_format_readonly("fechaemision", $this->form_encode_input($this->fechaemision)); ?></span><span id="id_read_off_fechaemision" class="css_read_off_fechaemision" style="white-space: nowrap;<?php echo $sStyleReadInp_fechaemision; ?>">
 ...
 size=10 maxlength=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
   ...
   <?php
    if (!isset($this->nm_new_label['guiaremision']))
    {
        $this->nm_new_label['guiaremision'] = "GUÍA DE REMISIÓN";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $sStyleHidden_guiaremision = '';
   if (isset($this->nmgp_cmp_hidden['guiaremision']) && $this->nmgp_cmp_hidden['guiaremision'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['guiaremision']);
       $sStyleHidden_guiaremision = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_guiaremision = 'display: none;';
   $sStyleReadInp_guiaremision = '';
   if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["guiaremision"]) &&  $this->nmgp_cmp_readonly["guiaremision"] == "on"))
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['guiaremision']);
       $sStyleReadLab_guiaremision = '';
       $sStyleReadInp_guiaremision = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['guiaremision']) && $this->nmgp_cmp_hidden['guiaremision'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="guiaremision" value="<?php echo $this->form_encode_input($guiaremision) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_guiaremision_line" id="hidden_field_data_guiaremision" style="<?php echo $sStyleHidden_guiaremision; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_guiaremision_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_guiaremision_label" style=""><span id="id_label_guiaremision"><?php echo $this->nm_new_label['guiaremision']; ?></span></span><br>
<?php if ($bTestReadOnly && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["guiaremision"]) &&  $this->nmgp_cmp_readonly["guiaremision"] == "on")) { 

 ?>
<input type="hidden" name="guiaremision" value="<?php echo $this->form_encode_input($guiaremision) . "\"><span id=\"id_ajax_label_guiaremision\">" . $guiaremision . "</span>"; ?>
<?php } else { ?>
<span id="id_read_on_guiaremision" class="sc-ui-readonly-guiaremision css_guiaremision_line" style="<?php echo $sStyleReadLab_guiaremision; ?>"><?php echo $this->form_format_readonly("guiaremision", $this->form_encode_input($this->guiaremision)); ?></span><span id="id_read_off_guiaremision" class="css_read_off_guiaremision" style="white-space: nowrap;<?php echo $sStyleReadInp_guiaremision; ?>">
 <input class="sc-js-input scFormObjectOdd css_guiaremision_obj" style="" id="id_sc_field_guiaremision" type=text name="guiaremision" value="<?php echo $this->form_encode_input($guiaremision) ?>"
 size=17 maxlength=17 alt="{datatype: 'text', maxLength: 17, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_guiaremision_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_guiaremision_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>

   <?php
    if (!isset($this->nm_new_label['idcomprador']))
    {
        $this->nm_new_label['idcomprador'] = "RUC";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<span id="id_read_on_idcomprador" class="sc-ui-readonly-idcomprador css_idcomprador_line" style="<?php echo $sStyleReadLab_idcomprador; ?>"><?php echo $this->form_format_readonly("idcomprador", $this->form_encode_input($this->idcomprador)); ?></span><span id="id_read_off_idcomprador" class="css_read_off_idcomprador" style="white-space: nowrap;<?php echo $sStyleReadInp_idcomprador; ?>">
 ...
 size=13 maxlength=13 alt="{datatype: 'text', maxLength: 13, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
   ...
   <?php
    ...
    {
        $this->nm_new_label['razonsocialcomprador'] = "RAZÓN SOCIAL";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php $sStyleHidden_guiaremision_dumb = ('' == $sStyleHidden_guiaremision) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_guiaremision_dumb" style="<?php echo $sStyleHidden_guiaremision_dumb; ?>"></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_propina_line" id="hidden_field_data_propina" style="<?php echo $sStyleHidden_propina; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_propina_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_propina_label" style=""><span id="id_label_propina"><?php echo $this->nm_new_label['propina']; ?></span></span><br>
...
<?php } else { ?>
<span id="id_read_on_propina" class="sc-ui-readonly-propina css_propina_line" style="<?php echo $sStyleReadLab_propina; ?>"><?php echo $this->form_format_readonly("propina", $this->form_encode_input($this->propina)); ?></span><span id="id_read_off_propina" class="css_read_off_propina" style="white-space: nowrap;<?php echo $sStyleReadInp_propina; ?>">
 <input class="sc-js-input scFormObjectOdd css_propina_obj" style="" id="id_sc_field_propina" type=text name="propina" value="<?php echo $this->form_encode_input($propina) ?>"
 size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 2, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['propina']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['propina']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['propina']['symbol_fmt']; ?>, manualDecimals: true, allowNegative: true, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['propina']['format_neg'] ? "'suffix'" : "'prefix'") ?>, enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php $sStyleHidden_propina_dumb = ('' == $sStyleHidden_propina) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_propina_dumb" style="<?php echo $sStyleHidden_propina_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
<?php
...
<TABLE align="center" id="hidden_bloco_2" class="scFormTable" width="100%" style="height: 100%;">   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont">DETALLE DE LA FACTURA</TD>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_factura'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_factura'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_factura'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_DETALLE_FACTURA']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init'] ]['form_FACTURA_bkp']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_FACTURA_bkp_empty.htm' : $this->Ini->link_form_DETALLE_FACTURA_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_detalle_factura']) && 'nmsc_iframe_liga_form_DETALLE_FACTURA' != $this->Ini->sc_lig_target['C_@scinf_detalle_factura'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detalle_factura'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['form_DETALLE_FACTURA_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
    scOpenMasterDetail("<?php echo $this->Ini->sc_lig_target['C_@scinf_detalle_factura'] ?>", "<?php echo $sDetailSrc; ?>");
});
</script>
<?php
}
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_DETALLE_FACTURA"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_DETALLE_FACTURA"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_FACTURA_bkp");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_FACTURA_bkp");
 parent.scAjaxDetailHeight("form_FACTURA_bkp", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<script type="text/javascript">
	function scBtnFn_redo_xml() {
		if ($("#sc_redo_xml_top").length && $("#sc_redo_xml_top").is(":visible")) {
			sc_btn_redo_xml()
			 return;
		}
	}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_FACTURA_bkp']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
