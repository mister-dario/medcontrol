<?php
//
class form_detalle_cita_presup_apl
{
   ...
   var $form_vert_form_detalle_cita_presup = array();
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_detalle_cita_presup']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_detalle_cita_presup']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_detalle_cita_presup']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_detalle_cita_presup']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_detalle_cita_presup']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_detalle_cita_presup']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->v_facturado)) 
          {
              $_SESSION['v_facturado'] = $this->v_facturado;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_detalle_cita_presup']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_detalle_cita_presup']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_detalle_cita_presup']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_detalle_cita_presup']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_detalle_cita_presup']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_detalle_cita_presup']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_detalle_cita_presup']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_detalle_cita_presup']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_detalle_cita_presup']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_detalle_cita_presup_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_detalle_cita_presup']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_detalle_cita_presup']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_detalle_cita_presup'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detalle_cita_presup']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detalle_cita_presup']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_detalle_cita_presup') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detalle_cita_presup']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " detalle_citadiagnos";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_detalle_cita_presup")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_detalle_cita_presup']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_detalle_cita_presup'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalle_cita_presup']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_detalle_cita_presup'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_detalle_cita_presup'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['exit'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_detalle_cita_presup", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_detalle_cita_presup_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_detalle_cita_presup_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_detalle_cita_presup/form_detalle_cita_presup_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_detalle_cita_presup_erro.class.php"); 
      }
      $this->Erro      = new form_detalle_cita_presup_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['sc_max_reg']) == "all")
      {
          $this->form_paginacao = "total";
      }
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['opcao']))
         { 
             if ($this->dcdsecuen_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['final'];
      }
      else
      {
      }
...
//
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "change_qtd_line")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['sc_max_reg'] = $this->nmgp_max_line;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dados_form'][$sc_seq_vert];
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_detalle_cita_presup']) || !is_array($this->NM_ajax_info['errList']['geral_form_detalle_cita_presup']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_detalle_cita_presup'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_detalle_cita_presup'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_detalle_cita_presup'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_detalle_cita_presup'][] = $this->Campos_Mens_erro;
                  }
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['sc_redir_atualiz'] == "ok")
          {
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_detalle_cita_presup_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_detalle_cita_presup_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      { 
         ...
         if (isset($this->dcdporcendesc_)) { $this->nm_limpa_alfa($this->dcdporcendesc_); }
         if (isset($this->dcdtotal_)) { $this->nm_limpa_alfa($this->dcdtotal_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dados_select'][$sc_seq_vert];
         }
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_detalle_cita_presup[$sc_seq_vert]['sercodigo_'] =  $this->sercodigo_; 
             $this->form_vert_form_detalle_cita_presup[$sc_seq_vert]['dcdcantidad_'] =  $this->dcdcantidad_; 
             $this->form_vert_form_detalle_cita_presup[$sc_seq_vert]['dcdprecio_'] =  $this->dcdprecio_; 
             $this->form_vert_form_detalle_cita_presup[$sc_seq_vert]['dcdporcendesc_'] =  $this->dcdporcendesc_; 
             $this->form_vert_form_detalle_cita_presup[$sc_seq_vert]['dcdtotal_'] =  $this->dcdtotal_; 
             $this->form_vert_form_detalle_cita_presup[$sc_seq_vert]['dcdsecuen_'] =  $this->dcdsecuen_; 
             $this->form_vert_form_detalle_cita_presup[$sc_seq_vert]['citid_'] =  $this->citid_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_detalle_cita_presup);
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_detalle_cita_presup.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_detalle_cita_presup_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_detalle_cita_presup"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_detalle_cita_presup'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      {
      $_SESSION['scriptcase']['form_detalle_cita_presup']['contr_erro'] = 'on';
...
if ($error_test)
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_detalle_cita_presup' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_detalle_cita_presup']['contr_erro'] = 'off'; 
    ...
    function ValidateField_sercodigo_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['php_cmp_required']['sercodigo_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['php_cmp_required']['sercodigo_'] == "on")) 
      { 
          if ($this->sercodigo_ == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_dcdcantidad_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['php_cmp_required']['dcdcantidad_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['php_cmp_required']['dcdcantidad_'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_dcdprecio_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['php_cmp_required']['dcdprecio_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['php_cmp_required']['dcdprecio_'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "PRECIO" ; 
              if (!isset($Campos_Erros['dcdprecio_']))
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['dcdsecuen_']['keyVal'] = form_detalle_cita_presup_pack_protect_string($this->nmgp_dados_form['dcdsecuen_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_detalle_cita_presup[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_detalle_cita_presup[$this->nmgp_refresh_row]['sercodigo_'] = $this->sercodigo_;
                  }
                  if (isset($this->NM_ajax_changed['dcdcantidad_']) && $this->NM_ajax_changed['dcdcantidad_'])
                  {
                      $this->form_vert_form_detalle_cita_presup[$this->nmgp_refresh_row]['dcdcantidad_'] = $this->dcdcantidad_;
                  }
                  if (isset($this->NM_ajax_changed['dcdprecio_']) && $this->NM_ajax_changed['dcdprecio_'])
                  {
                      $this->form_vert_form_detalle_cita_presup[$this->nmgp_refresh_row]['dcdprecio_'] = $this->dcdprecio_;
                  }
                  if (isset($this->NM_ajax_changed['dcdporcendesc_']) && $this->NM_ajax_changed['dcdporcendesc_'])
                  {
                      $this->form_vert_form_detalle_cita_presup[$this->nmgp_refresh_row]['dcdporcendesc_'] = $this->dcdporcendesc_;
                  }
                  if (isset($this->NM_ajax_changed['dcdtotal_']) && $this->NM_ajax_changed['dcdtotal_'])
                  {
                      $this->form_vert_form_detalle_cita_presup[$this->nmgp_refresh_row]['dcdtotal_'] = $this->dcdtotal_;
                  }
                  if (isset($this->NM_ajax_changed['dcdsecuen_']) && $this->NM_ajax_changed['dcdsecuen_'])
                  {
                      $this->form_vert_form_detalle_cita_presup[$this->nmgp_refresh_row]['dcdsecuen_'] = $this->dcdsecuen_;
                  }
              }
          }
          ...
          foreach($this->form_vert_form_detalle_cita_presup as $sc_seq_vert => $aRecData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['sercodigo_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][form_detalle_cita_presup_pack_protect_string($aRecData['sercodigo_'])]),
              );
              }
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
$_SESSION['scriptcase']['form_detalle_cita_presup']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              if (isset($NM_val_form['dcdtotal_']) && $NM_val_form['dcdtotal_'] != $this->nmgp_dados_select['dcdtotal_']) 
              { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['total']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_qtd']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_I_E']++; 
              $this->NM_gera_nav_page(); 
              $this->NM_ajax_info['navPage'] = $this->SC_nav_page; 
              $this->sc_teve_incl = true; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dados_select'][$sc_seq_vert]['sercodigo_'] = $this->sercodigo_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dados_select'][$sc_seq_vert]['dcdcantidad_'] = $this->dcdcantidad_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dados_select'][$sc_seq_vert]['dcdprecio_'] = $this->dcdprecio_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dados_select'][$sc_seq_vert]['dcdporcendesc_'] = $this->dcdporcendesc_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dados_select'][$sc_seq_vert]['dcdtotal_'] = $this->dcdtotal_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dados_select'][$sc_seq_vert]['dcdsecuen_'] = $this->dcdsecuen_;
              if (!empty($this->sc_force_zero))
              {
                  foreach ($this->sc_force_zero as $i_force_zero => $sc_force_zero_field)
                  {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $tmpLabel_sercodigo_ = $val_output;
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_detalle_cita_presup']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['parms'] = "dcdsecuen_?#?$this->dcdsecuen_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_detalle_cita_presup']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_liga_qtd_reg'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['sc_max_reg']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['sc_max_reg'] > 0 || strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['sc_max_reg']) == "all"))
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['sc_max_reg'];
      } 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_detalle_cita_presup = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['parms'] = ""; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      { 
          $GLOBALS["NM_ERRO_IBASE"] = 1;  
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_filter'] . ")";
          }
      }
      $sc_where = "";
      if ('' != $sc_where_filter)
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['total']))
          {
              ...
              $qt_geral_reg_form_detalle_cita_presup = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['total'] = $qt_geral_reg_form_detalle_cita_presup;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['total']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_I_E'] = 0; 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->dcdsecuen_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_detalle_cita_presup = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_detalle_cita_presup) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] += ($this->sc_max_reg + $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_I_E']); 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] > $qt_geral_reg_form_detalle_cita_presup)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] = $qt_geral_reg_form_detalle_cita_presup - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] = ($qt_geral_reg_form_detalle_cita_presup + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['ordem_ord']; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
      ...
      else
      {
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          { 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['parms'] = "dcdsecuen_?#?$this->dcdsecuen_?@?";
              } 
              $this->nm_proc_onload_record($sc_seq_vert);
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_detalle_cita_presup[$sc_seq_vert]['sercodigo_'] =  $this->sercodigo_; 
             $this->form_vert_form_detalle_cita_presup[$sc_seq_vert]['dcdcantidad_'] =  $this->dcdcantidad_; 
          ...
          ksort ($this->form_vert_form_detalle_cita_presup); 
          $rs->Close(); 
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] < (($qt_geral_reg_form_detalle_cita_presup + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['embutida_multi']) 
          { 
          } 
          else 
          { 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['reg_start'] + $this->sc_max_reg;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$titulo_cita1=$this->ds[0][0]." ".$this->ds[0][1]." (".$this->ds[0][2].")";
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_detalle_cita_presup = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['total'] = $qt_geral_reg_form_detalle_cita_presup;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_detalle_cita_presup_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_detalle_cita_presup_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_detalle_cita_presup_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['masterValue']))
{
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalle_cita_presup']['retorno_edit'] = "";
   }
