...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["main_menu"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["main_menu"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["main_menu"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($main_menu_menuData["data"]) && is_array($main_menu_menuData["data"]) && !empty($main_menu_menuData["data"]))
    {
        foreach($main_menu_menuData["data"] as $arr_item)
        {
   ...
   <TABLE width="100%" class="scMenuHHeader">
    ...
    <?php
        escreveMenuMobile($main_menu_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
