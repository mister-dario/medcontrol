 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-medico", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_sec_form_edit_users_event_medico_onchange) { do_ajax_sec_form_edit_users_event_medico_onchange(sRow); }
    }
   }
...
<?php 
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['fast_search'][2] : "";
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_label" id="hidden_field_label_tipo" style="<?php echo $sStyleHidden_tipo; ?>"><span id="id_label_tipo"><?php echo $this->nm_new_label['tipo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['php_cmp_required']['tipo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['php_cmp_required']['tipo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
$tipo_look = "";
 ...
 if ($this->tipo == "2") { $tipo_look .= "Médico" ;} 
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_tipo'][] = ''; ?>
 <option value="">------------------------</option>
 <option  value="0" <?php  if ($this->tipo == "0") { echo " selected" ;} ?>>Super Usuario</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_tipo'][] = '0'; ?>
 <option  value="1" <?php  if ($this->tipo == "1") { echo " selected" ;} ?>>Administrador</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_tipo'][] = '1'; ?>
 <option  value="2" <?php  if ($this->tipo == "2") { echo " selected" ;} ?>>Médico</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_tipo'][] = '2'; ?>
 <option  value="3" <?php  if ($this->tipo == "3") { echo " selected" ;} ?>>Digitador</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_tipo'][] = '3'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['medico'] = "Médico Asignado";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sucursal_label" id="hidden_field_label_sucursal" style="<?php echo $sStyleHidden_sucursal; ?>"><span id="id_label_sucursal"><?php echo $this->nm_new_label['sucursal']; ?></span></TD>
    <TD class="scFormDataOdd css_sucursal_line" id="hidden_field_data_sucursal" style="<?php echo $sStyleHidden_sucursal; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_sucursal'][] = '1'; ?>
 <option  value="2" <?php  if ($this->sucursal == "2") { echo " selected" ;} ?>>Guayaquil</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_sucursal'][] = '2'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bcancelar", "scBtnFn_sys_format_cnl()", "scBtnFn_sys_format_cnl()", "sc_b_sai_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-8", "", "");?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
