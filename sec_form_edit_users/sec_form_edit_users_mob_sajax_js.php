...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate tipo
  function do_ajax_sec_form_edit_users_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_sec_form_edit_users_mob_validate_tipo_cb);
  } // do_ajax_sec_form_edit_users_mob_validate_tipo

  function do_ajax_sec_form_edit_users_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_mob_validate_tipo_cb

  // ---------- Validate medico
  function do_ajax_sec_form_edit_users_mob_validate_medico()
  {
  } // do_ajax_sec_form_edit_users_mob_validate_medico

  function do_ajax_sec_form_edit_users_mob_validate_medico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medico";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_mob_validate_medico_cb
  ...
  // ---------- Validate sucursal
  function do_ajax_sec_form_edit_users_mob_validate_sucursal()
  {
    var nomeCampo_sucursal = "sucursal";
    var var_sucursal = scAjaxGetFieldSelect(nomeCampo_sucursal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_mob_validate_sucursal(var_sucursal, var_script_case_init, do_ajax_sec_form_edit_users_mob_validate_sucursal_cb);
  } // do_ajax_sec_form_edit_users_mob_validate_sucursal

  function do_ajax_sec_form_edit_users_mob_validate_sucursal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_mob_validate_sucursal_cb

  // ---------- Validate priv_admin
  function do_ajax_sec_form_edit_users_mob_validate_priv_admin()
  {
    var nomeCampo_priv_admin = "priv_admin";
    var var_priv_admin = scAjaxGetFieldText(nomeCampo_priv_admin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_mob_validate_priv_admin(var_priv_admin, var_script_case_init, do_ajax_sec_form_edit_users_mob_validate_priv_admin_cb);
  } // do_ajax_sec_form_edit_users_mob_validate_priv_admin

  function do_ajax_sec_form_edit_users_mob_validate_priv_admin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_mob_validate_priv_admin_cb

  // ---------- Event onchange tipo
  function do_ajax_sec_form_edit_users_mob_event_tipo_onchange()
  {
    var var_tipo = scAjaxGetFieldSelect("tipo");
    var var_medico = scAjaxGetFieldText("medico");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_sec_form_edit_users_mob_event_tipo_onchange(var_tipo, var_medico, var_script_case_init, do_ajax_sec_form_edit_users_mob_event_tipo_onchange_cb);
  } // do_ajax_sec_form_edit_users_mob_event_tipo_onchange

  function do_ajax_sec_form_edit_users_mob_event_tipo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tipo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_sec_form_edit_users_mob_event_tipo_onchange_cb_after_alert);
  } // do_ajax_sec_form_edit_users_mob_event_tipo_onchange_cb
  function do_ajax_sec_form_edit_users_mob_event_tipo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_sec_form_edit_users_mob_event_tipo_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_sec_form_edit_users_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_sec_form_edit_users_mob_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_tipo, var_medico, var_active, var_sucursal, var_priv_admin, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_sec_form_edit_users_mob_submit_form_cb);
...
?>
  ...
  function perform_ajax_sec_form_edit_users_mob_navigate_form()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_sec_form_edit_users_mob_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_sec_form_edit_users_mob_navigate_form_cb);
...
?>
  ...
  ajax_field_list[5] = "tipo";
  ajax_field_list[6] = "medico";
  ajax_field_list[7] = "active";
  ajax_field_list[8] = "sucursal";
  ajax_field_list[9] = "priv_admin";
  ...
  var ajax_error_list = {
    ...
    "tipo": {"label": "Perfil", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "medico": {"label": "Médico Asignado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "sucursal": {"label": "Sucursal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
