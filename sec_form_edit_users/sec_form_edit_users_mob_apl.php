   ...
   function ini_controle()
   {
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_form_edit_users_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_form_edit_users_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_list_users'] . "";
      ...
      if ($this->nmgp_opcao == "fast_search")  
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['opcao'] = "inicio";
...
$_SESSION['scriptcase']['sec_form_edit_users_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_tipo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['php_cmp_required']['tipo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['php_cmp_required']['tipo'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Perfil" ;
    ...
    function ValidateField_priv_admin(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_sec_users_fild_priv_admin'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 1 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
...
$aLookup[] = array(sec_form_edit_users_mob_pack_protect_string('0') => str_replace('<', '&lt;',sec_form_edit_users_mob_pack_protect_string("Super Usuario")));
$aLookup[] = array(sec_form_edit_users_mob_pack_protect_string('1') => str_replace('<', '&lt;',sec_form_edit_users_mob_pack_protect_string("Administrador")));
$aLookup[] = array(sec_form_edit_users_mob_pack_protect_string('2') => str_replace('<', '&lt;',sec_form_edit_users_mob_pack_protect_string("Médico")));
$aLookup[] = array(sec_form_edit_users_mob_pack_protect_string('3') => str_replace('<', '&lt;',sec_form_edit_users_mob_pack_protect_string("Digitador")));
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['Lookup_tipo'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['Lookup_tipo'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['Lookup_tipo'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['Lookup_tipo'][] = '3';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"tipo\"";
          ...
          {
              $this->NM_ajax_info['fldList']['tipo']['valList'][$i] = sec_form_edit_users_mob_pack_protect_string($v);
          }
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][sec_form_edit_users_mob_pack_protect_string(NM_charset_to_utf8($this->medico))]) ? $aLookup[0][sec_form_edit_users_mob_pack_protect_string(NM_charset_to_utf8($this->medico))] : "";
...
$aLookup[] = array(sec_form_edit_users_mob_pack_protect_string('Y') => str_replace('<', '&lt;',sec_form_edit_users_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_opt_yes'] . "")));
$aLookup[] = array(sec_form_edit_users_mob_pack_protect_string('N') => str_replace('<', '&lt;',sec_form_edit_users_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_opt_no'] . "")));
...
$aLookup[] = array(sec_form_edit_users_mob_pack_protect_string('1') => str_replace('<', '&lt;',sec_form_edit_users_mob_pack_protect_string("Quito")));
$aLookup[] = array(sec_form_edit_users_mob_pack_protect_string('2') => str_replace('<', '&lt;',sec_form_edit_users_mob_pack_protect_string("Guayaquil")));
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['Lookup_sucursal'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['Lookup_sucursal'][] = '2';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['sucursal']['valList'][$i] = sec_form_edit_users_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
      ...
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->login))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_sec_form_edit_users_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['reg_start'] > $qt_geral_reg_sec_form_edit_users_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['reg_start'] = $qt_geral_reg_sec_form_edit_users_mob; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_sec_form_edit_users_mob) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['total'] + 1; 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['reg_start'] + 1;
