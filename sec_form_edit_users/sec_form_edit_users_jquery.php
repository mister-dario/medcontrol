...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_priv_admin' + iSeqRow).bind('blur', function() { sc_sec_form_edit_users_priv_admin_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_sec_form_edit_users_priv_admin_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_sec_form_edit_users_priv_admin_onfocus(this, iSeqRow) });
  $('#id_sc_field_sucursal' + iSeqRow).bind('blur', function() { sc_sec_form_edit_users_sucursal_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_sec_form_edit_users_sucursal_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_sec_form_edit_users_sucursal_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo' + iSeqRow).bind('blur', function() { sc_sec_form_edit_users_tipo_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_sec_form_edit_users_tipo_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_sec_form_edit_users_tipo_onfocus(this, iSeqRow) });
  $('#id_sc_field_medico' + iSeqRow).bind('blur', function() { sc_sec_form_edit_users_medico_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_sec_form_edit_users_medico_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_sec_form_edit_users_medico_onfocus(this, iSeqRow) });
...
function sc_sec_form_edit_users_priv_admin_onblur(oThis, iSeqRow) {
...
function sc_sec_form_edit_users_priv_admin_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_sec_form_edit_users_sucursal_onblur(oThis, iSeqRow) {
  do_ajax_sec_form_edit_users_validate_sucursal();
  scCssBlur(oThis);
}

function sc_sec_form_edit_users_sucursal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_sec_form_edit_users_sucursal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_sec_form_edit_users_tipo_onblur(oThis, iSeqRow) {
  do_ajax_sec_form_edit_users_validate_tipo();
  scCssBlur(oThis);
}

function sc_sec_form_edit_users_tipo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_sec_form_edit_users_event_tipo_onchange();
}

function sc_sec_form_edit_users_tipo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_sec_form_edit_users_medico_onblur(oThis, iSeqRow) {
  do_ajax_sec_form_edit_users_validate_medico();
  scCssBlur(oThis);
}

function sc_sec_form_edit_users_medico_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_sec_form_edit_users_medico_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}
