...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_filtro_cobros_dia/control_filtro_cobros_dia_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_filtro_cobros_dia_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_filtro_cobros_dia_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    $vertical_center = '';
...
<?php
 include_once("control_filtro_cobros_dia_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_filtro_cobros_dia'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_filtro_cobros_dia'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php echo "COBROS DEL DÍA" ?></div>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emisor_label" id="hidden_field_label_emisor" style="<?php echo $sStyleHidden_emisor; ?>"><span id="id_label_emisor"><?php echo $this->nm_new_label['emisor']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['php_cmp_required']['emisor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['php_cmp_required']['emisor'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fecha_fin_label" id="hidden_field_label_fecha_fin" style="<?php echo $sStyleHidden_fecha_fin; ?>"><span id="id_label_fecha_fin"><?php echo $this->nm_new_label['fecha_fin']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['php_cmp_required']['fecha_fin']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['php_cmp_required']['fecha_fin'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("control_filtro_cobros_dia");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("control_filtro_cobros_dia");
 parent.scAjaxDetailHeight("control_filtro_cobros_dia", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
