...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("control_filtro_cobros_dia_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_filtro_cobros_dia_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['recarga'];
}
    $remove_margin = '';
    $remove_border = '';
    $vertical_center = '';
...
if (isset($_SESSION['scriptcase']['control_filtro_cobros_dia']['error_buffer']) && '' != $_SESSION['scriptcase']['control_filtro_cobros_dia']['error_buffer'])
{
    echo $_SESSION['scriptcase']['control_filtro_cobros_dia']['error_buffer'];
}
...
<?php
 include_once("control_filtro_cobros_dia_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="control_filtro_cobros_dia_mob.php" 
               target="_self">
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_filtro_cobros_dia_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_filtro_cobros_dia_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emisor_line" id="hidden_field_data_emisor" style="<?php echo $sStyleHidden_emisor; ?>"> <span class="scFormLabelOddFormat css_emisor_label" style=""><span id="id_label_emisor"><?php echo $this->nm_new_label['emisor']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['php_cmp_required']['emisor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['php_cmp_required']['emisor'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecha_inicio_line" id="hidden_field_data_fecha_inicio" style="<?php echo $sStyleHidden_fecha_inicio; ?>"> <span class="scFormLabelOddFormat css_fecha_inicio_label" style=""><span id="id_label_fecha_inicio"><?php echo $this->nm_new_label['fecha_inicio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['php_cmp_required']['fecha_inicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['php_cmp_required']['fecha_inicio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecha_fin_line" id="hidden_field_data_fecha_fin" style="<?php echo $sStyleHidden_fecha_fin; ?>"> <span class="scFormLabelOddFormat css_fecha_fin_label" style=""><span id="id_label_fecha_fin"><?php echo $this->nm_new_label['fecha_fin']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['php_cmp_required']['fecha_fin']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['php_cmp_required']['fecha_fin'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("control_filtro_cobros_dia_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("control_filtro_cobros_dia_mob");
 parent.scAjaxDetailHeight("control_filtro_cobros_dia_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['control_filtro_cobros_dia_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
