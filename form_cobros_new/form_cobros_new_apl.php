...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_cobros_new']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_cobros_new']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_cobros_new']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_cobros_new']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_cobros_new']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_cobros_new']['form_cuentasxcobrar_script_case_init'] ]['form_cuentasxcobrar']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_cobros_new']['form_cuentasxcobrar_script_case_init'] ]['form_cuentasxcobrar']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_cobros_new']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_cobros_new']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->v_emisor)) 
          {
              $_SESSION['v_emisor'] = $this->v_emisor;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_cobros_new']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_cobros_new']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_cobros_new']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_cobros_new']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_cobros_new']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_cobros_new']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_cobros_new']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_cobros_new']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_cobros_new']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_cobros_new_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['initialize'])
          {
              $_SESSION['scriptcase']['form_cobros_new']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_cobros_new']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['form_cobros_new']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_cobros_new']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_cobros_new'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cobros_new']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cobros_new']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_cobros_new') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cobros_new']['label'] = "COBRO";
      ...
      $_SESSION['scriptcase']['error_icon']['form_cobros_new']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_cobros_new'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_orig'] = " where emiruc='" . $_SESSION['v_emisor'] . "' and cobnumero=" . $_SESSION['v_numcobro'] . " and fclnumero=" . $_SESSION['v_fcliente'] . " and cobusucrea='" . $_SESSION['usr_login'] . "'";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_pesq'] = " where emiruc='" . $_SESSION['v_emisor'] . "' and cobnumero=" . $_SESSION['v_numcobro'] . " and fclnumero=" . $_SESSION['v_fcliente'] . " and cobusucrea='" . $_SESSION['usr_login'] . "'";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cobros_new']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_cobros_new'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_cobros_new'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_cobros_new", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_cobros_new/form_cobros_new_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_cobros_new_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_cobros_new_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_cobros_new_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_cobros_new/form_cobros_new_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_cobros_new_erro.class.php"); 
      }
      $this->Erro      = new form_cobros_new_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['opcao']))
         { 
             if ($this->emiruc != "" || $this->cobnumero != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_cobros_new']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['form_cuentasxcobrar_script_case_init'] ]['form_cuentasxcobrar']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['form_cuentasxcobrar_script_case_init'] ]['form_cuentasxcobrar']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['form_cuentasxcobrar_script_case_init'] ]['form_cuentasxcobrar']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['form_cuentasxcobrar_script_case_init'] ]['form_cuentasxcobrar']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_cuentasxcobrar') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_cuentasxcobrar') . "/form_cuentasxcobrar_apl.php");
          $this->form_cuentasxcobrar = new form_cuentasxcobrar_apl;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dados_select']['cobvalretfte']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cobvalretfte = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dados_select']['cobvalretfte'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dados_select']['cobvalefec']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cobvalefec = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dados_select']['cobvalefec'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dados_select']['cobvalcheq']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cobvalcheq = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dados_select']['cobvalcheq'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dados_select']['cobvaltarjcred']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cobvaltarjcred = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dados_select']['cobvaltarjcred'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dados_select']['cobvaltransf']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cobvaltransf = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dados_select']['cobvaltransf'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['recarga'] = $this->nmgp_opcao;
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_cobros_new.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_cobros_new_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_cobros_new"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_cobros_new']) || !is_array($this->NM_ajax_info['errList']['geral_form_cobros_new']))
              {
                  $this->NM_ajax_info['errList']['geral_form_cobros_new'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_cobros_new'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
if ($error_test)
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_cobros_new' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_cobros_new']['contr_erro'] = 'off'; 
   ...
   if ($this->nmgp_opcao == "incluir")
   {
      if ($this->emiruc == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['php_cmp_required']['emiruc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['php_cmp_required']['emiruc'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "EMISOR" ; 
          ...
          if (!empty($this->emiruc) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['Lookup_emiruc']) && !in_array($this->emiruc, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['Lookup_emiruc']))
          {
              $hasError = true;
    ...
    function ValidateField_cobnumero(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->cobnumero, 11, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "NÚMERO; " ; 
                  if (!isset($Campos_Erros['cobnumero']))
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['php_cmp_required']['cobnumero']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['php_cmp_required']['cobnumero'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "NÚMERO" ; 
              if (!isset($Campos_Erros['cobnumero']))
   ...
   if ($this->nmgp_opcao == "incluir")
   {
      if ($this->fclnumero == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['php_cmp_required']['fclnumero']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['php_cmp_required']['fclnumero'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->fclnumero) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['Lookup_fclnumero']) && !in_array($this->fclnumero, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['Lookup_fclnumero']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['fclnumero']))
    ...
    function ValidateField_cobfecha(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['php_cmp_required']['cobfecha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['php_cmp_required']['cobfecha'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "FECHA" ; 
              if (!isset($Campos_Erros['cobfecha']))
    ...
    function ValidateField_tipo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['php_cmp_required']['tipo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['php_cmp_required']['tipo'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "TIPO" ; 
      ...
      if ($this->tipo != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['Lookup_tipo']) && !in_array($this->tipo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['Lookup_tipo']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tipo']))
    ...
    function ValidateField_tcrcodigo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->tcrcodigo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['Lookup_tcrcodigo']) && !in_array($this->tcrcodigo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['Lookup_tcrcodigo']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_cobvalcruz(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->cobvalcruz, 12, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['emiruc']['keyVal'] = form_cobros_new_pack_protect_string($this->nmgp_dados_form['emiruc']);
              $this->NM_ajax_info['fldList']['cobnumero']['keyVal'] = form_cobros_new_pack_protect_string($this->nmgp_dados_form['cobnumero']);
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['total'] < 0)
              {
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_cobros_new_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_cobros_new_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['emiruc']['valList'][$i] = form_cobros_new_pack_protect_string($v);
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fclnumero']['valList'][$i] = form_cobros_new_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cobros_new_pack_protect_string('A') => str_replace('<', '&lt;',form_cobros_new_pack_protect_string("ABONO")));
$aLookup[] = array(form_cobros_new_pack_protect_string('R') => str_replace('<', '&lt;',form_cobros_new_pack_protect_string("RETENCIÓN")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['Lookup_tipo'][] = 'A';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['Lookup_tipo'][] = 'R';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['tipo']['valList'][$i] = form_cobros_new_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cobros_new_pack_protect_string('null') => str_replace('<', '&lt;',form_cobros_new_pack_protect_string('------------------------')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['Lookup_tcrcodigo'][] = 'null';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tcrcodigo']['valList'][$i] = form_cobros_new_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_cartera($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
$_SESSION['scriptcase']['form_cobros_new']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_cuentasxcobrar->ini_controle();
              if ($this->form_cuentasxcobrar->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_cobros_new']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['parms'] = "emiruc?#?$this->emiruc?@?cobnumero?#?$this->cobnumero?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['reg_start']) ;  
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['reg_start'] < $qt_geral_reg_form_cobros_new;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['opcao']   = '';
          }
      } 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_cobros_new_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_filter_form'] . " and (emiruc='" . $_SESSION['v_emisor'] . "' and cobnumero=" . $_SESSION['v_numcobro'] . " and fclnumero=" . $_SESSION['v_fcliente'] . " and cobusucrea='" . $_SESSION['usr_login'] . "') and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_cobros_new = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['total'] = $qt_geral_reg_form_cobros_new;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_cobros_new_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_cobros_new_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_cobros_new_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cobros_new']['masterValue']))
{
